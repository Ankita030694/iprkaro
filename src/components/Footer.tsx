...
//               <h4 className="text-sm font-semibold mb-4 uppercase">Follow us on</h4>
...
//             {/* Services - Mobile */}
//             <div>
//               <h4 className="text-sm font-semibold mb-4 uppercase">Our Services</h4>
//               <ul className="space-y-2">
//                 <li>
...
//           <h4 className="text-sm font-semibold mb-6 uppercase text-gray-400">Queries</h4>
    ...
    <footer className="text-white home-page-font" style={{ backgroundColor: '#202020' }}>
      <div className="max-w-8xl px-4 lg:px-24 py-12">
        ...
        <div className="border-t border-gray-700 mt-12 pt-8">
          ...
          >
            <h4 className="text-sm font-semibold uppercase text-gray-400 group-hover:text-white transition-colors">
              Explore More
            </h4>
