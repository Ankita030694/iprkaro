  ...
  return (
    <div className="space-y-6">
      ...
      <div className="rounded-[28px] p-6 sm:p-7 bg-white border border-stone-200/70 shadow-xs">
        <h5 className="text-[11px] font-black text-slate-500 uppercase tracking-widest text-center mb-6">
          ...
          >
            ...
            {submitted ? (
              <div className="text-center py-6">
                ...
                <h4 className="text-xl font-black text-slate-900 mb-2">Request Confirmed</h4>
              ...
              <div>
                <div className="text-center mb-5">
                  ...
                  <h4 className="text-xl font-black text-slate-900">Book Free IP Consultation</h4>
