...
export default function SimplePricing() {
  ...
  return (
    <section id="pricing" className="w-full bg-white py-20 px-4 md:px-8">
      <div className="max-w-[1100px] mx-auto flex flex-col items-center">
        <h3 className="text-[#0C002B] font-nunito text-[32px] md:text-[52px] font-semibold text-center mb-12 md:mb-16 leading-[1.1] tracking-tight max-w-[320px] md:max-w-none">
