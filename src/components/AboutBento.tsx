          ...
          <div className="hidden md:grid grid-cols-4 gap-4 lg:gap-6 h-screen py-6">
              ...
              <div className="bg-white rounded-xl p-3 border border-gray-100 h-full max-h-[600px] flex flex-col overflow-y-auto custom-scrollbar hover:border-[#FFB703]/50 hover:shadow-lg hover:shadow-[#FFB703]/10 transition-all duration-300 cursor-pointer">
                ...
                <div className="mb-2">
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="text-[#0C002B] font-semibold text-xs">Your Dashboard</h3>
                  </div>
                </div>

                {/* Health Score Banner */}
                <div className="mb-2">
                  <h2 className="text-xl font-bold text-[#0C002B] mb-1">Excellent</h2>
                ...
                <div className="grid grid-cols-2 gap-1.5 mb-2">
                  <div className="bg-slate-50 rounded-lg p-1.5 border border-gray-100">
                    <p className="text-gray-500 text-[9px]">Apps</p>
                    <p className="text-sm font-bold text-[#0C002B]">1,247</p>
                  </div>
                  
                  <div className="bg-slate-50 rounded-lg p-1.5 border border-gray-100">
                    <p className="text-gray-500 text-[9px]">Success</p>
                    <p className="text-sm font-bold text-[#0C002B]">94.5%</p>
                  </div>
                </div>

                {/* Circular Progress */}
                <div className="mb-2">
                  <h4 className="text-[#0C002B] font-medium text-[10px] mb-1">Registrability</h4>
                ...
                {/* Status Timeline */}
                <div className="mb-2">
                  <h4 className="text-[#0C002B] font-medium text-[10px] mb-1.5">Application Status</h4>
                  <div className="space-y-1.5">
                    <div className="flex items-center gap-2">
                      <div className="w-2 h-2 bg-green-500 rounded-full flex-shrink-0"></div>
                      <div className="flex-1 min-w-0">
                        <p className="text-[#0C002B] text-[9px] truncate">Filed Successfully</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-2">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <div className="flex-1 min-w-0">
                        <p className="text-gray-400 text-[9px] truncate">Publication Pending</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-3 gap-1 mb-2">
                  ...
                  <div className="bg-slate-50 rounded p-1 text-center border border-gray-100">
                    ...
                    <p className="text-[#0C002B] text-[9px] font-bold">3/5</p>
                    <p className="text-gray-500 text-[7px]">Steps</p>
                  </div>
                </div>
                    
                {/* SEO Keywords Section */}
                <div className="mb-2 bg-slate-50 border border-gray-100 rounded-lg p-1.5">
                  <h4 className="text-[#0C002B] font-medium text-[9px] mb-1">Protected Services</h4>
                  <div className="flex flex-wrap gap-1">
                    ...
                    <span className="text-[7px] bg-white text-[#0C002B] px-1.5 py-0.5 rounded border border-gray-100">Brand Protection</span>
                    <span className="text-[7px] bg-white text-[#0C002B] px-1.5 py-0.5 rounded border border-gray-100">IP Rights</span>
                  </div>
                </div>
            ...
            <div className="col-span-1 space-y-4">
              ...
              <div className="bg-white rounded-xl p-3 border border-gray-100 h-[200px] flex flex-col justify-center overflow-hidden hover:border-[#FFB703]/50 hover:shadow-lg hover:shadow-[#FFB703]/10 transition-all duration-300 cursor-pointer">
                <h4 className="text-[#0C002B] font-medium text-xs mb-2">Our Services</h4>
                <div className="space-y-1.5">
                  ...
                  <div className="flex items-center gap-2 p-1.5 bg-slate-50 rounded-lg hover:bg-gray-100 transition-colors cursor-pointer border border-gray-50">
                    <i className="fas fa-copyright text-green-500 text-[10px] flex-shrink-0"></i>
                    <div className="min-w-0">
                      <p className="text-[#0C002B] text-[10px] font-medium truncate">Copyright Protection</p>
                      <p className="text-gray-500 text-[9px] truncate">Secure Creative Work</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-slate-50 rounded-xl p-3 border border-gray-100 h-[400px] flex flex-col overflow-hidden hover:border-[#FFB703]/50 hover:shadow-lg hover:shadow-[#FFB703]/10 transition-all duration-300 cursor-pointer">
                <div className="mb-2 flex-shrink-0">
                  ...
                  <h3 className="text-[#0C002B] font-semibold text-xs mt-0.5">Knowledge Hub</h3>
                </div>

                {/* Featured Article - SEO Optimized */}
                <div className="bg-white rounded-lg p-2 mb-2 flex-shrink-0 border border-gray-100 shadow-sm">
                  <h4 className="text-[#0C002B] font-medium text-[10px] mb-1 line-clamp-2">Trademark Registration Guide</h4>
                ...
                <div className="flex gap-1.5 mb-2 flex-wrap flex-shrink-0">
                  <button className="px-2 py-0.5 bg-[#0C002B] text-white text-[9px] rounded-full">All</button>
                  <button className="px-2 py-0.5 bg-white text-[#0C002B] text-[9px] rounded-full hover:bg-gray-100 transition-colors border border-gray-100">Trademark</button>
                  <button className="px-2 py-0.5 bg-white text-[#0C002B] text-[9px] rounded-full hover:bg-gray-100 transition-colors border border-gray-100">Patent</button>
                </div>

                {/* Quick Topics - SEO Keywords */}
                <div className="flex-1 overflow-y-auto custom-scrollbar">
                  <h4 className="text-[#0C002B] font-medium text-[10px] mb-1.5">Popular Topics</h4>
            ...
            <div className="col-span-1">
              <div className="bg-white rounded-xl p-3 border border-gray-100 h-full max-h-[600px] flex flex-col overflow-hidden hover:border-cyan-500/50 hover:shadow-lg hover:shadow-cyan-500/20 transition-all duration-300 cursor-pointer">
                ...
                {/* AI Text */}
                <h2 className="text-3xl font-bold text-cyan-500 mb-2 text-center">AI</h2>
                ...
                <div className="space-y-1.5 mb-3">
                  <div className="bg-cyan-500/5 border border-cyan-500/20 rounded-lg p-2">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <h4 className="text-[#0C002B] font-medium text-[10px]">Smart Analysis</h4>
                    </div>
                  ...
                  <div className="bg-yellow-500/5 border border-yellow-500/20 rounded-lg p-2">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <h4 className="text-[#0C002B] font-medium text-[10px]">Deep Search</h4>
                    </div>
                    <p className="text-gray-500 text-[8px] leading-relaxed">
                  ...
                  <div className="bg-green-500/5 border border-green-500/20 rounded-lg p-2">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <h4 className="text-[#0C002B] font-medium text-[10px]">Risk Scoring</h4>
                    </div>
                    <p className="text-gray-500 text-[8px] leading-relaxed">
                ...
                <div className="bg-slate-50 rounded-lg p-2 mb-2 border border-gray-100">
                  <h4 className="text-[#0C002B] font-medium text-[10px] mb-2 text-center">AI Performance</h4>
                  <div className="grid grid-cols-2 gap-1.5">
                    ...
                    <div className="text-center">
                      <p className="text-green-600 font-bold text-sm">&lt;3s</p>
                      <p className="text-gray-500 text-[7px]">Search Time</p>
                    </div>
                    <div className="text-center">
                      <p className="text-purple-600 font-bold text-sm">24/7</p>
                      <p className="text-gray-500 text-[7px]">Available</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mb-2 bg-slate-50 border border-gray-100 rounded-lg p-1.5">
                  <h4 className="text-[#0C002B] font-medium text-[9px] mb-1">AI Capabilities</h4>
                  <div className="space-y-1">
                     <div className="flex items-center justify-between text-[8px]">
                    ...
                    <div className="flex items-center justify-between text-[8px]">
                      <span className="text-gray-600 flex items-center gap-1">
                        <i className="fas fa-database text-purple-500 text-[7px]"></i>
                        NLP Processing
                      </span>
                ...
                <div className="mb-2 space-y-1">
                  <div className="flex items-start gap-1.5">
                    <i className="fas fa-check-circle text-green-500 text-[7px] mt-0.5 flex-shrink-0"></i>
                    <p className="text-gray-600 text-[7px] leading-tight">Instant trademark availability check India</p>
                  </div>
                  <div className="flex items-start gap-1.5">
                    <i className="fas fa-check-circle text-green-500 text-[7px] mt-0.5 flex-shrink-0"></i>
                    <p className="text-gray-600 text-[7px] leading-tight">Real-time IP conflict detection system</p>
                  </div>
                  <div className="flex items-start gap-1.5">
                    <i className="fas fa-check-circle text-green-500 text-[7px] mt-0.5 flex-shrink-0"></i>
                    <p className="text-gray-600 text-[7px] leading-tight">Automated brand protection monitoring</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="col-span-1 space-y-4">
              ...
              <div className="bg-white rounded-xl p-3 border border-gray-100 h-[400px] flex flex-col overflow-y-auto custom-scrollbar hover:border-[#FFB703]/50 hover:shadow-lg hover:shadow-[#FFB703]/10 transition-all duration-300 cursor-pointer">
                <div className="mb-2 flex-shrink-0">
                  <h4 className="text-[#0C002B] font-medium text-xs mb-2 flex items-center gap-1.5">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="flex items-start gap-1.5 bg-slate-50 p-1.5 rounded-lg border border-gray-50">
                      <i className="fas fa-tag text-green-500 text-[9px] mt-0.5 flex-shrink-0"></i>
                      <div className="min-w-0">
                        <p className="text-[#0C002B] text-[10px] font-medium">Affordable Pricing</p>
                        <p className="text-gray-500 text-[8px] line-clamp-2">Transparent costs, no hidden fees</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex-1 mt-2">
                  <h4 className="text-[#0C002B] font-medium text-xs mb-2">Our Track Record</h4>
                  <div className="grid grid-cols-2 gap-1.5">
                    <div className="bg-green-500/5 border border-green-500/20 rounded p-1.5 text-center">
                      ...
                      <p className="text-gray-500 text-[8px]">Success Rate</p>
                    </div>
                    <div className="bg-blue-500/5 border border-blue-500/20 rounded p-1.5 text-center">
                    ...
                    <div className="bg-purple-500/5 border border-purple-500/20 rounded p-1.5 text-center">
                      <p className="text-purple-600 font-bold text-sm">24/7</p>
                      <p className="text-gray-500 text-[8px]">Support</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl p-3 border border-gray-100 h-[200px] flex flex-col justify-between overflow-hidden hover:border-[#FFB703]/50 hover:shadow-lg hover:shadow-[#FFB703]/10 transition-all duration-300 cursor-pointer">
                <div>
                  ...
                  <p className="text-gray-600 text-[9px] leading-relaxed mb-2 line-clamp-3">
                ...
                <div className="flex items-center justify-around pt-2 border-t border-gray-100">
                  <div className="text-center">
                    <i className="fas fa-shield-alt text-green-500 text-[10px] mb-0.5"></i>
                    <p className="text-gray-500 text-[7px]">Govt. Reg.</p>
                  </div>
                  <div className="text-center">
                    <i className="fas fa-certificate text-blue-500 text-[10px] mb-0.5"></i>
            ...
            <div className="grid grid-cols-2 grid-rows-3 gap-2 h-full">
              ...
              <div className="bg-white rounded-lg p-3 border border-gray-100 flex flex-col justify-center hover:border-[#FFB703]/50 hover:shadow-lg hover:shadow-[#FFB703]/10 transition-all duration-300 cursor-pointer">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h3 className="text-[#0C002B] font-semibold text-xs">Dashboard</h3>
                </div>
                <h2 className="text-xl font-bold text-[#0C002B] mb-1">Excellent</h2>
                ...
                <div className="grid grid-cols-2 gap-1">
                  <div className="bg-slate-50 rounded p-1 text-center border border-gray-100">
                    <p className="text-[#0C002B] text-sm font-bold">94.5%</p>
                    <p className="text-gray-500 text-[8px]">Success</p>
                  </div>
                  <div className="bg-slate-50 rounded p-1 text-center border border-gray-100">
                    <p className="text-[#0C002B] text-sm font-bold">1.2L+</p>
                    <p className="text-gray-500 text-[8px]">Clients</p>
                  </div>
                </div>
              </div>
              ...
              <div className="row-span-2 bg-white rounded-lg p-3 border border-gray-100 flex flex-col justify-center items-center hover:border-cyan-500/50 hover:shadow-lg hover:shadow-cyan-500/20 transition-all duration-300 cursor-pointer">
                ...
                <h2 className="text-3xl font-bold text-cyan-500 mb-2">AI</h2>
                ...
                <div className="grid grid-cols-2 gap-1.5 w-full">
                  <div className="bg-cyan-500/5 rounded p-1.5 text-center border border-cyan-500/20">
                    <p className="text-cyan-600 font-bold text-sm">10M+</p>
              ...
              <div className="bg-white rounded-lg p-3 border border-gray-100 flex flex-col justify-center hover:border-cyan-500/50 hover:shadow-lg hover:shadow-cyan-500/20 transition-all duration-300 cursor-pointer">
                <h4 className="text-[#0C002B] font-semibold text-xs mb-2">Our Services</h4>
                <div className="space-y-1.5">
                  ...
                  <div className="flex items-center gap-2 bg-slate-50 rounded p-1.5 border border-gray-100">
                    <i className="fas fa-copyright text-green-500 text-xs"></i>
                    <p className="text-[#0C002B] text-[9px] font-medium">Copyright Protection</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-slate-50 rounded-lg p-3 border border-gray-100 flex flex-col hover:border-[#FFB703]/50 hover:shadow-lg hover:shadow-[#FFB703]/10 transition-all duration-300 cursor-pointer">
                <div className="mb-2">
                  ...
                  <h3 className="text-[#0C002B] font-semibold text-xs text-opacity-80">Knowledge Hub</h3>
                </div>
                <div className="bg-white rounded p-2 mb-2 border border-gray-100 shadow-sm">
                  <h4 className="text-[#0C002B] font-medium text-[9px] mb-1">Trademark Guide 2025</h4>
                  <div className="flex gap-1">
              ...
              <div className="bg-white rounded-lg p-3 border border-gray-100 flex flex-col hover:border-green-500/50 hover:shadow-lg hover:shadow-green-500/20 transition-all duration-300 cursor-pointer">
                <h4 className="text-[#0C002B] font-semibold text-xs mb-2 flex items-center gap-1">
                  <i className="fas fa-star text-yellow-500 text-[10px]"></i>
                  Why IPR Karo
                </h4>
                <div className="space-y-1.5 mb-2">
                  ...
                  <div className="flex items-center gap-1.5 bg-slate-50 rounded p-1.5 border border-gray-100">
                    <i className="fas fa-tag text-green-500 text-[9px]"></i>
                    <p className="text-[#0C002B] text-[9px]">Affordable Price</p>
                  </div>
                </div>
                <div className="flex gap-1 justify-around pt-2 border-t border-gray-100">
                  <div className="text-center">
                    <i className="fas fa-shield-alt text-green-500 text-xs"></i>
                    <p className="text-gray-500 text-[7px]">Govt.</p>
                  </div>
                  <div className="text-center">
