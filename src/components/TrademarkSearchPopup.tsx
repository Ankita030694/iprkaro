    ...
    <>
      ...
      <div className="w-full h-screen relative overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row gap-0 h-full overflow-hidden">
          ...
          <div 
            className="w-full lg:w-[70%] h-full flex flex-col overflow-hidden"
            style={{
          ...
          <div className="w-full lg:w-[30%] bg-[#121212] p-4 sm:p-5 lg:p-6 flex flex-col justify-center h-full overflow-hidden">
            ...
            <form onSubmit={handleSubmit} className="space-y-2 sm:space-y-2.5">
                ...
                <label className="text-white text-sm sm:text-xs font-medium mb-2 sm:mb-1 block font-nunito text-left">
                  ...
                  className={`w-full px-2 py-1.5 sm:px-3 sm:py-2 border rounded-lg text-white text-xs sm:text-sm focus:outline-none focus:border-[#fbbf24] placeholder-gray-400 bg-transparent ${
              ...
              <div>
                ...
                <label className="text-white text-sm sm:text-xs font-medium mb-2 sm:mb-1 block font-nunito text-left">
                    ...
                    <select
                      ...
                      onChange={handleInputChange}
                  className={`w-full px-2 py-1.5 sm:px-3 sm:py-2 border rounded-lg text-white text-xs sm:text-sm focus:outline-none focus:border-[#fbbf24] bg-transparent ${
                ...
                <label className="text-white text-sm sm:text-xs font-medium mb-2 sm:mb-1 block font-nunito text-left">
                    ...
                    <div className="relative">
                      <input
                        ...
                        onChange={handleInputChange}
                    className="w-full px-2 py-1.5 sm:px-3 sm:py-2 pr-8 border border-gray-600 rounded-lg text-white text-xs sm:text-sm focus:outline-none focus:border-[#fbbf24] placeholder-gray-400 bg-transparent"
                        readOnly
                      />
                      <button
                        type="button"
              ...
              <button
                ...
                className={`w-full font-semibold py-2 sm:py-2.5 rounded-lg transition-colors duration-300 mt-2 sm:mt-3 text-sm ${
                  isSubmitting 
