        ...
        <div className="relative z-10 mt-6 md:mt-16 px-2 lg:px-3 mb-6 md:mb-16">
          <div className="max-w-8xl mx-auto">
            ...
            <div className="text-center mb-6 md:mb-10">
              <h3 className="text-white text-center font-nunito text-[26px] md:text-[40px] lg:text-[36px] font-medium leading-[30px] md:leading-[44px] lg:leading-[40px] w-full mb-3">
                    ...
                    >
                      ...
                      >
                        ...
                        <div className="w-full text-center mb-4">
                          <h4 className="text-white font-nunito text-[15px] md:text-[18px] lg:text-[22px] font-semibold leading-snug">
                            {plan.name}
                          </h4>
                        </div>
