  ...
  return (
    <section className="w-full bg-white py-10 px-4 md:px-8">
      <div className="max-w-[800px] mx-auto flex flex-col items-center">
        <h3 className="text-[#0C002B] font-nunito text-[32px] md:text-[42px] font-semibold text-center mb-10 leading-[1.1] tracking-tight max-w-[300px] md:max-w-[500px]">
          {title || (
            <>
            ...
            return (
              ...
              >
                <div className="p-4 md:p-6 flex justify-between items-center bg-white z-10 relative min-h-[80px] md:min-h-0">
                  <h4 className="text-[#0C002B] font-nunito text-[15px] md:text-[20px] font-medium pr-4 leading-tight">
                    {faq.question}
                  </h4>
