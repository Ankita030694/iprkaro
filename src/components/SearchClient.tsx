      ...
      <div className="w-full max-w-2xl lg:max-w-2xl relative mt-4 lg:mt-7 px-4 lg:px-0">
        <div className="relative">
          ...
          <button 
            ...
            className="absolute right-2 lg:right-4 top-1/2 transform -translate-y-1/2 px-4 lg:px-8 py-2 rounded-[20px] bg-[#FFB703] hover:bg-[#e6a602] transition-colors duration-300 text-[#170154] font-nunito font-semibold text-xs lg:text-sm"
          >
            Search
          </button>
        </div>
