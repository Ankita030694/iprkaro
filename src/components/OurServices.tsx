    ...
    <section className="py-12 lg:py-16 relative overflow-hidden" style={{ backgroundColor: '#0C002B' }}>
      <div className="container mx-auto px-4 md:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-8 lg:mb-12">
          <h3 className="text-white font-nunito text-[28px] md:text-[36px] lg:text-[38px] font-medium leading-[32px] md:leading-[39.6px] lg:leading-[42px] mb-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-6">
          {services.map((service, index) => (
            ...
            >
              ...
              {/* Title */}
              <h4 className="text-white font-nunito text-[18px] md:text-[20px] lg:text-[22px] font-semibold leading-tight mb-3">
                {service.title}
              </h4>
