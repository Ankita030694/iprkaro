        ...
        <div className="grid lg:grid-cols-2 gap-10 items-start">
          ...
          <div className="space-y-[28.8px] flex flex-col justify-start">
            <div className="space-y-[18px]">
              <h3 className="text-white text-left font-nunito text-[23.4px] md:text-[36px] font-medium leading-[28.8px] md:leading-[39.6px] w-full">
                Have Question?
                <br />
            ...
            {searchResult && (
              ...
              >
                <div className="flex justify-between items-start mb-[10.8px]">
                  <h5 className="text-white font-nunito text-[14.4px] md:text-[16.2px] font-semibold leading-snug" style={{ color: '#FFB703' }}>
              ...
              <div key={index} className="relative">
                ...
                >
                  ...
                  <div className="flex justify-between items-center mb-[10.8px]">
                    <h4 className="text-white font-nunito text-[13.5px] md:text-[16.2px] lg:text-[19.8px] font-semibold pr-[14.4px] leading-snug">
                      {faq.question}
                    </h4>
                    <FontAwesomeIcon
                      icon={faChevronDown}
