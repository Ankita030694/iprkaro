...
export default function WhyTrademark() {
  ...
  return (
    <section className="w-full px-0 md:px-20 lg:px-10 relative overflow-visible mt-5 rounded-[40px] md:min-h-fit min-h-[1200px] py-8" style={{
      ...
      <h3 className="text-white text-center font-nunito text-[28px] md:text-[45px] lg:text-[38px] font-medium leading-[32px] md:leading-[45px] lg:leading-[42px] w-full my-8 md:my-20 lg:my-16">
          <span
              ...
              {featureCards.map((card, index) => {
                ...
                return (
                  ...
                  <div className="relative z-[2] w-full text-left">
                    <h4 className="text-white font-nunito text-[12px] md:text-[20px] lg:text-[18px] font-semibold leading-tight mb-1 md:mb-1.5 lg:mb-0.5 break-words">
                      {card.title}
                    </h4>
      ...
      <div className="w-full relative z-10 px-8 md:px-20 lg:px-20 min-h-fit mt-30 mb-30">
        ...
        <div className="hidden md:flex flex-row w-full gap-4 lg:gap-3">
            ...
            >
              ...
              <div className="relative z-10 flex flex-col h-full">
                <div className="flex flex-col justify-start px-3 md:px-4 lg:px-5 py-3 md:py-4 lg:py-4 items-start">
                  <h4 className="text-white font-nunito text-[18px] md:text-[22px] lg:text-[20px] font-semibold leading-tight mb-1 md:mb-2 lg:mb-1.5 break-words mt-6 md:mt-8 lg:mt-6">
          ...
          <div className="flex-1 flex flex-col items-stretch min-w-[260px] lg:min-w-[220px]">
            ...
            >
              <h4 className="text-white font-nunito text-[20px] md:text-[24px] lg:text-[20px] font-semibold leading-tight mb-2 lg:mb-1.5 text-center -mt-20">
        ...
        <div className="flex md:hidden flex-col w-full gap-4 min-h-fit">
            ...
            >
              ...
              <div className="relative z-10 flex flex-col h-full">
                <div className="flex flex-col justify-start px-3 py-3 items-start">
                  <h4 className="text-white font-nunito text-[16px] font-semibold leading-tight mb-1 break-words mt-4">
                    Instant AI-Powered Trademark Search
                  </h4>
          ...
          <div className="flex justify-center items-center">
            ...
            >
              <h4 className="text-white font-nunito text-[18px] font-semibold leading-tight mb-2 text-center">
                Start Your Trademark Registration Now
              </h4>
