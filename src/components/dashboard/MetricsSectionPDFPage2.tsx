  ...
  return (
    <div className="w-full font-[Poppins] pdf-page-2" style={{ padding: '8px', boxSizing: 'border-box' }}>
      ...
      <div className="w-full" style={{
        ...
        <h3 className="text-black text-xl font-medium" style={{ marginBottom: '12px', paddingBottom: '0px', boxSizing: 'border-box' }}>Key Factors</h3>
          ...
          {keyFactors.map((factor, index) => (
            ...
            >
              ...
              <div className="flex-1" style={{ boxSizing: 'border-box' }}>
                <h5 className="text-black text-base font-medium" style={{ marginBottom: '4px', paddingBottom: '0px', boxSizing: 'border-box' }}>
                  {factor.label}
                </h5>
      ...
      <div className="w-full" style={{
        ...
        <h3 className="text-black text-xl font-medium" style={{ marginBottom: '12px', paddingBottom: '0px', boxSizing: 'border-box' }}>Documents Required for Trademark Registration</h3>
        <div 
          style={{ 
            display: 'grid',
