  ...
  return (
    <div className="space-y-4 md:space-y-6 md:mx-auto w-full">
      ...
      <div className="space-y-5">
        <h4 className="text-[#0C002B] font-nunito text-lg md:text-2xl font-medium text-center md:text-left">
            ...
            <div className="grid grid-cols-2 grid-rows-3 gap-3">
              {features.map((feature, index) => (
                <div key={index} className="flex items-center gap-3">
                  ...
                  <h4 className="text-[#0C002B] font-nunito text-[14px] font-medium leading-[14px] break-words flex-1">
                    {feature.text}
                  </h4>
                </div>
              ))}
      ...
      <div className="mt-0 md:mt-12 mb-6 w-full">
        ...
        <div className="flex-1 space-y-8">
            <div className="text-center lg:text-left">
              <h4 className="text-[#0C002B] font-nunito text-base md:text-xl lg:text-2xl font-medium">
