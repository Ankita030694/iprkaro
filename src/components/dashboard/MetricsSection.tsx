      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-5 items-stretch">
          <div className="lg:col-span-3 flex flex-col">
            ...
            >
              <h4 className="text-[#0C002B] font-nunito text-lg md:text-xl font-semibold">
...
function MetricCard({ 
  ...
  return (
    <div className="flex flex-col items-center h-full">
      <h5 className="text-[#0C002B] font-nunito text-base md:text-lg font-semibold mb-3">
        {title}
      </h5>
      ...
      >
        <div className="flex items-center justify-between mb-2">
          <h6 className="text-[#0C002B] font-nunito text-md font-semibold">
            Remarks
          </h6>
...
function KeyFactorsColumn({ keyFactors }: { keyFactors: AnalysisData['keyFactors'] }) {
  ...
  return (
    <div className="lg:col-span-1 flex flex-col">
      ...
      >
        <h4 className="text-[#0C002B] font-nunito text-lg md:text-xl xl:text-lg font-semibold">
          Key Factors
        </h4>
      </div>
        ...
        {factors.map((factor, index) => (
          ...
          >
            ...
            <div className="flex-1">
              <h5 className="text-[#0C002B] font-nunito text-sm font-semibold mb-0.5">
                {factor.label}
              </h5>
  ...
  return (
    <div className="block md:hidden space-y-6">
      <div className="space-y-3">
        <h5 className="text-[#0C002B] font-nunito text-base font-semibold text-center">
  ...
  return (
    <div className="p-2" style={{ borderRadius: '8px', border: '1.5px solid #e2e8f0', background: '#ffffff' }}>
      <div className="flex items-center justify-between mb-1.5">
        <h6 className="text-[#0C002B] font-nunito text-[10px] font-semibold">Assessment</h6>
        <div>
          {!isGood ? (
...
function MobileKeyFactors({ keyFactors }: { keyFactors: AnalysisData['keyFactors'] }) {
  ...
  return (
    <div className="mb-10">
      ...
      >
        <h4 className="text-[#0C002B] font-nunito text-base font-semibold text-left">
          Key Factors
        </h4>
      </div>
        ...
        <div className="space-y-2">
          {factors.map((factor, index) => (
            <div key={index} className="flex items-start gap-2 p-2 rounded-lg border border-slate-100 bg-white shadow-sm">
              ...
              <div className="flex-1">
                <h6 className="text-[#0C002B] font-nunito text-[10px] font-semibold mb-0.5">{factor.label}</h6>
                <p className="font-nunito text-[9px] leading-tight text-[#4B5563]">
                  {factor.value}
                </p>
              </div>
