...
export default function PlansSection() {
  ...
  return (
    <div className="flex-1 space-y-3">
      <h5 className="text-[#0C002B] font-nunito font-medium text-lg md:text-3xl leading-[20px] mb-5 text-center">
        Our Plans
      </h5>
          ...
          >
            ...
            >
              <div className="text-center mb-5">
                <h4 className="text-[#0C002B] font-nunito text-lg md:text-3xl font-semibold mb-1.5">
                  {plan.name}
                </h4>
