  ...
  return (
    <div className="hidden lg:block sticky top-24 ml-40" style={{ zoom: 0.68 }}>
      ...
      >
        ...
        >
          <h4 className="text-[#0C002B] font-nunito font-medium text-lg md:text-3xl leading-[50px]">
        ...
        >
          <h5 className="text-[#0C002B] font-nunito font-medium text-lg md:text-3xl leading-[16px] mb-5 text-center">
            Price Breakdown
          </h5>
