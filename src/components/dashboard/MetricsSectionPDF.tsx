  ...
  return (
    <div className="w-full font-[Poppins]" style={{ padding: '8px', boxSizing: 'border-box' }}>
      ...
      <div className="w-full" style={{
        ...
        <div className="flex items-start justify-between" style={{ boxSizing: 'border-box' }}>
          {/* Logo */}
          <div className="relative" style={{ width: '70px', height: '50px', boxSizing: 'border-box' }}>
            <img
          ...
          {/* Report Details */}
          <div className="text-right" style={{ boxSizing: 'border-box' }}>
            ...
            <div className="flex flex-col" style={{ boxSizing: 'border-box' }}>
              <p className="text-black text-lg font-medium" style={{ marginBottom: '5px', paddingBottom: '0px', boxSizing: 'border-box' }}>Generated by: {userName}</p>
