      ...
      <div className="relative z-10 w-full max-w-8xl mx-auto px-6 md:px-12 lg:px-16">
        ...
        <div className="text-center mb-12 md:mb-16 pt-8 md:pt-12">
          <div className="inline-block relative">
            ...
            <h3 className="text-white font-nunito text-[28px] md:text-[48px] font-bold leading-[36px] md:leading-[56px] tracking-tight">
          ...
          <div className="space-y-6 md:space-y-8">
            ...
            <div className="space-y-6 md:space-y-8">
              <div className="flex items-center space-x-3">
                ...
                <h4 className="text-white font-nunito text-[18px] md:text-[32px] font-bold leading-[24px] md:leading-[38px]">
