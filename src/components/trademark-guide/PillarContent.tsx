    ...
    <div className="space-y-3 lg:space-y-4 xl:space-y-5">
      ...
      <section id="what-is-trademark" className="scroll-mt-14">
        <div className="space-y-2 lg:space-y-3">
          <div className="flex items-center gap-1.5 lg:gap-2">
            ...
            <h3 className="text-white font-nunito text-lg md:text-xl lg:text-2xl xl:text-3xl font-bold">
              What is a Trademark?
            </h3>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2 mt-3">
              ...
              >
                <div className="flex items-center gap-1.5 mb-1">
                  ...
                  <h5 className="text-white font-nunito text-sm lg:text-base font-semibold">Word Marks</h5>
                </div>
              ...
              >
                <div className="flex items-center gap-1.5 mb-1">
                  ...
                  <h5 className="text-white font-nunito text-sm lg:text-base font-semibold">Logo Marks</h5>
                </div>
                <p className="text-white/90 font-nunito text-xs lg:text-sm">
              ...
              >
                <div className="flex items-center gap-1.5 mb-1">
                  ...
                  <h5 className="text-white font-nunito text-sm lg:text-base font-semibold">Composite Marks</h5>
                </div>
                <p className="text-white/90 font-nunito text-xs lg:text-sm">
              ...
              >
                <div className="flex items-center gap-1.5 mb-1">
                  ...
                  <h5 className="text-white font-nunito text-sm lg:text-base font-semibold">Non-Traditional Marks</h5>
                </div>
                <p className="text-white/90 font-nunito text-xs lg:text-sm">
            ...
            <div className="space-y-2">
              ...
              >
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <h5 className="text-white font-nunito text-sm lg:text-base font-semibold mb-1">
      ...
      <section id="process" className="scroll-mt-14">
        <div className="space-y-3 lg:space-y-3.5">
          <div className="flex items-center gap-2 lg:gap-3">
            ...
            <h3 className="text-white font-nunito text-xl md:text-2xl lg:text-3xl xl:text-4xl font-bold">
          ...
          >
                ...
                <div key={index} className="relative flex gap-3">
                  ...
                  >
                    <div className="flex items-center justify-between flex-wrap gap-1.5 mb-1.5">
                      <h5 className="text-white font-nunito text-sm lg:text-base font-semibold">
                        {step.step}
                      </h5>
                      <span
            ...
            >
              <div className="flex items-start gap-2">
                ...
                <div>
                  <h6 className="text-white font-nunito text-sm font-semibold mb-1">Forms Used in Trademark Registration</h6>
      ...
      <section id="fees" className="scroll-mt-14">
        <div className="space-y-3 lg:space-y-3.5">
          ...
          >
            ...
            >
              <h5 className="text-white font-nunito text-base font-semibold mb-2 flex items-center gap-1.5">
            ...
            {/* Service Packages */}
            <h5 className="text-white font-nunito text-base font-semibold mb-3">Our Service Packages</h5>
              ...
              {feesStructure.map((pkg, index) => (
                ...
                >
                  ...
                  <div className="text-center mb-3">
                    <h6 className="text-white font-nunito text-base font-semibold mb-1.5">
                      {pkg.package}
                    </h6>
          ...
          >
            ...
            >
              <div className="flex items-start gap-2">
                ...
                <div>
                  <h6 className="text-white font-nunito text-sm font-semibold mb-0.5">Pro Tip</h6>
                  <p className="text-white/90 font-nunito text-xs">
      ...
      <section id="classes" className="scroll-mt-14">
        <div className="space-y-3 lg:space-y-3.5">
          ...
          >
            ...
            >
              <h5 className="text-white font-nunito text-sm lg:text-base font-semibold mb-1.5 flex items-center gap-1.5">
            ...
            <h5 className="text-white font-nunito text-base font-semibold mb-2">Popular Trademark Classes:</h5>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
            ...
            >
              <div className="flex items-start gap-2">
                ...
                <div>
                  <h6 className="text-white font-nunito text-sm font-semibold mb-1.5">Need Help Selecting Classes?</h6>
          ...
          >
                ...
                >
                  <div className="flex items-start gap-2 mb-2">
                    ...
                    <div className="flex-1">
                      <h5 className="text-white font-nunito text-sm lg:text-base font-semibold mb-0.5">
                        {item.objection}
                      </h5>
            ...
            >
              <div className="flex items-start gap-2">
                ...
                <div>
                  <h6 className="text-white font-nunito text-sm lg:text-base font-semibold mb-1.5">
      ...
      <section id="cta" className="scroll-mt-14">
        ...
        >
          ...
          <div className="relative text-center">
            ...
            <h4 className="text-white font-nunito text-xl lg:text-2xl xl:text-3xl font-bold mb-3">
      ...
      <section id="related-resources" className="scroll-mt-14">
        <div className="space-y-3 lg:space-y-3.5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
            {[
              ...
              >
                ...
                <h5 className="text-white font-nunito text-sm lg:text-base font-semibold mb-1.5 group-hover:text-[#FFB703] transition-colors">
                  {resource.title}
                </h5>
          ...
          >
            <h5 className="text-white font-nunito text-base font-semibold mb-2">
