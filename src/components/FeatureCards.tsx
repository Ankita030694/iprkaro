    ...
    <section className="w-full bg-[#171717] py-16 px-4">
      <div className="max-w-6xl mx-auto">
        <div className="flex flex-col lg:flex-row items-center justify-center gap-6">
          ...
          <div className="group bg-[rgba(251,191,36,0.10)] hover:bg-[rgba(251,191,36,0.15)] rounded-[15px] p-[25px_27.5px_24px_28.5px] flex items-center justify-center gap-10 w-full max-w-[469px] h-[114px] hover:h-[240px] transition-all duration-700 ease-out cursor-pointer relative overflow-hidden backdrop-blur-[17.7px]">
            ...
            <div className="w-full text-center group-hover:block hidden relative z-10">
              <h4 className="text-[#fbbf24] font-bold text-lg mb-2 w-full">Instant AI search & class suggestions</h4>
          ...
          <div className="group bg-[rgba(251,191,36,0.10)] hover:bg-[rgba(251,191,36,0.15)] rounded-[15px] p-[25px_27.5px_24px_28.5px] flex items-center justify-center gap-10 w-full max-w-[469px] h-[114px] hover:h-[240px] transition-all duration-700 ease-out cursor-pointer relative overflow-hidden backdrop-blur-[17.7px]">
            ...
            {/* Hover state content */}
            <div className="w-full text-center group-hover:block hidden relative z-10">
              <h4 className="text-[#fbbf24] font-bold text-lg mb-2 w-full">Risk prediction & objection alerts</h4>
              <div className="w-full h-px bg-[#fbbf24] mb-3 mx-auto"></div>
              <p className="text-gray-300 text-sm leading-relaxed">
          ...
          <div className="group bg-[rgba(251,191,36,0.10)] hover:bg-[rgba(251,191,36,0.15)] rounded-[15px] p-[25px_27.5px_24px_28.5px] flex items-center justify-center gap-10 w-full max-w-[469px] h-[114px] hover:h-[240px] transition-all duration-700 ease-out cursor-pointer relative overflow-hidden backdrop-blur-[17.7px]">
            ...
            {/* Hover state content */}
            <div className="w-full text-center group-hover:block hidden relative z-10">
              <h4 className="text-[#fbbf24] font-bold text-lg mb-2 w-full">Easy filing with expert support</h4>
              <div className="w-full h-px bg-[#fbbf24] mb-3 mx-auto"></div>
              <p className="text-gray-300 text-sm leading-relaxed">
