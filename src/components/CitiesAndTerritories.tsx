    ...
    <section className="bg-[#0C002B] py-16 sm:py-20 md:py-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 sm:mb-16">
          <h3 className="text-white font-nunito font-semibold text-2xl sm:text-3xl md:text-4xl mb-4 sm:mb-6">
        ...
        {/* All Locations Grid */}
        <div>
          <h4 className="text-[#FFB703] font-nunito font-semibold text-xl sm:text-2xl mb-6 sm:mb-8 text-center">
        ...
        <div className="mt-12 sm:mt-16 text-center">
          <div className="bg-gradient-to-r from-[rgba(255,183,3,0.1)] to-[rgba(6,154,129,0.1)] rounded-xl p-6 sm:p-8 border border-[rgba(255,183,3,0.2)]">
            <h5 className="text-white font-nunito font-semibold text-lg sm:text-xl mb-4">
