      ...
      <section id="overview" className="scroll-mt-20">
        <div className="space-y-3 lg:space-y-4 xl:space-y-5">
          <div className="flex items-center gap-2 lg:gap-3 xl:gap-4">
            ...
            <h3 className="text-white font-nunito text-base md:text-lg lg:text-xl xl:text-2xl 2xl:text-3xl font-bold">
          ...
          >
            ...
            <div className="relative flex flex-col md:flex-row items-center justify-between gap-3 lg:gap-4">
              <div className="flex items-start gap-3 lg:gap-4">
                ...
                <div>
                  <h4 className="text-white font-nunito text-base md:text-lg lg:text-xl xl:text-2xl font-bold mb-1.5">
          ...
          <div className="relative space-y-3 lg:space-y-4">
            ...
            {processSteps.map((step, index) => (
              <div key={index} className="relative flex gap-3 lg:gap-4">
                ...
                >
                  <h5 className="text-white font-nunito text-sm md:text-base lg:text-lg font-semibold mb-1.5">
                    {step.step}
                  </h5>
            ...
            <div className="relative">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-4">
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <h5 className="text-white font-nunito font-semibold text-xs lg:text-sm mb-0.5">End-to-End Support</h5>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <h5 className="text-white font-nunito font-semibold text-xs lg:text-sm mb-0.5">Expert Team</h5>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <h5 className="text-white font-nunito font-semibold text-xs lg:text-sm mb-0.5">Quick Process</h5>
