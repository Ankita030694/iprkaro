            ...
            <div className="min-w-0">
              ...
              <div className="bg-white p-4 md:p-12 rounded-xl md:rounded-2xl shadow-sm space-y-8 md:space-y-16">
                ...
                <section id="eligible-works" className="scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Comprehensive List of Eligible Works</h3>
                  ...
                  <div className="space-y-6">
                      ...
                      <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
                          <div className="flex items-center mb-4">
                              ...
                              <h4 className="text-xl font-bold text-gray-900">1. Literary Works</h4>
                          </div>
                      ...
                      <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
                          <div className="flex items-center mb-4">
                              ...
                              <h4 className="text-xl font-bold text-gray-900">2. Musical Works</h4>
                          </div>
                          <p className="text-gray-700 mb-3">
                      ...
                      <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
                          <div className="flex items-center mb-4">
                              ...
                              <h4 className="text-xl font-bold text-gray-900">3. Artistic Works</h4>
                          </div>
                          <p className="text-gray-700 mb-3">
                      ...
                      <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
                          <div className="flex items-center mb-4">
                              ...
                              <h4 className="text-xl font-bold text-gray-900">4. Cinematograph Films</h4>
                          </div>
                          <p className="text-gray-700 mb-3">
                      ...
                      <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow">
                          <div className="flex items-center mb-4">
                              ...
                              <h4 className="text-xl font-bold text-gray-900">5. Sound Recordings</h4>
                          </div>
                          <p className="text-gray-700 mb-3">
                ...
                <section id="owner-rights" className="scroll-mt-24 md:scroll-mt-32">
                    <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Rights of the Copyright Owner</h3>
                    <p className="text-base md:text-lg leading-relaxed mb-6 text-gray-700">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        <div className="bg-gray-50 p-6 rounded-xl">
                            <h4 className="font-bold text-lg text-[rgb(110,94,147)] mb-3">1. Economic Rights</h4>
                        ...
                        <div className="bg-gray-50 p-6 rounded-xl">
                            <h4 className="font-bold text-lg text-[rgb(110,94,147)] mb-3">2. Moral Rights (Section 57)</h4>
                ...
                <section id="software-copyright" className="scroll-mt-24 md:scroll-mt-32">
                    <div className="bg-[rgb(110,94,147)]/5 border border-[rgb(110,94,147)]/20 p-6 md:p-8 rounded-2xl">
                        <div className="flex items-start mb-4">
                             ...
                             <h3 className="text-xl md:text-3xl font-bold text-gray-900">Software Protection: A Special Case</h3>
                        </div>
                        ...
                        <h4 className="font-bold text-lg text-gray-900 mb-2">What qualifies as "Software"?</h4>
                        <p className="text-gray-700 mb-4">
                            It includes Source Code (human-readable), Object Code (machine-readable), and even the user manuals.
                        </p>
                        <h4 className="font-bold text-lg text-gray-900 mb-2">Do I need to reveal my entire code?</h4>
                        <p className="text-gray-700 mb-4">
                ...
                <section id="copyright-fees" className="scroll-mt-24 md:scroll-mt-32">
                   <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Copyright Registration Costs (2025)</h3>
                   <p className="text-base md:text-lg leading-relaxed mb-6 text-gray-700">
                ...
                <section id="registration-process" className="scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">The Registration Process</h3>
                  <div className="relative border-l-2 border-gray-200 ml-4 md:ml-6 pl-8 md:pl-10 space-y-8 md:space-y-12 my-8">
                     ...
                     <div className="relative">
                        ...
                        <h4 className="text-lg md:text-xl font-bold text-gray-900 mb-2">Filing Application (Form XIV)</h4>
                     ...
                     <div className="relative">
                        ...
                        <h4 className="text-lg md:text-xl font-bold text-gray-900 mb-2">Diary Number & Mandatory Wait</h4>
                     ...
                     <div className="relative">
                        ...
                        <h4 className="text-lg md:text-xl font-bold text-gray-900 mb-2">Scrutiny & Examination</h4>
                     ...
                     <div className="relative">
                        ...
                        <h4 className="text-lg md:text-xl font-bold text-gray-900 mb-2">Registration (ROC)</h4>
                ...
                <section id="societies-royalty" className="scroll-mt-24 md:scroll-mt-32">
                   <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Copyright Societies & Royalties</h3>
                   <p className="text-base md:text-lg leading-relaxed mb-6 text-gray-700">
                   ...
                   <div className="grid md:grid-cols-2 gap-6">
                      <div className="p-6 border border-gray-200 rounded-xl">
                          <h4 className="text-lg font-bold text-gray-900 mb-2">IPRS (Indian Performing Right Society)</h4>
                      ...
                      <div className="p-6 border border-gray-200 rounded-xl">
                          <h4 className="text-lg font-bold text-gray-900 mb-2">ISRA (Indian Singers Rights Association)</h4>
                ...
                <section id="documents-checklist" className="scroll-mt-24 md:scroll-mt-32">
                   <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Documents Required for Filing</h3>
                ...
                <section id="term-of-protection" className="scroll-mt-24 md:scroll-mt-32">
                    <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">How Long Does It Last?</h3>
                    <div className="grid md:grid-cols-2 gap-6">
                        <div className="bg-purple-50 p-6 rounded-xl border border-purple-100">
                             <h4 className="font-bold text-xl text-[rgb(110,94,147)] mb-2">Lifetime + 60 Years</h4>
                        ...
                        <div className="bg-purple-50 p-6 rounded-xl border border-purple-100">
                             <h4 className="font-bold text-xl text-[rgb(110,94,147)] mb-2">60 Years Flat</h4>
                ...
                <section id="infringement-remedies" className="scroll-mt-24 md:scroll-mt-32">
                   <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Infringement & Legal Remedies</h3>
                   <p className="text-base md:text-lg leading-relaxed mb-6 text-gray-700">
                   ...
                   <div className="space-y-6">
                      <div className="bg-red-50 p-6 rounded-lg border-l-4 border-red-500">
                          <h4 className="font-bold text-lg text-red-900 mb-2">1. Civil Remedies</h4>
                      ...
                      <div className="bg-red-50 p-6 rounded-lg border-l-4 border-red-500">
                          <h4 className="font-bold text-lg text-red-900 mb-2">2. Criminal Remedies</h4>
                ...
                <section id="copyright-vs-others" className="scroll-mt-24 md:scroll-mt-32">
                   <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Copyright vs Trademark vs Patent</h3>
                ...
                <section className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-xl md:rounded-3xl p-6 md:p-16 text-center text-white relative overflow-hidden mt-8 md:mt-12">
                   <div className="relative z-10">
                    <h3 className="text-xl md:text-4xl font-bold mb-4 md:mb-6">Ready to Own Your Work?</h3>
             ...
             <div className="hidden lg:block space-y-8 sticky top-32">
                ...
                <div className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] p-6 rounded-xl shadow-lg border border-gray-800 text-white text-center">
                  <h4 className="text-xl font-bold mb-3">IP Protection Check</h4>
