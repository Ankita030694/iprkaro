                    ...
                    <div className="space-y-12 animate-fade-in-up">
                        <div className="grid md:grid-cols-2 gap-12 items-center">
                            <div className="space-y-6">
                                <h4 className="text-3xl font-bold text-[#0C002B]">Your Brand Identity, <span className="text-[#1952C7]">Secured Forever.</span></h4>
                            ...
                            <LightCard className="bg-slate-50 border-slate-100 shadow-inner">
                                <h5 className="text-xl font-bold text-[#1952C7] mb-6">The Trademark Lifecycle</h5>
                        ...
                        <div className="grid sm:grid-cols-3 gap-6">
                            <LightCard hoverEffect={false}>
                                <h5 className="font-bold text-lg mb-2 text-[#0C002B]">Objection Handling</h5>
                            ...
                            <LightCard hoverEffect={false}>
                                <h5 className="font-bold text-lg mb-2 text-[#0C002B]">Renewal & Restoration</h5>
                            ...
                            <LightCard hoverEffect={false}>
                                <h5 className="font-bold text-lg mb-2 text-[#0C002B]">Watch Services</h5>
                    ...
                    <div className="space-y-12 animate-fade-in-up">
                         <div className="grid md:grid-cols-2 gap-12 items-center">
                             ...
                             <div className="space-y-6 order-1 md:order-2">
                                <h4 className="text-3xl font-bold text-[#0C002B]">Protecting the <span className="text-[#8A38F5]">Expression of Ideas.</span></h4>
                                <div className="space-y-4 text-[#6B7280] text-lg leading-relaxed">
                                    <p>
                 ...
                 {activeTab === 'patent' && (
                    <div className="space-y-12 animate-fade-in-up">
                         <div className="space-y-8 text-center max-w-4xl mx-auto">
                            <h4 className="text-3xl font-bold text-[#0C002B]">For the Inventors & <span className="text-[#FFB703]">Deep-Tech Pioneers.</span></h4>
                         ...
                         <div className="grid md:grid-cols-3 gap-8">
                             <LightCard className="relative overflow-hidden group">
                                 ...
                                 <h5 className="text-xl font-bold text-[#FFB703] mb-4">Provisional Application</h5>
                             ...
                             <LightCard className="relative overflow-hidden group">
                                 ...
                                 <h5 className="text-xl font-bold text-[#FFB703] mb-4">Complete Specification</h5>
                                 <p className="text-[#6B7280] text-sm mb-4">
                             ...
                             <LightCard className="relative overflow-hidden group">
                                 ...
                                 <h5 className="text-xl font-bold text-[#FFB703] mb-4">PCT / International</h5>
                                 <p className="text-[#6B7280] text-sm mb-4">
                ...
                {activeTab === 'design' && (
                    <div className="space-y-12 animate-fade-in-up text-center max-w-4xl mx-auto">
                        <LightCard>
                            ...
                            <h4 className="text-3xl font-bold text-[#0C002B] mb-6">Industrial Design Registration</h4>
                            ...
                            <div className="grid md:grid-cols-2 gap-8 text-left">
                                <div>
                                    <h5 className="font-bold text-[#009B7C] mb-2">What is protected?</h5>
                                ...
                                <div>
                                    <h5 className="font-bold text-[#009B7C] mb-2">Duration</h5>
        ...
        <section className="bg-slate-50 p-8 sm:p-12 rounded-[30px] border border-slate-100 relative overflow-hidden shadow-sm">
             ...
             <div className="relative z-10 grid md:grid-cols-12 gap-12 items-center">
                 <div className="md:col-span-7 space-y-6">
                     ...
                     <h3 className="text-3xl sm:text-4xl font-bold text-[#0C002B]">Are you a DPIIT Recognized Startup?</h3>
            ...
            <div className="grid md:grid-cols-3 gap-6">
                 {[
                     ...
                     <div key={idx} className="group p-8 rounded-2xl bg-slate-50 border border-slate-100 hover:border-[#1952C7] transition-colors shadow-sm">
                         ...
                         <h4 className="text-xl font-bold text-[#0C002B] mb-4">{item.title}</h4>
