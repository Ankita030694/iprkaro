        ...
        >
          ...
          <div className="w-full">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6 max-w-6xl mx-auto">
              ...
              <Link href="/our-services/trademark-registration">
                <div
              ...
              <Link href="/our-services/copyright-registration">
                <div
                  className="p-3 md:p-6 text-center space-y-3 md:space-y-5 relative group transition-all duration-300 hover:scale-105 cursor-pointer"
                  style={{
                    borderRadius: '20px',
              ...
              <Link href="/our-services/patent-registration">
                <div
                  className="p-3 md:p-6 text-center space-y-3 md:space-y-5 relative group transition-all duration-300 hover:scale-105 cursor-pointer"
                  style={{
                    borderRadius: '20px',
...
export default function ServicesClient() {
  ...
  const handleAiSubmit = (e: React.FormEvent) => {
    ...
    if (aiQuestion.trim()) {
      ...
      const scoredFaqs = servicesFaqs.map(faq => {
