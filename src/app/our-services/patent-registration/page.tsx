            ...
            <div className="min-w-0">
              ...
              <div className="bg-white p-4 md:p-12 rounded-xl md:rounded-2xl shadow-sm space-y-8 md:space-y-16">
                ...
                <section id="patent-fees-cost" className="scroll-mt-24 md:scroll-mt-32">
                   <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Patent Registration Fees & Costs (2025)</h3>
                ...
                <section id="patentability-criteria" className="scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">The "N.I.U" Criteria: Is Your Idea Patentable?</h3>
                  <p className="text-base md:text-lg leading-relaxed mb-4 md:mb-6 text-gray-700">
                  ...
                  <div className="grid md:grid-cols-3 gap-6">
                     <div className="bg-gray-50 p-6 rounded-lg text-center">
                        ...
                        <h4 className="font-bold text-lg mb-2 text-gray-900">1. Novelty (New)</h4>
                     ...
                     <div className="bg-gray-50 p-6 rounded-lg text-center">
                        ...
                        <h4 className="font-bold text-lg mb-2 text-gray-900">2. Inventive Step</h4>
                     ...
                     <div className="bg-gray-50 p-6 rounded-lg text-center">
                        ...
                        <h4 className="font-bold text-lg mb-2 text-gray-900">3. Industrial Use</h4>
                ...
                <section id="filing-process-roadmap" className="scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">The Patent Lifecycle: From Idea to Grant</h3>
                  <p className="text-base md:text-lg leading-relaxed mb-4 md:mb-6 text-gray-700">
                ...
                <section id="provisional-vs-complete" className="scroll-mt-24 md:scroll-mt-32">
                   <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Provisional vs Complete Specification</h3>
                   <p className="text-base md:text-lg leading-relaxed mb-4 md:mb-6 text-gray-700">
                   ...
                   <div className="grid md:grid-cols-2 gap-8">
                       <div className="bg-green-50 p-6 rounded-xl border border-green-100">
                           <h4 className="font-bold text-lg mb-4 text-green-900">Provisional Application</h4>
                       ...
                       <div className="bg-blue-50 p-6 rounded-xl border border-blue-100">
                           <h4 className="font-bold text-lg mb-4 text-blue-900">Complete Specification</h4>
                           <ul className="space-y-3">
                               <li className="flex items-start">
                ...
                <section id="documents-checklist" className="scroll-mt-24 md:scroll-mt-32">
                   <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Documents Checklist for Filing</h3>
                   <div className="grid md:grid-cols-2 gap-6">
                      <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
                          <h4 className="font-bold text-lg mb-4 text-[rgb(110,94,147)]">Mandatory Documents</h4>
                          <ul className="space-y-3">
                               <li className="flex items-start">
                      ...
                      <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
                          <h4 className="font-bold text-lg mb-4 text-[rgb(110,94,147)]">Identity & Discounts</h4>
                          <ul className="space-y-3">
                               <li className="flex items-start">
                                    <FontAwesomeIcon icon={faCheck} className="mt-1 mr-3 text-green-500 text-sm w-4 h-4" />
                ...
                <section id="fast-track-patents" className="scroll-mt-24 md:scroll-mt-32">
                   <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Fast-Track Your Patent (Expedited Examination)</h3>
                   <p className="text-base md:text-lg leading-relaxed mb-4 md:mb-6 text-gray-700">
                ...
                <section id="pct-international" className="scroll-mt-24 md:scroll-mt-32">
                   <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Global Protection: PCT Applications</h3>
                   ...
                   <div className="grid md:grid-cols-2 gap-6">
                      <div className="p-4 border border-gray-100 rounded-lg">
                         ...
                         <h4 className="font-bold text-lg mb-2">The 30-Month Advantage</h4>
                      ...
                      <div className="p-4 border border-gray-100 rounded-lg">
                         ...
                         <h4 className="font-bold text-lg mb-2">International Search Report</h4>
                         <p className="text-sm text-gray-600 mb-2">
                ...
                <section id="commercialization" className="scroll-mt-24 md:scroll-mt-32">
                   <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Commercialization: Making Money from Patents</h3>
                   <p className="text-base md:text-lg leading-relaxed mb-6 text-gray-700">
                ...
                <section id="why-choose-iprkaro" className="scroll-mt-24 md:scroll-mt-32 bg-black text-white p-6 md:p-8 rounded-xl md:rounded-2xl">
                  <h3 className="text-xl md:text-3xl font-bold mb-4 md:mb-6">Why Choose IPR Karo for Patents?</h3>
                  <div className="grid md:grid-cols-3 gap-6 text-center">
                    <div className="p-2 md:p-4">
                      ...
                      <h4 className="font-bold text-lg md:text-xl mb-2 text-[#FFD700]">Technical Expertise</h4>
                    ...
                    <div className="p-2 md:p-4">
                      ...
                      <h4 className="font-bold text-lg md:text-xl mb-2 text-[#FFD700]">Robust Drafting</h4>
                    ...
                    <div className="p-2 md:p-4">
                      ...
                      <h4 className="font-bold text-lg md:text-xl mb-2 text-[#FFD700]">Fixed Pricing</h4>
                ...
                <section className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-xl md:rounded-3xl p-6 md:p-16 text-center text-white relative overflow-hidden mt-8 md:mt-12">
                   <div className="relative z-10">
                    <h3 className="text-xl md:text-4xl font-bold mb-4 md:mb-6">Ready to Protect Your Invention?</h3>
             ...
             <div className="hidden lg:block space-y-8 sticky top-32">
                ...
                <div className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] p-6 rounded-xl shadow-lg border border-gray-800 text-white text-center">
                  <h4 className="text-xl font-bold mb-3">Patent Eligibility Check</h4>
