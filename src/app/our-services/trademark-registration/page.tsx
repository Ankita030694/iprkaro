...
export const metadata: Metadata = {
  ...
  description: validateAndNormalizeDescription('Register your trademark online in India with IPR Karo. Expert legal filing, expedited processing, and comprehensive objection handling from ₹1499. Secure your brand now.', "app/our-services/trademark-registration/page.tsx "),
  keywords: [
  ...
  openGraph: {
    title: 'Trademark Registration in India | IPR Karo',
    description: validateAndNormalizeDescription('Fast, affordable, and expert-assisted trademark registration services in India. Protect your brand identity today.', "app/our-services/trademark-registration/page.tsx "),
            ...
            <div className="min-w-0">
              ...
              <div className="bg-white p-4 md:p-12 rounded-xl md:rounded-2xl shadow-sm space-y-8 md:space-y-16">
                ...
                <section id="types-of-trademarks" className="scroll-mt-24 md:scroll-mt-32">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                     <div className="bg-gray-50 p-6 rounded-lg">
                        <h4 className="font-bold text-lg mb-2 text-[rgb(110,94,147)]">Word Marks</h4>
                     ...
                     <div className="bg-gray-50 p-6 rounded-lg">
                        <h4 className="font-bold text-lg mb-2 text-[rgb(110,94,147)]">Device Marks (Logos)</h4>
                     ...
                     <div className="bg-gray-50 p-6 rounded-lg">
                        <h4 className="font-bold text-lg mb-2 text-[rgb(110,94,147)]">Slogans & Taglines</h4>
                        <p className="text-gray-700 text-sm">Protects distinctive catchphrases used in advertising (e.g., "Just Do It" or "I'm Lovin' It").</p>
                     </div>
                     <div className="bg-gray-50 p-6 rounded-lg">
                        <h4 className="font-bold text-lg mb-2 text-[rgb(110,94,147)]">Shape Marks</h4>
                     ...
                     <div className="bg-gray-50 p-6 rounded-lg">
                        <h4 className="font-bold text-lg mb-2 text-[rgb(110,94,147)]">Sound Marks</h4>
                ...
                <section id="registration-process-detailed" className="scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">The Detailed 5-Step Registration Ecosystem</h3>
                  <p className="text-base md:text-lg leading-relaxed mb-4 md:mb-6 text-gray-700">
                  ...
                  <div className="space-y-4 md:space-y-8 mt-6 md:mt-8">
                    ...
                    <div className="flex flex-col md:flex-row gap-6 relative">
                       ...
                       <div className="bg-white p-4 md:p-6 rounded-xl border border-gray-100 shadow-sm flex-1 hover:shadow-md transition-all">
                          <h4 className="text-lg md:text-xl font-bold text-gray-900 mb-2 md:mb-3 flex items-center">
                ...
                <section id="documents-checklist" className="scroll-mt-24 md:scroll-mt-32">
                   <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Required Documents For Different Entities</h3>
                   <p className="text-base md:text-lg leading-relaxed mb-4 md:mb-6 text-gray-700">
                   ...
                   <div className="grid md:grid-cols-2 gap-8">
                       <div className="bg-gray-50 p-6 rounded-xl border border-gray-100">
                           <h4 className="font-bold text-lg mb-4 text-[rgb(110,94,147)]">Individuals & Sole Proprietors</h4>
                       ...
                       <div className="bg-gray-50 p-6 rounded-xl border border-gray-100">
                           <h4 className="font-bold text-lg mb-4 text-[rgb(110,94,147)]">Companies, LLPs & Startups</h4>
                           <ul className="space-y-3">
                               <li className="flex items-start">
                                    <FontAwesomeIcon icon={faCheck} className="mt-1 mr-3 text-green-500 text-sm w-4 h-4" />
                ...
                <section id="trademark-classes" className="scroll-mt-24 md:scroll-mt-32">
                   <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Decoding Trademark Classes (Nice Classification)</h3>
                   <p className="text-base md:text-lg leading-relaxed mb-4 md:mb-6 text-gray-700">
                ...
                <section id="objection-handling-mastery" className="scroll-mt-24 md:scroll-mt-32">
                   <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Mastery in Handling Objections</h3>
                   <p className="text-base md:text-lg leading-relaxed mb-4 md:mb-6 text-gray-700">
                ...
                <section id="opposition-proceedings" className="scroll-mt-24 md:scroll-mt-32">
                   <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Understanding Opposition Proceedings (Section 21)</h3>
                ...
                <section id="renewal-restoration" className="scroll-mt-24 md:scroll-mt-32">
                   <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Lifecycle Management: Renewal & Restoration</h3>
                   <div className="grid md:grid-cols-2 gap-6">
                      <div className="p-4 border border-gray-100 rounded-lg">
                         <div className="text-[rgb(110,94,147)] mb-3">
                            <FontAwesomeIcon icon={faSync} className="text-2xl w-8 h-8" />
                         </div>
                         <h4 className="font-bold text-lg mb-2">Trademark Renewal (Form TM-R)</h4>
                      ...
                      <div className="p-4 border border-gray-100 rounded-lg">
                         ...
                         <h4 className="font-bold text-lg mb-2">Restoration (Grace Period)</h4>
                         <p className="text-sm text-gray-600 mb-2">
                ...
                <section id="assignment-licensing" className="scroll-mt-24 md:scroll-mt-32">
                   <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Monetizing Your Brand: Assignment & Licensing</h3>
                   <p className="text-base md:text-lg leading-relaxed mb-6 text-gray-700">
                ...
                <section id="international-registration" className="scroll-mt-24 md:scroll-mt-32">
                   <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Going Global: The Madrid Protocol</h3>
                   <p className="text-base md:text-lg leading-relaxed mb-4 text-gray-700">
                ...
                <section id="enforcement-infringement" className="scroll-mt-24 md:scroll-mt-32">
                   <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Enforcement: Fighting Infringement</h3>
                   <p className="text-base md:text-lg leading-relaxed mb-6 text-gray-700">
                   ...
                   <div className="grid md:grid-cols-2 gap-6">
                      <div className="p-4 bg-red-50 rounded-lg border border-red-100">
                         <h4 className="font-bold text-red-800 mb-2">Civil Remedies</h4>
                      ...
                      <div className="p-4 bg-red-50 rounded-lg border border-red-100">
                         <h4 className="font-bold text-red-800 mb-2">Criminal Remedies</h4>
                ...
                <section id="why-choose-iprkaro" className="scroll-mt-24 md:scroll-mt-32 bg-black text-white p-6 md:p-8 rounded-xl md:rounded-2xl">
                  <h3 className="text-xl md:text-3xl font-bold mb-4 md:mb-6">Why Trust IPR Karo?</h3>
                  <div className="grid md:grid-cols-3 gap-6 text-center">
                    <div className="p-2 md:p-4">
                      ...
                      <h4 className="font-bold text-lg md:text-xl mb-2 text-[#FFD700]">Same-Day Filing</h4>
                    ...
                    <div className="p-2 md:p-4">
                      ...
                      <h4 className="font-bold text-lg md:text-xl mb-2 text-[#FFD700]">Legal Expertise</h4>
                    ...
                    <div className="p-2 md:p-4">
                      ...
                      <h4 className="font-bold text-lg md:text-xl mb-2 text-[#FFD700]">Transparent Pricing</h4>
                ...
                <section className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-xl md:rounded-3xl p-6 md:p-16 text-center text-white relative overflow-hidden mt-8 md:mt-12">
                   <div className="relative z-10">
                    <h3 className="text-xl md:text-4xl font-bold mb-4 md:mb-6">Start Your Application Today</h3>
