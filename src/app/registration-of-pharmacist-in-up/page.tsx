                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[220px_1fr_300px] gap-4 md:gap-12 mt-8 items-start">
                        ...
                        <div className="min-w-0">
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-xl md:rounded-2xl shadow-sm border border-gray-100 prose prose-lg max-w-none text-gray-800 font-sans">
                                ...
                                <section id="introduction" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h2 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6">Professional Licensing in Uttar Pradesh</h2>
                                ...
                                <section id="uppc-overview" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">The Uttar Pradesh Pharmacy Council (UPPC): Statutory Mandate</h3>
                                ...
                                <section id="document-checklist" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Document Forensic: High School to Degree Verification</h3>
                                    ...
                                    <ul className="space-y-6 my-10 list-none p-0 text-lg">
                                        <li className="flex gap-4 p-6 bg-gray-50 rounded-2xl border border-gray-200 shadow-sm border-l-[10px] border-l-[#6E5E93]">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-[#0C002B] text-xl mb-1">Academic Proofs</h5>
                                        ...
                                        <li className="flex gap-4 p-6 bg-gray-50 rounded-2xl border border-gray-200 shadow-sm border-l-[10px] border-l-[#160049]">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-[#0C002B] text-xl mb-1">Training & Legal</h5>
                                ...
                                <section id="practical-training" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Form-V Forensics: The 500-Hour Hospital Mandatory Period</h3>
                                    <p className="mb-4 leading-relaxed text-lg">
                                    ...
                                    <div className="bg-white border-2 border-[#6E5E93] p-8 rounded-3xl shadow-sm my-6">
                                        <h5 className="font-bold text-[#0C002B] text-xl mb-4">Forensic Verification of Form-V:</h5>
                                ...
                                <section id="online-process" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Digital Navigation: Step-by-Step Online Portal Guide</h3>
                                    <p className="mb-6 leading-relaxed text-lg">
                                    ...
                                    <div className="p-8 bg-[#0C002B] text-white rounded-[2rem] shadow-2xl my-10">
                                        <h5 className="text-cyan-400 font-bold text-2xl mb-4">The Digital Workflow</h5>
                                ...
                                <section id="fee-structure" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-8 text-center">Investment in Career: Registration & Renewal Fee Schedule</h3>
                                ...
                                <section id="why-iprkaro" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6 text-center">Why Care Professionals Trust IPR Karo for Licensing Forensics</h3>
                                    ...
                                    <div className="grid md:grid-cols-3 gap-8 text-center bg-[#0C002B] p-10 rounded-[3rem] text-white">
                                        <div className="space-y-4">
                                            ...
                                            <h5 className="font-bold text-xl">Document Scrubbing</h5>
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <h5 className="font-bold text-xl">Affidavit Drafting</h5>
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <h5 className="font-bold text-xl">Transfer Assistance</h5>
                                ...
                                <section id="renewal-transfer" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Staying Active: 5-Year Renewal & Reciprocal Transfer Rules</h3>
                                    <p className="mb-4 leading-relaxed text-lg">
                                    ...
                                    <div className="grid md:grid-cols-2 gap-8 my-8">
                                        <div className="p-6 bg-white border border-gray-200 rounded-2xl shadow-sm">
                                            <h5 className="font-bold text-[#160049] mb-3">Renewal Protocol</h5>
                                        ...
                                        <div className="p-6 bg-white border border-gray-200 rounded-2xl shadow-sm">
                                            <h5 className="font-bold text-[#6E5E93] mb-3">Reciprocal Transfer</h5>
                                ...
                                <section id="conclusion" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6 text-center">Conclusion: Securing the Future of Public Health in Uttar Pradesh</h3>
                                ...
                                <div className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[40px] p-10 md:p-20 text-center text-white relative overflow-hidden mt-20 shadow-2xl">
                                    <div className="relative z-10">
                                        <h3 className="text-3xl md:text-5xl font-bold mb-6">Need Help with Council Licensing?</h3>
                        ...
                        <aside className="hidden lg:block space-y-10 sticky top-32">
                            ...
                            <div className="bg-[#0C002B] p-8 rounded-3xl shadow-xl border border-gray-800 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-2xl font-bold mb-4 relative z-10">Lucknow Verification</h4>
