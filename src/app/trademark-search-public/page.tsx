...
export const metadata: Metadata = {
    ...
    description: validateAndNormalizeDescription('Master the IP India public search portal. Learn how to perform Wordmark, Phonetic, and Vienna code searches to ensure your brand name is available and conflict-free.', "app/trademark-search-public/page.tsx "),
    keywords: [
    ...
    openGraph: {
        title: 'Public Trademark Search in India',
        description: validateAndNormalizeDescription('Dont file blindly. Learn how to use the IP India portal to find similar brands and avoid costly legal rejections. Comprehensive Wordmark & Phonetic search guide.', "app/trademark-search-public/page.tsx "),
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[220px_1fr_300px] gap-4 md:gap-12 mt-8 items-start">
                        ...
                        <div className="min-w-0">
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-xl md:rounded-2xl shadow-sm border border-gray-100 prose prose-lg max-w-none text-gray-800 font-sans">
                                ...
                                <section id="introduction" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h2 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6">Why Trademark Search Matters</h2>
                                ...
                                <section id="wordmark-search" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Wordmark Search: Mastering the "Contains" Strategy</h3>
                                    ...
                                    <div className="grid md:grid-cols-3 gap-6 my-10">
                                        <div className="p-6 bg-gray-50 rounded-2xl border border-gray-200">
                                            <h5 className="font-bold text-[#0C002B] text-xl mb-3">Starts With</h5>
                                        ...
                                        <div className="p-6 bg-[#160049] text-white rounded-2xl border border-gray-200 shadow-lg scale-105">
                                            <h5 className="font-bold text-cyan-400 text-xl mb-3">Contains (Best)</h5>
                                        ...
                                        <div className="p-6 bg-gray-50 rounded-2xl border border-gray-200">
                                            <h5 className="font-bold text-[#0C002B] text-xl mb-3">Match With</h5>
                                ...
                                <section id="phonetic-search" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">The Sound of Conflict: Why Phonetic Search is Critical</h3>
                                    <p className="mb-6 leading-relaxed text-lg">
                                    ...
                                    <div className="p-8 bg-red-50 rounded-3xl border border-red-100 my-10">
                                        <h5 className="font-bold text-red-900 text-2xl mb-4 flex items-center">
                                ...
                                <section id="vienna-code" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Decoding Logos: The Vienna Classification System</h3>
                                    <p className="mb-6 leading-relaxed text-lg">
                                ...
                                <section id="nice-classification" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Nice Classification (Classes 1-45): Finding Your Niche</h3>
                                    <p className="mb-8 leading-relaxed text-lg">
                                ...
                                <section id="cross-class-conflicts" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">The Hidden Trap: Cross-Class Conflicts in Search</h3>
                                    <p className="mb-4 leading-relaxed text-lg">
                                ...
                                <section id="madrid-international" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Madrid Protocol: Searching for International Designations</h3>
                                    <p className="mb-4 leading-relaxed text-lg">
                                ...
                                <section id="search-status-meaning" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Understanding Search Results: What "Registered" vs "Objected" Means</h3>
                                    <p className="mb-6 leading-relaxed text-lg">
                                    ...
                                    <ul className="space-y-6 my-10 list-none p-0">
                                        <li className="flex gap-4 p-6 bg-gray-50 rounded-2xl border border-gray-200 shadow-sm border-l-[10px] border-l-blue-500">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-[#0C002B] text-xl mb-1">Registered</h5>
                                        ...
                                        <li className="flex gap-4 p-6 bg-gray-50 rounded-2xl border border-gray-200 shadow-sm border-l-[10px] border-l-yellow-500">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-[#0C002B] text-xl mb-1">Objected / Opposed</h5>
                                        ...
                                        <li className="flex gap-4 p-6 bg-gray-50 rounded-2xl border border-gray-200 shadow-sm border-l-[10px] border-l-red-500">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-[#0C002B] text-xl mb-1">Refused / Abandoned</h5>
                                ...
                                <section id="zombie-trademarks" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Zombie Trademarks: Rectification and Removal Opportunities</h3>
                                    <p className="mb-4 leading-relaxed text-lg">
                                ...
                                <section id="well-known-marks" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">The Forbidden Zone: Well-Known and Prohibited Marks</h3>
                                    <p className="mb-6 leading-relaxed text-lg">
                                ...
                                <section id="why-iprkaro" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6">Why Thousands of Brands Trust IPR Karo for Search Services</h3>
                                    ...
                                    <div className="grid md:grid-cols-3 gap-8 text-center bg-[#0C002B] p-10 rounded-[3rem] text-white">
                                        <div className="space-y-4">
                                            ...
                                            <h5 className="font-bold text-xl">Forensic Filtering</h5>
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <h5 className="font-bold text-xl">Registrability Score</h5>
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <h5 className="font-bold text-xl">Conflict Mitigation</h5>
                                ...
                                <section id="conclusion" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6 text-center">Conclusion: Securing Your Brand’s Future Today</h3>
                                ...
                                <div className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[40px] p-10 md:p-20 text-center text-white relative overflow-hidden mt-20 shadow-2xl">
                                    <div className="relative z-10">
                                        <h3 className="text-3xl md:text-5xl font-bold mb-6">Is Your Brand Name Available?</h3>
                        ...
                        <aside className="hidden lg:block space-y-10 sticky top-32">
                            ...
                            <div className="bg-gray-50 p-8 rounded-3xl shadow-sm border border-gray-100">
                                <h4 className="text-xl font-bold text-[#0C002B] mb-6 border-b pb-4">Branding Tools</h4>
