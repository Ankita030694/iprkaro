          ...
          <div className="container mx-auto px-4 py-12 lg:py-32 relative z-10 text-center">
            <h1 className="text-2xl md:text-5xl lg:text-6xl font-extrabold mb-4 md:mb-6 leading-tight mt-20 md:mt-10 text-white">
              ...
              <span className="text-[#6E5E93] bg-clip-text text-transparent bg-gradient-to-r from-[#8A7AB5] to-[#D1C4E9]" style={{ WebkitTextFillColor: 'rgb(110, 94, 147)' }}>
                Registration for Jewellery Brands
              </span>
            </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_280px] gap-5 md:gap-8 items-start">
            ...
            <div className="hidden lg:block sticky top-32 h-[calc(100vh-160px)] overflow-y-auto no-scrollbar">
              <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                <p className="text-gray-900 font-black text-lg mb-5 uppercase tracking-widest border-l-4 border-[rgb(110,94,147)] pl-3">Table of Contents</p>
              ...
              <div className="bg-white rounded-xl md:rounded-2xl shadow-sm border border-gray-100 p-3 md:p-10 overflow-hidden relative">
                ...
                <article className="prose prose-base max-w-none text-gray-700 leading-relaxed font-normal">
                  ...
                  <section id="importance-of-trademark" className="scroll-mt-28 md:scroll-mt-36 mb-12 md:mb-20">
                    <h2 className="text-lg md:text-2xl lg:text-3xl font-extrabold text-gray-900 mb-5 md:mb-6 border-b-4 border-[rgb(110,94,147)] inline-block pb-2">Why Your Jewellery Brand Demands a Trademark</h2>
                    <p className="text-xl mb-8 text-gray-600 italic font-medium border-l-6 border-[rgb(110,94,147)] pl-6 py-3">
                    ...
                    <p className="mb-8 first-letter:text-6xl first-letter:font-black first-letter:text-[rgb(110,94,147)] first-letter:mr-2 first-letter:float-left">
                    ...
                    <div className="bg-gradient-to-br from-indigo-50 to-purple-50 p-10 my-11 rounded-[1.5rem] border-2 border-[rgb(110,94,147)]/30 shadow-inner">
                      <h4 className="text-gray-900 font-black text-2xl mb-5">Strategy Over Formality</h4>
                  ...
                  <section id="what-can-be-protected" className="scroll-mt-28 md:scroll-mt-36 mb-12 md:mb-20">
                    <h3 className="text-lg md:text-2xl lg:text-3xl font-extrabold text-gray-900 mb-5 md:mb-6 border-b-4 border-[rgb(110,94,147)] inline-block pb-2">
                    ...
                    <div className="grid md:grid-cols-2 gap-6 mb-10">
                      <div className="bg-gray-50 p-6 rounded-xl hover:shadow-md transition-all border border-gray-100">
                        ...
                        <h4 className="font-bold text-xl mb-3 text-gray-900">Word Marks</h4>
                      ...
                      <div className="bg-gray-50 p-6 rounded-xl hover:shadow-md transition-all border border-gray-100">
                        ...
                        <h4 className="font-bold text-xl mb-3 text-[#312e81]">Device Marks (Logos)</h4>
                      ...
                      <div className="bg-gray-50 p-6 rounded-xl hover:shadow-md transition-all border border-gray-100">
                        ...
                        <h4 className="font-bold text-xl mb-3 text-[#312e81]">Distinctive Packaging</h4>
                      ...
                      <div className="bg-gray-50 p-6 rounded-xl hover:shadow-md transition-all border border-gray-100">
                        ...
                        <h4 className="font-bold text-xl mb-3 text-[#312e81]">Signature Motifs</h4>
                  ...
                  <section id="class-14-guide" className="scroll-mt-28 md:scroll-mt-36 mb-12 md:mb-20">
                    ...
                    <div className="space-y-8">
                      <div className="bg-gradient-to-r from-gray-50 to-white p-6 rounded-xl border-l-6 border-[rgb(110,94,147)] shadow-sm">
                        <h4 className="text-xl font-bold text-gray-900 mb-3 flex items-center">
                          <span className="bg-[rgb(110,94,147)] text-white w-8 h-8 rounded-full flex items-center justify-center mr-3 text-xs font-bold">14</span>
                        ...
                        <ul className="mt-3 space-y-1.5 text-xs text-gray-600 grid grid-cols-2">
                          <li className="flex items-center"><FontAwesomeIcon icon={faCheck} className="w-3 h-3 md:w-5 md:h-5 text-[rgb(110,94,147)] mr-2" /> Gold & Platinum Jewellery</li>
                          <li className="flex items-center"><FontAwesomeIcon icon={faCheck} className="w-3 h-3 md:w-5 md:h-5 text-[rgb(110,94,147)] mr-2" /> Diamonds & Gemstones</li>
                          <li className="flex items-center"><FontAwesomeIcon icon={faCheck} className="w-3 h-3 md:w-5 md:h-5 text-[rgb(110,94,147)] mr-2" /> Luxury Timepieces</li>
                          <li className="flex items-center"><FontAwesomeIcon icon={faCheck} className="w-3 h-3 md:w-5 md:h-5 text-[rgb(110,94,147)] mr-2" /> Custom Crafted Ornaments</li>
                        </ul>
                      </div>

                      <div className="bg-gradient-to-r from-gray-50 to-white p-6 rounded-xl border-l-6 border-[#312e81] shadow-sm">
                        <h4 className="text-xl font-bold text-[#312e81] mb-3 flex items-center">
                  ...
                  <section id="step-by-step-process" className="scroll-mt-28 md:scroll-mt-36 mb-12 md:mb-20">
                    <h3 className="text-2xl md:text-4xl lg:text-5xl font-black text-gray-900 mb-10 text-center uppercase tracking-tighter">
                    ...
                    <div className="space-y-3 md:space-y-6 mt-5 md:mt-6">
                      ...
                      <div className="flex flex-col md:flex-row gap-5 relative">
                        <div className="flex-shrink-0 hidden md:flex flex-col items-center">
                          <div className="w-8 h-8 bg-[rgb(110,94,147)] text-white rounded-full flex items-center justify-center font-bold z-10 text-lg">1</div>
                        ...
                        <div className="bg-white p-3 md:p-5 rounded-lg border border-gray-100 shadow-sm flex-1 hover:shadow-md transition-all">
                          <h4 className="text-base md:text-lg font-bold text-gray-900 mb-1.5 md:mb-2 flex items-center">
                            <span className="md:hidden bg-[rgb(110,94,147)] text-white w-5 h-5 rounded-full flex items-center justify-center mr-2 text-[10px]">1</span>
                            <FontAwesomeIcon icon={faSearch} className="w-12 h-12 text-[rgb(110,94,147)] mr-2" />
                      ...
                      <div className="flex flex-col md:flex-row gap-5 relative">
                        ...
                        <div className="bg-white p-3 md:p-5 rounded-lg border border-gray-100 shadow-sm flex-1 hover:shadow-md transition-all">
                          <h4 className="text-base md:text-lg font-bold text-[#312e81] mb-1.5 md:mb-2 flex items-center">
                  ...
                  <section id="documents-required" className="scroll-mt-28 md:scroll-mt-36 mb-12 md:mb-20">
                    <h3 className="text-2xl md:text-4xl lg:text-5xl font-black text-gray-900 mb-8 leading-none">
                  ...
                  <section id="cost-of-tm" className="scroll-mt-28 md:scroll-mt-36 mb-12 md:mb-20 px-3">
                    <h3 className="text-2xl md:text-4xl lg:text-6xl font-black text-gray-900 mb-10 text-center">
                      Transparent Investment Structure
                    </h3>
                    <div className="grid md:grid-cols-2 gap-6">
                      <div className="bg-[rgb(110,94,147)] text-white p-8 rounded-2xl shadow-xl transform transition-transform hover:-translate-y-2">
                        <h4 className="text-xl font-bold mb-5 text-purple-400">Government Fees</h4>
                      ...
                      <div className="bg-gradient-to-br from-indigo-50 to-white p-8 rounded-2xl border border-indigo-100 shadow-xl transform transition-transform hover:-translate-y-2">
                        <h4 className="text-xl font-bold mb-5 text-[#312e81]">IPR Karo Professional Fee</h4>
                        <div className="space-y-5">
                  ...
                  <section id="overcoming-objections" className="scroll-mt-28 md:scroll-mt-36 mb-12 md:mb-20">
                    ...
                    <div className="space-y-6">
                      <div className="bg-red-50 p-6 rounded-xl border-l-6 border-red-500 shadow-sm hover:shadow-md transition-all">
                        <h5 className="text-xl font-bold text-red-800 mb-3 flex items-center">
                      ...
                      <div className="bg-indigo-50 p-6 rounded-xl border-l-6 border-indigo-500 shadow-sm hover:shadow-md transition-all">
                        <h5 className="text-xl font-bold text-indigo-900 mb-3 flex items-center">
                  ...
                  <section id="opposition-and-defense" className="scroll-mt-28 md:scroll-mt-36 mb-12 md:mb-20">
                    ...
                    <ul className="list-none space-y-5 mb-10">
                      <li className="flex items-start bg-gray-50 p-5 rounded-xl border-l-4 border-[rgb(110,94,147)]">
                        <span className="font-black text-lg mr-3 text-[rgb(110,94,147)]">01.</span>
                  ...
                  <section id="online-advantages" className="scroll-mt-28 md:scroll-mt-36 mb-12 md:mb-20">
                    ...
                    <div className="bg-[rgb(110,94,147)] text-white p-10 rounded-[1.5rem] shadow-2xl relative overflow-hidden my-10">
                      <div className="absolute top-0 right-0 p-8 opacity-10">
                        <FontAwesomeIcon icon={faShoppingCart} className="w-6 h-6 md:w-10 md:h-10 text-7xl text-indigo-200" />
                      </div>
                      <div className="relative z-10">
                        <h5 className="text-2xl font-bold mb-5 text-purple-400">Unlocking Amazon Brand Registry</h5>
                  ...
                  <section id="international-protection" className="scroll-mt-28 md:scroll-mt-36 mb-12 md:mb-20">
                    <h3 className="text-2xl md:text-4xl lg:text-5xl font-black text-[#312e81] mb-10 leading-none">
                    ...
                    <div className="bg-gray-50 p-6 rounded-xl flex flex-col md:flex-row items-center gap-6 border border-gray-100">
                      <div className="flex-1">
                        <h5 className="font-bold text-lg mb-3 text-[#312e81]">The 6-Month Window</h5>
                  ...
                  <section id="faqs" className="scroll-mt-28 md:scroll-mt-36 mb-12 md:mb-20">
                    <h3 className="text-2xl md:text-4xl lg:text-5xl font-black text-gray-900 mb-10 text-center uppercase">
                    ...
                    <div className="grid gap-6">
                      {faqs.map((faq, index) => (
                        <details key={index} className="group bg-white border border-gray-100 rounded-[1.5rem] shadow-sm overflow-hidden transition-all hover:shadow-2xl">
                          <summary className="flex items-center justify-between p-5 cursor-pointer list-none text-base font-bold text-gray-900 group-open:bg-indigo-50 group-open:text-[rgb(110,94,147)] transition-colors">
                            <span className="flex items-center">
                              <span className="bg-[rgb(110,94,147)] text-white w-8 h-8 rounded-full flex items-center justify-center mr-5 text-xs font-bold">Q</span>
                              {faq.question}
                            </span>
                  ...
                  <section className="bg-gradient-to-br from-[#1a0033] to-[#312e81] rounded-xl md:rounded-[2.5rem] p-6 md:p-16 text-center text-white relative overflow-hidden mt-12 shadow-[0_30px_90px_rgba(0,0,0,0.5)] group">
                    ...
                    <div className="relative z-10">
                      <h3 className="text-xl md:text-3xl lg:text-5xl font-extrabold mb-5 md:mb-6">Your Brand is a Diamond. <br /> Don't Leave it Unguarded.</h3>
            ...
            <aside className="hidden lg:block space-y-8 sticky top-28">
              ...
              {/* Sidebar CTA Box */}
              <div className="bg-[rgb(12,0,43)] p-6 rounded-2xl shadow-xl border border-gray-800 text-white relative overflow-hidden group">
                <div className="absolute -top-8 -right-8 w-32 h-32 bg-[rgb(110,94,147)] rounded-full blur-[60px] opacity-20 group-hover:opacity-40 transition-opacity"></div>
                <h4 className="text-xl font-bold mb-3 relative z-10 leading-tight">Is Your Name Safe to Use?</h4>
                ...
                <Link href="/contact-us" className="block relative z-10">
                  <button className="w-full bg-[rgb(110,94,147)] hover:bg-[rgb(90,74,127)] text-white font-extrabold py-3 px-3 rounded-lg transition-all shadow-lg transform hover:-translate-y-1">
                    Start Precise Search
                  </button>
                </Link>
                <div className="mt-8 pt-8 border-t border-white/10 relative z-10 text-center">
                  <a href="tel:+919289707648" className="text-[rgb(110,94,147)] font-black text-lg hover:text-white transition-colors flex items-center justify-center italic">
              ...
              <div className="bg-gray-50 p-6 rounded-2xl shadow-sm border border-gray-100">
                <h4 className="text-lg font-black text-gray-900 mb-6 border-b-2 border-[rgb(110,94,147)] pb-3 uppercase tracking-widest">Premium Services</h4>
                <ul className="space-y-5">
                  <li>
                    <Link href="/our-services/trademark-registration" className="group flex items-center text-gray-700 hover:text-[rgb(110,94,147)] transition-all">
