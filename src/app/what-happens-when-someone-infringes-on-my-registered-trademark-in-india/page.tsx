                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_320px] gap-4 md:gap-12 mt-8 items-start">
                        ...
                        <div className="min-w-0">
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-xl md:rounded-2xl shadow-sm border border-gray-100 prose prose-lg max-w-none text-gray-800 font-sans">
                                ...
                                <section id="statutory-foundation" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Statutory Foundation: Section 29</h3>
                                    ...
                                    <div className="grid md:grid-cols-2 gap-6 my-10 text-center">
                                        <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100">
                                            <h5 className="font-bold text-[#0C002B] text-xl mb-4">Unauthorized Use</h5>
                                            <p className="text-sm text-gray-600">Usage of an identical or similar mark in the course of trade by a non-owner.</p>
                                        </div>
                                        <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100">
                                            <h5 className="font-bold text-[#0C002B] text-xl mb-4">Likelihood of Confusion</h5>
                                ...
                                <section id="civil-remedies" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Civil Remedies: Injunctions & Damages</h3>
                                ...
                                <section id="special-orders" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Special Orders: Anton Piller & John Doe</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-10">
                                        <div className="p-8 bg-white border border-gray-100 rounded-3xl shadow-sm border-l-8 border-[#6E5E93]">
                                            <h5 className="font-bold text-[#0C002B] text-xl mb-2">Anton Piller Order</h5>
                                        ...
                                        <div className="p-8 bg-white border border-gray-100 rounded-3xl shadow-sm border-l-8 border-[#6E5E93]">
                                            <h5 className="font-bold text-[#0C002B] text-xl mb-2">John Doe Order</h5>
                                ...
                                <section id="criminal-remedies" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Criminal Remedies: Jail & Fines</h3>
                                    <div className="p-8 bg-red-50 border-l-8 border-red-600 rounded-r-2xl my-10">
                                        <h5 className="font-bold text-red-600 mb-4 uppercase tracking-wide flex items-center gap-2">
                                ...
                                <section id="lifecycle" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">The Enforcement Lifecycle</h3>
                                ...
                                <section id="case-analysis" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">2026 Case Analysis: Asian Paints Case</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify">
                                ...
                                <section id="deceptive-similarity" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6 text-justify">Proving Deceptive Similarity</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify">
                                        The 2026 judiciary uses a three-fold forensic test:
                                    </p>
                                    <div className="grid md:grid-cols-3 gap-6 my-10 text-center">
                                        <div className="p-6 bg-gray-50 rounded-2xl">
                                            <h6 className="font-bold text-[#160049] mb-2">Phonetic</h6>
                                            <p className="text-sm opacity-70 italic">Sounds like...</p>
                                        </div>
                                        <div className="p-6 bg-gray-50 rounded-2xl">
                                            <h6 className="font-bold text-[#160049] mb-2">Visual</h6>
                                            <p className="text-sm opacity-70 italic">Looks like...</p>
                                        </div>
                                        <div className="p-6 bg-gray-50 rounded-2xl">
                                            <h6 className="font-bold text-[#160049] mb-2">Conceptual</h6>
                                ...
                                <section id="counterfeiting" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Counterfeiting vs. Infringement</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify">
                                ...
                                <section id="online-infringement" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Digital Infringement & Takedowns</h3>
                                    <ul className="space-y-4 my-10 list-none p-0">
                                        <li className="flex gap-4 p-6 bg-white border border-gray-100 rounded-2xl shadow-sm">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-[#0C002B] text-lg">Domain Squatting</h5>
                                        ...
                                        <li className="flex gap-4 p-6 bg-white border border-gray-100 rounded-2xl shadow-sm">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-[#0C002B] text-lg">Social Media Takedowns</h5>
                                ...
                                <section id="conclusion" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6 text-center text-justify">Protecting Your Perpetual Asset</h3>
                                ...
                                <div className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[40px] p-10 md:p-20 text-center text-white relative overflow-hidden mt-20 shadow-2xl">
                                    <div className="relative z-10">
                                        <h3 className="text-3xl md:text-5xl font-bold mb-6">Initiate Enforcement Now</h3>
                        ...
                        <aside className="hidden lg:block space-y-10 sticky top-32">
                            ...
                            <div className="bg-[#0C002B] p-8 rounded-3xl shadow-xl border border-gray-800 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-2xl font-bold mb-4 relative z-10">Brand Under Threat?</h4>
                            ...
                            <div className="bg-gray-50 p-8 rounded-3xl shadow-sm border border-gray-100">
                                <h4 className="text-xl font-bold text-[#0C002B] mb-6 border-b pb-4">Enforcement Hub</h4>
