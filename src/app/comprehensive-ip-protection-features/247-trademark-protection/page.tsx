            ...
            <div className="min-w-0">
              ...
              <div className="bg-white p-4 md:p-12 rounded-2xl shadow-sm space-y-8 md:space-y-12">
                ...
                <section id="introduction" className="scroll-mt-32">
                  <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">Why Constant Vigilance is Non-Negotiable</h2>
                ...
                <section id="comprehensive-monitoring" className="scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">A Multi-Layered Monitoring Shield</h3>
                  <p className="text-lg leading-relaxed mb-6 text-gray-700">
                  ...
                  <div className="space-y-8">
                    <div className="flex flex-col md:flex-row gap-6 items-start bg-gray-50 p-6 rounded-xl border border-gray-100">
                        ...
                        <div>
                            <h5 className="text-xl font-bold text-gray-900 mb-3">Trademark Registry Watch</h5>
                    ...
                    <div className="flex flex-col md:flex-row gap-6 items-start bg-gray-50 p-6 rounded-xl border border-gray-100">
                        ...
                        <div>
                            <h5 className="text-xl font-bold text-gray-900 mb-3">Social Media & Digital Identity Watch</h5>
                            <p className="text-gray-700 mb-3">
                    ...
                    <div className="flex flex-col md:flex-row gap-6 items-start bg-gray-50 p-6 rounded-xl border border-gray-100">
                        ...
                        <div>
                            <h5 className="text-xl font-bold text-gray-900 mb-3">E-Commerce Marketplace Surveillance</h5>
                            <p className="text-gray-700 mb-3">
                    ...
                    <div className="flex flex-col md:flex-row gap-6 items-start bg-gray-50 p-6 rounded-xl border border-gray-100">
                        ...
                        <div>
                            <h5 className="text-xl font-bold text-gray-900 mb-3">Domain Name & Cybersquatting Alerts</h5>
                            <p className="text-gray-700 mb-3">
                ...
                <section id="registration-process" className="scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">Navigating the Trademark Registration Lifecycle</h3>
                  <p className="text-lg leading-relaxed mb-6 text-gray-700">
                ...
                <section id="objection-handling" className="scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">Expertise in Handling Objections & Oppositions</h3>
                  <p className="text-lg leading-relaxed mb-6 text-gray-700">
                  ...
                  <div className="grid md:grid-cols-2 gap-8 mb-8">
                    <div className="bg-gray-50 p-6 rounded-xl border-l-4 border-[rgb(110,94,147)]">
                      <h4 className="text-xl font-bold text-gray-900 mb-3">Section 9: Absolute Grounds</h4>
                      <p className="text-gray-700 mb-3">
                    ...
                    <div className="bg-gray-50 p-6 rounded-xl border-l-4 border-[rgb(110,94,147)]">
                      <h4 className="text-xl font-bold text-gray-900 mb-3">Section 11: Relative Grounds</h4>
                      <p className="text-gray-700 mb-3">
                ...
                <section id="legal-enforcement" className="scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">Enforcement: Turning Rights into Action</h3>
                  <p className="text-lg leading-relaxed mb-6 text-gray-700">
                  ...
                  <div className="space-y-6">
                     <div className="bg-white border border-gray-200 p-6 rounded-xl hover:shadow-md transition-all">
                        <div className="flex items-center mb-4">
                           ...
                           <h4 className="text-xl font-bold text-gray-900">Step 1: The Legal Notice (Cease & Desist)</h4>
                        </div>
                     ...
                     <div className="bg-white border border-gray-200 p-6 rounded-xl hover:shadow-md transition-all">
                        <div className="flex items-center mb-4">
                           ...
                           <h4 className="text-xl font-bold text-gray-900">Step 2: Civil Litigation (Injunctions)</h4>
                        </div>
                        <p className="text-gray-700 leading-relaxed">
                     ...
                     <div className="bg-white border border-gray-200 p-6 rounded-xl hover:shadow-md transition-all">
                        <div className="flex items-center mb-4">
                           <span className="text-3xl mr-4">👮</span>
                           <h4 className="text-xl font-bold text-gray-900">Step 3: Criminal Action</h4>
                        </div>
                        <p className="text-gray-700 leading-relaxed">
                ...
                <section id="global-protection" className="scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">Scaling Your Protection Globally</h3>
                  <p className="text-lg leading-relaxed mb-6 text-gray-700">
                ...
                <section id="digital-brand-safety" className="scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">Safeguarding Your Digital Assets</h3>
                  <p className="text-lg leading-relaxed mb-6 text-gray-700">
                ...
                <section id="renewal-restoration" className="scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">Lifecycle Management: Renewal & Restoration</h3>
                  <p className="text-lg leading-relaxed mb-6 text-gray-700">
                 ...
                 <section id="client-success-stories" className="scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-8">Real-World Success Stories</h3>
                ...
                <section className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-xl md:rounded-3xl p-8 md:p-16 text-center text-white relative overflow-hidden mt-12">
                   <div className="relative z-10">
                    <h3 className="text-2xl md:text-4xl font-bold mb-6">Don't Leave Your Brand Defenseless</h3>
