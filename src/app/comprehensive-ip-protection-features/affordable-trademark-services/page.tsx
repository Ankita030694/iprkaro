      ...
      <div className="bg-gray-50 min-h-screen font-sans text-gray-800">
        ...
        <div className="relative w-full overflow-hidden" 
          ...
          <div className="container mx-auto px-4 py-20 lg:py-32 relative z-10 text-center">
             ...
             <h2 className="text-xl md:text-2xl font-medium text-gray-300 mb-8 max-w-3xl mx-auto">Affordable Trademark Services</h2>
            ...
            <div className="min-w-0">
              ...
              <div className="bg-white p-4 md:p-12 rounded-2xl shadow-sm space-y-8 md:space-y-12">
                ...
                <section id="introduction" className="scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">Smart Protection for the Modern Indian Business</h3>
                ...
                <section id="affordable-vs-cheap" className="scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">The Critical Difference: Affordable vs. Cheap</h3>
                  <p className="text-lg leading-relaxed mb-6 text-gray-700">
                  ...
                  <div className="grid md:grid-cols-2 gap-8 my-8">
                    <div className="bg-red-50 p-6 rounded-xl border border-red-100">
                       <h4 className="text-xl font-bold text-red-800 mb-4">The "Cheap" Trap</h4>
                    ...
                    <div className="bg-[rgba(110,94,147,0.1)] p-6 rounded-xl border border-[rgba(110,94,147,0.2)]">
                       <h4 className="text-xl font-bold text-[rgb(110,94,147)] mb-4">The IPRKaro Model</h4>
                       <p className="text-gray-700 mb-4">
                ...
                <section id="price-breakdown" className="scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">Transparent Cost Breakdown</h3>
                  <p className="text-lg leading-relaxed mb-6 text-gray-700">
                ...
                <section id="hidden-costs" className="scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">Exposing the Hidden Fees</h3>
                  <p className="text-lg leading-relaxed mb-6 text-gray-700">
                  ...
                  <ul className="space-y-4">
                    <li className="flex items-start">
                       ...
                       <div className="ml-4">
                         <h5 className="text-lg font-bold text-gray-900">The "Clerical" Charge</h5>
                    ...
                    <li className="flex items-start">
                       <div className="flex-shrink-0 h-6 w-6 rounded-full bg-red-100 flex items-center justify-center text-red-500 mt-1">!</div>
                       <div className="ml-4">
                         <h5 className="text-lg font-bold text-gray-900">Affidavit Fees</h5>
                    ...
                    <li className="flex items-start">
                       <div className="flex-shrink-0 h-6 w-6 rounded-full bg-red-100 flex items-center justify-center text-red-500 mt-1">!</div>
                       <div className="ml-4">
                         <h5 className="text-lg font-bold text-gray-900">Certificate Delivery</h5>
                ...
                <section id="tech-advantage" className="scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">The Tech Advantage: How We Do It</h3>
                  <p className="text-lg leading-relaxed mb-6 text-gray-700">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="bg-gray-50 p-6 rounded-xl text-center hover:shadow-md transition-shadow">
                      ...
                      <h4 className="font-bold text-gray-900 mb-2">AI-Assisted Search</h4>
                ...
                <section id="detailed-process" className="scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">Detailed Registration Process Step-by-Step</h3>
                  <p className="text-lg leading-relaxed mb-6 text-gray-700">
                  ...
                  <div className="space-y-8">
                     <div className="borderl-4 border-[rgb(110,94,147)] pl-6">
                        <h4 className="text-xl font-bold text-gray-900 mb-2">Step 1: The Clearance Search (Day 1)</h4>
                     ...
                     <div className="border-l-4 border-[rgb(110,94,147)] pl-6">
                        <h4 className="text-xl font-bold text-gray-900 mb-2">Step 2: Class Selection & Description (Day 1-2)</h4>
                        <p className="text-gray-700 leading-relaxed">
                     ...
                     <div className="border-l-4 border-[rgb(110,94,147)] pl-6">
                        <h4 className="text-xl font-bold text-gray-900 mb-2">Step 3: Filing Form TM-A (Day 2-3)</h4>
                        <p className="text-gray-700 leading-relaxed">
                     ...
                     <div className="border-l-4 border-[rgb(110,94,147)] pl-6">
                        <h4 className="text-xl font-bold text-gray-900 mb-2">Step 4: Examination (Month 1-3)</h4>
                        <p className="text-gray-700 leading-relaxed">
                     ...
                     <div className="border-l-4 border-[rgb(110,94,147)] pl-6">
                        <h4 className="text-xl font-bold text-gray-900 mb-2">Step 5: Journal Publication (Month 4-8)</h4>
                        <p className="text-gray-700 leading-relaxed">
                     ...
                     <div className="border-l-4 border-[rgb(110,94,147)] pl-6">
                        <h4 className="text-xl font-bold text-gray-900 mb-2">Step 6: Registration (Month 9-12)</h4>
                        <p className="text-gray-700 leading-relaxed">
                ...
                <section id="documentation" className="scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">Required Documents Checklist</h3>
                  <p className="text-lg leading-relaxed mb-6 text-gray-700">
                  ...
                  <div className="space-y-6">
                     <div className="bg-gray-50 p-6 rounded-lg">
                        <h4 className="text-lg font-bold text-[rgb(110,94,147)] mb-3">For Individuals / Sole Proprietorships</h4>
                        <ul className="list-disc pl-5 space-y-2 text-gray-700">
                     ...
                     <div className="bg-gray-50 p-6 rounded-lg">
                        <h4 className="text-lg font-bold text-[rgb(110,94,147)] mb-3">For Companies (Pvt Ltd, LLP, OPC) / Partnerships</h4>
                        <ul className="list-disc pl-5 space-y-2 text-gray-700">
                ...
                <section id="legal-framework" className="scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">The Legal Framework: Rights You Are Securing</h3>
                  <p className="text-lg leading-relaxed mb-6 text-gray-700">
                  ...
                  <div className="space-y-6">
                    <div className="bg-[rgba(110,94,147,0.1)] p-6 rounded-xl border border-[rgba(110,94,147,0.2)]">
                      <h4 className="text-xl font-bold text-[rgb(110,94,147)] mb-3">Exclusive Right to Use (Section 28)</h4>
                    ...
                    <div className="bg-[rgba(110,94,147,0.1)] p-6 rounded-xl border border-[rgba(110,94,147,0.2)]">
                      <h4 className="text-xl font-bold text-[rgb(110,94,147)] mb-3">Remedy for Infringement (Section 29)</h4>
                      <p className="text-gray-700">
                    ...
                    <div className="bg-[rgba(110,94,147,0.1)] p-6 rounded-xl border border-[rgba(110,94,147,0.2)]">
                      <h4 className="text-xl font-bold text-[rgb(110,94,147)] mb-3">Asset Creation & Valuation</h4>
                      <p className="text-gray-700">
                    ...
                    <div className="bg-[rgba(110,94,147,0.1)] p-6 rounded-xl border border-[rgba(110,94,147,0.2)]">
                      <h4 className="text-xl font-bold text-[rgb(110,94,147)] mb-3">Protection Against Cybersquatters</h4>
                      <p className="text-gray-700">
                ...
                <section id="sector-guide" className="scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">Sector-Specific Trademark Needs</h3>
                  <p className="text-lg leading-relaxed mb-6 text-gray-700">
                ...
                <section id="risks-of-diy" className="scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">The High Risks of DIY Filing</h3>
                  <p className="text-lg leading-relaxed mb-6 text-gray-700">
                ...
                <section id="comparison" className="scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">IPRKaro vs. The Rest</h3>
                 ...
                 <section id="success-stories" className="scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-8">Trusted by Budget-Conscious Entrepreneurs</h3>
                ...
                <section className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-xl md:rounded-3xl p-8 md:p-16 text-center text-white relative overflow-hidden mt-12">
                   <div className="relative z-10">
                    <h3 className="text-2xl md:text-4xl font-bold mb-6">Stop Overpaying for Trademarks</h3>
             ...
             <div className="hidden lg:block space-y-8 sticky top-32">
                ...
                <div className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] p-6 rounded-xl shadow-lg border border-gray-800 text-white text-center">
                  <h4 className="text-xl font-bold mb-3">Need Expert Advice?</h4>
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                  <h4 className="text-lg font-bold text-gray-900 mb-4">Related Features</h4>
