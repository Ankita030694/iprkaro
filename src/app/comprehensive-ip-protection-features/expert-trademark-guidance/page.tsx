      ...
      <div className="bg-gray-50 min-h-screen font-sans text-gray-800">
        ...
        <div className="relative w-full overflow-hidden" 
          ...
          <div className="container mx-auto px-4 py-20 lg:py-32 relative z-10 text-center">
             ...
             <h2 className="text-xl md:text-2xl font-light text-gray-300 mb-8 max-w-4xl mx-auto leading-relaxed">Expert Trademark Guidance</h2>
            ...
            <div className="min-w-0">
              ...
              <div className="bg-white p-4 md:p-12 rounded-2xl shadow-sm space-y-8 md:space-y-12">
                ...
                <section id="introduction" className="scroll-mt-32">
                  <h3 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">Expert Legal Guidance: Your First Line of Defense</h3>
                ...
                <section id="tm-registration" className="scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">Mastering Trademark Registration</h3>
                  <p className="text-lg leading-relaxed mb-6 text-gray-700">
                  ...
                  <div className="grid md:grid-cols-2 gap-8 my-8">
                     <div className="border border-gray-100 bg-gray-50 p-6 rounded-xl">
                        <h4 className="text-xl font-bold text-gray-900 mb-3">Classification Strategy</h4>
                     ...
                     <div className="border border-gray-100 bg-gray-50 p-6 rounded-xl">
                        <h4 className="text-xl font-bold text-gray-900 mb-3">Distinctiveness Analysis</h4>
                        <p className="text-gray-700 leading-relaxed">
                ...
                <section id="patent-services" className="scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">Comprehensive Patent Services for Innovators</h3>
                  <p className="text-lg leading-relaxed mb-6 text-gray-700">
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start">
                       ...
                       <div className="ml-4">
                          <h5 className="text-xl font-bold text-gray-900 mb-2">Patentability Search & Prior Art Analysis</h5>
                    ...
                    <div className="flex items-start">
                       ...
                       <div className="ml-4">
                          <h5 className="text-xl font-bold text-gray-900 mb-2">Drafting Specifications</h5>
                          <p className="text-gray-700">
                    ...
                    <div className="flex items-start">
                       ...
                       <div className="ml-4">
                          <h5 className="text-xl font-bold text-gray-900 mb-2">Prosecution & Maintenance</h5>
                          <p className="text-gray-700">
                ...
                <section id="copyright-protection" className="scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">Robust Copyright Protection</h3>
                  <p className="text-lg leading-relaxed mb-6 text-gray-700">
                ...
                <section id="search-analysis" className="scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">Strategic Search & Clearance</h3>
                  <p className="text-lg leading-relaxed mb-6 text-gray-700">
                    ...
                    <div className="bg-gradient-to-r from-gray-900 to-gray-800 text-white p-8 rounded-2xl shadow-lg">
                       <h4 className="text-xl font-bold mb-4 text-[#8A7AB5]">The IPR Karo Deep Search</h4>
                ...
                <section id="objection-handling" className="scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">Expert Handling of Objections & Oppositions</h3>
                  <p className="text-lg leading-relaxed mb-6 text-gray-700">
                 ...
                 <section id="global-protection" className="scroll-mt-32">
                   <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">Global IP Strategy</h3>
                   <p className="text-lg leading-relaxed mb-6 text-gray-700">
                ...
                <section id="brand-valuation" className="scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">IP Valuation & Monetization</h3>
                  <p className="text-lg leading-relaxed mb-6 text-gray-700">
                ...
                <section id="client-stories" className="scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-8">Client Success Stories</h3>
                ...
                <section className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-xl md:rounded-3xl p-8 md:p-16 text-center text-white relative overflow-hidden mt-12">
                   <div className="relative z-10">
                    <h3 className="text-2xl md:text-4xl font-bold mb-6">Secure Your Intellectual Property Today</h3>
             ...
             <div className="hidden lg:block space-y-8 sticky top-32">
                ...
                <div className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] p-6 rounded-xl shadow-lg border border-gray-800 text-white text-center">
                  <h4 className="text-xl font-bold mb-3">Expert Legal Advice</h4>
