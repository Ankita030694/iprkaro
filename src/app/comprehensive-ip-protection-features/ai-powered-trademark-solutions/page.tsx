      ...
      <div className="bg-gray-50 min-h-screen font-sans text-gray-800">
        ...
        <div className="relative w-full overflow-hidden" 
          ...
          <div className="container mx-auto px-4 py-20 lg:py-32 relative z-10 text-center">
             ...
             <h2 className="text-xl md:text-2xl font-medium text-gray-300 mb-8 max-w-3xl mx-auto">AI-Powered Trademark Solutions</h2>
            ...
            <div className="min-w-0">
              ...
              <div className="bg-white p-4 md:p-12 rounded-2xl shadow-sm space-y-8 md:space-y-12">
                ...
                <section id="introduction" className="scroll-mt-32">
                  <h3 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">The AI Revolution in Intellectual Property</h3>
                ...
                <section id="why-ai-matters" className="scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">Why AI Matters in IP Protection</h3>
                  <p className="text-lg leading-relaxed mb-6 text-gray-700">
                  ...
                  <div className="grid md:grid-cols-2 gap-8 my-8">
                    <div className="bg-[rgba(110,94,147,0.1)] p-8 rounded-xl border border-[rgba(110,94,147,0.2)]">
                       <h4 className="text-xl font-bold text-[rgb(110,94,147)] mb-4">The Precision Gap</h4>
                    ...
                    <div className="bg-gray-50 p-8 rounded-xl border border-gray-100">
                       <h4 className="text-xl font-bold text-gray-900 mb-4">The Speed Advantage</h4>
                       <p className="text-gray-700 mb-4">
                ...
                <section id="smart-search-tech" className="scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">Inside Our Smart Search Technology</h3>
                  <p className="text-lg leading-relaxed mb-6 text-gray-700">
                  ...
                  <div className="space-y-8">
                     <div className="flex flex-col md:flex-row gap-6 items-start">
                        ...
                        <div>
                           <h4 className="text-xl font-bold text-gray-900 mb-2">Phonetic Similarity Analysis</h4>
                     ...
                     <div className="flex flex-col md:flex-row gap-6 items-start">
                        ...
                        <div>
                           <h4 className="text-xl font-bold text-gray-900 mb-2">Visual & Image Recognition</h4>
                           <p className="text-gray-700 leading-relaxed">
                     ...
                     <div className="flex flex-col md:flex-row gap-6 items-start">
                        ...
                        <div>
                           <h4 className="text-xl font-bold text-gray-900 mb-2">Semantic & Conceptual Matching</h4>
                           <p className="text-gray-700 leading-relaxed">
                ...
                <section id="process-optimization" className="scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">Optimizing the Entire Lifecycle</h3>
                  <p className="text-lg leading-relaxed mb-6 text-gray-700">
                  ...
                  <div className="overflow-hidden rounded-xl border border-gray-200 shadow-sm">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 divide-y md:divide-y-0 md:divide-x divide-gray-200 bg-gray-50">
                      <div className="p-6 text-center hover:bg-white transition-colors">
                        ...
                        <h5 className="font-bold text-gray-900 mb-2">Smart Drafting</h5>
                      ...
                      <div className="p-6 text-center hover:bg-white transition-colors">
                        <div className="text-3xl mb-3">⚡</div>
                        <h5 className="font-bold text-gray-900 mb-2">Instant Filing</h5>
                      ...
                      <div className="p-6 text-center hover:bg-white transition-colors">
                        <div className="text-3xl mb-3">🔔</div>
                        <h5 className="font-bold text-gray-900 mb-2">status Tracking</h5>
                      ...
                      <div className="p-6 text-center hover:bg-white transition-colors">
                        ...
                        <h5 className="font-bold text-gray-900 mb-2">Watch Service</h5>
                ...
                <section id="patent-copyright-ai" className="scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">AI in Patent Services & Copyright Protection</h3>
                  <p className="text-lg leading-relaxed mb-6 text-gray-700">
                  ...
                  <div className="bg-[rgb(110,94,147)] text-white rounded-2xl p-8 mb-8 relative overflow-hidden">
                    <div className="relative z-10">
                      <h4 className="text-2xl font-bold mb-4 border-b border-white/20 pb-4">Patent Services Reimagined</h4>
                  ...
                  <div className="bg-white border border-gray-200 rounded-2xl p-8">
                     <h4 className="text-2xl font-bold text-gray-900 mb-4">Copyright Protection in the Digital Age</h4>
                ...
                <section id="risk-prediction" className="scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">Predictive Analytics: Knowing Before You File</h3>
                  <p className="text-lg leading-relaxed mb-6 text-gray-700">
                ...
                <section id="human-ai-hybrid" className="scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">The Human-AI Synergy</h3>
                  <p className="text-lg leading-relaxed mb-6 text-gray-700">
                  ...
                  <div className="flex flex-col md:flex-row items-center bg-gradient-to-r from-gray-100 to-gray-200 rounded-xl p-8">
                     <div className="md:w-1/3 mb-6 md:mb-0 md:pr-8 text-center">
                        ...
                        <h5 className="font-bold text-gray-900">Best of Both Worlds</h5>
                     </div>
                ...
                <section id="sector-benefits" className="scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">Sector-Specific Benefits</h3>
                  <p className="text-lg leading-relaxed mb-6 text-gray-700">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="border border-gray-200 p-6 rounded-lg">
                       <h4 className="font-bold text-gray-900 mb-2">Startups & Tech</h4>
                    ...
                    <div className="border border-gray-200 p-6 rounded-lg">
                       <h4 className="font-bold text-gray-900 mb-2">Pharma & Healthcare</h4>
                    ...
                    <div className="border border-gray-200 p-6 rounded-lg">
                       <h4 className="font-bold text-gray-900 mb-2">E-Commerce & Retail</h4>
                    ...
                    <div className="border border-gray-200 p-6 rounded-lg">
                       <h4 className="font-bold text-gray-900 mb-2">Media & Entertainment</h4>
                ...
                <section id="comparison" className="scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-6">Manual vs. AI-Powered Process</h3>
                ...
                <section id="client-reviews" className="scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-8">What Our Clients Say</h3>
                ...
                <section className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-xl md:rounded-3xl p-8 md:p-16 text-center text-white relative overflow-hidden mt-12">
                   <div className="relative z-10">
                    <h3 className="text-2xl md:text-4xl font-bold mb-6">Ready to Upgrade Your IP Strategy?</h3>
