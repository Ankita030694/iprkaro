        ...
        <div className="relative w-full overflow-hidden"
          ...
          <div className="container mx-auto px-4 py-12 lg:py-32 relative z-10 text-center">
            <h1 className="text-2xl md:text-5xl lg:text-6xl font-bold mb-4 md:mb-6 leading-snug md:leading-tight mt-20 md:mt-10 text-white px-4">
              <span className="text-[#6E5E93] bg-clip-text text-transparent bg-gradient-to-r from-[#6E5E93] to-[#8A7AB5]" style={{ WebkitTextFillColor: 'rgb(110, 94, 147)' }}>In India the Trademark Registration Should Be Renewed Every</span> 10 Years
            </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[220px_1fr_300px] gap-4 md:gap-12 mt-8 items-start">
            ...
            <div className="min-w-0">
              ...
              <div className="bg-white p-4 md:p-12 rounded-xl md:rounded-2xl shadow-sm border border-gray-100 prose prose-lg max-w-none text-gray-800 font-sans">
                ...
                <section id="introduction" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h2 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6">Why Renewal is Vital</h2>
                ...
                <section id="renewal-cycle" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">The 10 Year Cycle: How the Law Works in India</h3>
                  ...
                  <div className="bg-white border-2 border-dashed border-[#6E5E93] p-8 my-10 rounded-3xl">
                    <h5 className="font-bold text-[#0C002B] text-xl mb-4">The Priority Date Rule</h5>
                ...
                <section id="legal-framework" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Legal Framework: Section 25 of the Trade Marks Act 1999</h3>
                  <p className="mb-6 leading-relaxed text-lg">
                  ...
                  <ul className="space-y-6 my-10 list-none p-0">
                    <li className="flex gap-4 p-6 bg-blue-50 rounded-2xl border border-blue-100 shadow-sm border-l-[10px] border-l-blue-500">
                      ...
                      <div>
                        <h5 className="font-bold text-blue-900 text-xl mb-2">Duration of Protection</h5>
                    ...
                    <li className="flex gap-4 p-6 bg-blue-50 rounded-2xl border border-blue-100 shadow-sm border-l-[10px] border-l-blue-500">
                      ...
                      <div>
                        <h5 className="font-bold text-blue-900 text-xl mb-2">The Renewal Application</h5>
                    ...
                    <li className="flex gap-4 p-6 bg-blue-50 rounded-2xl border border-blue-100 shadow-sm border-l-[10px] border-l-blue-500">
                      ...
                      <div>
                        <h5 className="font-bold text-blue-900 text-xl mb-2">Removal for Non-Renewal</h5>
                ...
                <section id="renewal-timeline" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">The Renewal Timeline: From Pre Expiry to Restoration</h3>
                  ...
                  <div className="space-y-12 my-12 relative before:absolute before:inset-0 before:ml-5 md:before:ml-[31px] before:-z-10 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-indigo-200 before:via-purple-200 before:to-transparent">
                    ...
                    <div className="relative flex items-center gap-6 md:gap-10">
                      ...
                      <div className="flex flex-col bg-gray-50 p-6 rounded-2xl border border-gray-100 shadow-sm w-full">
                        <h5 className="font-bold text-[#0C002B] text-xl mb-2">Proactive Filing (6 Months Before Expiry)</h5>
                    ...
                    <div className="relative flex items-center gap-6 md:gap-10">
                      ...
                      <div className="flex flex-col bg-gray-50 p-6 rounded-2xl border border-gray-100 shadow-sm w-full">
                        <h5 className="font-bold text-[#0C002B] text-xl mb-2">Late Filing (6 Months After Expiry)</h5>
                    ...
                    <div className="relative flex items-center gap-6 md:gap-10">
                      ...
                      <div className="flex flex-col bg-gray-50 p-6 rounded-2xl border border-gray-100 shadow-sm w-full">
                        <h5 className="font-bold text-[#0C002B] text-xl mb-2">Restoration Window (6-12 Months After Expiry)</h5>
                ...
                <section id="step-by-step" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Step by Step: Filing Form TM R for Renewal</h3>
                  <p className="mb-6 leading-relaxed text-lg">
                ...
                <section id="documents" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Documents Checklist for a Seamless Renewal</h3>
                  <p className="mb-6 leading-relaxed text-lg">
                  ...
                  <div className="grid md:grid-cols-2 gap-8 my-10">
                    <div className="bg-indigo-50 p-8 rounded-3xl border border-indigo-100 h-full">
                      <h5 className="font-bold text-[#0C002B] text-2xl mb-4">Core Essentials</h5>
                    ...
                    <div className="bg-purple-50 p-8 rounded-3xl border border-purple-100 h-full">
                      <h5 className="font-bold text-[#0C002B] text-2xl mb-4">Conditional Documents</h5>
                      <ul className="space-y-4">
                ...
                <section id="fees-breakdown" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Government Fees and Surcharges: 2026 Price List</h3>
                  <p className="mb-8 leading-relaxed text-lg">
                ...
                <section id="ot-notice" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">The O-3 Notice: Your Final Legal Safety Net</h3>
                  <p className="mb-6 leading-relaxed text-lg">
                ...
                <section id="restoration" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Restoration of Trademark: Bringing a Dead Mark Back to Life</h3>
                  <p className="mb-6 leading-relaxed text-lg">
                  ...
                  <div className="bg-white border-l-[10px] border-l-[#0C002B] p-8 my-10 rounded-r-3xl shadow-xl">
                    <h5 className="font-bold text-[#0C002B] text-2xl mb-4">The Restoration Procedure</h5>
                ...
                <section id="benefits" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Unlocking Value: The 5 Major Benefits of Timely Renewal</h3>
                  <p className="mb-6 leading-relaxed text-lg">
                  ...
                  <ul className="space-y-6 my-10 list-none p-0">
                    <li className="flex gap-4 p-6 bg-green-50 rounded-2xl border border-green-100 shadow-sm border-l-[10px] border-l-green-500">
                      ...
                      <div>
                        <h5 className="font-bold text-green-900 text-xl mb-2">Perpetual Legal Monopoly</h5>
                    ...
                    <li className="flex gap-4 p-6 bg-green-50 rounded-2xl border border-green-100 shadow-sm border-l-[10px] border-l-green-500">
                      ...
                      <div>
                        <h5 className="font-bold text-green-900 text-xl mb-2">Asset Growth and Valuation</h5>
                    ...
                    <li className="flex gap-4 p-6 bg-green-50 rounded-2xl border border-green-100 shadow-sm border-l-[10px] border-l-green-500">
                      ...
                      <div>
                        <h5 className="font-bold text-green-900 text-xl mb-2">Digital Ecosystem Protection</h5>
                ...
                <section id="common-pitfalls" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Avoid These Common Pitfalls in Online Trademark Renewal</h3>
                  <p className="mb-6 leading-relaxed text-lg">
                ...
                <section id="tmr-nuances" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Technical Nuances: Mastering Form TM-R</h3>
                  <p className="mb-4 leading-relaxed text-lg">
                ...
                <section id="startup-consequences" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Impact: Consequences of Removal for Startups</h3>
                  <p className="mb-4 leading-relaxed text-lg">
                ...
                <section id="global-renewal" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Global Renewals: Madrid Protocol & Dependencies</h3>
                  <p className="mb-6 leading-relaxed text-lg">
                  ...
                  <div className="bg-[#6E5E93]/10 p-8 rounded-3xl border border-[#6E5E93]/20 my-10">
                    <h5 className="text-[#0C002B] font-bold text-2xl mb-4">The Central Attack Risk</h5>
                ...
                <section id="why-iprkaro" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6">Why Hundreds of Brands Choose IPR Karo for Renewals</h3>
                  ...
                  <div className="grid md:grid-cols-3 gap-8 text-center bg-[#0C002B] p-10 rounded-[3rem] text-white">
                    <div className="space-y-4">
                      ...
                      <h5 className="font-bold text-xl">Rapid Processing</h5>
                    ...
                    <div className="space-y-4">
                      ...
                      <h5 className="font-bold text-xl">Active Monitoring</h5>
                    ...
                    <div className="space-y-4">
                      ...
                      <h5 className="font-bold text-xl">Legal Expertise</h5>
                ...
                <section id="conclusion" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6 text-center">Conclusion: Securing Your Brand for the Future</h3>
                ...
                <div className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[40px] p-10 md:p-20 text-center text-white relative overflow-hidden mt-20 shadow-2xl">
                  <div className="relative z-10">
                    <h3 className="text-3xl md:text-5xl font-bold mb-6">Don't Let Your Trademark Expire</h3>
            ...
            <aside className="hidden lg:block space-y-10 sticky top-32">
              ...
              <div className="bg-[#0C002B] p-8 rounded-3xl shadow-xl border border-gray-800 text-white relative overflow-hidden group">
                ...
                <h4 className="text-2xl font-bold mb-4 relative z-10">Free Status Audit</h4>
