                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_320px] gap-4 md:gap-12 mt-8 items-start">
                        ...
                        <div className="min-w-0">
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-xl md:rounded-2xl shadow-sm border border-gray-100 prose prose-lg max-w-none text-gray-800 font-sans">
                                ...
                                <section id="statutory-framework" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Statutory Framework: Section 58</h3>
                                    ...
                                    <div className="grid md:grid-cols-2 gap-6 my-10 text-center">
                                        <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100">
                                            <h5 className="font-bold text-[#0C002B] text-xl mb-4 text-justify">Error Correction</h5>
                                        ...
                                        <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100">
                                            <h5 className="font-bold text-[#0C002B] text-xl mb-4">Entry Updates</h5>
                                ...
                                <section id="pending-vs-registered" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Pending vs. Registered Marks</h3>
                                    <div className="bg-[#0C002B] text-white p-10 rounded-[2.5rem] shadow-xl my-10 relative overflow-hidden group">
                                        <div className="relative z-10">
                                            <h5 className="text-2xl font-bold mb-4 flex items-center gap-3 text-justify">
                                ...
                                <section id="name-change" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">The Name Change Protocol</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify text-justify">
                                    ...
                                    <div className="grid md:grid-cols-2 gap-8 my-10">
                                        <div className="p-6 bg-white border border-gray-100 rounded-2xl shadow-sm text-center">
                                            <h6 className="font-bold text-[#0C002B] mb-3">Corporate Mergers</h6>
                                            <p className="text-sm text-gray-500">Updating rights from Company A to the newly formed entity Company B.</p>
                                        </div>
                                        <div className="p-6 bg-white border border-gray-100 rounded-2xl shadow-sm text-center">
                                            <h6 className="font-bold text-[#0C002B] mb-3">Startup Incorporation</h6>
                                ...
                                <section id="address-change" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Moving Your Base: Address Updates</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify">
                                    ...
                                    <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100 my-10 text-center">
                                        <h5 className="font-bold text-[#0C002B] text-xl mb-4 uppercase tracking-wide">The Benefits of Accuracy</h5>
                                ...
                                <section id="clerical-errors" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Correcting Clerical Errors</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify">
                                ...
                                <section id="amending-mark" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Amending the Mark Identity</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify text-justify">
                                ...
                                <section id="deleting-goods" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Deleting Goods and Services</h3>
                                    <div className="p-8 bg-indigo-50 border-l-8 border-[#160049] rounded-r-2xl my-10">
                                        <h5 className="font-bold text-[#0C002B] mb-2 uppercase tracking-wide">Strategic Deletion</h5>
                                ...
                                <section id="process-timelines" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Process and Timelines 2026</h3>
                                ...
                                <section id="common-pitfalls" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Why Amendments Get Rejected</h3>
                                ...
                                <section id="conclusion" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6 text-center text-justify">Bulletproof Brand Records</h3>
                                ...
                                <div className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[40px] p-10 md:p-20 text-center text-white relative overflow-hidden mt-20 shadow-2xl">
                                    <div className="relative z-10">
                                        <h3 className="text-3xl md:text-5xl font-bold mb-6 text-center">Update Your Legal Shield</h3>
                        ...
                        <aside className="hidden lg:block space-y-10 sticky top-32">
                            ...
                            <div className="bg-[#0C002B] p-8 rounded-3xl shadow-xl border border-gray-800 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-2xl font-bold mb-4 relative z-10 text-justify">Maintain Your Edge</h4>
                            ...
                            <div className="bg-gray-50 p-8 rounded-3xl shadow-sm border border-gray-100">
                                <h4 className="text-xl font-bold text-[#0C002B] mb-6 border-b pb-4 text-justify">Amendment Hub</h4>
