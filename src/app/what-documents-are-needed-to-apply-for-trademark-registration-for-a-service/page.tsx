                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_320px] gap-4 md:gap-12 mt-8 items-start">
                        ...
                        <div className="min-w-0">
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-xl md:rounded-2xl shadow-sm border border-gray-100 prose prose-lg max-w-none text-gray-800 font-sans">
                                ...
                                <section id="introduction" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h2 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6">Securing Your Service Mark</h2>
                                ...
                                <section id="global-vs-indian" className="mb-12 scroll-mt-24 md:scroll-mt-32 text-justify">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6 text-justify">Global Standards vs. Indian Registry Requirements</h3>
                                    ...
                                    <div className="grid md:grid-cols-2 gap-6 my-10">
                                        <div className="p-6 bg-gray-50 rounded-2xl border border-gray-200">
                                            <h5 className="font-bold text-[#0C002B] text-xl mb-3 flex items-center gap-3">
                                ...
                                <section id="master-checklist" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">The Master Checklist: Form TM-A and Power of Attorney</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify text-justify">
                                    ...
                                    <div className="space-y-6 my-10">
                                        <div className="flex gap-6 p-8 bg-[#0C002B] text-white rounded-[2.5rem] shadow-xl relative overflow-hidden group">
                                            ...
                                            <div>
                                                <h5 className="text-2xl font-bold mb-2">Form TM-A (The Primary Application)</h5>
                                        ...
                                        <div className="flex gap-6 p-8 bg-gray-50 border border-gray-200 rounded-[2.5rem] group hover:border-[#6E5E93] transition-colors relative">
                                            ...
                                            <div>
                                                <h5 className="text-2xl font-bold mb-2 text-[#0C002B]">Form TM-48 (The Power of Attorney)</h5>
                                ...
                                <section id="individual-docs" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Requirements for Individuals and Sole Proprietors</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify text-justify">
                                    ...
                                    <div className="grid md:grid-cols-2 gap-8 my-10">
                                        <div className="p-8 bg-indigo-50 rounded-3xl border border-indigo-100">
                                            <h5 className="font-bold text-indigo-900 text-xl mb-4 flex items-center gap-3">
                                        ...
                                        <div className="p-8 bg-green-50 rounded-3xl border border-green-100">
                                            <h5 className="font-bold text-green-900 text-xl mb-4 flex items-center gap-3">
                                ...
                                <section id="company-docs" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Checklist for Private and Public Limited Companies</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify text-justify">
                                ...
                                <section id="partnership-docs" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Documents for LLPs and Partnership Firms</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify text-justify">
                                ...
                                <section id="msme-startup-docs" className="mb-12 scroll-mt-24 md:scroll-mt-32 text-justify">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6 text-center text-justify">Rebate Secrets: MSME and Startup Documentation</h3>
                                ...
                                <section id="user-affidavit" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Evidence of Use: Drafting the User Affidavit</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify text-justify">
                                ...
                                <section id="digital-specs" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Digital Signatures and Technical Image Specifications</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify text-justify text-justify">
                                    ...
                                    <div className="grid md:grid-cols-2 gap-8 my-10">
                                        <div className="p-6 bg-gray-50 rounded-2xl border border-gray-200">
                                            <h5 className="font-bold text-[#0C002B] mb-2 flex items-center gap-3">
                                ...
                                <section id="service-statements" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">The Nice Classification: Describing Your Services</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify text-justify">
                                ...
                                <section id="why-iprkaro" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6 text-center">IPRKaro: Forensic Document Management for Rank 1 Results</h3>
                                    ...
                                    <div className="grid md:grid-cols-2 gap-8 my-10">
                                        <div className="flex gap-4 items-start">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-[#0C002B] text-xl mb-1">Curation over Collection</h5>
                                        ...
                                        <div className="flex gap-4 items-start">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-[#0C002B] text-xl mb-1">Signatory Verification</h5>
                                ...
                                <section id="conclusion" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6 text-center">Building Your Brand Fortress with Correct Records</h3>
                                ...
                                <div className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[40px] p-10 md:p-20 text-center text-white relative overflow-hidden mt-20 shadow-2xl">
                                    <div className="relative z-10">
                                        <h3 className="text-3xl md:text-5xl font-bold mb-6">Secure Your Brands Legal Future</h3>
                        ...
                        <aside className="hidden lg:block space-y-10 sticky top-32">
                            ...
                            <div className="bg-[#0C002B] p-8 rounded-3xl shadow-xl border border-gray-800 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-2xl font-bold mb-4 relative z-10">Document Review</h4>
                            ...
                            <div className="bg-gray-50 p-8 rounded-3xl shadow-sm border border-gray-100">
                                <h4 className="text-xl font-bold text-[#0C002B] mb-6 border-b pb-4">Essential Filing Links</h4>
