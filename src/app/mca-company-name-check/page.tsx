                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[220px_1fr_300px] gap-4 md:gap-12 mt-8 items-start">
                        ...
                        <div className="min-w-0">
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-xl md:rounded-2xl shadow-sm border border-gray-100 prose prose-lg max-w-none text-gray-800 font-sans">
                                ...
                                <section id="introduction" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h2 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6">The First Step to Incorporation</h2>
                                ...
                                <section id="ai-algorithms" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">The Machine Behind the Screen: AI in MCA V3 Name Check</h3>
                                    <p className="mb-4 leading-relaxed text-lg">
                                ...
                                <section id="how-to-check" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">How to Check Name Availability on the MCA V3 Portal</h3>
                                    ...
                                    <div className="bg-white border-2 border-dashed border-[#6E5E93] p-8 my-10 rounded-3xl">
                                        <h5 className="font-bold text-[#0C002B] text-xl mb-4">The Official Workflow</h5>
                                    ...
                                    <div className="bg-gray-50 p-8 rounded-3xl border border-gray-200 my-10">
                                        <h5 className="font-bold text-[#0C002B] text-xl mb-4">Pro-Tip: Use the 'Partial Search' Feature</h5>
                                ...
                                <section id="naming-rules" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Naming Rules: The Companies (Incorporation) Rules 2014</h3>
                                    <p className="mb-6 leading-relaxed text-lg">
                                    ...
                                    <ul className="space-y-6 my-10 list-none p-0">
                                        <li className="flex gap-4 p-6 bg-blue-50 rounded-2xl border border-blue-100 shadow-sm border-l-[10px] border-l-blue-500">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-blue-900 text-xl mb-2">The 'Too Similar' Exception</h5>
                                        ...
                                        <li className="flex gap-4 p-6 bg-blue-50 rounded-2xl border border-blue-100 shadow-sm border-l-[10px] border-l-blue-500">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-blue-900 text-xl mb-2">The Common Prefix Rule</h5>
                                        ...
                                        <li className="flex gap-4 p-6 bg-blue-50 rounded-2xl border border-blue-100 shadow-sm border-l-[10px] border-l-blue-500">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-blue-900 text-xl mb-2">Business Object Alignment</h5>
                                ...
                                <section id="restricted-words" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Restricted Words: What Requires Prior Approval?</h3>
                                    <p className="mb-6 leading-relaxed text-lg">
                                ...
                                <section id="capital-requirements" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Capital Requirements: Naming Based on Financial Power</h3>
                                ...
                                <section id="identical-names" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">The Legal Test: Identical vs. Too Nearly Resembling</h3>
                                    <p className="mb-6 leading-relaxed text-lg">
                                    ...
                                    <div className="bg-white border-l-[10px] border-l-[#0C002B] p-8 my-10 rounded-r-3xl shadow-xl">
                                        <h5 className="font-bold text-[#0C002B] text-2xl mb-4">What the ROC Ignores for Uniqueness:</h5>
                                ...
                                <section id="run-service" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">RUN Service: Reserving Your Unique Name</h3>
                                    <p className="mb-6 leading-relaxed text-lg">
                                    ...
                                    <div className="space-y-12 my-12 relative before:absolute before:inset-0 before:ml-5 md:before:ml-[31px] before:-z-10 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-indigo-200 before:via-purple-200 before:to-transparent">
                                        ...
                                        <div className="relative flex items-center gap-6 md:gap-10">
                                            ...
                                            <div className="flex flex-col bg-gray-50 p-6 rounded-2xl border border-gray-100 shadow-sm w-full">
                                                <h5 className="font-bold text-[#0C002B] text-xl mb-2">Two Preferences</h5>
                                        ...
                                        <div className="relative flex items-center gap-6 md:gap-10">
                                            ...
                                            <div className="flex flex-col bg-gray-50 p-6 rounded-2xl border border-gray-100 shadow-sm w-full">
                                                <h5 className="font-bold text-[#0C002B] text-xl mb-2">Government Fee (₹1,000)</h5>
                                        ...
                                        <div className="relative flex items-center gap-6 md:gap-10">
                                            ...
                                            <div className="flex flex-col bg-gray-50 p-6 rounded-2xl border border-gray-100 shadow-sm w-full">
                                                <h5 className="font-bold text-[#0C002B] text-xl mb-2">Reservation Validity</h5>
                                ...
                                <section id="spice-plus" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">SPICe+ Part A: The Modern Integrated Workflow</h3>
                                    <p className="mb-4 leading-relaxed text-lg">
                                    ...
                                    <div className="grid md:grid-cols-2 gap-8 my-10 text-white">
                                        <div className="bg-[#0C002B] p-8 rounded-[2rem] border border-gray-700">
                                            <h5 className="text-xl font-bold mb-4">When to use RUN</h5>
                                        ...
                                        <div className="bg-[#160049] p-8 rounded-[2rem] border border-gray-700">
                                            <h5 className="text-xl font-bold mb-4">When to use SPICe+ Part A</h5>
                                            <ul className="text-sm opacity-80 space-y-2 mb-6 p-0 list-none">
                                ...
                                <section id="re-submission" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Mastering the Re-Submission: Strategic Plan B</h3>
                                    <p className="mb-4 leading-relaxed text-lg">
                                ...
                                <section id="trademark-conflict" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6 text-red-700">The Hidden Trap: MCA Approval vs. Trademark Registry</h3>
                                    <p className="mb-6 leading-relaxed text-lg">
                                ...
                                <section id="rejection-reasons" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Top 10 Reasons Why MCA Rejects Company Names</h3>
                                ...
                                <section id="llp-naming" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Naming an LLP: Critical Differences</h3>
                                    <p className="mb-6 leading-relaxed text-lg">
                                ...
                                <section id="why-iprkaro" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6">Why Hundreds of Startups Choose IPR Karo for Naming</h3>
                                    ...
                                    <div className="grid md:grid-cols-3 gap-8 text-center bg-[#0C002B] p-10 rounded-[3rem] text-white">
                                        <div className="space-y-4">
                                            ...
                                            <h5 className="font-bold text-xl">Duo-Database Audit</h5>
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <h5 className="font-bold text-xl">NOC Assistance</h5>
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <h5 className="font-bold text-xl">24-Hour Clearance</h5>
                                ...
                                <section id="conclusion" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6 text-center">Conclusion: Building a Brand on a Solid Foundation</h3>
                                ...
                                <div className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[40px] p-10 md:p-20 text-center text-white relative overflow-hidden mt-20 shadow-2xl">
                                    <div className="relative z-10">
                                        <h3 className="text-3xl md:text-5xl font-bold mb-6">Found Your Perfect Name?</h3>
                        ...
                        <aside className="hidden lg:block space-y-10 sticky top-32">
                            ...
                            <div className="bg-[#0C002B] p-8 rounded-3xl shadow-xl border border-gray-800 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-2xl font-bold mb-4 relative z-10">Instant Check</h4>
                            ...
                            <div className="bg-gray-50 p-8 rounded-3xl shadow-sm border border-gray-100">
                                <h4 className="text-xl font-bold text-[#0C002B] mb-6 border-b pb-4">Key Links</h4>
