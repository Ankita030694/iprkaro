                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_320px] gap-4 md:gap-12 mt-8 items-start">
                        ...
                        <div className="min-w-0">
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-xl md:rounded-2xl shadow-sm border border-gray-100 prose prose-lg max-w-none text-gray-800 font-sans">
                                ...
                                <section id="introduction" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h2 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6">The Pillars of Intellectual Property in Bharat</h2>
                                ...
                                <section id="ranking-methodology" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">How We Rank the Best IP Legal Firms</h3>
                                ...
                                <section id="ipr-karo" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <div className="bg-gradient-to-r from-[#0C002B] to-[#160049] p-1 rounded-3xl mb-8">
                                        <div className="bg-white p-8 md:p-12 rounded-[1.4rem]">
                                            <h3 className="text-3xl md:text-5xl font-bold text-[#0C002B] mb-6 flex items-center">
                                            ...
                                            <div className="grid md:grid-cols-2 gap-8 my-10">
                                                <div className="space-y-4">
                                                    <h5 className="font-bold text-[#6E5E93] flex items-center">
                                ...
                                <section id="ama-legal" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <div className="border-4 border-[#6E5E93] p-1 rounded-3xl mb-8 border-dashed">
                                        <div className="bg-white p-8 md:p-12 rounded-[1.4rem]">
                                            ...
                                            <div className="text-center mt-6">
                                                <a href="https://amalegalsolutions.com" target="_blank" rel="nofollow noopener noreferrer" className="text-[#6E5E93] font-bold hover:underline">Visit AMA Legal Solutions</a>
                                            </div>
                                        </div>
                                    </div>
                                </section>
                                ...
                                <section id="anand-anand" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">3. Anand and Anand: The Legend of Indian IP Law</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-center">
                                    ...
                                    <div className="p-8 bg-indigo-50 rounded-3xl my-10 border-l-8 border-[#6E5E93]">
                                        <h5 className="font-bold text-[#0C002B] mb-4 text-xl">Legacy of Excellence:</h5>
                                    ...
                                    <div className="text-center">
                                        <a href="https://anandandanand.com" target="_blank" rel="nofollow noopener noreferrer" className="text-[#6E5E93] font-bold hover:underline">Visit Anand and Anand</a>
                                    </div>
                                </section>

                                <section id="k-s-partners" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">4. K&S Partners: Specialists in Technical IP</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-center">
                                    ...
                                    <div className="text-center mt-6">
                                        <a href="https://knspartners.com" target="_blank" rel="nofollow noopener noreferrer" className="text-[#6E5E93] font-bold hover:underline">Visit K&S Partners</a>
                                    </div>
                                </section>

                                <section id="remfry-sagar" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">5. Remfry & Sagar: A 19th Century Legacy in a 21st Century World</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-center">
                                    ...
                                    <div className="text-center mt-6">
                                        <a href="https://remfry.com" target="_blank" rel="nofollow noopener noreferrer" className="text-[#6E5E93] font-bold hover:underline">Visit Remfry & Sagar</a>
                                    </div>
                                </section>

                                <section id="lall-sethi" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">6. Lall & Sethi: The Strategists of Brand Protection</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-center">
                                    ...
                                    <div className="text-center mt-6">
                                        <a href="https://lallsethi.com" target="_blank" rel="nofollow noopener noreferrer" className="text-[#6E5E93] font-bold hover:underline">Visit Lall & Sethi</a>
                                    </div>
                                </section>

                                <section id="saikrishna" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">7. Saikrishna & Associates: Media and Tech IP Leaders</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-center">
                                    ...
                                    <div className="text-center mt-6">
                                        <a href="https://saikrishnaassociates.com" target="_blank" rel="nofollow noopener noreferrer" className="text-[#6E5E93] font-bold hover:underline">Visit Saikrishna & Associates</a>
                                    </div>
                                </section>

                                <section id="khaitan" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">8. Khaitan & Co.: Full Service Excellence in IP</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-center">
                                    ...
                                    <div className="text-center mt-6">
                                        <a href="https://khaitanco.com" target="_blank" rel="nofollow noopener noreferrer" className="text-[#6E5E93] font-bold hover:underline">Visit Khaitan & Co.</a>
                                    </div>
                                </section>

                                <section id="khurana" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">9. Khurana and Khurana: The Patent Prosecution Powerhouse</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-center">
                                    ...
                                    <div className="text-center mt-6">
                                        <a href="https://khuranaandkhurana.com" target="_blank" rel="nofollow noopener noreferrer" className="text-[#6E5E93] font-bold hover:underline">Visit Khurana and Khurana</a>
                                    </div>
                                </section>

                                <section id="ls-attorneys" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">10. Lakshmikumaran & Sridharan: Global Dispute Experts</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-center">
                                    ...
                                    <div className="text-center mt-6">
                                        <a href="https://lakshmikumaran.com" target="_blank" rel="nofollow noopener noreferrer" className="text-[#6E5E93] font-bold hover:underline">Visit Lakshmikumaran & Sridharan</a>
                                    </div>
                                </section>

                                <section id="other-notable-firms" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Other Notable Names in the Indian IP Domain</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-center">
                                    ...
                                    <ul className="space-y-4 my-10 list-none p-0 text-center">
                                        <li className="p-6 bg-gray-50 rounded-2xl border border-gray-200">
                                            <h5 className="font-bold text-[#0C002B] mb-1">Inttl Advocare</h5>
                                            <p className="text-gray-600 mb-2">Specialists in IP enforcement and brand auditing for consumer goods.</p>
                                            <a href="https://inttladvocare.com" target="_blank" rel="nofollow noopener noreferrer" className="text-[#6E5E93] text-sm font-bold hover:underline">Visit Website</a>
                                        </li>
                                        <li className="p-6 bg-gray-50 rounded-2xl border border-gray-200">
                                            <h5 className="font-bold text-[#0C002B] mb-1">AZB & Partners</h5>
                                            <p className="text-gray-600 mb-2">A corporate giant with a highly sophisticated IP transactional practice.</p>
                                            <a href="https://azbpartners.com" target="_blank" rel="nofollow noopener noreferrer" className="text-[#6E5E93] text-sm font-bold hover:underline">Visit Website</a>
                                        </li>
                                        <li className="p-6 bg-gray-50 rounded-2xl border border-gray-200">
                                            <h5 className="font-bold text-[#0C002B] mb-1">S. Majumdar & Co.</h5>
                                            <p className="text-gray-600 mb-2">One of the oldest firms in Kolkata, known for patent filing and licensing.</p>
                                            <a href="https://s-majumdar.com" target="_blank" rel="nofollow noopener noreferrer" className="text-[#6E5E93] text-sm font-bold hover:underline">Visit Website</a>
                                        </li>
                                    </ul>
                                </section>

                                <section id="choosing-the-right-firm" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6 text-center">Forensic Guide to Choosing the Right IP Partner</h3>
                                    <p className="mb-6 leading-relaxed text-lg text-center">
                                    ...
                                    <div className="bg-[#0C002B] p-10 rounded-[3rem] text-white my-10 relative overflow-hidden">
                                        <div className="grid md:grid-cols-2 gap-8 text-center">
                                            <div className="space-y-4">
                                                <h5 className="font-bold text-xl text-[#6E5E93]">Sector Specificity</h5>
                                            ...
                                            <div className="space-y-4">
                                                <h5 className="font-bold text-xl text-[#6E5E93]">Turnaround Time</h5>
                                            ...
                                            <div className="space-y-4">
                                                <h5 className="font-bold text-xl text-[#6E5E93]">Search Methodology</h5>
                                            ...
                                            <div className="space-y-4">
                                                <h5 className="font-bold text-xl text-[#6E5E93]">Fee Structure</h5>
                                ...
                                <section id="statutory-framework" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6 text-center">The Statutory Landscape: IP Laws in India 2026</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-center">
                                ...
                                <section id="conclusion" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6 text-center">Conclusion: Securing Your Innovations in the Global Market</h3>
                                ...
                                <div className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[40px] p-10 md:p-20 text-center text-white relative overflow-hidden mt-20 shadow-2xl">
                                    <div className="relative z-10">
                                        <h3 className="text-3xl md:text-5xl font-bold mb-6">Secure Your Brand with the Best</h3>
                        ...
                        <aside className="hidden lg:block space-y-10 sticky top-32">
                            ...
                            <div className="bg-[#0C002B] p-8 rounded-3xl shadow-xl border border-gray-800 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-2xl font-bold mb-4 relative z-10">Priority IP Filing</h4>
                            ...
                            <div className="bg-gray-50 p-8 rounded-3xl shadow-sm border border-gray-100">
                                <h4 className="text-xl font-bold text-[#0C002B] mb-6 border-b pb-4">Legal Resources</h4>
