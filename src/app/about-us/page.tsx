...
export const metadata: Metadata = {
  ...
  description: validateAndNormalizeDescription('Learn about IPR Karo, India\'s first AI-driven platform for trademark registration. Our mission is to simplify brand protection using cutting-edge technology and expert legal guidance. Trusted by 5,000+ businesses.', "app/about-us/page.tsx "),
  alternates: {
    canonical: '/about-us',
  },
  robots: {
