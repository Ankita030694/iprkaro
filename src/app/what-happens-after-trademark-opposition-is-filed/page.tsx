                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_300px] gap-8 items-start">
                        ...
                        <aside className="hidden lg:block sticky top-32 h-[calc(100vh-160px)] overflow-y-auto">
                            <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                                <p className="text-gray-900 font-bold text-lg mb-6 border-l-4 border-[rgb(110,94,147)] pl-3">Process Map</p>
                                ...
                                <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed font-normal">
                                    ...
                                    <section id="stage-1-notice" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8 mb-12">
                                            <div className="bg-gray-50 p-8 rounded-3xl border border-transparent hover:border-[rgb(110,94,147)] transition-all shadow-sm group">
                                                ...
                                                <h4 className="font-bold text-lg mb-2 text-gray-900 uppercase">Arrival of Notice</h4>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-3xl border border-transparent hover:border-[rgb(110,94,147)] transition-all shadow-sm group">
                                                ...
                                                <h4 className="font-bold text-lg mb-2 text-gray-900 uppercase">The 2-Month Rule</h4>
                                    ...
                                    <section id="stage-2-counter" className="scroll-mt-32">
                                        ...
                                        <div className="bg-gray-50 border-l-8 border-[rgb(110,94,147)] p-10 my-10 rounded-r-3xl">
                                            <h5 className="font-black text-gray-900 mb-4">What goes into a Counter-Statement?</h5>
                                    ...
                                    <section id="consequences-late-file" className="scroll-mt-32 pt-16">
                                        <h3 className="text-2xl md:text-3xl lg:text-4xl font-black text-red-600 mb-6 leading-tight">
                                    ...
                                    <section id="stage-4-hearing" className="scroll-mt-32 pt-16">
                                        ...
                                        <div className="bg-gray-900 text-white p-12 rounded-[3.5rem] my-16 shadow-2xl relative overflow-hidden group border border-white/5">
                                            ...
                                            <h5 className="text-3xl font-black mb-6 uppercase tracking-wider relative z-10">Inside the Hearing</h5>
                                    ...
                                    <section id="winning-strategies" className="scroll-mt-32 pt-20">
                                        ...
                                        <div className="grid md:grid-cols-3 gap-8">
                                            <div className="bg-gray-50 p-8 rounded-[2rem] border hover:border-[rgb(199,125,255)] transition-all">
                                                <h6 className="font-black text-xs uppercase mb-4 tracking-widest text-[rgb(199,125,255)]">The Priority Defense</h6>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-[2rem] border hover:border-[rgb(199,125,255)] transition-all">
                                                <h6 className="font-black text-xs uppercase mb-4 tracking-widest text-[rgb(199,125,255)]">The Class Defense</h6>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-[2rem] border hover:border-[rgb(199,125,255)] transition-all">
                                                <h6 className="font-black text-xs uppercase mb-4 tracking-widest text-[rgb(199,125,255)]">The Inactivity Defense</h6>
                                    ...
                                    <section id="reviews" className="scroll-mt-32 pt-12">
                                        <h3 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-12 text-center underline decoration-[rgb(110,94,147)] decoration-4 underline-offset-8 uppercase tracking-tight">
                                        ...
                                        <div className="space-y-6">
                                            {faqs.map((faq, index) => (
                                                <div key={index} className="bg-gray-50 p-8 rounded-3xl hover:bg-white border border-transparent hover:border-gray-100 transition-all shadow-sm">
                                                    <h4 className="text-lg font-black text-gray-900 mb-4 flex items-start">
                                    ...
                                    <section className="bg-indigo-950 text-white p-12 rounded-[4rem] my-20 shadow-2xl relative overflow-hidden group">
                                        ...
                                        <h3 className="text-3xl md:text-5xl font-black mb-8 leading-tight relative z-10">Don't Sacrifice Your Identity</h3>
                        ...
                        <aside className="hidden lg:block space-y-8 sticky top-32">
                            ...
                            <div className="bg-[#0C011A] p-10 rounded-[2.5rem] shadow-2xl border border-white/5 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-xl font-black mb-6 relative z-10 uppercase tracking-tight">Got a TM-O Notice?</h4>
                            ...
                            <div className="bg-gray-50 p-10 rounded-[2.5rem] shadow-sm border border-gray-100">
                                <h4 className="text-sm font-black text-gray-900 mb-8 border-b-4 border-[rgb(110,94,147)] pb-4 uppercase tracking-[0.2em]">Resources</h4>
