...
const tocSections = [
    ...
    { id: 'section9-absolute', title: 'Reasons for Trademark Rejection' },
    { id: 'section11-relative', title: 'Reasons for Trademark Rejection' },
    { id: 'procedural-grounds', title: 'Reasons for Trademark Rejection' },
    { id: 'case-analysis', title: 'Reasons for Trademark Rejection' },
    { id: 'mitigation', title: 'Reasons for Trademark Rejection' },
    { id: 'faqs', title: 'Reasons for Trademark Rejection' },
    { id: 'reviews', title: 'Reasons for Trademark Rejection' },
    { id: 'conclusion', title: 'Reasons for Trademark Rejection' },
];
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_320px] gap-4 md:gap-12 mt-8 items-start">
                        ...
                        <div className="min-w-0">
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-xl md:rounded-2xl shadow-sm border border-gray-100 prose prose-lg max-w-none text-gray-800 font-sans">
                                ...
                                <section id="section9-absolute" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Section 9: Absolute Grounds for Refusal - Inherent Flaws</h3>
                                ...
                                <section id="section11-relative" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Section 11: Relative Grounds for Refusal - External Conflicts</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify text-justify">
                                ...
                                <section id="procedural-grounds" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Procedural & Formal Grounds: Errors in Filing</h3>
                                    <p className="mb-6 leading-relaxed text-lg text-justify text-justify">
                                ...
                                <section id="case-analysis" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Forensic Case Analysis: 2024-2026 Precedents</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify text-justify">
                                    ...
                                    <ul className="space-y-6 my-10 list-none p-0">
                                        <li className="flex gap-4 p-6 bg-white border border-gray-200 rounded-2xl shadow-sm hover:border-[#6E5E93] transition-colors">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-[#0C002B] text-xl">The Lotus Predominance (2026)</h5>
                                        ...
                                        <li className="flex gap-4 p-6 bg-white border border-gray-200 rounded-2xl shadow-sm hover:border-[#6E5E93] transition-colors">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-[#0C002B] text-xl">The Transliteration Trap (2026)</h5>
                                ...
                                <section id="mitigation" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Strategic Mitigation: How IPR Karo Prevents Rejection</h3>
                                    <div className="p-10 bg-gradient-to-br from-indigo-900 to-blue-900 text-white rounded-[3rem] shadow-2xl my-10 relative overflow-hidden group">
                                        <div className="relative z-10 flex flex-col md:flex-row gap-8 items-center">
                                            ...
                                            <div>
                                                <h5 className="text-2xl font-bold mb-3">Forensic Pre-Filing Audit</h5>
                                ...
                                <section id="conclusion" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6 text-center">Building a Fortress Brand on Solid Legal Ground</h3>
                                ...
                                <div className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[40px] p-10 md:p-20 text-center text-white relative overflow-hidden mt-20 shadow-2xl">
                                    <div className="relative z-10">
                                        <h3 className="text-3xl md:text-5xl font-bold mb-6">Avoid Costly Rejections Today</h3>
                        ...
                        <aside className="hidden lg:block space-y-10 sticky top-32">
                            ...
                            <div className="bg-[#0C002B] p-8 rounded-3xl shadow-xl border border-gray-800 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-2xl font-bold mb-4 relative z-10">Received an Objection?</h4>
                            ...
                            <div className="bg-gray-50 p-8 rounded-3xl shadow-sm border border-gray-100">
                                <h4 className="text-xl font-bold text-[#0C002B] mb-6 border-b pb-4">Prevention Resources</h4>
