                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_300px] gap-8 items-start">
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-2xl shadow-sm border border-gray-100 space-y-12 md:space-y-20">
                                ...
                                <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed font-normal">
                                    ...
                                    <section id="legal-framework" className="scroll-mt-32">
                                        <h2 className="text-3xl md:text-5xl font-black text-gray-900 mb-8 leading-tight">Introduction to Rejection Grounds</h2>
                                        <p className="mb-6">
                                    ...
                                    <section id="section-9-overview" className="scroll-mt-32">
                                        <h3 className="text-2xl md:text-4xl font-black text-gray-900 mb-6 leading-tight">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8 my-10">
                                            <div className="bg-gray-50 p-8 rounded-3xl border border-transparent hover:border-[rgb(110,94,147)] transition-all group shadow-sm">
                                                ...
                                                <h5 className="font-bold text-lg mb-2">Non-Distinctive Marks</h5>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-3xl border border-transparent hover:border-[rgb(110,94,147)] transition-all group shadow-sm">
                                                <FontAwesomeIcon icon={faSection} className="text-[rgb(110,94,147)] text-3xl mb-4 group-hover:rotate-12 transition-transform" />
                                                <h5 className="font-bold text-lg mb-2">Descriptive Indications</h5>
                                    ...
                                    <section id="distinctiveness-criteria" className="scroll-mt-32">
                                        ...
                                        <div className="space-y-6">
                                            <div className="bg-gray-900 text-white p-6 rounded-2xl flex items-center gap-6 group hover:translate-x-2 transition-transform">
                                                ...
                                                <div>
                                                    <h6 className="font-bold text-lg mb-1">Generic Marks (Zero Protection)</h6>
                                            ...
                                            <div className="bg-gray-800 text-white p-6 rounded-2xl flex items-center gap-6 group hover:translate-x-2 transition-transform">
                                                ...
                                                <div>
                                                    <h6 className="font-bold text-lg mb-1">Descriptive Marks (Weak Protection)</h6>
                                            ...
                                            <div className="bg-gray-700 text-white p-6 rounded-2xl flex items-center gap-6 group hover:translate-x-2 transition-transform">
                                                ...
                                                <div>
                                                    <h6 className="font-bold text-lg mb-1">Suggestive Marks (Strong Protection)</h6>
                                            ...
                                            <div className="bg-gray-600 text-white p-6 rounded-2xl flex items-center gap-6 group hover:translate-x-2 transition-transform">
                                                ...
                                                <div>
                                                    <h6 className="font-bold text-lg mb-1">Arbitrary & Fanciful Marks (Elite Protection)</h6>
                                    ...
                                    <section id="descriptive-marks" className="scroll-mt-32">
                                        ...
                                        <div className="bg-blue-50 p-8 rounded-3xl my-10 shadow-sm border border-blue-100">
                                            <h5 className="font-bold text-blue-900 mb-4">The 'De-Descriptivilizer' Strategy</h5>
                                    ...
                                    <section id="public-policy" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-6 mb-12">
                                            <div className="p-6 bg-[#0C002B] text-white rounded-2xl relative overflow-hidden group">
                                                ...
                                                <h6 className="font-bold mb-3 text-[rgb(110,94,147)]">Deceptive Marks</h6>
                                            ...
                                            <div className="p-6 bg-[#0C002B] text-white rounded-2xl relative overflow-hidden group">
                                                ...
                                                <h6 className="font-bold mb-3 text-[rgb(110,94,147)]">Religious Susceptibilities</h6>
                                            ...
                                            <div className="p-6 bg-[#0C002B] text-white rounded-2xl relative overflow-hidden group">
                                                ...
                                                <h6 className="font-bold mb-3 text-[rgb(110,94,147)]">Scandalous Matter</h6>
                                            ...
                                            <div className="p-6 bg-[#0C002B] text-white rounded-2xl relative overflow-hidden group">
                                                ...
                                                <h6 className="font-bold mb-3 text-[rgb(110,94,147)]">Prohibited Emblems</h6>
                                    ...
                                    <section id="identity-vs-similarity" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-3 gap-8 mb-12">
                                            <div className="p-8 bg-gray-50 rounded-3xl border border-transparent hover:border-[rgb(110,94,147)] transition-all flex flex-col items-center text-center">
                                                ...
                                                <h6 className="font-bold text-lg mb-3">Visual Similarity</h6>
                                            ...
                                            <div className="p-8 bg-gray-50 rounded-3xl border border-transparent hover:border-[rgb(110,94,147)] transition-all flex flex-col items-center text-center">
                                                ...
                                                <h6 className="font-bold text-lg mb-3">Phonetic Similarity</h6>
                                            ...
                                            <div className="p-8 bg-gray-50 rounded-3xl border border-transparent hover:border-[rgb(110,94,147)] transition-all flex flex-col items-center text-center">
                                                ...
                                                <h6 className="font-bold text-lg mb-3">Conceptual Similarity</h6>
                                    ...
                                    <section id="well-known-marks" className="scroll-mt-32">
                                        ...
                                        <div className="bg-[#0C002B] text-white p-10 rounded-[2.5rem] my-10 shadow-2xl relative overflow-hidden">
                                            ...
                                            <h5 className="text-2xl font-bold mb-4 uppercase tracking-widest text-[rgb(110,94,147)]">The Immortality of Giants</h5>
                                        ...
                                        <div className="relative space-y-12">
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900">Arguing Acquired Distinctiveness</h4>
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900">Differentiation of Trade Channels</h4>
                                                    <p className="text-base text-gray-600">
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900">Honest Concurrent Use</h4>
                                                    <p className="text-base text-gray-600">
                                    ...
                                    <section className="bg-black text-white p-12 rounded-[3rem] my-16 shadow-2xl relative overflow-hidden group">
                                        ...
                                        <h3 className="text-3xl md:text-5xl font-black mb-8 leading-tight">Don't Navigate This Alone</h3>
                                        ...
                                        <div className="space-y-4">
                                            {faqs.map((faq, index) => (
                                                <div key={index} className="border-b border-gray-100 last:border-0 pb-6 mb-6 group">
                                                    <h4 className="text-lg md:text-xl font-bold text-gray-900 mb-4 flex items-start group-hover:text-[rgb(110,94,147)] transition-colors">
                        ...
                        <aside className="hidden lg:block space-y-8 sticky top-32">
                            ...
                            <div className="bg-[#0C002B] p-8 rounded-3xl shadow-[0_20px_40px_rgba(0,0,0,0.1)] border border-gray-800 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-xl font-bold mb-4 relative z-10 leading-tight">Overcome Your Objection</h4>
                            ...
                            <div className="bg-gray-50 p-8 rounded-3xl shadow-sm border border-gray-100">
                                <h4 className="text-lg font-black text-gray-900 mb-6 border-b-2 border-[rgb(110,94,147)] pb-4 uppercase tracking-widest">Legal Library</h4>
