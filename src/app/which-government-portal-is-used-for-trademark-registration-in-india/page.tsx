                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_320px] gap-4 md:gap-12 mt-8 items-start">
                        ...
                        <div className="min-w-0">
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-xl md:rounded-2xl shadow-sm border border-gray-100 prose prose-lg max-w-none text-gray-800 font-sans">
                                ...
                                <section id="introduction" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h2 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6">Bharat</h2>
                                ...
                                <section id="official-portal" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Which Government Portal is Used? Decoding ipindia.gov.in</h3>
                                ...
                                <section id="cgpdtm-role" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Role of CGPDTM: The Administrative Powerhouse</h3>
                                    <p className="mb-6 leading-relaxed text-lg text-justify">
                                    ...
                                    <div className="bg-white border-2 border-dashed border-[#6E5E93] p-8 my-10 rounded-3xl">
                                        <h5 className="font-bold text-[#0C002B] text-xl mb-4 text-center">Functions of the CGPDTM:</h5>
                                ...
                                <section id="portal-anatomy" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Anatomy of the Portal: Exploring Key Sections</h3>
                                    <p className="mb-6 leading-relaxed text-lg text-justify">
                                    ...
                                    <div className="p-8 bg-gray-50 rounded-3xl border border-gray-200 my-10">
                                        <div className="grid md:grid-cols-2 gap-8">
                                            <div className="flex gap-4">
                                                ...
                                                <div>
                                                    <h5 className="font-bold text-[#0C002B]">Public Search</h5>
                                            ...
                                            <div className="flex gap-4">
                                                ...
                                                <div>
                                                    <h5 className="font-bold text-[#0C002B]">Trade Mark Status</h5>
                                            ...
                                            <div className="flex gap-4">
                                                ...
                                                <div>
                                                    <h5 className="font-bold text-[#0C002B]">E-Filing Gateway</h5>
                                            ...
                                            <div className="flex gap-4">
                                                ...
                                                <div>
                                                    <h5 className="font-bold text-[#0C002B]">TM Journal</h5>
                                ...
                                <section id="efiling-services" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Comprehensive e-Filing Services: The Digital Engine</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify">
                                ...
                                <section id="public-search" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Public Search Tool: The First Step of Every Brand</h3>
                                    <p className="mb-6 leading-relaxed text-lg text-justify">
                                ...
                                <section id="classification" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Nice Classification and the MGS Manager Integration</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify">
                                ...
                                <section id="forms-fees" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Standard Forms and Fee Dynamics on the Portal</h3>
                                    <p className="mb-6 leading-relaxed text-lg text-justify">
                                ...
                                <section id="regional-registries" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Connecting with Regional Trade Marks Registries</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify">
                                    ...
                                    <ul className="space-y-4 my-10 list-none p-0">
                                        <li className="flex gap-4 p-6 bg-gray-50 rounded-2xl border border-gray-200 shadow-sm border-l-[10px] border-l-[#6E5E93]">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-[#0C002B] text-xl mb-1">Mumbai (Head Office)</h5>
                                        ...
                                        <li className="flex gap-4 p-6 bg-gray-50 rounded-2xl border border-gray-200 shadow-sm border-l-[10px] border-l-[#6E5E93]">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-[#0C002B] text-xl mb-1">Delhi Office</h5>
                                ...
                                <section id="post-registration" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Beyond Registration: Renewals and Oppositions</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify">
                                ...
                                <section id="common-errors" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6">Avoidable Mistakes While Using the IP India Portal</h3>
                                    ...
                                    <div className="grid md:grid-cols-2 gap-8 bg-[#0C002B] p-10 rounded-[3rem] text-white">
                                        <div className="space-y-4">
                                            <h5 className="font-bold text-xl text-[#6E5E93]">01. Wrong User Category</h5>
                                        ...
                                        <div className="space-y-4">
                                            <h5 className="font-bold text-xl text-[#6E5E93]">02. Incorrect Class mapping</h5>
                                        ...
                                        <div className="space-y-4">
                                            <h5 className="font-bold text-xl text-[#6E5E93]">03. Pixelated Logo uploads</h5>
                                        ...
                                        <div className="space-y-4">
                                            <h5 className="font-bold text-xl text-[#6E5E93]">04. Ignoring Deadlines</h5>
                                ...
                                <section id="why-iprkaro" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">IPRKaro: Navigating the Portal for Global Success</h3>
                                    <p className="mb-6 leading-relaxed text-lg text-justify">
                                ...
                                <section id="conclusion" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6 text-center">Conclusion: Building a Protected Legacy Online</h3>
                                ...
                                <div className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[40px] p-10 md:p-20 text-center text-white relative overflow-hidden mt-20 shadow-2xl">
                                    <div className="relative z-10">
                                        <h3 className="text-3xl md:text-5xl font-bold mb-6">Expert Portal Navigation</h3>
                        ...
                        <aside className="hidden lg:block space-y-10 sticky top-32">
                            ...
                            <div className="bg-[#0C002B] p-8 rounded-3xl shadow-xl border border-gray-800 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-2xl font-bold mb-4 relative z-10">Instant Search Report</h4>
                            ...
                            <div className="bg-gray-50 p-8 rounded-3xl shadow-sm border border-gray-100">
                                <h4 className="text-xl font-bold text-[#0C002B] mb-6 border-b pb-4">Portal Resources</h4>
