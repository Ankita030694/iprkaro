                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_300px] gap-8 items-start">
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-2xl shadow-sm border border-gray-100 space-y-12 md:space-y-20">
                                ...
                                <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed font-normal">
                                    ...
                                    <section id="importance-of-trademark" className="scroll-mt-32">
                                        <h2 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-6 leading-tight">Trademark Registration for Appliance Brands</h2>
                                        <p className="mb-6">
                                    ...
                                    <section id="classification-guide" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-3 gap-8 mb-10">
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                                ...
                                                <h4 className="font-bold text-xl mb-3 text-gray-900">Class 11: The Core Class</h4>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                                ...
                                                <h4 className="font-bold text-xl mb-3 text-gray-900">Class 7: Machines & Motors</h4>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                                ...
                                                <h4 className="font-bold text-xl mb-3 text-gray-900">Class 9: Smart Technology</h4>
                                        ...
                                        <div className="relative space-y-12">
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900">Stage 1: Multi-Class Clearance Search</h4>
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900">Stage 2: Filing Form TM-A</h4>
                                                    <p className="text-base text-gray-600 mb-4">
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900">Stage 3: Examination and Journaling</h4>
                                                    <p className="text-base text-gray-600 mb-4">
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900">Stage 4: Registration and Renewal</h4>
                                                    <p className="text-base text-gray-600 mb-4">
                                    ...
                                    <section id="overcoming-objections" className="scroll-mt-32">
                                        ...
                                        <div className="bg-gray-50 p-10 rounded-[2.5rem] my-10 border border-gray-100">
                                            <h4 className="text-2xl font-bold mb-6 text-gray-900">Relative Grounds (Section 11)</h4>
                                            ...
                                            <h4 className="text-2xl font-bold mb-6 text-gray-900">Absolute Grounds (Section 9)</h4>
                                    ...
                                    <section id="common-mistakes" className="scroll-mt-32">
                                        ...
                                        <ul className="space-y-6 list-none p-0">
                                            <li className="bg-white p-6 rounded-2xl border-l-4 border-red-500 shadow-sm">
                                                <h5 className="font-bold text-gray-900 mb-2">1. The 'Descriptive Name' Trap</h5>
                                            ...
                                            <li className="bg-white p-6 rounded-2xl border-l-4 border-red-500 shadow-sm">
                                                <h5 className="font-bold text-gray-900 mb-2">2. Neglecting Class 7 for Class 11</h5>
                                            ...
                                            <li className="bg-white p-6 rounded-2xl border-l-4 border-red-500 shadow-sm">
                                                <h5 className="font-bold text-gray-900 mb-2">3. Delayed Filing Until Launch</h5>
                                            ...
                                            <li className="bg-white p-6 rounded-2xl border-l-4 border-red-500 shadow-sm">
                                                <h5 className="font-bold text-gray-900 mb-2">4. Forgetting the Logo (Device Mark)</h5>
                                            ...
                                            <li className="bg-white p-6 rounded-2xl border-l-4 border-red-500 shadow-sm">
                                                <h5 className="font-bold text-gray-900 mb-2">5. Ignoring the Madrid Protocol</h5>
                                    ...
                                    <section className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[2.5rem] p-8 md:p-16 text-center text-white relative overflow-hidden mt-12 shadow-2xl border border-white/5">
                                        ...
                                        <div className="relative z-10">
                                            <h3 className="text-3xl md:text-5xl font-black mb-6 leading-tight">Don't Let Your Innovation Go Unprotected</h3>
                        ...
                        <aside className="hidden lg:block space-y-8 sticky top-32 h-[calc(100vh-100px)] overflow-y-auto pr-2 scrollbar-hide">
                            ...
                            <div className="bg-gray-50 p-8 rounded-3xl shadow-sm border border-gray-100">
                                <h4 className="text-lg font-black text-gray-900 mb-6 border-b-2 border-[rgb(110,94,147)] pb-4 uppercase tracking-widest text-xs">Industry Protection</h4>
