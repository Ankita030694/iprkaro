  ...
  return (
    <>
      ...
      <div className="bg-white min-h-screen font-sans text-gray-800">
        ...
        {/* Hero Section */}
        <div className="relative w-full overflow-hidden bg-gradient-to-b from-[#0C002B] via-[#160049] to-[#6E5E93] py-12 lg:py-40">
          <div className="container mx-auto px-4 relative z-10 text-center">
             <h1 className="text-2xl md:text-5xl lg:text-7xl font-extrabold mb-4 md:mb-6 text-white leading-tight mt-16 md:mt-24">
               Secure Your Fashion Legacy: <br />
               <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-300 to-indigo-200">
                 Expert Trademark Registration for Clothing Brands
               </span>
             </h1>
             <p className="text-base md:text-2xl mb-6 md:mb-10 max-w-4xl mx-auto text-gray-200 font-medium leading-relaxed px-2">
             ...
             <div className="flex flex-col items-center gap-4 justify-center">
               <Link href="/contact-us">
                 <button className="bg-white text-[#0C002B] hover:bg-gray-100 font-bold py-4 px-10 rounded-full transition-all transform hover:scale-105 shadow-xl text-lg w-full sm:w-auto">
                   Launch Your Brand Protection
                 </button>
               </Link>
               <a href="tel:+919289707648">
                 <button className="bg-transparent border-2 border-white/50 hover:border-white text-white font-bold py-4 px-10 rounded-full transition-all text-lg flex items-center justify-center w-full sm:w-auto">
                   <FontAwesomeIcon icon={faPhone} className="w-6 h-6 mr-3" />
                   Call for Free Search
                 </button>
               </a>
             </div>
          </div>
