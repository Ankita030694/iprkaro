...
export default function ManipurPage() {
    ...
    const mainReviewSchema = {
        ...
        "itemReviewed": {
            "@type": "Service",
            "name": "Trademark Registration Manipur"
        },
        "reviewRating": {
            "@type": "Rating",
            "ratingValue": "5",
        ...
        "reviewBody": "IPR Karo secured our brand for organic ginger products in record time. Their digital process is perfect for Imphal startups."
    };
