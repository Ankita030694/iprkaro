...
const tocSections = [
    { id: 'introduction', title: 'Fast Track Trademark Registration' },
    { id: 'statutory-framework', title: 'Fast Track Trademark Registration' },
    { id: 'comparison', title: 'Fast Track Trademark Registration' },
    { id: 'eligibility', title: 'Fast Track Trademark Registration' },
    { id: 'mechanism', title: 'Fast Track Trademark Registration' },
    { id: 'fee-structure', title: 'Fast Track Trademark Registration' },
    { id: 'benefits', title: 'Fast Track Trademark Registration' },
    { id: 'examination', title: 'Fast Track Trademark Registration' },
    { id: 'pitfalls', title: 'Fast Track Trademark Registration' },
    { id: 'use-cases', title: 'Fast Track Trademark Registration' },
    { id: 'faqs', title: 'Fast Track Trademark Registration' },
    { id: 'reviews', title: 'Fast Track Trademark Registration' },
    { id: 'conclusion', title: 'Fast Track Trademark Registration' },
];
...
export default function FastTrackTrademarkPage() {
    ...
    const articleSchema = {
        "@context": "https://schema.org",
        "@type": "Article",
        "headline": "Fast Track Trademark Registration",
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_320px] gap-4 md:gap-12 mt-8 items-start">
                        ...
                        <div className="min-w-0">
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-xl md:rounded-2xl shadow-sm border border-gray-100 prose prose-lg max-w-none text-gray-800 font-sans">
                                ...
                                <section id="statutory-framework" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Statutory Framework: Rule 34</h3>
                                    ...
                                    <div className="grid md:grid-cols-2 gap-6 my-10 text-center">
                                        <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100">
                                            <h5 className="font-bold text-[#0C002B] text-xl mb-4">Priority Examination</h5>
                                        ...
                                        <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100">
                                            <h5 className="font-bold text-[#0C002B] text-xl mb-4">Rule 34 Activation</h5>
                                ...
                                <section id="comparison" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Standard vs. Fast Track Timeline</h3>
                                    <div className="bg-[#0C002B] text-white p-10 rounded-[2.5rem] shadow-xl my-10 relative overflow-hidden group text-center">
                                        <div className="relative z-10">
                                            <h5 className="text-2xl font-bold mb-4 flex items-center justify-center gap-3">
                                            ...
                                            <div className="grid md:grid-cols-2 gap-8 text-lg opacity-80 leading-relaxed">
                                                <div className="p-4 border-r border-white/10 last:border-0">
                                                    <h6 className="font-bold text-[#6E5E93] mb-2 uppercase italic">Standard</h6>
                                                    <p>18 to 24 Months</p>
                                                </div>
                                                <div className="p-4">
                                                    <h6 className="font-bold text-[#6E5E93] mb-2 uppercase italic">Fast Track</h6>
                                                    <p>6 to 8 Months</p>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <section id="eligibility" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Eligibility: Who Can Expedite?</h3>
                                    <ul className="space-y-6 my-10 list-none p-0">
                                        <li className="flex gap-4 p-6 bg-white border border-gray-100 rounded-2xl shadow-sm hover:border-[#6E5E93] transition-colors">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-[#0C002B] text-xl">DPIIT Startups & MSMEs</h5>
                                        ...
                                        <li className="flex gap-4 p-6 bg-white border border-gray-100 rounded-2xl shadow-sm hover:border-[#6E5E93] transition-colors">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-[#0C002B] text-xl">Global Exporters</h5>
                                ...
                                <section id="mechanism" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">The Filing Mechanism: TM-A + TM-M</h3>
                                ...
                                <section id="fee-structure" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Fee Structure 2026</h3>
                                ...
                                <section id="benefits" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6 text-justify">Benefits of Brand Acceleration</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-10">
                                        {[
                                            ...
                                            <div key={i} className="p-8 bg-white border border-gray-100 rounded-3xl shadow-sm hover:border-[#6E5E93] transition-all">
                                                ...
                                                <h5 className="font-bold text-[#0C002B] text-xl mb-2">{benefit.title}</h5>
                                ...
                                <section id="pitfalls" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6 text-justify">Common Pitfalls to Avoid</h3>
                                    <div className="p-8 bg-indigo-50 border-l-8 border-[#160049] rounded-r-2xl my-10">
                                        <h5 className="font-bold text-[#160049] mb-4 uppercase tracking-wide flex items-center gap-2">
                                ...
                                <section id="faqs" className="mb-16 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-3xl md:text-5xl font-bold text-[#0C002B] mb-12 text-center text-justify">Frequently Asked Questions</h3>
                                ...
                                <section id="conclusion" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6 text-center text-justify">Accelerating Your Brand Vision</h3>
                                ...
                                <div className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[40px] p-10 md:p-20 text-center text-white relative overflow-hidden mt-20 shadow-2xl">
                                    <div className="relative z-10">
                                        <h3 className="text-3xl md:text-5xl font-bold mb-6">Drive Your Brand to the Fast Lane</h3>
                        ...
                        <aside className="hidden lg:block space-y-10 sticky top-32">
                            ...
                            <div className="bg-[#0C002B] p-8 rounded-3xl shadow-xl border border-gray-800 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-2xl font-bold mb-4 relative z-10">Get Your ® in 6 Months</h4>
                            ...
                            <div className="bg-gray-50 p-8 rounded-3xl shadow-sm border border-gray-100">
                                <h4 className="text-xl font-bold text-[#0C002B] mb-6 border-b pb-4">Acceleration Resources</h4>
