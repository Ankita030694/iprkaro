          ...
          <div className="grid grid-cols-1 lg:grid-cols-[220px_1fr_300px] gap-4 md:gap-12 mt-8 items-start">
              ...
              <div className="bg-white p-4 md:p-12 rounded-xl md:rounded-2xl shadow-sm border border-gray-100 prose prose-lg max-w-none text-gray-800 font-nunito">
                ...
                <section id="introduction" className="mb-20 scroll-mt-24 md:scroll-mt-32">
                  ...
                  <div className="bg-[#0C002B] p-12 my-12 rounded-[2.5rem] shadow-2xl relative overflow-hidden group">
                    ...
                    <h5 className="text-[#FFB703] font-bold text-3xl mb-6 relative z-10">Strategic Insight</h5>
                ...
                <section id="startup-benefits" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-4">Unlocking Government Benefits: 50% Fee Subsidy</h3>
                  ...
                  <div className="grid md:grid-cols-2 gap-4 my-8">
                    <div className="p-5 bg-purple-50 rounded-2xl border border-purple-100 shadow-sm flex flex-col justify-center text-center">
                      <h5 className="font-bold text-purple-900 text-lg mb-1">Fee Rebate</h5>
                    ...
                    <div className="p-5 bg-purple-50 rounded-2xl border border-purple-100 shadow-sm flex flex-col justify-center text-center">
                      <h5 className="font-bold text-purple-900 text-lg mb-1">Fast-Track</h5>
                  ...
                  <h4 className="text-3xl font-bold text-[#160049] mb-6">The SIPP Scheme (Scheme for IPR Protection)</h4>
                  <p className="mb-8 leading-relaxed text-lg">
                  ...
                  <div className="bg-red-50 p-12 rounded-[2rem] border-l-[16px] border-red-600 my-12 shadow-inner">
                    <h5 className="text-red-900 font-bold text-2xl mb-4 uppercase tracking-tighter">Immediate Action Required</h5>
                ...
                <section id="registration-process" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-4">The Step-by-Step Registration Journey</h3>
                  <div className="space-y-6 my-10">
                    <div className="flex gap-4">
                      ...
                      <div>
                        <h5 className="font-bold text-[#0C002B] text-lg mb-1">Advanced AI Search</h5>
                    ...
                    <div className="flex gap-4">
                      ...
                      <div>
                        <h5 className="font-bold text-[#0C002B] text-lg mb-1">E-Filing (Within 24 Hours)</h5>
                    ...
                    <div className="flex gap-4">
                      ...
                      <div>
                        <h5 className="font-bold text-[#0C002B] text-lg mb-1">Examination & Objections</h5>
                    ...
                    <div className="flex gap-4">
                      ...
                      <div>
                        <h5 className="font-bold text-[#0C002B] text-lg mb-1">Journal Publication</h5>
                    ...
                    <div className="flex gap-4">
                      ...
                      <div>
                        <h5 className="font-bold text-[#0C002B] text-lg mb-1">Final Registration</h5>
                ...
                <section id="documents-checklist" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-4">Required Documents Checklist</h3>
                  <div className="grid md:grid-cols-2 gap-6 my-8">
                    <div className="p-6 bg-gray-50 rounded-2xl border border-gray-100 h-full">
                      <h5 className="font-bold text-[#0C002B] text-lg mb-3 underline">For Individual Founders</h5>
                    ...
                    <div className="p-6 bg-gray-50 rounded-2xl border border-gray-100 h-full">
                      <h5 className="font-bold text-[#0C002B] text-lg mb-3 underline">For Companies / LLPs</h5>
                      <ul className="space-y-2.5">
                ...
                <section id="naming-strategy" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-4">Naming & Class Strategy: The Power of Distinctiveness</h3>
                  <p className="mb-4 leading-relaxed text-base">
                  ...
                  <div className="grid md:grid-cols-2 gap-4 my-8">
                    <div className="p-5 bg-purple-50 rounded-2xl border border-purple-100 shadow-sm">
                      <h5 className="font-bold text-[#0C002B] text-lg mb-1">Coined Marks</h5>
                    ...
                    <div className="p-5 bg-blue-50 rounded-2xl border border-blue-100 shadow-sm">
                      <h5 className="font-bold text-[#0C002B] text-lg mb-1">Arbitrary Marks</h5>
                ...
                <section id="industry-classification" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-4">Industry-Specific Classification Guide</h3>
                  <p className="mb-4 leading-relaxed text-base">
                ...
                <section id="global-protection" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-4">Global Brand Protection: Madrid Protocol</h3>
                  <p className="mb-4 leading-relaxed text-base">
                  ...
                  <div className="bg-[#160049] p-8 rounded-2xl text-white shadow-xl my-8">
                    <h5 className="text-xl font-bold mb-4">The Madrid Advantage</h5>
                ...
                <section id="legal-enforcement" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-4">Enforcement & Litigation: Protecting Your Moat</h3>
                  <p className="mb-4 leading-relaxed text-base">
                  ...
                  <div className="grid md:grid-cols-2 gap-4 my-8">
                    <div className="p-5 bg-white rounded-2xl border border-gray-100 shadow-sm">
                      <h6 className="font-bold text-[#0C002B] text-lg mb-1">Notice & Takedown</h6>
                    ...
                    <div className="p-5 bg-white rounded-2xl border border-gray-100 shadow-sm">
                      <h6 className="font-bold text-[#0C002B] text-lg mb-1">Cease & Desist</h6>
                ...
                <section id="assignment-licensing" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-4">IP Monetization: Assignment and Licensing</h3>
                  <p className="mb-4 leading-relaxed text-base">
                ...
                <section id="common-mistakes" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-4">Navigating the Minefield: Pitfalls to Avoid</h3>
                  <p className="mb-4 leading-relaxed text-base">
                ...
                <section id="funding-and-ip" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-4">IP & Investor Readiness</h3>
                  <p className="mb-4 leading-relaxed text-base">
                ...
                <section id="future-of-ip" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-4">The Future of Brand Protection: AI and IP</h3>
                  <p className="mb-4 leading-relaxed text-base">
                  ...
                  <div className="bg-amber-50 p-8 rounded-2xl border border-amber-100 shadow-sm my-8">
                    <h5 className="text-lg font-bold text-amber-900 mb-4 uppercase tracking-widest text-center">Founder's Masterclass</h5>
                    <div className="grid md:grid-cols-2 gap-4">
                      <div className="p-4 bg-white rounded-xl shadow-sm border border-amber-50">
                        <h6 className="font-bold text-base mb-1 text-[#0C002B]">Active Monitoring</h6>
                      ...
                      <div className="p-4 bg-white rounded-xl shadow-sm border border-amber-50">
                        <h6 className="font-bold text-base mb-1 text-[#0C002B]">Defensive Filing</h6>
                ...
                <section id="faqs" className="bg-gray-50 py-16 mt-16 scroll-mt-24 md:scroll-mt-32">
                  <div className="container mx-auto px-4 max-w-4xl">
                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-10 text-center">Frequently Asked Questions</h3>
                    <div className="space-y-6">
                      {faqs.map((faq, index) => (
                        <div key={index} className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                          <h4 className="text-lg font-bold text-[#160049] mb-3">{faq.question}</h4>
            ...
            <aside className="hidden lg:block space-y-10 sticky top-32">
              ...
              <div className="bg-[#0C002B] p-8 rounded-3xl shadow-xl border border-gray-800 text-white relative overflow-hidden group">
                ...
                <h4 className="text-2xl font-bold mb-4 relative z-10">Fast Filing</h4>
