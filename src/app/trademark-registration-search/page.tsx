                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[220px_1fr_300px] gap-4 md:gap-12 mt-8 items-start">
                        ...
                        <div className="min-w-0">
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-xl md:rounded-2xl shadow-sm border border-gray-100 prose prose-lg max-w-none text-gray-800 font-sans">
                                ...
                                <section id="why-search" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Why You Must Conduct a Search Before Filing</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-gray-800">
                                    ...
                                    <div className="grid md:grid-cols-2 gap-6 my-10">
                                        <div className="p-8 bg-blue-50/50 border border-blue-100 rounded-3xl transition-transform hover:-translate-y-1 shadow-md hover:shadow-xl">
                                            ...
                                            <h5 className="font-bold text-xl mb-2 text-black">Avert Immediate Rejection Risk</h5>
                                        ...
                                        <div className="p-8 bg-blue-50/50 border border-blue-100 rounded-3xl transition-transform hover:-translate-y-1 shadow-md hover:shadow-xl">
                                            ...
                                            <h5 className="font-bold text-xl mb-2 text-black">Preserve Massive Capital Waste</h5>
                                        ...
                                        <div className="p-8 bg-blue-50/50 border border-blue-100 rounded-3xl transition-transform hover:-translate-y-1 shadow-md hover:shadow-xl">
                                            ...
                                            <h5 className="font-bold text-xl mb-2 text-black">Enable Strategic Brand Pivots</h5>
                                        ...
                                        <div className="p-8 bg-blue-50/50 border border-blue-100 rounded-3xl transition-transform hover:-translate-y-1 shadow-md hover:shadow-xl">
                                            ...
                                            <h5 className="font-bold text-xl mb-2 text-black">Confirm Absolute Absolute Distinctiveness</h5>
                                ...
                                <section id="ip-india-portal" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Using the Official IP India Search Portal</h3>
                                ...
                                <section id="phonetic-search" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Phonetic vs Wordmark: The Trap of the Similar Sound</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-gray-800">
                                ...
                                <section id="vienna-classification" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Vienna Code Search: Decoding Visual Identity</h3>
                                    <p className="mb-6 leading-relaxed text-lg">
                                ...
                                <section id="common-errors" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Top 5 Mistakes in Public Searches</h3>
                                    <p className="mb-4 leading-relaxed text-lg">
                                ...
                                <section id="interpret-results" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Status Decoding: Interpreting your Search results</h3>
                                    <p className="mb-6 leading-relaxed text-lg">
                                    ...
                                    <div className="grid md:grid-cols-2 gap-8 my-10">
                                        <div className="p-8 bg-[#0C002B] text-white rounded-[3rem] shadow-2xl">
                                            <h5 className="font-bold text-2xl mb-6">High Risk Statuses</h5>
                                        ...
                                        <div className="p-8 bg-gray-50 border border-gray-200 rounded-[3rem]">
                                            <h5 className="font-bold text-2xl mb-6 text-[#160049]">Potential Opportunities</h5>
                                ...
                                <section id="reviews" className="mb-16 scroll-mt-24 md:scroll-mt-32">
                                    <div className="py-16 bg-[#0C002B] rounded-3xl relative overflow-hidden">
                                        ...
                                        <div className="max-w-6xl mx-auto px-6">
                                            <h3 className="text-3xl md:text-4xl font-bold text-white mb-4 text-center">What <span className="text-[#FFB703]">Brands Say</span> About Our Clearance Reports</h3>
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                                <div className="p-6 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm">
                                                    <div className="flex items-center gap-4 mb-4">
                                                        ...
                                                        <div><h4 className="text-white font-bold">Gaurav Anand</h4><p className="text-white/50 text-xs">Founder, Quick Commerce App</p></div>
                                                    </div>
                                                ...
                                                <div className="p-6 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm">
                                                    <div className="flex items-center gap-4 mb-4">
                                                        ...
                                                        <div><h4 className="text-white font-bold">Isha Saxena</h4><p className="text-white/50 text-xs">Brand Manager, Luxury Jewellery House</p></div>
                                                    </div>
                                                    <div className="mb-3 text-[#FFB703] text-sm flex gap-1">★★★★★</div>
                                                ...
                                                <div className="p-6 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm">
                                                    <div className="flex items-center gap-4 mb-4">
                                                        ...
                                                        <div><h4 className="text-white font-bold">Kunal Rawat</h4><p className="text-white/50 text-xs">CEO, Agri-Tech Startup</p></div>
                                                    </div>
                                                    <div className="mb-3 text-[#FFB703] text-sm flex gap-1">★★★★★</div>
                                ...
                                <section id="conclusion" className="mb-12 scroll-mt-24 md:scroll-mt-32 text-gray-800">
                                    <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6 text-center">Nishkarsh: Your Brand's First Line of Defense</h3>
                                ...
                                <div className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[40px] p-10 md:p-20 text-center text-white relative overflow-hidden mt-20 shadow-2xl">
                                    <div className="relative z-10">
                                        <h3 className="text-3xl md:text-5xl font-bold mb-6">Know Before You Grow</h3>
                        ...
                        <aside className="hidden lg:block space-y-10 sticky top-32">
                            ...
                            <div className="bg-[#0C002B] p-8 rounded-3xl shadow-xl border border-gray-800 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-2xl font-bold mb-4 relative z-10">Search Experts</h4>
