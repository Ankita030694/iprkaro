...
const tocSections = [
  { id: 'understanding-objected-status', title: 'Objected Trademark Status Meaning' },
  { id: 'absolute-grounds-section-9', title: 'Objected Trademark Status Meaning' },
  { id: 'relative-grounds-section-11', title: 'Objected Trademark Status Meaning' },
  { id: 'difference-between-objection-and-opposition', title: 'Objected Trademark Status Meaning' },
  { id: 'procedural-objections', title: 'Objected Trademark Status Meaning' },
  { id: 'honest-concurrent-user-defence', title: 'Objected Trademark Status Meaning' },
  { id: 'drafting-the-reply', title: 'Objected Trademark Status Meaning' },
  { id: 'supporting-evidence-affidavit', title: 'Objected Trademark Status Meaning' },
  { id: 'the-hearing-process', title: 'Objected Trademark Status Meaning' },
  { id: 'impact-on-brand-valuation', title: 'Objected Trademark Status Meaning' },
  { id: 'remedies-after-refusal', title: 'Objected Trademark Status Meaning' },
  { id: 'international-filing-consequences', title: 'Objected Trademark Status Meaning' },
  { id: 'common-mistakes-to-avoid', title: 'Objected Trademark Status Meaning' },
  { id: 'faqs', title: 'Objected Trademark Status Meaning' },
];
...
export default function TrademarkObjectedPage() {
  ...
  const articleSchema = {
    "@context": "https://schema.org",
    "@type": "Article",
    "headline": "Objected Trademark Status Meaning",
          ...
          <div className="container mx-auto px-4 py-12 lg:py-32 relative z-10 text-center">
             <h1 className="text-2xl md:text-5xl lg:text-6xl font-extrabold mb-4 md:mb-6 leading-tight mt-20 md:mt-10 text-white">
               ...
               <span className="text-[#6E5E93] bg-clip-text text-transparent bg-gradient-to-r from-[#8A7AB5] to-[#D1C4E9]" style={{ WebkitTextFillColor: 'rgb(110, 94, 147)' }}>
                 Solutions to Secure Your Trademark
               </span>
             </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_300px] gap-8 items-start">
              ...
              <div className="bg-white p-4 md:p-12 rounded-2xl shadow-sm border border-gray-100 space-y-12 md:space-y-20">
                ...
                <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed font-normal">
                  ...
                  <section id="understanding-objected-status" className="scroll-mt-32">
                    <h2 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-6 leading-tight">The Gateway to Trademark Protection</h2>
                    <p className="mb-6">
                  ...
                  <section id="absolute-grounds-section-9" className="scroll-mt-32">
                    ...
                    <div className="grid md:grid-cols-2 gap-8 mb-10">
                      <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                        ...
                        <h4 className="font-bold text-xl mb-3 text-gray-900">Descriptive Marks</h4>
                      ...
                      <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                        ...
                        <h4 className="font-bold text-xl mb-3 text-gray-900">Lack of Distinctiveness</h4>
                      ...
                      <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                        ...
                        <h4 className="font-bold text-xl mb-3 text-gray-900">Customary Language</h4>
                      ...
                      <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                        ...
                        <h4 className="font-bold text-xl mb-3 text-gray-900">Scandalous or Deceptive</h4>
                    ...
                    <div className="relative space-y-12">
                       ...
                       <div className="flex gap-8 items-start relative">
                          ...
                          <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                             <h4 className="text-xl font-bold mb-4 text-gray-900">Missing Authorization (TM-48)</h4>
                       ...
                       <div className="flex gap-8 items-start relative">
                          ...
                          <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                             <h4 className="text-xl font-bold mb-4 text-gray-900">User Date Discrepancies</h4>
                             <p className="text-base text-gray-600 mb-4">
                       ...
                       <div className="flex gap-8 items-start relative">
                          ...
                          <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                             <h4 className="text-xl font-bold mb-4 text-gray-900">Classification and Specification</h4>
                             <p className="text-base text-gray-600 mb-4">
                  ...
                  <section id="post-objection-outcome" className="scroll-mt-32">
                    <h3 className="text-3xl md:text-5xl font-black text-gray-900 mb-12 text-center">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100 flex flex-col items-center text-center">
                           ...
                           <h5 className="font-bold text-xl mb-4">Accepted & Advertised</h5>
                        ...
                        <div className="p-8 bg-[#0C002B] text-white rounded-3xl shadow-xl flex flex-col items-center text-center">
                           ...
                           <h5 className="font-bold text-xl mb-4">Advertised Before Accepted</h5>
                  ...
                  <section className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[2.5rem] p-8 md:p-16 text-center text-white relative overflow-hidden mt-12 shadow-2xl">
                     <div className="relative z-10">
                        <h3 className="text-3xl md:text-5xl font-black mb-6 leading-tight">Overcome Your Objection Today</h3>
            ...
            <aside className="hidden lg:block space-y-8 sticky top-32">
              ...
              <div className="bg-[#0C002B] p-8 rounded-3xl shadow-[0_20px_40px_rgba(0,0,0,0.1)] border border-gray-800 text-white relative overflow-hidden group">
                 ...
                 <h4 className="text-xl font-bold mb-4 relative z-10 leading-tight">Analyze Your Objection Report</h4>
              ...
              <div className="bg-gray-50 p-8 rounded-3xl shadow-sm border border-gray-100">
                <h4 className="text-lg font-black text-gray-900 mb-6 border-b-2 border-[rgb(110,94,147)] pb-4 uppercase tracking-widest">Objection Help</h4>
