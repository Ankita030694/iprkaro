          ...
          <div className="grid grid-cols-1 lg:grid-cols-[220px_1fr_300px] gap-4 md:gap-12 items-start mt-8">
            ...
            <div className="hidden lg:block sticky top-32">
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                <p className="text-lg font-bold text-gray-900 mb-6 flex items-center">`n                  <FontAwesomeIcon icon={faSitemap} className="mr-3 text-[#6E5E93] w-12 h-12" />`n                  Contents`n                </p>
              ...
              <div className="bg-white p-6 md:p-16 rounded-2xl md:rounded-3xl shadow-sm border border-gray-100">
                ...
                <article className="prose prose-xl max-w-none text-gray-700 leading-relaxed">
                  ...
                  <section id="why-check-availability" className="mb-24 scroll-mt-32">
                    <h3 className="text-3xl md:text-4xl font-black text-gray-900 mb-10 group">
                    ...
                    <div className="grid md:grid-cols-2 gap-10 mb-12">
                      <div className="bg-gray-50 p-8 rounded-3xl border border-gray-100 hover:shadow-xl transition-all">
                        ...
                        <h4 className="text-2xl font-bold text-gray-900 mb-4">Eliminating Rejection Risks</h4>
                      ...
                      <div className="bg-gray-50 p-8 rounded-3xl border border-gray-100 hover:shadow-xl transition-all">
                        ...
                        <h4 className="text-2xl font-bold text-gray-900 mb-4">Protecting Marketing Spend</h4>
                      ...
                      <div className="bg-gray-50 p-8 rounded-3xl border border-gray-100 hover:shadow-xl transition-all">
                        ...
                        <h4 className="text-2xl font-bold text-gray-900 mb-4">Avoiding 'Passing Off' Claims</h4>
                      ...
                      <div className="bg-gray-50 p-8 rounded-3xl border border-gray-100 hover:shadow-xl transition-all">
                        ...
                        <h4 className="text-2xl font-bold text-gray-900 mb-4">Attracting Investment</h4>
                  ...
                  <section id="ip-india-portal" className="mb-24 scroll-mt-32">
                    <div className="bg-black text-white p-10 md:p-16 rounded-3xl mb-12 relative overflow-hidden">
                      ...
                      <h3 className="text-3xl md:text-5xl font-black mb-8 relative z-10">The Gateway: IP India Public Search Portal</h3>
                  ...
                  <section id="search-methodology" className="mb-24 scroll-mt-32">
                    <h3 className="text-3xl md:text-4xl font-black text-gray-900 mb-10">
                    ...
                    <div className="space-y-12">
                      <div className="flex gap-6">
                        ...
                        <div>
                          <h4 className="text-2xl font-bold mb-4">Exact Wordmark Analysis</h4>
                      ...
                      <div className="flex gap-6">
                        ...
                        <div>
                          <h4 className="text-2xl font-bold mb-4">Prefix and Suffix Variation</h4>
                      ...
                      <div className="flex gap-6">
                        ...
                        <div>
                          <h4 className="text-2xl font-bold mb-4">Cross-Class Sector Analysis</h4>
                  ...
                  <section id="common-mistakes" className="mb-24 scroll-mt-32">
                    ...
                    <div className="space-y-6">
                      <div className="bg-red-50 p-8 rounded-3xl border border-red-100 flex items-start gap-6">
                        ...
                        <div>
                          <h5 className="text-xl font-bold text-red-900 mb-2 italic">"I only searched for the exact name."</h5>
                      ...
                      <div className="bg-red-50 p-8 rounded-3xl border border-red-100 flex items-start gap-6">
                        <FontAwesomeIcon icon={faQuoteLeft} className="text-red-200 h-12 w-12 mt-2" />
                        <div>
                          <h5 className="text-xl font-bold text-red-900 mb-2 italic">"I didn't check the status of existing applications."</h5>
                      ...
                      <div className="bg-red-50 p-8 rounded-3xl border border-red-100 flex items-start gap-6">
                        <FontAwesomeIcon icon={faQuoteLeft} className="text-red-200 h-12 w-12 mt-2" />
                        <div>
                          <h5 className="text-xl font-bold text-red-900 mb-2 italic">"I only searched one class."</h5>
                  ...
                  <section id="expert-assistance" className="mb-24 scroll-mt-32 border-t-2 border-gray-100 pt-20">
                    <div className="flex flex-col md:flex-row gap-12 items-center">
                      <div className="flex-1">
                        <h3 className="text-3xl md:text-4xl font-black text-gray-900 mb-6">Why You Need a Legal Partner</h3>
                        <p className="text-xl mb-8">
                      ...
                      <div className="w-full md:w-[400px] bg-gradient-to-br from-[#0C002B] to-[#1a0033] p-10 rounded-3xl text-white text-center shadow-2xl">
                        ...
                        <h4 className="text-2xl font-bold mb-4">Certified Search Report</h4>
                  ...
                  <section id="faqs" className="mb-24 scroll-mt-32">
                    <div className="flex items-center mb-12">
                      ...
                      <h3 className="text-3xl md:text-5xl font-black text-gray-900 m-0">Frequently Asked Questions</h3>
                    </div>
                    <div className="space-y-8">
                      {faqs.map((faq, index) => (
                        <div key={index} className="bg-gray-50 p-8 rounded-3xl border border-gray-100 hover:border-[#6E5E93]/30 transition-colors group">
                          <h4 className="text-xl md:text-2xl font-bold text-gray-900 mb-6 flex items-start">
                  ...
                  <section className="mb-24 scroll-mt-32">
                    <h3 className="text-3xl md:text-4xl font-black text-gray-900 mb-8 underline decoration-[#6E5E93]/30 underline-offset-8">The Evolution of Trademark Law and Public Access in India</h3>
                    <p className="mb-8">
                    ...
                    <h3 className="text-3xl md:text-4xl font-black text-gray-900 mb-8">Deep Dive into Sector-Specific Search Strategies</h3>
                    <p className="mb-8">
                    ...
                    <h4 className="text-2xl font-bold mb-4">1. Pharmaceuticals (Class 5)</h4>
                    <p className="mb-8">
                    ...
                    <h4 className="text-2xl font-bold mb-4">2. Technology and Software (Class 42)</h4>
                    <p className="mb-8">
                    ...
                    <h4 className="text-2xl font-bold mb-4">3. Fashion and Apparel (Class 25)</h4>
                    <p className="mb-8">
                    ...
                    <h3 className="text-3xl md:text-4xl font-black text-gray-900 mb-8">Case Study: The Impact of Improper Searching</h3>
                    <div className="bg-orange-50 p-10 rounded-3xl border border-orange-100 mb-12">
                      <h5 className="text-xl font-bold text-orange-900 mb-4">The Big Basket vs. Daily Fish Dispute</h5>
                    ...
                    <h3 className="text-3xl md:text-4xl font-black text-gray-900 mb-8">Detailed Checklist for a Professional-Grade Search</h3>
                    ...
                    <h3 className="text-3xl md:text-4xl font-black text-gray-900 mb-8">The Legal Standard of 'Deceptive Similarity'</h3>
                    <p className="mb-8">
                    ...
                    <h3 className="text-3xl md:text-4xl font-black text-gray-900 mb-8">Long-Term Brand Strategy: Beyond the Registration</h3>
                    <p className="mb-8">
                  ...
                  <section id="reviews" className="mb-24 scroll-mt-32">
                    <div className="flex items-center mb-12">
                      ...
                      <h3 className="text-3xl md:text-5xl font-black text-gray-900 m-0">What Our Clients Say</h3>
                    </div>
                  ...
                  <section className="mb-24 scroll-mt-32">
                    <h3 className="text-3xl md:text-4xl font-black text-gray-900 mb-8 underline decoration-[#6E5E93]/30 underline-offset-8">Geographical Indications vs. Trademarks: A Crucial Distinction</h3>
                    <p className="mb-8">
                    ...
                    <h3 className="text-3xl md:text-4xl font-black text-gray-900 mb-8">Conflict Resolution: What if Your Name is (Partially) Taken?</h3>
                    <p className="mb-8">
                  ...
                  <section className="mb-24 scroll-mt-32">
                    <h3 className="text-3xl md:text-4xl font-black text-gray-900 mb-8 text-center bg-gray-900 text-white p-6 rounded-2xl">Final Thoughts: Your Name is Your Destiny</h3>
                ...
                <section className="bg-gradient-to-r from-[#0C002B] via-[#160049] to-[#0C002B] rounded-3xl md:rounded-[40px] p-8 md:p-24 text-center text-white relative overflow-hidden mt-16 shadow-[0_20px_50px_rgba(0,0,0,0.3)]">
                  ...
                  <div className="relative z-10 max-w-4xl mx-auto">
                    <h3 className="text-3xl md:text-6xl font-black mb-8 leading-tight">Don't Leave Your Brand to <span className="text-[#6E5E93]">Chance</span></h3>
                ...
                <section className="mt-24 space-y-12">
                  <h3 className="text-3xl md:text-5xl font-black text-gray-900 border-b-4 border-[#6E5E93] pb-4 inline-block">The Intellectual Property Glossary for Founders</h3>
                  ...
                  <div className="grid md:grid-cols-2 gap-8">
                    <div className="p-8 bg-white rounded-3xl border border-gray-100 shadow-sm">
                      <h5 className="font-bold text-xl mb-4 text-[#6E5E93]">Abandoned Mark</h5>
                    ...
                    <div className="p-8 bg-white rounded-3xl border border-gray-100 shadow-sm">
                      <h5 className="font-bold text-xl mb-4 text-[#6E5E93]">Associated Marks</h5>
                    ...
                    <div className="p-8 bg-white rounded-3xl border border-gray-100 shadow-sm">
                      <h5 className="font-bold text-xl mb-4 text-[#6E5E93]">Collective Mark</h5>
                    ...
                    <div className="p-8 bg-white rounded-3xl border border-gray-100 shadow-sm">
                      <h5 className="font-bold text-xl mb-4 text-[#6E5E93]">Well-Known Trademark</h5>
                  ...
                  <h3 className="text-3xl md:text-4xl font-black text-gray-900 mt-20">Global Expansion: Searching Under the Madrid Protocol</h3>
                  ...
                  <h3 className="text-3xl md:text-4xl font-black text-gray-900 mt-20">Navigating the 'Opposed' and 'Refused' Statuses</h3>
                  <p className="text-lg mb-8">
                  ...
                  <h3 className="text-3xl md:text-4xl font-black text-gray-900 mt-20">The Future of Trademark Availability: The AI Revolution</h3>
                  <p className="text-lg mb-8">
                  ...
                  <h3 className="text-3xl md:text-4xl font-black text-gray-900 mt-20">Strategic Trademark Maintenance: Beyond the Registration Certificate</h3>
                  <p className="text-lg mb-8">
                  ...
                  <div className="bg-blue-50 p-10 rounded-3xl border border-blue-100 mb-12">
                    <h4 className="text-2xl font-bold text-blue-900 mb-4">The 3 Pillars of Post-Search Maintenance</h4>
                  ...
                  <h3 className="text-3xl md:text-4xl font-black text-gray-900 mt-20">Summary: Building a Legacy Brand</h3>
                  <p className="text-lg mb-8">
