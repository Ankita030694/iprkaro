          ...
          <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_300px] gap-8 items-start">
            ...
            <aside className="hidden lg:block sticky top-32 h-[calc(100vh-160px)] overflow-y-auto">
              <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                <p className="text-gray-900 font-bold text-lg mb-6 border-l-4 border-[rgb(110,94,147)] pl-3 italic uppercase tracking-[0.2em] font-black underline underline-offset-4 decoration-[rgb(110,94,147)]">Enforcement Playbook</p>
                ...
                <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed">
                  ...
                  <section id="monitoring" className="scroll-mt-32">
                    ...
                    <div className="grid md:grid-cols-3 gap-6 mb-10">
                      <div className="p-6 bg-gray-50 rounded-2xl border border-gray-100 hover:shadow-md transition-all">
                        ...
                        <h5 className="font-black text-gray-900 mb-2 text-sm uppercase">Registry Watch</h5>
                      ...
                      <div className="p-6 bg-gray-50 rounded-2xl border border-gray-100 hover:shadow-md transition-all">
                        ...
                        <h5 className="font-black text-gray-900 mb-2 text-sm uppercase">Online Monitoring</h5>
                        <p className="text-xs text-gray-600 leading-relaxed font-bold italic">
                      ...
                      <div className="p-6 bg-gray-50 rounded-2xl border border-gray-100 hover:shadow-md transition-all">
                        ...
                        <h5 className="font-black text-gray-900 mb-2 text-sm uppercase">Physical Market Watch</h5>
                        <p className="text-xs text-gray-600 leading-relaxed font-bold italic">
                  ...
                  <section id="cease-desist" className="scroll-mt-32">
                    ...
                    <div className="bg-[#0C002B] text-white p-10 rounded-[3rem] shadow-2xl relative overflow-hidden my-12">
                      ...
                      <h5 className="text-xl font-black mb-6 uppercase italic">Anatomy of a Winning C&D Letter</h5>
                  ...
                  <section id="civil-remedies" className="scroll-mt-32">
                    ...
                    <h4 className="text-xl font-black text-gray-900 mb-4 uppercase">1. Interim Injunction</h4>
                    <p className="mb-6">
                    ...
                    <div className="grid md:grid-cols-3 gap-6 mb-10">
                      <div className="bg-green-50 p-6 rounded-2xl border border-green-100">
                        <h6 className="font-black text-green-900 text-xs uppercase mb-2">Prima Facie Case</h6>
                      ...
                      <div className="bg-blue-50 p-6 rounded-2xl border border-blue-100">
                        <h6 className="font-black text-blue-900 text-xs uppercase mb-2">Balance of Convenience</h6>
                      ...
                      <div className="bg-red-50 p-6 rounded-2xl border border-red-100">
                        <h6 className="font-black text-red-900 text-xs uppercase mb-2">Irreparable Injury</h6>
                    ...
                    <h4 className="text-xl font-black text-gray-900 mb-4 uppercase">2. Anton Piller Orders</h4>
                    <p className="mb-6">
                    ...
                    <h4 className="text-xl font-black text-gray-900 mb-4 uppercase">3. John Doe Orders (Ashok Kumar Orders)</h4>
                    <p className="mb-6">
                    ...
                    <h4 className="text-xl font-black text-gray-900 mb-4 uppercase">4. Damages and Account of Profits</h4>
                    <p className="mb-6">
                    ...
                    <h4 className="text-xl font-black text-gray-900 mb-4 uppercase">5. Destruction of Infringing Goods</h4>
                    <p className="mb-6">
                  ...
                  <section id="online-enforcement" className="scroll-mt-32">
                    ...
                    <div className="grid md:grid-cols-2 gap-8 mb-10">
                      <div className="bg-white border border-gray-100 p-8 rounded-3xl shadow-sm hover:shadow-md transition-all">
                        <h5 className="font-black text-gray-900 mb-4 uppercase text-sm flex items-center gap-3">
                    ...
                    <div className="space-y-4 mb-10">
                      {[
                        ...
                        <div key={item.num} className="flex gap-6 items-center bg-gray-50 p-6 rounded-2xl border border-gray-100">
                          ...
                          <div>
                            <h5 className="font-black text-gray-900 uppercase text-sm mb-1">{item.label}</h5>
                    ...
                    <div className="space-y-4">
                      {faqs.map((f, i) => (
                        <div key={i} className="group border-b border-gray-100 pb-6 mb-6">
                          <h4 className="text-lg md:text-xl font-black text-gray-900 mb-4 flex items-start group-hover:text-[rgb(110,94,147)] transition-colors">
                  ...
                  <section className="bg-gradient-to-br from-[#0C002B] to-[#1a0031] rounded-[4rem] p-10 md:p-20 text-center text-white relative overflow-hidden mt-12 shadow-[0_40px_100px_rgba(0,0,0,0.3)] group border border-white/5">
                    ...
                    <div className="relative z-10">
                      <h3 className="text-4xl md:text-6xl font-black mb-8 leading-tight uppercase italic tracking-tighter">Your Brand Deserves a Fighter</h3>
            ...
            <aside className="hidden lg:block space-y-8 sticky top-32">
              <div className="bg-[#0C002B] p-8 rounded-3xl shadow-[0_30px_60px_rgba(0,0,0,0.2)] border border-gray-800 text-white relative overflow-hidden group">
                ...
                <h4 className="text-xl font-bold mb-4 relative z-10 leading-tight uppercase font-black italic tracking-[0.1em]">Free Enforcement Audit</h4>
              ...
              <div className="bg-gray-50 p-8 rounded-3xl shadow-sm border border-gray-100">
                <h4 className="text-sm font-black text-gray-400 mb-6 border-b-2 border-gray-100 pb-4 uppercase tracking-widest italic">Related Legal Guides</h4>
