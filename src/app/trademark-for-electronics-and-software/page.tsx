                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_300px] gap-8 items-start">
                        ...
                        <aside className="hidden lg:block sticky top-32">
                            <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                                <p className="text-gray-900 font-bold text-lg mb-6 border-l-4 border-[rgb(110,94,147)] pl-3">Tech IP Hub</p>
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-2xl shadow-sm border border-gray-100 space-y-12 md:space-y-20">
                                ...
                                <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed font-normal">
                                    ...
                                    <section id="digital-frontier-ip" className="scroll-mt-32">
                                        <h2 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-6 leading-tight flex items-center">Why IP Matters in the Tech Economy</h2>
                                        <p className="mb-6">
                                    ...
                                    <section id="class-9-vs-42" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8 mb-10">
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all">
                                                ...
                                                <h4 className="font-bold text-xl mb-3">Class 9: Tech Products</h4>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all">
                                                ...
                                                <h4 className="font-bold text-xl mb-3">Class 42: Tech Services</h4>
                                    ...
                                    <section id="comprehensive-it-list" className="scroll-mt-32 pt-12">
                                        <h3 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-6 leading-tight text-center uppercase tracking-tighter">
                                        ...
                                        <div className="grid md:grid-cols-3 gap-6 mb-12">
                                            <div className="p-6 bg-gray-50 rounded-xl border border-gray-100 hover:bg-white hover:shadow-xl transition-all">
                                                <h5 className="font-bold text-[rgb(110,94,147)] mb-3 text-lg">Hardware & Gadgets</h5>
                                            ...
                                            <div className="p-6 bg-gray-50 rounded-xl border border-gray-100 hover:bg-white hover:shadow-xl transition-all">
                                                <h5 className="font-bold text-[rgb(110,94,147)] mb-3 text-lg">Industrial Automation</h5>
                                            ...
                                            <div className="p-6 bg-gray-50 rounded-xl border border-gray-100 hover:bg-white hover:shadow-xl transition-all">
                                                <h5 className="font-bold text-[rgb(110,94,147)] mb-3 text-lg">Digital Recording</h5>
                                        ...
                                        <div className="space-y-12 relative">
                                            ...
                                            <div className="flex gap-8 items-start relative transition-all hover:translate-x-2">
                                                ...
                                                <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm flex-1">
                                                    <h4 className="text-xl font-bold mb-3">Phase 1: Deep Tech Clearance Search</h4>
                                            ...
                                            <div className="flex gap-8 items-start relative transition-all hover:translate-x-2">
                                                ...
                                                <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm flex-1">
                                                    <h4 className="text-xl font-bold mb-3">Phase 2: Tactical Specification Drafting</h4>
                                                    <p className="text-gray-600 leading-relaxed">
                                            ...
                                            <div className="flex gap-8 items-start relative transition-all hover:translate-x-2">
                                                ...
                                                <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm flex-1">
                                                    <h4 className="text-xl font-bold mb-3">Phase 3: Examination and Journal Success</h4>
                                                    <p className="text-gray-600 leading-relaxed">
                                    ...
                                    <section id="legal-hurdles-tech" className="scroll-mt-32 pt-12">
                                        ...
                                        <div className="space-y-8">
                                            <div className="p-6 bg-white border-l-4 border-[rgb(110,94,147)] shadow-sm">
                                                <h5 className="font-bold text-lg mb-2 text-gray-900">1. Functionality-based Objections</h5>
                                            ...
                                            <div className="p-6 bg-white border-l-4 border-[rgb(110,94,147)] shadow-sm">
                                                <h5 className="font-bold text-lg mb-2 text-gray-900">2. Class Overlap (Class 38 vs 42)</h5>
                                    ...
                                    <section id="pricing-and-fees" className="scroll-mt-12 focus:outline-none">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8 mb-16">
                                            <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100 flex flex-col items-center">
                                                <h5 className="font-bold text-xl mb-6 text-gray-900 uppercase tracking-widest">Government Fees</h5>
                                            ...
                                            <div className="p-8 bg-[rgb(110,94,147)] text-white rounded-3xl shadow-2xl flex flex-col items-center">
                                                <h5 className="font-bold text-xl mb-6 uppercase tracking-widest">IPR Karo Service Fee</h5>
                                                <div className="space-y-4 w-full">
                                    ...
                                    <section id="faqs" className="scroll-mt-32 pt-16 focus:outline-none">
                                        <h3 className="text-3xl md:text-5xl font-black text-gray-900 mb-12 text-center uppercase tracking-tighter leading-snug">
                                    ...
                                    <section className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[3rem] p-10 md:p-24 text-center text-white relative overflow-hidden mt-12 shadow-2xl group">
                                        ...
                                        <div className="relative z-10">
                                            <h3 className="text-4xl md:text-7xl font-black mb-10 leading-tight tracking-tighter uppercase">Scale Your Tech Infinity.</h3>
                        ...
                        <aside className="hidden lg:block space-y-8 sticky top-32">
                            ...
                            <div className="bg-[#0C002B] p-10 rounded-[2.5rem] shadow-2xl border border-gray-800 text-white group text-center relative overflow-hidden">
                                ...
                                <h4 className="text-2xl font-black mb-6 uppercase tracking-tighter relative z-10 leading-tight leading-snug">Tech Scan</h4>
                            ...
                            <div className="bg-gray-50 p-10 rounded-[2.5rem] border border-gray-100 shadow-sm">
                                <h4 className="text-[10px] font-black text-gray-400 mb-8 uppercase tracking-[0.4em] border-b border-gray-200 pb-4">Digital IP Shield</h4>
