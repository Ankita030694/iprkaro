...
export const metadata: Metadata = {
    ...
    description: validateAndNormalizeDescription('Perform a free trademark search on the official IP India database. Check brand name availability, phonetic similarities, and get expert legal reports instantly.', "app/trademark-search/page.tsx "),
    keywords: [
        'trademark search',
    ...
    openGraph: {
        ...
        description: validateAndNormalizeDescription('Learn how to verify your brand name availability using the official Indian trademark database. Step by step instructions and expert tips.', "app/trademark-search/page.tsx "),
                        ...
                        <div className="min-w-0">
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-xl md:rounded-2xl shadow-sm border border-gray-100 prose prose-lg max-w-none text-gray-800 font-sans">
                                ...
                                <section id="introduction" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h2 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6">Trademark Search</h2>
                                ...
                                <section id="search-portals" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Top Portals for Trademark Search in 2026</h3>
                                ...
                                <section id="how-to-search" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">How to Conduct a Manual Trademark Search: A Step by Step Guide</h3>
                                    ...
                                    <div className="space-y-8 my-10 relative">
                                        <div className="flex gap-6 items-start">
                                            ...
                                            <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100 w-full shadow-sm">
                                                <h5 className="font-bold text-gray-900 mb-2">Access the Portal</h5>
                                        ...
                                        <div className="flex gap-6 items-start">
                                            ...
                                            <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100 w-full shadow-sm">
                                                <h5 className="font-bold text-gray-900 mb-2">Choose Search Type</h5>
                                        ...
                                        <div className="flex gap-6 items-start">
                                            ...
                                            <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100 w-full shadow-sm">
                                                <h5 className="font-bold text-gray-900 mb-2">Input Brand Details</h5>
                                        ...
                                        <div className="flex gap-6 items-start">
                                            ...
                                            <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100 w-full shadow-sm">
                                                <h5 className="font-bold text-gray-900 mb-2">Assign Classification</h5>
                                ...
                                <section id="phonetic-nuances" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Mastering the Phonetic Search: Beyond Spelling</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-gray-800">
                                    ...
                                    <div className="grid md:grid-cols-2 gap-8 my-10">
                                        <div className="p-8 bg-[#0C002B] text-white rounded-3xl shadow-xl">
                                            <h5 className="font-bold text-xl mb-4 text-[#6E5E93]">The Apple vs. Appel Rule</h5>
                                        ...
                                        <div className="p-8 bg-blue-50 border border-blue-100 rounded-3xl">
                                            <h5 className="font-bold text-xl mb-4 text-[#0C002B]">Strategic Phonetic Tips</h5>
                                ...
                                <section id="class-selection" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Choosing the Right Class for Your Search</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-gray-800">
                                ...
                                <section id="logo-search" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Visual Search: The Vienna Classification Decoded</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-gray-800">
                                ...
                                <section id="search-risk-levels" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Risk Assessment: Green, Yellow, and Red Signals</h3>
                                    <p className="mb-6 leading-relaxed text-lg text-gray-800">
                                    ...
                                    <div className="grid md:grid-cols-3 gap-6 my-10 text-center">
                                        <div className="p-6 bg-green-50 rounded-2xl border border-green-200 shadow-sm">
                                            ...
                                            <h5 className="font-bold text-green-700 text-lg mb-2">Category: Green</h5>
                                        ...
                                        <div className="p-6 bg-yellow-50 rounded-2xl border border-yellow-200 shadow-sm">
                                            ...
                                            <h5 className="font-bold text-yellow-700 text-lg mb-2">Category: Yellow</h5>
                                        ...
                                        <div className="p-6 bg-red-50 rounded-2xl border border-red-200 shadow-sm">
                                            ...
                                            <h5 className="font-bold text-red-700 text-lg mb-2">Category: Red</h5>
                                ...
                                <section id="reviews" className="mb-16 scroll-mt-24 md:scroll-mt-32">
                                    <div className="py-16 bg-[#0C002B] rounded-3xl relative overflow-hidden">
                                        ...
                                        <div className="max-w-6xl mx-auto px-6">
                                            <h3 className="text-3xl md:text-4xl font-bold text-white mb-4 text-center">What <span className="text-[#FFB703]">Clients Say</span> About Our Search Reports</h3>
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                                <div className="p-6 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm">
                                                    <div className="flex items-center gap-4 mb-4">
                                                        ...
                                                        <div><h4 className="text-white font-bold">Arjun Khanna</h4><p className="text-white/50 text-xs">Founder, Fashion E-commerce</p></div>
                                                    </div>
                                                ...
                                                <div className="p-6 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm">
                                                    <div className="flex items-center gap-4 mb-4">
                                                        ...
                                                        <div><h4 className="text-white font-bold">Meera Pillai</h4><p className="text-white/50 text-xs">CEO, Health Supplement Brand</p></div>
                                                    </div>
                                                    <div className="mb-3 text-[#FFB703] text-sm flex gap-1">★★★★★</div>
                                                ...
                                                <div className="p-6 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm">
                                                    <div className="flex items-center gap-4 mb-4">
                                                        ...
                                                        <div><h4 className="text-white font-bold">Tarun Verma</h4><p className="text-white/50 text-xs">Director, Packaging Solutions</p></div>
                                                    </div>
                                                    <div className="mb-3 text-[#FFB703] text-sm flex gap-1">★★★★★</div>
                                ...
                                <section id="conclusion" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6 text-center">Protecting Your Brand Identity Starts Here</h3>
                                ...
                                <div className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[40px] p-10 md:p-20 text-center text-white relative overflow-hidden mt-20 shadow-2xl">
                                    <div className="relative z-10">
                                        <h3 className="text-3xl md:text-5xl font-bold mb-6">Search Before You Scale</h3>
