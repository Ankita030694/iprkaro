...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (description.length > 150) {
    description = `Trademark registration in ${location}. Legal assistance for brand protection & TM filing by IPR Karo.`;
  }
  if (description.length > 150) {
    description = `Trademark registration in ${location}. Brand protection & TM filing by IPR Karo.`;
  }
  if (description.length > 150) {
    description = `Trademark registration in ${location} by IPR Karo.`;
  }
  if (description.length > 150) {
...
export default async function LocationTrademarkPage({ params }: Props) {
  ...
  // Redirect to the dedicated static page if one exists
  const targetSlug = staticLocationMapping[slug] || slug;
  if (staticLocationSlugs.includes(targetSlug)) {
    redirect(`/trademark-registration-in-${targetSlug}`);
  }
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[220px_1fr_280px] gap-4 md:gap-8 items-start mt-6">
            ...
            <div className="hidden lg:block sticky top-32">
              <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-100">
                <p className="font-bold text-gray-900 mb-4 border-b pb-2">Contents</p>
            ...
            <div className="min-w-0">
              ...
              <div className="bg-white p-5 md:p-12 rounded-xl md:rounded-2xl shadow-sm space-y-10 md:space-y-16">
                ...
                <section id="key-benefits" className="scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Key Benefits of Trademark Registration in {location}</h3>
                  ...
                  <div className="space-y-6 md:space-y-10">
                    <div className="flex flex-col md:flex-row gap-6 relative">
                      ...
                      <div className="bg-white p-6 md:p-8 rounded-xl border border-gray-100 shadow-sm flex-1 hover:shadow-lg transition-shadow duration-300">
                        <h4 className="text-xl md:text-2xl font-bold text-gray-900 mb-3 flex items-center">
                ...
                <section id="documents-checklist" className="scroll-mt-24 md:scroll-mt-32 bg-gray-50 p-6 md:p-10 rounded-2xl border border-gray-200">
                  ...
                  <div className="grid md:grid-cols-2 gap-8">
                    <div className="bg-white p-6 rounded-xl shadow-sm">
                      <h4 className="font-bold text-xl mb-4 text-[rgb(110,94,147)] border-b pb-2">For Individuals & Proprietorships</h4>
                    ...
                    <div className="bg-white p-6 rounded-xl shadow-sm">
                      <h4 className="font-bold text-xl mb-4 text-[rgb(110,94,147)] border-b pb-2">For Companies, LLPs & Startups</h4>
                      <ul className="space-y-4">
                        <li className="flex items-start">
                          <FontAwesomeIcon icon={faCheck} className="mt-1 mr-3 text-green-500 w-5 h-5 flex-shrink-0" />
                ...
                <section id="cost-and-timeline" className="scroll-mt-24 md:scroll-mt-32">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="border border-gray-200 rounded-xl p-6 bg-white shadow-sm flex items-start">
                      ...
                      <div>
                        <h4 className="font-bold text-xl text-gray-900 mb-2">Government Fees</h4>
                    ...
                    <div className="border border-gray-200 rounded-xl p-6 bg-white shadow-sm flex items-start">
                      ...
                      <div>
                        <h4 className="font-bold text-xl text-gray-900 mb-2">Professional Fees</h4>
                  ...
                  <div className="space-y-6">
                    {faqs.map((faq, index) => (
                      <div key={index} className="border-b border-gray-200 pb-6 last:border-0">
                        <h4 className="text-lg md:text-xl font-bold text-[rgb(110,94,147)] mb-3 flex items-start">
                ...
                <section id="reviews" className="scroll-mt-24 md:scroll-mt-32 bg-gray-50 p-6 md:p-10 rounded-2xl border border-gray-200">
                  <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-8 text-center">Trusted by Businesses in {location}</h3>
                    ...
                    {reviews.map((rev, i) => (
                      <div key={i} className="bg-white p-6 rounded-xl border border-gray-100 flex flex-col justify-between shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <div className="flex items-center gap-3 pt-4 border-t border-gray-50">
                          ...
                          <div>
                            <h5 className="font-bold text-gray-900 text-base">{rev.author}</h5>
                ...
                <section id="why-choose-iprkaro" className="scroll-mt-24 md:scroll-mt-32 bg-black text-white p-8 md:p-12 rounded-2xl shadow-2xl relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    <h3 className="text-2xl md:text-4xl font-bold mb-10 text-center">Why Choose IPR Karo for Trademark Registration in {location}?</h3>
                    <div className="grid md:grid-cols-3 gap-8 text-center">
                      <div className="p-4">
                        <div className="bg-white/10 w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-6">
                          <FontAwesomeIcon icon={faRocket} className="w-10 h-10 text-[#FFD700]" />
                        </div>
                        <h4 className="font-bold text-xl mb-3 text-white">Same-Day TM Filing</h4>
                      ...
                      <div className="p-4">
                        ...
                        <h4 className="font-bold text-xl mb-3 text-white">Top Legal Expertise</h4>
                      ...
                      <div className="p-4">
                        ...
                        <h4 className="font-bold text-xl mb-3 text-white">100% Transparent Pricing</h4>
                ...
                <section className="bg-gradient-to-br from-[rgb(110,94,147)] to-[#1a0033] rounded-3xl p-8 md:p-16 text-center text-white shadow-xl mt-12 border border-[#8A7AB5]/30">
                  <div className="relative z-10">
                    <h3 className="text-3xl md:text-5xl font-bold mb-6 tracking-tight">Secure Your Brand Name Today</h3>
            ...
            <div className="hidden lg:block space-y-8 sticky top-32">
              ...
              <div className="bg-gradient-to-b from-[#0C002B] to-[#1a0033] p-6 rounded-2xl shadow-xl border border-gray-800 text-white text-center relative overflow-hidden">
                <div className="relative z-10">
                  <h4 className="text-2xl font-bold mb-3">Free TM Search</h4>
              ...
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                <h4 className="text-lg font-bold text-gray-900 mb-5 border-b pb-3">Explore Other Services</h4>
                <ul className="space-y-4">
                  <li>
              ...
              <div className="bg-blue-50 p-6 rounded-2xl border border-blue-100">
                <h4 className="text-lg font-bold text-gray-900 mb-2">Need Direct Help?</h4>
