...
const tocSections = [
    { id: 'foundations-of-search', title: 'Trademark Search Before Filing' },
    { id: 'importance-of-searching', title: 'Trademark Search Before Filing' },
    { id: 'indian-landscape', title: 'Trademark Search Before Filing' },
    { id: 'preliminary-steps', title: 'Trademark Search Before Filing' },
    { id: 'ip-india-guide', title: 'Trademark Search Before Filing' },
    { id: 'word-mark-strategies', title: 'Trademark Search Before Filing' },
    { id: 'vienna-codes', title: 'Trademark Search Before Filing' },
    { id: 'beyond-registry', title: 'Trademark Search Before Filing' },
    { id: 'risk-assessment', title: 'Trademark Search Before Filing' },
    { id: 'common-mistakes', title: 'Trademark Search Before Filing' },
    { id: 'reviews', title: 'Trademark Search Before Filing' },
    { id: 'professional-help', title: 'Trademark Search Before Filing' },
    { id: 'faqs', title: 'Trademark Search Before Filing' },
];
...
export default function TrademarkSearchGuidePage() {
    ...
    const articleSchema = {
        "@context": "https://schema.org",
        "@type": "Article",
        "headline": "Trademark Search Before Filing",
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_300px] gap-8 items-start">
                        ...
                        <aside className="hidden lg:block sticky top-32 h-[calc(100vh-160px)] overflow-y-auto">
                            <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                                <p className="text-gray-900 font-bold text-lg mb-6 border-l-4 border-[rgb(110,94,147)] pl-3">Search Roadmap</p>
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-2xl shadow-sm border border-gray-100 space-y-12 md:space-y-20">
                                ...
                                <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed font-normal">
                                    ...
                                    <section id="foundations-of-search" className="scroll-mt-32">
                                        <h2 className="text-2xl md:text-4xl lg:text-5xl font-black text-gray-900 mb-8 leading-tight">Understanding Trademark Foundations</h2>
                                        <p className="mb-6">
                                    ...
                                    <section id="importance-of-searching" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8 mb-12">
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm group">
                                                ...
                                                <h4 className="font-bold text-xl mb-4 text-gray-900">Legal Risk Mitigation</h4>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm group">
                                                ...
                                                <h4 className="font-bold text-xl mb-4 text-gray-900">Financial Optimization</h4>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm group">
                                                ...
                                                <h4 className="font-bold text-xl mb-4 text-gray-900">Brand Strength Assessment</h4>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm group">
                                                ...
                                                <h4 className="font-bold text-xl mb-4 text-gray-900">Evidence for Prosecution</h4>
                                    ...
                                    <section id="preliminary-steps" className="scroll-mt-32">
                                        <h3 className="text-3xl md:text-5xl font-black text-gray-900 mb-12 text-center uppercase tracking-tighter">
                                        ...
                                        <div className="relative space-y-12">
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900">Define Your Mark Variations</h4>
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900">Analyze Component Meanings</h4>
                                                    <p className="text-base text-gray-600">
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900">Map the Commercial Intent</h4>
                                                    <p className="text-base text-gray-600">
                                    ...
                                    <section id="ip-india-guide" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-3 gap-6 mb-10">
                                            <div className="p-6 bg-[#0C002B] text-white rounded-2xl shadow-lg border border-white/10">
                                                <h5 className="font-bold text-lg mb-3 text-[rgb(110,94,147)]">Word Mark Search</h5>
                                            ...
                                            <div className="p-6 bg-[#0C002B] text-white rounded-2xl shadow-lg border border-white/10">
                                                <h5 className="font-bold text-lg mb-3 text-[rgb(110,94,147)]">Phonetic Search</h5>
                                            ...
                                            <div className="p-6 bg-[#0C002B] text-white rounded-2xl shadow-lg border border-white/10">
                                                <h5 className="font-bold text-lg mb-3 text-[rgb(110,94,147)]">Vienna Code Search</h5>
                                    ...
                                    <section id="word-mark-strategies" className="scroll-mt-32">
                                        ...
                                        <div className="space-y-6">
                                            <div className="bg-gray-50 p-8 rounded-2xl border-l-8 border-[rgb(110,94,147)]">
                                                <h5 className="font-bold text-xl mb-3">The 'Syllable Breakdown' Method</h5>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-2xl border-l-8 border-[rgb(110,94,147)]">
                                                <h5 className="font-bold text-xl mb-3">The 'Vowel Mutation' Search</h5>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-2xl border-l-8 border-[rgb(110,94,147)]">
                                                <h5 className="font-bold text-xl mb-3">The 'Translation' Trap</h5>
                                    ...
                                    <section id="vienna-codes" className="scroll-mt-32">
                                        <h3 className="text-2xl md:text-4xl lg:text-5xl font-black text-gray-900 mb-8 leading-tight">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-10 my-10">
                                            <div className="bg-[#0C002B] text-white p-8 rounded-[2rem] relative overflow-hidden">
                                                ...
                                                <h5 className="text-xl font-bold mb-4 text-[#D1C4E9]">Find Your Codes</h5>
                                            ...
                                            <div className="bg-[#0C002B] text-white p-8 rounded-[2rem] relative overflow-hidden">
                                                ...
                                                <h5 className="text-xl font-bold mb-4 text-[#D1C4E9]">Execute the Query</h5>
                                    ...
                                    <section id="beyond-registry" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                                            <div className="p-6 bg-gray-50 rounded-2xl text-center border border-gray-100 hover:shadow-lg transition-all">
                                                ...
                                                <h6 className="font-bold text-sm mb-2">Google Search</h6>
                                            ...
                                            <div className="p-6 bg-gray-50 rounded-2xl text-center border border-gray-100 hover:shadow-lg transition-all">
                                                ...
                                                <h6 className="font-bold text-sm mb-2">Domain WHOIS</h6>
                                            ...
                                            <div className="p-6 bg-gray-50 rounded-2xl text-center border border-gray-100 hover:shadow-lg transition-all">
                                                ...
                                                <h6 className="font-bold text-sm mb-2">Social Media</h6>
                                            ...
                                            <div className="p-6 bg-gray-50 rounded-2xl text-center border border-gray-100 hover:shadow-lg transition-all">
                                                ...
                                                <h6 className="font-bold text-sm mb-2">MCA Portal</h6>
                                    ...
                                    <section id="common-mistakes" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-6">
                                            <div className="flex items-start p-6 bg-red-50 rounded-2xl border-l-4 border-red-500">
                                                ...
                                                <div>
                                                    <h5 className="font-bold text-gray-900 mb-2">The 'Identical Only' Search</h5>
                                            ...
                                            <div className="flex items-start p-6 bg-red-50 rounded-2xl border-l-4 border-red-500">
                                                <FontAwesomeIcon icon={faChevronRight} className="text-red-500 mt-1 mr-4 shrink-0" />
                                                <div>
                                                    <h5 className="font-bold text-gray-900 mb-2">Single Class Tunnel Vision</h5>
                                            ...
                                            <div className="flex items-start p-6 bg-red-50 rounded-2xl border-l-4 border-red-500">
                                                <FontAwesomeIcon icon={faChevronRight} className="text-red-500 mt-1 mr-4 shrink-0" />
                                                <div>
                                                    <h5 className="font-bold text-gray-900 mb-2">Ignoring the Phonetics</h5>
                                            ...
                                            <div className="flex items-start p-6 bg-red-50 rounded-2xl border-l-4 border-red-500">
                                                <FontAwesomeIcon icon={faChevronRight} className="text-red-500 mt-1 mr-4 shrink-0" />
                                                <div>
                                                    <h5 className="font-bold text-gray-900 mb-2">Stopping at the First Page</h5>
                                    ...
                                    <section id="professional-help" className="scroll-mt-32">
                                        ...
                                        <div className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[2.5rem] p-8 md:p-16 text-center text-white relative overflow-hidden my-12 shadow-2xl">
                                            <div className="relative z-10">
                                                <h3 className="text-3xl md:text-5xl font-black mb-6 leading-tight">Get Your Expert Search Report</h3>
                        ...
                        <aside className="hidden lg:block space-y-8 sticky top-32">
                            ...
                            <div className="bg-[#0C002B] p-8 rounded-3xl shadow-[0_20px_40px_rgba(0,0,0,0.1)] border border-gray-800 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-xl font-bold mb-4 relative z-10 leading-tight">Professional Search Report</h4>
                            ...
                            <div className="bg-gray-50 p-8 rounded-3xl shadow-sm border border-gray-100">
                                <h4 className="text-lg font-black text-gray-900 mb-6 border-b-2 border-[rgb(110,94,147)] pb-4 uppercase tracking-widest">Guide Library</h4>
