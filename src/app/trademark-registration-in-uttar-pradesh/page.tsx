...
export const metadata: Metadata = {
    ...
    description: validateAndNormalizeDescription("Register your trademark in Uttar Pradesh (UP). Expert filing for Noida, Lucknow, and Kanpur at the Dwarka Registry. 3500+ words of SEO legal content.", "app/trademark-registration-in-uttar-pradesh/page.tsx "),
    keywords: [
    ...
    const breadcrumbSchema = {
        ...
        "itemListElement": [
            ...
            },
            {
                ...
                "item": "https://www.iprkaro.com/trademark-registration-in-uttar-pradesh"
            }
        ]
    };
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr_320px] gap-8 items-start">
                        <aside className="hidden lg:block sticky top-32">
                            <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                                <p className="text-gray-900 font-bold text-lg mb-6 border-l-4 border-[rgb(110,94,147)] pl-3">UP State Guide</p>
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-2xl shadow-sm border border-gray-100 space-y-12 md:space-y-20 article-content">
                                <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed font-normal">
                                    ...
                                    <section id="why-register" className="scroll-mt-32 pt-12">
                                        <h3 className="text-2xl md:text-4xl font-black text-gray-900 mb-8 flex items-center"><FontAwesomeIcon icon={faShieldHalved} className="w-12 h-12 mr-4 text-[rgb(110,94,147)]" />Why Register Your Trademark in UP?</h3>
                                    ...
                                    <section id="noida-tech" className="scroll-mt-32 pt-12">
                                        <h3 className="text-2xl md:text-4xl font-black text-gray-900 mb-8 flex items-center"><FontAwesomeIcon icon={faMicrochip} className="w-12 h-12 mr-4 text-[rgb(110,94,147)]" />Noida & Greater Noida: The Tech Fortress</h3>
                                    ...
                                    <section id="kanpur-legacy" className="scroll-mt-32 pt-12">
                                        <h3 className="text-2xl md:text-4xl font-black text-gray-900 mb-8 flex items-center"><FontAwesomeIcon icon={faIndustry} className="w-12 h-12 mr-4 text-[rgb(110,94,147)]" />Kanpur: Protecting the Leather & Textile Legacy</h3>
                                    ...
                                    <section id="lucknow-service" className="scroll-mt-32 pt-12">
                                        <h3 className="text-2xl md:text-4xl font-black text-gray-900 mb-8 flex items-center"><FontAwesomeIcon icon={faBuilding} className="w-12 h-12 mr-4 text-[rgb(110,94,147)]" />Lucknow: The Governance & Service Center</h3>
                                    ...
                                    <section id="classes" className="scroll-mt-32 pt-12">
                                        <h3 className="text-2xl md:text-4xl font-black text-gray-900 mb-8">Detailed Industry Class Breakdown for UP</h3>
                                        ...
                                        <div className="grid md:grid-cols-2 gap-6 my-10">
                                            <div className="bg-gray-50 p-6 rounded-3xl border border-gray-100">
                                                <h5 className="font-bold text-gray-900 mb-2">Textiles (Varanasi/Kanpur)</h5>
                                            ...
                                            <div className="bg-gray-50 p-6 rounded-3xl border border-gray-100">
                                                <h5 className="font-bold text-gray-900 mb-2">Electronic/IT (Noida)</h5>
                                                <p className="text-sm">Class 9 for hardware/apps and Class 42 for SaaS/IT services. The backbone of the UP tech ecosystem.</p>
                                            </div>
                                            <div className="bg-gray-50 p-6 rounded-3xl border border-gray-100">
                                                <h5 className="font-bold text-gray-900 mb-2">Agri & Food (Lucknow)</h5>
                                            ...
                                            <div className="bg-gray-50 p-6 rounded-3xl border border-gray-100">
                                                <h5 className="font-bold text-gray-900 mb-2">Manufacturing (Ghaziabad)</h5>
                                    ...
                                    <section id="process" className="scroll-mt-32 pt-12">
                                        <h3 className="text-2xl md:text-4xl font-black text-gray-900 mb-8">Our 5-Step Process for UP Registrations</h3>
                                        <div className="space-y-8">
                                            <div className="flex gap-6">
                                                ...
                                                <div><h5 className="font-bold text-xl mb-1 text-gray-900">Technical Clearance Search</h5><p>We perform a deep-scan of the Delhi Registry to find phonetic and visual similarities before you file.</p></div>
                                            </div>
                                            <div className="flex gap-6">
                                                ...
                                                <div><h5 className="font-bold text-xl mb-1 text-gray-900">Same-Day e-Filing</h5><p>We file Form TM-A electronically. You get your application number in hours and can use ™ immediately.</p></div>
                                            </div>
                                            <div className="flex gap-6">
                                                ...
                                                <div><h5 className="font-bold text-xl mb-1 text-gray-900">Examination Support</h5><p>We handle all objections from the Dwarka registrar, drafting technical replies based on local precedents.</p></div>
                                            </div>
                                            <div className="flex gap-6">
                                                ...
                                                <div><h5 className="font-bold text-xl mb-1 text-gray-900">Journal Monitoring</h5><p>We watch the weekly journal for 4 months to catch any rival oppositions against your brand.</p></div>
                                            </div>
                                            <div className="flex gap-6">
                                                ...
                                                <div><h5 className="font-bold text-xl mb-1 text-gray-900">Final Certification</h5><p>Once cleared, the Registration Certificate is issued. You now own the ® symbol nationwide.</p></div>
                                            </div>
                                        </div>
                                    </section>

                                    <section id="objections" className="scroll-mt-32 pt-12">
                                        <h3 className="text-2xl md:text-4xl font-black text-gray-900 mb-8 flex items-center"><FontAwesomeIcon icon={faGavel} className="w-12 h-12 mr-4 text-[rgb(110,94,147)]" />Legal Nuances: Objections in the Dwarka Registry</h3>
                                    ...
                                    <section id="enforcement" className="scroll-mt-32 pt-12">
                                        <h3 className="text-2xl md:text-4xl font-black text-gray-900 mb-8 flex items-center"><FontAwesomeIcon icon={faScaleBalanced} className="w-12 h-12 mr-4 text-[rgb(110,94,147)]" />Enforcement Matrix: Protecting UP Brands</h3>
                                    ...
                                    <section id="faqs" className="scroll-mt-32 pt-12">
                                        <h3 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-12 text-center text-[rgb(110,94,147)]">Uttar Pradesh Trademark FAQ</h3>
                                    ...
                                    <section id="reviews" className="scroll-mt-32 pt-16">
                                        <h3 className="text-3xl font-black text-gray-900 mb-12 text-center uppercase tracking-widest">Customer Trust in UP</h3>
                        ...
                        <aside className="hidden lg:block space-y-8 sticky top-32">
                            <div className="bg-[#0C002B] p-10 rounded-[2.5rem] shadow-2xl border border-white/5 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-2xl font-black mb-6 relative z-10 leading-tight">UP Search & Clearance</h4>
                            ...
                            <div className="bg-gray-50 p-10 rounded-[2.5rem] shadow-sm border border-gray-100">
                                <h4 className="text-sm font-black text-gray-400 mb-8 uppercase tracking-[0.3em]">Quick Links</h4>
