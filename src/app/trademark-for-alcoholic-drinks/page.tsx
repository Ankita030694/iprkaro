                    ...
                    <div className="container mx-auto px-4 py-12 lg:py-32 relative z-10 text-center">
                        <h1 className="text-2xl md:text-5xl lg:text-6xl font-extrabold mb-4 md:mb-6 leading-tight mt-20 md:mt-10 text-white">
                            ...
                            <span className="text-[#6E5E93] bg-clip-text text-transparent bg-gradient-to-r from-[#8A7AB5] to-[#D1C4E9]" style={{ WebkitTextFillColor: 'rgb(110, 94, 147)' }}>
                                Trademark Registration for Alcoholic Drinks
                            </span>
                        </h1>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_300px] gap-8 items-start">
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-2xl shadow-sm border border-gray-100 space-y-12 md:space-y-20">
                                ...
                                <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed font-normal">
                                    ...
                                    <section id="introduction" className="scroll-mt-32">
                                        <h2 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-6 leading-tight">Why Alcoholic Brands Need Absolute Trademark Protection</h2>
                                        <p className="mb-6">
                                    ...
                                    <section id="wine-spirits-liqueurs" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8 mb-10">
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                                ...
                                                <h4 className="font-bold text-xl mb-3 text-gray-900">Distilled Spirits</h4>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                                ...
                                                <h4 className="font-bold text-xl mb-3 text-gray-900">Wines & Fortified Wines</h4>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                                ...
                                                <h4 className="font-bold text-xl mb-3 text-gray-900">Liqueurs & Bitters</h4>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                                ...
                                                <h4 className="font-bold text-xl mb-3 text-gray-900">Traditional RTDs</h4>
                                    ...
                                    <section id="what-is-excluded" className="scroll-mt-32">
                                        ...
                                        <div className="bg-orange-50 border border-orange-200 p-8 rounded-2xl space-y-6 shadow-sm">
                                            <div className="flex items-start">
                                                ...
                                                <div>
                                                    <h5 className="font-bold text-gray-900">Beer & Malt Beverages (Class 32)</h5>
                                            ...
                                            <div className="flex items-start">
                                                ...
                                                <div>
                                                    <h5 className="font-bold text-gray-900">Medicinal Beverages (Class 5)</h5>
                                    ...
                                    <section id="registration-process" className="scroll-mt-32">
                                        ...
                                        <div className="relative space-y-8">
                                            ...
                                            <div className="flex flex-col md:flex-row gap-8 bg-gray-50 p-8 rounded-3xl border-2 border-transparent hover:border-[rgb(110,94,147)] transition-all">
                                                ...
                                                <div>
                                                    <h4 className="text-xl font-bold mb-3">Trademark Search & Clearance</h4>
                                            ...
                                            <div className="flex flex-col md:flex-row gap-8 bg-gray-50 p-8 rounded-3xl border-2 border-transparent hover:border-[rgb(110,94,147)] transition-all">
                                                ...
                                                <div>
                                                    <h4 className="text-xl font-bold mb-3">Application Filing (Form TM-A)</h4>
                                            ...
                                            <div className="flex flex-col md:flex-row gap-8 bg-gray-50 p-8 rounded-3xl border-2 border-transparent hover:border-[rgb(110,94,147)] transition-all">
                                                ...
                                                <div>
                                                    <h4 className="text-xl font-bold mb-3">Examination & Response</h4>
                                    ...
                                    <section id="documents-checklist" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-10">
                                            <div className="bg-white p-8 rounded-3xl border shadow-sm hover:shadow-md transition-all">
                                                <h4 className="font-bold text-xl text-[rgb(110,94,147)] mb-6">For Individuals/Startups</h4>
                                            ...
                                            <div className="bg-white p-8 rounded-3xl border shadow-sm hover:shadow-md transition-all">
                                                <h4 className="font-bold text-xl text-gray-500 mb-6">For Companies (LLP/Pvt Ltd)</h4>
                                                <ul className="space-y-4 text-sm text-gray-600">
                                    ...
                                    <section className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[3rem] p-8 md:p-16 text-center text-white relative overflow-hidden mt-12 shadow-2xl">
                                        <div className="relative z-10">
                                            <h3 className="text-3xl md:text-5xl font-black mb-6 leading-tight">Elevate Your Spirit's Identity</h3>
                        ...
                        <aside className="hidden lg:block space-y-8 sticky top-32">
                            ...
                            <div className="bg-[#0C002B] p-8 rounded-[2rem] shadow-2xl border border-gray-800 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-xl font-bold mb-4 relative z-10 leading-tight">Test Your Spirit's Name Unique Path</h4>
                            ...
                            <div className="bg-gray-50 p-8 rounded-[2rem] shadow-sm border border-gray-100">
                                <h4 className="text-lg font-black text-gray-900 mb-6 border-b-2 border-[rgb(110,94,147)] pb-4 uppercase tracking-tighter text-sm">Industry Focus</h4>
