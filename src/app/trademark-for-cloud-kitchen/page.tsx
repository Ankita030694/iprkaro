                    ...
                    <div className="container mx-auto px-4 py-12 lg:py-32 relative z-10 text-center">
                        <h1 className="text-2xl md:text-5xl lg:text-6xl font-extrabold mb-4 md:mb-6 leading-tight mt-20 md:mt-10 text-white">
                            ...
                            <span className="text-[#6E5E93] bg-clip-text text-transparent bg-gradient-to-r from-[#8A7AB5] to-[#D1C4E9]" style={{ WebkitTextFillColor: 'rgb(110, 94, 147)' }}>
                                Registration for Cloud Kitchens
                            </span>
                        </h1>
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-2xl shadow-sm border border-gray-100 space-y-12 md:space-y-20">
                                ...
                                <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed font-normal">
                                    ...
                                    <section id="cloud-kitchen-revolution" className="scroll-mt-32">
                                        <h2 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-6 leading-tight">Navigating the Cloud Kitchen Era in India</h2>
                                        <p className="mb-6">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8 mb-10">
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                                <div className="text-[rgb(110,94,147)] mb-4 flex items-center">
                                                    ...
                                                    <h4 className="font-bold text-xl text-gray-900">Legal Exclusivity</h4>
                                                </div>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                                <div className="text-[rgb(110,94,147)] mb-4 flex items-center">
                                                    ...
                                                    <h4 className="font-bold text-xl text-gray-900">Enforcement Power</h4>
                                                </div>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                                <div className="text-[rgb(110,94,147)] mb-4 flex items-center">
                                                    ...
                                                    <h4 className="font-bold text-xl text-gray-900">Valuable Asset</h4>
                                                </div>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                                <div className="text-[rgb(110,94,147)] mb-4 flex items-center">
                                                    ...
                                                    <h4 className="font-bold text-xl text-gray-900">Trust & Credibility</h4>
                                                </div>
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8 mb-10">
                                            <div className="bg-white border-2 border-gray-100 p-8 rounded-3xl hover:border-[rgb(110,94,147)] transition-all">
                                                <div className="text-[rgb(110,94,147)] mb-4 flex items-center">
                                                    ...
                                                    <h4 className="font-bold text-xl text-gray-900 uppercase">Class 43: Services</h4>
                                                </div>
                                            ...
                                            <div className="bg-white border-2 border-gray-100 p-8 rounded-3xl hover:border-[rgb(110,94,147)] transition-all">
                                                <div className="text-[rgb(110,94,147)] mb-4 flex items-center">
                                                    ...
                                                    <h4 className="font-bold text-xl text-gray-900 uppercase">Class 29 & 30: Products</h4>
                                                </div>
                                                <p className="text-base text-gray-600 mb-4">
                                            ...
                                            <div className="bg-white border-2 border-gray-100 p-8 rounded-3xl hover:border-[rgb(110,94,147)] transition-all">
                                                <div className="text-[rgb(110,94,147)] mb-4 flex items-center">
                                                    ...
                                                    <h4 className="font-bold text-xl text-gray-900 uppercase">Class 35: Business</h4>
                                                </div>
                                                <p className="text-base text-gray-600 mb-4">
                                            ...
                                            <div className="bg-white border-2 border-gray-100 p-8 rounded-3xl hover:border-[rgb(110,94,147)] transition-all">
                                                <div className="text-[rgb(110,94,147)] mb-4 flex items-center">
                                                    ...
                                                    <h4 className="font-bold text-xl text-gray-900 uppercase">Class 39: Logistics</h4>
                                                </div>
                                                <p className="text-base text-gray-600 mb-4">
                                        ...
                                        <div className="relative space-y-12">
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900">Step 1: Proprietary AI-Driven Search Analysis</h4>
                                                    <p className="text-base text-gray-600 mb-4">
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900">Step 2: Technical Drafting & Precision Filing</h4>
                                                    <p className="text-base text-gray-600 mb-4">
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900">Step 3: Prosecution, Hearings & Registration</h4>
                                                    <p className="text-base text-gray-600 mb-4">
                                    ...
                                    <section id="scaling-and-franchising" className="scroll-mt-32">
                                        ...
                                        <div className="bg-black text-white p-10 rounded-3xl my-10 shadow-2xl">
                                            <h4 className="text-2xl font-bold mb-4 text-[rgb(110,94,147)] uppercase">Protecting Your Digital Billboard</h4>
                                    ...
                                    <section id="costs-and-fees" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8">
                                            <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100 flex flex-col items-center text-center">
                                                ...
                                                <h5 className="font-bold text-xl mb-4 text-gray-900">Government Statutory Fees</h5>
                                    ...
                                    <section className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[2.5rem] p-8 md:p-16 text-center text-white relative overflow-hidden mt-12 shadow-2xl">
                                        <div className="relative z-10">
                                            <h3 className="text-3xl md:text-5xl font-black mb-6 leading-tight">Secure Your Brand's Digital Real Estate</h3>
