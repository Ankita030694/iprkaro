...
const tocSections = [
    { id: 'introduction', title: 'Udyam (MSME) Registration 2026' },
    { id: 'what-is-udyam', title: 'Udyam (MSME) Registration 2026' },
    { id: 'new-classification', title: 'Udyam (MSME) Registration 2026' },
    { id: 'registration-process', title: 'Udyam (MSME) Registration 2026' },
    { id: 'financial-benefits', title: 'Udyam (MSME) Registration 2026' },
    { id: 'payment-protection', title: 'Udyam (MSME) Registration 2026' },
    { id: 'treds-liquidity', title: 'Udyam (MSME) Registration 2026' },
    { id: 'public-procurement', title: 'Udyam (MSME) Registration 2026' },
    { id: 'zed-certification', title: 'Udyam (MSME) Registration 2026' },
    { id: 'ipr-subsidies', title: 'Udyam (MSME) Registration 2026' },
    { id: 'udyam-assist', title: 'Udyam (MSME) Registration 2026' },
    { id: 'why-iprkaro', title: 'Udyam (MSME) Registration 2026' },
    { id: 'faqs', title: 'Udyam (MSME) Registration 2026' },
    { id: 'reviews', title: 'Udyam (MSME) Registration 2026' },
    { id: 'conclusion', title: 'Udyam (MSME) Registration 2026' },
];
...
export default function UdyamRegistrationPage() {
    ...
    const articleSchema = {
        "@context": "https://schema.org",
        "@type": "Article",
        "headline": "Udyam (MSME) Registration 2026",
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[220px_1fr_300px] gap-4 md:gap-12 mt-8 items-start">
                        ...
                        <div className="min-w-0">
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-xl md:rounded-2xl shadow-sm border border-gray-100 prose prose-lg max-w-none text-gray-800 font-sans">
                                ...
                                <section id="introduction" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h2 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6">The Importance of MSME Registration</h2>
                                ...
                                <section id="what-is-udyam" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">What is Udyam Registration? Decoding MSMED Act 2006</h3>
                                    ...
                                    <div className="bg-white border-2 border-dashed border-[#6E5E93] p-8 my-10 rounded-3xl">
                                        <h5 className="font-bold text-[#0C002B] text-xl mb-4">The Udyam Shift (July 2020)</h5>
                                ...
                                <section id="new-classification" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">New MSME Classification: Investment & Turnover Criteria</h3>
                                ...
                                <section id="registration-process" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Step-by-Step Guide to Online Udyam Registration</h3>
                                    ...
                                    <div className="space-y-12 relative before:absolute before:inset-0 before:ml-5 md:before:ml-[31px] before:-z-10 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-indigo-200 before:via-purple-200 before:to-transparent">
                                        ...
                                        <div className="relative flex items-center gap-6 md:gap-10">
                                            ...
                                            <div className="flex flex-col bg-white p-6 rounded-2xl border border-gray-100 shadow-md w-full hover:border-[#6E5E93] transition-all group">
                                                <h5 className="font-bold text-[#0C002B] text-xl mb-2 group-hover:text-[#6E5E93]">Aadhaar Authentication</h5>
                                        ...
                                        <div className="relative flex items-center gap-6 md:gap-10">
                                            ...
                                            <div className="flex flex-col bg-white p-6 rounded-2xl border border-gray-100 shadow-md w-full hover:border-[#6E5E93] transition-all group">
                                                <h5 className="font-bold text-[#0C002B] text-xl mb-2 group-hover:text-[#6E5E93]">PAN & GST Verification</h5>
                                        ...
                                        <div className="relative flex items-center gap-6 md:gap-10">
                                            ...
                                            <div className="flex flex-col bg-white p-6 rounded-2xl border border-gray-100 shadow-md w-full hover:border-[#6E5E93] transition-all group">
                                                <h5 className="font-bold text-[#0C002B] text-xl mb-2 group-hover:text-[#6E5E93]">NIC Code Selection</h5>
                                        ...
                                        <div className="relative flex items-center gap-6 md:gap-10">
                                            ...
                                            <div className="flex flex-col bg-white p-6 rounded-2xl border border-gray-100 shadow-md w-full hover:border-[#6E5E93] transition-all group">
                                                <h5 className="font-bold text-[#0C002B] text-xl mb-2 group-hover:text-[#6E5E93]">Final Submission</h5>
                                ...
                                <section id="financial-benefits" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Financial Benefits: Loans, CGTMSE & Interest Subsidies</h3>
                                    <p className="mb-6 leading-relaxed text-lg">
                                    ...
                                    <ul className="space-y-6 my-10 list-none p-0">
                                        <li className="flex gap-4 p-6 bg-green-50 rounded-2xl border border-green-100 shadow-sm border-l-[10px] border-l-green-500">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-green-900 text-xl mb-1">Collateral-Free Loans (CGTMSE)</h5>
                                        ...
                                        <li className="flex gap-4 p-6 bg-green-50 rounded-2xl border border-green-100 shadow-sm border-l-[10px] border-l-green-500">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-green-900 text-xl mb-1">Interest Rate Concessions</h5>
                                ...
                                <section id="payment-protection" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6 text-[#160049]">The Shield of Samadhaan: Protection Against Delayed Payments</h3>
                                    <p className="mb-6 leading-relaxed text-lg">
                                    ...
                                    <div className="p-8 bg-[#0C002B] rounded-[2rem] text-white my-10 relative overflow-hidden">
                                        ...
                                        <h5 className="font-bold text-2xl mb-4 relative z-10 flex items-center">
                                ...
                                <section id="ipr-subsidies" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Innovation Booster: Subsidies for Patents & Trademarks</h3>
                                    <p className="mb-6 leading-relaxed text-lg">
                                    ...
                                    <div className="grid md:grid-cols-2 gap-6 my-10">
                                        <div className="p-8 bg-purple-50 rounded-3xl border border-purple-100">
                                            <h5 className="font-bold text-[#160049] text-xl mb-3 flex items-center">
                                ...
                                <section id="udyam-assist" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Udyam Assist Platform for Informal Micro Enterprises</h3>
                                    <p className="mb-6 leading-relaxed text-lg">
                                ...
                                <section id="why-iprkaro" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6">Why Hundreds of Enterprises Trust IPR Karo for MSME Compliance</h3>
                                    ...
                                    <div className="grid md:grid-cols-3 gap-8 text-center bg-[#0C002B] p-10 rounded-[3rem] text-white">
                                        <div className="space-y-4">
                                            ...
                                            <h5 className="font-bold text-xl">Correct NIC Mapping</h5>
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <h5 className="font-bold text-xl">Late Payment Legal Support</h5>
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <h5 className="font-bold text-xl">Benefit Optimization</h5>
                                ...
                                <section id="conclusion" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6 text-center">Conclusion: Scaling Your Legacy with Udyam</h3>
                                ...
                                <div className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[40px] p-10 md:p-20 text-center text-white relative overflow-hidden mt-20 shadow-2xl">
                                    <div className="relative z-10">
                                        <h3 className="text-3xl md:text-5xl font-bold mb-6">Ready to Scale Your Business?</h3>
                        ...
                        <aside className="hidden lg:block space-y-10 sticky top-32">
                            ...
                            <div className="bg-[#0C002B] p-8 rounded-3xl shadow-xl border border-gray-800 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-2xl font-bold mb-4 relative z-10">Fast-Track Status</h4>
                            ...
                            <div className="bg-gray-50 p-8 rounded-3xl shadow-sm border border-gray-100">
                                <h4 className="text-xl font-bold text-[#0C002B] mb-6 border-b pb-4">Business Links</h4>
