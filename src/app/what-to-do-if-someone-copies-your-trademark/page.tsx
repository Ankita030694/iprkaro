                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_300px] gap-8 items-start">
                        ...
                        <aside className="hidden lg:block sticky top-32 h-[calc(100vh-160px)] overflow-y-auto">
                            <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                                <p className="text-gray-900 font-bold text-lg mb-6 border-l-4 border-[rgb(110,94,147)] pl-3">Action Guide</p>
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-2xl shadow-sm border border-gray-100 space-y-12 md:space-y-20">
                                ...
                                <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed font-normal">
                                    ...
                                    <section id="introduction" className="scroll-mt-32">
                                        <h2 className="text-2xl md:text-4xl lg:text-5xl font-black text-gray-900 mb-8 leading-tight">Why You Must Act Immediately</h2>
                                        <p className="mb-6">
                                    ...
                                    <section id="infringement-vs-passingoff" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8 mb-12">
                                            <div className="bg-gray-50 p-8 rounded-3xl border border-transparent hover:border-[rgb(110,94,147)] transition-all shadow-sm group">
                                                ...
                                                <h4 className="font-bold text-base mb-2 uppercase tracking-tighter">Trademark Infringement</h4>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-3xl border border-transparent hover:border-[rgb(110,94,147)] transition-all shadow-sm group">
                                                ...
                                                <h4 className="font-bold text-base mb-2 uppercase tracking-tighter">Common Law Passing Off</h4>
                                    ...
                                    <section id="customs-recordal" className="scroll-mt-32 pt-16">
                                        ...
                                        <div className="bg-[#f0f9ff] border-l-8 border-blue-500 p-8 rounded-2xl mb-12 font-normal">
                                            <h5 className="font-bold text-blue-900 mb-2 font-normal">Strategic Border Defense:</h5>
                                    ...
                                    <section id="legal-notice" className="scroll-mt-32 pt-20">
                                        ...
                                        <div className="bg-white border-2 border-dashed border-gray-300 p-10 rounded-[2.5rem] my-10 relative group">
                                            ...
                                            <h5 className="font-bold text-gray-900 mb-4 uppercase tracking-tighter">What a C&D Notice Accomplishes:</h5>
                                    ...
                                    <section id="civil-remedies" className="scroll-mt-32 pt-16">
                                        ...
                                        <div className="bg-gray-900 text-white p-12 rounded-[3.5rem] my-12 relative overflow-hidden">
                                            <div className="grid md:grid-cols-2 gap-12 relative z-10">
                                                <div className="space-y-6">
                                                    <h5 className="font-black text-xl mb-4 text-[rgb(110,94,147)] uppercase tracking-widest font-normal">Innocence is no excuse</h5>
                                    ...
                                    <section id="criminal-action" className="scroll-mt-32 pt-20">
                                        ...
                                        <div className="bg-red-50 border border-red-100 p-10 rounded-[3rem] shadow-sm mb-12">
                                            <h5 className="font-bold text-red-900 mb-6 uppercase tracking-widest text-sm font-normal">The Hammer of the Law:</h5>
                                    ...
                                    <section id="online-enforcement" className="scroll-mt-32 pt-16">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8 mb-12">
                                            <div className="bg-gray-50 p-8 rounded-3xl border border-gray-100 font-normal">
                                                <h5 className="font-bold text-gray-900 mb-4 uppercase tracking-tighter">Marketplace Takedowns</h5>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-3xl border border-gray-100 font-normal">
                                                <h5 className="font-bold text-gray-900 mb-4 uppercase tracking-tighter">Social Media Reporting</h5>
                                                <p className="text-sm text-gray-600 leading-relaxed font-normal">
                                    ...
                                    <section id="domain-disputes" className="scroll-mt-32 pt-16">
                                        ...
                                        <div className="bg-white border-l-4 border-[rgb(110,94,147)] p-8 my-8 shadow-sm font-normal">
                                            <h5 className="font-bold text-gray-900 mb-4 font-normal">The Dispute Resolution Path:</h5>
                                    ...
                                    <section id="damages" className="scroll-mt-32 pt-12">
                                        ...
                                        <div className="grid md:grid-cols-3 gap-8 mb-12">
                                            <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm hover:shadow-md transition-all">
                                                <h6 className="font-black text-xs uppercase mb-4 text-[rgb(110,94,147)] font-normal">Nominal Damages</h6>
                                            ...
                                            <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm hover:shadow-md transition-all">
                                                <h6 className="font-black text-xs uppercase mb-4 text-[rgb(110,94,147)] font-normal">Punitive Damages</h6>
                                            ...
                                            <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm hover:shadow-md transition-all">
                                                <h6 className="font-black text-xs uppercase mb-4 text-[rgb(110,94,147)] font-normal">Account of Profits</h6>
                                    ...
                                    <section className="bg-black text-white p-12 rounded-[3.5rem] my-16 shadow-2xl relative overflow-hidden group border border-white/5">
                                        ...
                                        <h3 className="text-3xl md:text-5xl font-black mb-8 leading-tight relative z-10 font-normal">Ready to Shut Them Down?</h3>
                        ...
                        <aside className="hidden lg:block space-y-8 sticky top-32">
                            ...
                            <div className="bg-[#0C002B] p-8 rounded-3xl shadow-[0_20px_40px_rgba(0,0,0,0.1)] border border-gray-800 text-white relative overflow-hidden group font-normal">
                                ...
                                <h4 className="text-xl font-bold mb-4 relative z-10 leading-tight font-normal">IP Enforcement Cell</h4>
                            ...
                            <div className="bg-gray-50 p-8 rounded-3xl shadow-sm border border-gray-100 font-normal">
                                <h4 className="text-lg font-black text-gray-900 mb-6 border-b-2 border-[rgb(110,94,147)] pb-4 uppercase tracking-widest font-normal">Legal Library</h4>
