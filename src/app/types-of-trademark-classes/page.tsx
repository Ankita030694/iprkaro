          ...
          <div className="grid grid-cols-1 lg:grid-cols-[220px_1fr_300px] gap-4 md:gap-12 items-start mt-8">
              ...
              <div className="bg-white p-4 md:p-12 rounded-xl md:rounded-2xl shadow-sm space-y-8 md:space-y-16">
                ...
                <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed">
                  ...
                  <section id="why-classification-matters" className="mb-20 scroll-mt-28">
                    ...
                    <div className="grid md:grid-cols-3 gap-6 my-12">
                      <div className="p-6 bg-gray-50 rounded-2xl border border-gray-100 hover:shadow-lg transition-all">
                        <h4 className="font-bold text-[#160049] mb-3">Legal Enforceability</h4>
                        <p className="text-sm">Stop infringers effectively within your specific industry without overstepping legal boundaries.</p>
                      </div>
                      <div className="p-6 bg-gray-50 rounded-2xl border border-gray-100 hover:shadow-lg transition-all">
                        <h4 className="font-bold text-[#160049] mb-3">Avoid Rejection</h4>
                      ...
                      <div className="p-6 bg-gray-50 rounded-2xl border border-gray-100 hover:shadow-lg transition-all">
                        <h4 className="font-bold text-[#160049] mb-3">Cost Efficiency</h4>
                  ...
                  <section id="goods-classes-1-34" className="mb-20 scroll-mt-28">
                    ...
                    <div className="space-y-12">
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 1: Chemicals and Industrial Substances</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 2: Paints and Finishers</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 3: Cosmetics and Cleaning Preparations</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 4: Lubricants and Fuels</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 5: Pharmaceuticals and Medical Supplies</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 6: Metal Goods and Hardware</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 7: Machines and Power Tools</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 8: Hand Tools and Cutlery</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 9: Computers, Software, and Electronics</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 10: Surgical and Medical Apparatus</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 11: Appliances for Heating and Cooling</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 12: Vehicles</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 13: Firearms and Explosives</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 14: Precious Metals and Jewelry</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 15: Musical Instruments</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 16: Paper, Stationery, and Printed Matter</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 17: Rubber and Insulating Materials</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 18: Leather Goods</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 19: Non-Metallic Building Materials</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 20: Furniture and Plastic Goods</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 21: Household Utensils</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 22: Ropes, Tents, and Sacks</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 23: Yarns and Threads</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 24: Textiles and Fabrics</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 25: Clothing, Footwear, and Headwear</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 26: Lace, Ribbons, and Notions</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 27: Floor Coverings and Wall Hangings</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 28: Games, Toys, and Sports Equipment</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 29: Meat, Fish, and Dairy</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 30: Spices, Grains, and Sweets</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 31: Raw Agricultural Products</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 32: Non-Alcoholic Beverages</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 17: Rubber and Plastics (Raw/Semi-Processed)</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 18: Leather and Imitation Leather</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 21: Household and Kitchen Utensils</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 22: Ropes, Nets, and Sails</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 24: Textiles and Fabric Goods</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 26: Lace, Embroidery, and Ribbons</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 27: Carpets, Rugs, and Wall Hangings</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 28: Games, Toys, and Sporting Articles</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 29: Meat, Fish, and Poultry</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 30: Coffee, Tea, and Confectionery</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 33: Alcoholic Beverages (Except Beer)</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 34: Tobacco and Smokers' Articles</h4>
                  ...
                  <section id="service-classes-35-45" className="mb-20 scroll-mt-28">
                    ...
                    <div className="space-y-12">
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 35: Business Management and Advertising</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 36: Finance and Real Estate</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 37: Construction and Repair</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 38: Telecommunications</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 39: Transport and Storage</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 40: Treatment of Materials</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 41: Education and Entertainment</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 42: Software Development and Scientific Services</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 43: Food Services and Accommodation</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 44: Medical and Beauty Services</h4>
                      ...
                      <div className="border-b pb-8">
                        <h4 className="text-xl font-bold text-[#6E5E93] mb-4">Class 45: Legal and Security Services</h4>
                  ...
                  <section id="business-case-studies" className="mb-20 scroll-mt-28">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                      <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 italic">
                        <h4 className="text-xl font-bold text-gray-900 mb-4 not-italic">Scenario A: The Fintech Giant</h4>
                      ...
                      <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 italic">
                        <h4 className="text-xl font-bold text-gray-900 mb-4 not-italic">Scenario B: The D2C Beauty Brand</h4>
                        <p className="text-gray-600 mb-4">
                      ...
                      <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 italic">
                        <h4 className="text-xl font-bold text-gray-900 mb-4 not-italic">Scenario C: The EdTech Platform</h4>
                        <p className="text-gray-600 mb-4">
                      ...
                      <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 italic">
                        <h4 className="text-xl font-bold text-gray-900 mb-4 not-italic">Scenario D: The EV Infrastructure Startup</h4>
                        <p className="text-gray-600 mb-4">
                  ...
                  <section id="common-mistakes" className="mb-20 scroll-mt-28">
                    ...
                    <div className="bg-orange-50 p-8 rounded-3xl border border-orange-100">
                      <h4 className="text-xl font-bold text-orange-900 mb-4">The 'Vague Description' Trap</h4>
                  ...
                  <section id="class-finder-tools" className="mb-20 scroll-mt-28">
                    ...
                    <div className="bg-[#6E5E93] text-white p-10 rounded-[3rem] shadow-xl">
                      <h4 className="text-2xl font-bold mb-6">Why Use a Representative?</h4>
                  ...
                  <section id="client-success-stories" className="mb-20 scroll-mt-28">
                    <h3 className="text-3xl md:text-4xl font-black text-gray-900 mb-12 flex items-center">
                    ...
                    <div className="grid md:grid-cols-2 gap-10">
                      <div className="bg-white p-8 rounded-[2.5rem] shadow-lg border border-gray-100 relative group overflow-hidden">
                        ...
                        <div className="flex items-center mb-6">
                          ...
                          <div className="ml-5">
                            <h5 className="text-xl font-bold text-gray-900">Ananya Singh</h5>
                      ...
                      <div className="bg-white p-8 rounded-[2.5rem] shadow-lg border border-gray-100 relative group overflow-hidden">
                        ...
                        <div className="flex items-center mb-6">
                          ...
                          <div className="ml-5">
                            <h5 className="text-xl font-bold text-gray-900">Vikram Jain</h5>
                  ...
                  <section id="emi-consequences-business" className="mb-20 scroll-mt-28">
                    ...
                    <div className="bg-red-50 p-8 rounded-3xl border border-red-100 mt-10">
                      <h5 className="text-red-800 font-bold mb-4">Key Risks of EMI Default:</h5>
                  ...
                  <section id="faqs" className="mb-20 scroll-mt-28">
                    <h3 className="text-3xl md:text-4xl font-black text-gray-900 mb-12">Expert Insights: Frequently Asked Questions</h3>
                    <div className="space-y-8">
                      {faqs.map((faq, index) => (
                        <div key={index} className="group border-b border-gray-100 pb-8 last:border-0 transition-all">
                          <h4 className="text-xl font-bold text-gray-900 mb-4 flex items-start group-hover:text-[#6E5E93]">
                  ...
                  <section id="strategic-trademark-management" className="mb-20 scroll-mt-28">
                    ...
                    <div className="space-y-8">
                      <div className="p-8 bg-purple-50 rounded-3xl border border-purple-100">
                        <h4 className="text-2xl font-bold text-[#6E5E93] mb-4">The Doctrine of 'Associated Marks'</h4>
                      ...
                      <div className="p-8 bg-blue-50 rounded-3xl border border-blue-100">
                        <h4 className="text-2xl font-bold text-blue-900 mb-4">Impact of Class Selection on Infringement Litigation</h4>
                      ...
                      <div className="p-8 bg-green-50 rounded-3xl border border-green-100">
                        <h4 className="text-2xl font-bold text-green-900 mb-4">The Madrid Protocol: Global Class Alignment</h4>
                      ...
                      <div className="p-8 bg-yellow-50 rounded-3xl border border-yellow-100">
                        <h4 className="text-2xl font-bold text-yellow-900 mb-4">Class 35: The 'Universal' Shield for Business Names</h4>
                        <p className="mb-4">
                  ...
                  <section className="bg-gray-900 rounded-[2rem] p-8 md:p-16 text-center text-white relative overflow-hidden">
                    <div className="relative z-10">
                      <h3 className="text-3xl md:text-5xl font-bold mb-8">Secure Your Brand in the Right Class Today</h3>
            ...
            <aside className="hidden lg:block space-y-10 sticky top-32">
              ...
              <div className="bg-[#0C002B] p-8 rounded-3xl shadow-xl border border-gray-800 text-white relative overflow-hidden group">
                ...
                <h4 className="text-2xl font-bold mb-4 relative z-10">Protect Your Brand Now</h4>
              ...
              <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100">
                <h4 className="text-xl font-bold text-[#0C002B] mb-6 border-b pb-4">Related Topics</h4>
