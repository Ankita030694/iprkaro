            ...
            <div className="min-w-0">
              ...
              <div className="bg-white p-4 md:p-12 rounded-xl md:rounded-2xl shadow-sm border border-gray-100 prose prose-lg max-w-none text-gray-800 font-sans">
                ...
                <section id="introduction" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h2 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6">Bharat Mein Brand Registration Ka Safar</h2>
                ...
                <section id="what-is-trademark" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Asal Mein Trademark Kya Hota Hai?</h3>
                ...
                <section id="why-register" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Registration Ke Bina Business Karna Khatarnak Kyun Hai?</h3>
                  <p className="mb-6 leading-relaxed text-lg">
                  ...
                  <ul className="space-y-6 my-10 list-none p-0">
                    <li className="flex gap-4 p-6 bg-green-50 rounded-2xl border border-green-100 shadow-sm border-l-[10px] border-l-green-500">
                      ...
                      <div>
                        <h5 className="font-bold text-green-900 text-xl mb-2">Legal Monopoly (Akela Adhikar)</h5>
                    ...
                    <li className="flex gap-4 p-6 bg-green-50 rounded-2xl border border-green-100 shadow-sm border-l-[10px] border-l-green-500">
                      ...
                      <div>
                        <h5 className="font-bold text-green-900 text-xl mb-2">Asset Valuation (Sampatti Ka Mulya)</h5>
                    ...
                    <li className="flex gap-4 p-6 bg-green-50 rounded-2xl border border-green-100 shadow-sm border-l-[10px] border-l-green-500">
                      ...
                      <div>
                        <h5 className="font-bold text-green-900 text-xl mb-2">Global Protection (Duniya Bhar Mein Suraksha)</h5>
                ...
                <section id="pre-filing-search" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Filing Se Pehle Trademark Search Sabse Zaruri Kyun Hai?</h3>
                  <p className="mb-6 leading-relaxed text-lg">
                ...
                <section id="step-by-step-guide" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Puri Step-by-Step Registration Process (Simplified)</h3>
                  ...
                  <div className="space-y-10 my-12">
                    <div className="flex gap-6 relative">
                      ...
                      <div>
                        <h5 className="font-bold text-[#0C002B] text-xl md:text-2xl mb-2">Application Filing (Form TM-A)</h5>
                    ...
                    <div className="flex gap-6 relative">
                      ...
                      <div className="absolute left-5 md:left-8 top-10 md:top-16 w-1 h-20 bg-gray-100 -z-0 hidden md:block"></div>
                      <div>
                        <h5 className="font-bold text-[#0C002B] text-xl md:text-2xl mb-2">Formalities Check Pass</h5>
                    ...
                    <div className="flex gap-6 relative">
                      ...
                      <div className="absolute left-5 md:left-8 top-10 md:top-16 w-1 h-20 bg-gray-100 -z-0 hidden md:block"></div>
                      <div>
                        <h5 className="font-bold text-[#0C002B] text-xl md:text-2xl mb-2">Examination & Examination Report</h5>
                    ...
                    <div className="flex gap-6 relative">
                      ...
                      <div className="absolute left-5 md:left-8 top-10 md:top-16 w-1 h-20 bg-gray-100 -z-0 hidden md:block"></div>
                      <div>
                        <h5 className="font-bold text-[#0C002B] text-xl md:text-2xl mb-2">Publication In Journal</h5>
                    ...
                    <div className="flex gap-6 relative">
                      ...
                      <div>
                        <h5 className="font-bold text-[#0C002B] text-xl md:text-2xl mb-2">Registration Certificate Issue</h5>
                ...
                <section id="documents-required" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Zaruri Documents Ki Checklist (Tayaar Rakhein)</h3>
                  <p className="mb-6 leading-relaxed text-lg">
                  ...
                  <div className="grid md:grid-cols-2 gap-8 my-10">
                    <div className="bg-blue-50 p-8 rounded-3xl border border-blue-100 h-full">
                      <h5 className="font-bold text-[#0C002B] text-2xl mb-4">Individuals/Sole Proprietors</h5>
                    ...
                    <div className="bg-purple-50 p-8 rounded-3xl border border-purple-100 h-full">
                      <h5 className="font-bold text-[#0C002B] text-2xl mb-4">MSMEs & Startups</h5>
                      <ul className="space-y-4">
                ...
                <section id="trademark-classes" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Trademark Classes: Sahi Chunav Kaise Karein?</h3>
                  <p className="mb-6 leading-relaxed text-lg">
                ...
                <section id="government-fees" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Government Fees Breakdown (Latest 2026 Updates)</h3>
                  <p className="mb-8 leading-relaxed text-lg">
                  ...
                  <div className="flex flex-col md:flex-row gap-8 my-12">
                    <div className="flex-1 p-8 bg-gradient-to-br from-purple-100 to-white rounded-3xl border-2 border-purple-200 text-center shadow-lg hover:-translate-y-2 transition-transform">
                      <h5 className="font-bold text-[#0C002B] text-4xl mb-2">₹4,500</h5>
                    ...
                    <div className="flex-1 p-8 bg-gray-50 rounded-3xl border border-gray-200 text-center shadow-md hover:-translate-y-2 transition-transform">
                      <h5 className="font-bold text-gray-800 text-4xl mb-2">₹9,000</h5>
                ...
                <section id="objection-handling" className="mb-16 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-3xl md:text-4xl font-bold text-[#0C002B] mb-8">Objection Aane Par Ghabrayein Nahi (Legal Handle Kaise Karein)</h3>
                  <p className="mb-6 leading-relaxed text-lg">
                ...
                <section id="msme-startup-benefits" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Startups Ke Liye Vishesh Suvidhayein Aur Chhutein</h3>
                  <p className="mb-8 leading-relaxed text-lg">
                  ...
                  <div className="grid md:grid-cols-2 gap-6 my-10 list-none p-0">
                    <div className="p-6 bg-purple-100/50 rounded-2xl border border-purple-200 text-center">
                      ...
                      <h6 className="font-bold text-lg mb-1">50% Fee Rebate</h6>
                      <p className="text-sm">Seedha 4500 rupaye ki bachat.</p>
                    </div>
                    <div className="p-6 bg-purple-100/50 rounded-2xl border border-purple-200 text-center">
                      <div className="text-3xl mb-2">⚡</div>
                      <h6 className="font-bold text-lg mb-1">Priority Processing</h6>
                      <p className="text-sm">Examiner pehle aapki file dekhenge.</p>
                    </div>
                    <div className="p-6 bg-purple-100/50 rounded-2xl border border-purple-200 text-center">
                      <div className="text-3xl mb-2">⚖️</div>
                      <h6 className="font-bold text-lg mb-1">Free Facilitators</h6>
                      <p className="text-sm">Sarkar ke empanelled vakilon ki madad.</p>
                    </div>
                    <div className="p-6 bg-purple-100/50 rounded-2xl border border-purple-200 text-center">
                      <div className="text-3xl mb-2">🛡️</div>
                      <h6 className="font-bold text-lg mb-1">Stronger Defense</h6>
                ...
                <section id="legal-enforcement" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Infringement Se Ladai: Kab Aur Kaise Action Lein?</h3>
                  <p className="mb-6 leading-relaxed text-lg">
                  ...
                  <h4 className="text-xl font-bold text-[#160049] mb-3 flex items-center">
                  ...
                  <div className="bg-red-50 p-8 rounded-3xl border-l-[10px] border-red-600 my-10">
                    <h5 className="text-red-900 font-bold text-2xl mb-4 italic">Asli Power: Injunction Orders</h5>
                ...
                <section id="conclusion" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6">Nishkarsh: Apne Brand Ko Bharat Ki Shaan Banayein</h3>
                ...
                <div className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[40px] p-10 md:p-20 text-center text-white relative overflow-hidden mt-20 shadow-2xl">
                  <div className="relative z-10">
                    <h3 className="text-3xl md:text-5xl font-bold mb-6">Aaj Hi Apna Brand Safe Karein</h3>
