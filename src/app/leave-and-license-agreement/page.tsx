                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[220px_1fr_300px] gap-4 md:gap-12 mt-8 items-start">
                        ...
                        <div className="min-w-0">
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-xl md:rounded-2xl shadow-sm border border-gray-100 prose prose-lg max-w-none text-gray-800 font-sans">
                                ...
                                <section id="introduction" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h2 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6">Understanding Leave and License</h2>
                                ...
                                <section id="e-registration-tech" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">The Digital Shift: e-Registration and iSarita 2.0</h3>
                                    <p className="mb-4 leading-relaxed text-lg">
                                ...
                                <section id="legal-definition" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Legal Foundations: Section 52 of the Indian Easements Act 1882</h3>
                                ...
                                <section id="license-vs-lease" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">The Great Debate: Leave and License vs. Lease</h3>
                                ...
                                <section id="essential-clauses" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Mandatory Clauses for a Bulletproof Agreement</h3>
                                    <p className="mb-6 leading-relaxed text-lg">
                                ...
                                <section id="registration-process" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Registration: Why 11 Months is the Indian Standard</h3>
                                    <p className="mb-6 leading-relaxed text-lg">
                                ...
                                <section id="maharashtra-rules" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">The Maharashtra Landscape: Section 55 Compliance</h3>
                                    <p className="mb-6 leading-relaxed text-lg">
                                ...
                                <section id="stamp-duty" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Stamp Duty and Registration Fees: The Calculator</h3>
                                    <p className="mb-8 leading-relaxed text-lg">
                                    ...
                                    <div className="p-8 bg-gray-50 rounded-3xl border border-gray-200 my-10">
                                        <h5 className="font-bold text-[#0C002B] text-2xl mb-4">Sample Calculation Table (Maharashtra)</h5>
                                ...
                                <section id="eviction-rights" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Eviction and Summary Possession: Landlord Safeguards</h3>
                                    <p className="mb-6 leading-relaxed text-lg">
                                    ...
                                    <ul className="space-y-6 my-10 list-none p-0">
                                        <li className="flex gap-4 p-6 bg-red-50 rounded-2xl border border-red-100 shadow-sm border-l-[10px] border-l-red-500">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-red-900 text-xl mb-1">Competent Authority Jurisdiction</h5>
                                        ...
                                        <li className="flex gap-4 p-6 bg-red-50 rounded-2xl border border-red-100 shadow-sm border-l-[10px] border-l-red-500">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-red-900 text-xl mb-1">Double License Fee Damages</h5>
                                ...
                                <section id="tax-implications" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Navigating Finances: Income Tax and GST</h3>
                                    <p className="mb-6 leading-relaxed text-lg">
                                ...
                                <section id="termination-penalties" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Termination Penalties: Beyond the Notice Period</h3>
                                ...
                                <section id="why-iprkaro" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6">Why Thousands of Property Owners Trust IPR Karo</h3>
                                    ...
                                    <div className="grid md:grid-cols-3 gap-8 text-center bg-[#0C002B] p-10 rounded-[3rem] text-white">
                                        <div className="space-y-4">
                                            ...
                                            <h5 className="font-bold text-xl">Custom Drafting</h5>
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <h5 className="font-bold text-xl">Doorstep e-Registration</h5>
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <h5 className="font-bold text-xl">Compliance First</h5>
                                ...
                                <section id="conclusion" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6 text-center">Conclusion: Securing Your Peace of Mind</h3>
                                ...
                                <div className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[40px] p-10 md:p-20 text-center text-white relative overflow-hidden mt-20 shadow-2xl">
                                    <div className="relative z-10">
                                        <h3 className="text-3xl md:text-5xl font-bold mb-6">Ready to Protect Your Property?</h3>
                        ...
                        <aside className="hidden lg:block space-y-10 sticky top-32">
                            ...
                            <div className="bg-[#0C002B] p-8 rounded-3xl shadow-xl border border-gray-800 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-2xl font-bold mb-4 relative z-10">Quick Drafting</h4>
                            ...
                            <div className="bg-gray-50 p-8 rounded-3xl shadow-sm border border-gray-100">
                                <h4 className="text-xl font-bold text-[#0C002B] mb-6 border-b pb-4">Real Estate Links</h4>
