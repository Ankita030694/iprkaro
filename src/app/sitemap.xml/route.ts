...
export async function GET() {
  ...
  const patentStatePages = [
    ...
    '/services/patent-services/andhra-pradesh',
    '/services/patent-services/arunachal-pradesh',
    '/services/patent-services/assam',
    '/services/patent-services/bihar',
    '/services/patent-services/chandigarh',
    '/services/patent-services/chhattisgarh',
    '/services/patent-services/dadra-and-nagar-haveli-and-daman-and-diu',
    '/services/patent-services/delhi',
    '/services/patent-services/goa',
    '/services/patent-services/gujarat',
    '/services/patent-services/haryana',
    ...
    '/services/patent-services/ladakh',
    '/services/patent-services/lakshadweep',
    '/services/patent-services/madhya-pradesh',
    '/services/patent-services/maharashtra',
    '/services/patent-services/manipur',
    '/services/patent-services/meghalaya',
    '/services/patent-services/mizoram',
    '/services/patent-services/nagaland',
    '/services/patent-services/odisha',
    ...
    '/services/patent-services/telangana',
    '/services/patent-services/tripura',
    '/services/patent-services/uttar-pradesh',
    '/services/patent-services/uttarakhand',
    '/services/patent-services/west-bengal',
  ].map(path => ({ path, priority: '0.85', changefreq: 'weekly' } as RouteConfig));

  // 12. State Pages - Copyright
  const copyrightStatePages = [
    '/services/copyright-protection/andaman-and-nicobar-islands',
    '/services/copyright-protection/andhra-pradesh',
    '/services/copyright-protection/arunachal-pradesh',
    '/services/copyright-protection/assam',
    '/services/copyright-protection/bihar',
    '/services/copyright-protection/chandigarh',
    '/services/copyright-protection/chhattisgarh',
    '/services/copyright-protection/dadra-and-nagar-haveli-and-daman-and-diu',
    '/services/copyright-protection/delhi',
    '/services/copyright-protection/goa',
    '/services/copyright-protection/gujarat',
    '/services/copyright-protection/haryana',
    '/services/copyright-protection/himachal-pradesh',
    '/services/copyright-protection/jammu-and-kashmir',
    '/services/copyright-protection/jharkhand',
    '/services/copyright-protection/karnataka',
    '/services/copyright-protection/kerala',
    '/services/copyright-protection/ladakh',
    '/services/copyright-protection/lakshadweep',
    '/services/copyright-protection/madhya-pradesh',
    '/services/copyright-protection/maharashtra',
    '/services/copyright-protection/manipur',
    '/services/copyright-protection/meghalaya',
    '/services/copyright-protection/mizoram',
    '/services/copyright-protection/nagaland',
    '/services/copyright-protection/odisha',
    '/services/copyright-protection/puducherry',
    '/services/copyright-protection/punjab',
    '/services/copyright-protection/rajasthan',
    '/services/copyright-protection/sikkim',
    '/services/copyright-protection/tamil-nadu',
    '/services/copyright-protection/telangana',
    '/services/copyright-protection/tripura',
    '/services/copyright-protection/uttar-pradesh',
    '/services/copyright-protection/uttarakhand',
    '/services/copyright-protection/west-bengal',
  ].map(path => ({ path, priority: '0.85', changefreq: 'weekly' } as RouteConfig));
