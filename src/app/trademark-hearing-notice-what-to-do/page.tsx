...
const tocSections = [
    { id: 'introduction', title: 'Trademark Hearing Notice Steps' },
    { id: 'legal-authority', title: 'Trademark Hearing Notice Steps' },
    { id: 'why-notified', title: 'Trademark Hearing Notice Steps' },
    { id: 'immediate-actions', title: 'Trademark Hearing Notice Steps' },
    { id: 'preparing-defense', title: 'Trademark Hearing Notice Steps' },
    { id: 'evidence-building', title: 'Trademark Hearing Notice Steps' },
    { id: 'virtual-protocols', title: 'Trademark Hearing Notice Steps' },
    { id: 'the-hearing-day', title: 'Trademark Hearing Notice Steps' },
    { id: 'adjournments', title: 'Trademark Hearing Notice Steps' },
    { id: 'hearing-outcomes', title: 'Trademark Hearing Notice Steps' },
    { id: 'post-hearing-appeals', title: 'Trademark Hearing Notice Steps' },
    { id: 'costs-and-planning', title: 'Trademark Hearing Notice Steps' },
    { id: 'faqs', title: 'Trademark Hearing Notice Steps' },
];
...
export default function TrademarkHearingPlanPage() {
    ...
    const articleSchema = {
        "@context": "https://schema.org",
        "@type": "Article",
        "headline": "Trademark Hearing Notice Steps",
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_300px] gap-8 items-start">
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-2xl shadow-sm border border-gray-100 space-y-12 md:space-y-20">
                                ...
                                <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed font-normal">
                                    ...
                                    <section id="introduction" className="scroll-mt-32">
                                        <h2 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-6 leading-tight">The Final Frontier of Brand Registration</h2>
                                        <p className="mb-6">
                                    ...
                                    <section id="legal-authority" className="scroll-mt-32">
                                        ...
                                        <div className="bg-black text-white p-10 rounded-3xl my-10 shadow-2xl">
                                            <h4 className="text-2xl font-bold mb-4 text-[rgb(110,94,147)] uppercase">The Power of Choice</h4>
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8 mb-10">
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                                <div className="text-[rgb(110,94,147)] mb-4 flex items-center">
                                                    ...
                                                    <h4 className="font-bold text-xl text-gray-900">Absolute Grounds (Section 9)</h4>
                                                </div>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                                <div className="text-[rgb(110,94,147)] mb-4 flex items-center">
                                                    ...
                                                    <h4 className="font-bold text-xl text-gray-900">Relative Grounds (Section 11)</h4>
                                                </div>
                                    ...
                                    <section id="immediate-actions" className="scroll-mt-32">
                                        ...
                                        <div className="bg-gray-100 p-8 rounded-3xl my-10 flex items-start gap-6 border border-gray-200">
                                            ...
                                            <div>
                                                <h5 className="text-xl font-bold text-gray-900 mb-2">The 'Non-Appearance' Risk</h5>
                                    ...
                                    <section id="preparing-defense" className="scroll-mt-32">
                                        <h3 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-6 leading-tight uppercase tracking-tight">
                                        ...
                                        <div className="relative space-y-12">
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all border border-transparent hover:border-[rgb(110,94,147)]">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900 uppercase">Step 1: Logging into the Lobby</h4>
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all border border-transparent hover:border-[rgb(110,94,147)]">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900 uppercase">Step 2: Addressing the Objections</h4>
                                                    <p className="text-base text-gray-600 mb-4">
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all border border-transparent hover:border-[rgb(110,94,147)]">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900 uppercase">Step 3: Receiving the Verbal Order</h4>
                                                    <p className="text-base text-gray-600 mb-4">
                                    ...
                                    <section id="hearing-outcomes" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-3 gap-6 my-10">
                                            <div className="p-8 bg-green-50 rounded-2xl border border-green-100 flex flex-col items-center text-center hover:shadow-lg transition-all">
                                                ...
                                                <h5 className="font-bold text-gray-900 mb-2">Accepted</h5>
                                            ...
                                            <div className="p-8 bg-yellow-50 rounded-2xl border border-yellow-100 flex flex-col items-center text-center hover:shadow-lg transition-all">
                                                ...
                                                <h5 className="font-bold text-gray-900 mb-2">Conditional</h5>
                                    ...
                                    <section id="costs-and-planning" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8">
                                            <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100 flex flex-col items-center text-center">
                                                ...
                                                <h5 className="font-bold text-xl mb-4">Possible Government Costs</h5>
                                            ...
                                            <div className="p-8 bg-[rgb(110,94,147)] text-white rounded-3xl shadow-xl flex flex-col items-center text-center">
                                                ...
                                                <h5 className="font-bold text-xl mb-4 text-white">Professional Representation</h5>
                                    ...
                                    <section id="faqs" className="scroll-mt-32">
                                        <h3 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-12 text-center uppercase tracking-tight font-serif">
                                    ...
                                    <section className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[2.5rem] p-8 md:p-16 text-center text-white relative overflow-hidden mt-12 shadow-2xl">
                                        <div className="relative z-10">
                                            <h3 className="text-3xl md:text-5xl font-black mb-6 leading-tight">Secure Your Brand's Legacy Today</h3>
                        ...
                        <aside className="hidden lg:block space-y-8 sticky top-32 h-screen overflow-y-auto no-scrollbar pb-24">
                            <div className="bg-[#0C002B] p-8 rounded-3xl shadow-[0_20px_40px_rgba(0,0,0,0.1)] border border-gray-800 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-xl font-bold mb-4 relative z-10 leading-tight">Hearing Date Fixed?</h4>
                            ...
                            <div className="bg-gray-50 p-8 rounded-3xl shadow-sm border border-gray-100">
                                <h4 className="text-lg font-black text-gray-900 mb-6 border-b-2 border-[rgb(110,94,147)] pb-4 uppercase tracking-widest">Other Resources</h4>
                            ...
                            <div className="bg-white p-8 rounded-3xl shadow-sm border border-gray-100 flex flex-col items-center text-center">
                                ...
                                <h4 className="text-lg font-bold text-gray-900 mb-2">High Court Appeal</h4>
