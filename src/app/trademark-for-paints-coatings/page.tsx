                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_300px] gap-8 items-start">
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-2xl shadow-sm border border-gray-100 space-y-12 md:space-y-20">
                                ...
                                <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed font-normal">
                                    ...
                                    <section id="industry-overview" className="scroll-mt-32">
                                        <h2 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-6 leading-tight">India's Paints and Coatings Sector</h2>
                                        <p className="mb-6">
                                    ...
                                    <section id="importance-of-trademark" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8 mb-10">
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                                ...
                                                <h4 className="font-bold text-xl mb-3 text-gray-900">Preventing Brand Hijacking</h4>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                                ...
                                                <h4 className="font-bold text-xl mb-3 text-gray-900">Enhancing Business Valuation</h4>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                                ...
                                                <h4 className="font-bold text-xl mb-3 text-gray-900">National and Global Reach</h4>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                                ...
                                                <h4 className="font-bold text-xl mb-3 text-gray-900">Consumer Clarity</h4>
                                    ...
                                    <section id="trademark-class-2" className="scroll-mt-32">
                                        ...
                                        <div className="bg-gray-50 border-2 border-[rgb(110,94,147)] p-8 rounded-3xl my-10">
                                            <h4 className="text-2xl font-bold mb-6 text-gray-900">Detailed Breakdown of Class 2 Goods:</h4>
                                        ...
                                        <div className="relative space-y-12">
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                                                    <h4 className="font-bold text-xl mb-4 text-gray-900">Step 1: The Strategic Name Search</h4>
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                                                    <h4 className="font-bold text-xl mb-4 text-gray-900">Step 2: Drafting and Filing Form TM-A</h4>
                                                    <p className="text-base text-gray-600 mb-4">
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                                                    <h4 className="font-bold text-xl mb-4 text-gray-900">Step 3: Navigating the Legal Examination</h4>
                                                    <p className="text-base text-gray-600 mb-4">
                                    ...
                                    <section id="brand-valuation" className="scroll-mt-32">
                                        ...
                                        <div className="bg-black text-white p-10 rounded-3xl my-10 shadow-2xl relative overflow-hidden">
                                            ...
                                            <h4 className="text-2xl font-bold mb-4 text-[rgb(110,94,147)] uppercase">The ROI of Registration</h4>
                                    ...
                                    <section id="global-protection" className="scroll-mt-32">
                                        ...
                                        <h4 className="text-xl font-bold mt-10 mb-6 text-gray-900">Trademark Lifecycle Management: From Application to Renewal</h4>
                                        <p className="mb-6">
                                        ...
                                        <h4 className="text-xl font-bold mt-10 mb-6 text-gray-900">Legal Precedents: Understanding the 'Nervous' Nature of Chemical Trademarks</h4>
                                        <p className="mb-6">
                                        ...
                                        <h4 className="text-xl font-bold mt-10 mb-6 text-gray-900">Advanced Brand Valuation Methodologies</h4>
                                        <p className="mb-6">
                                        ...
                                        <h4 className="text-xl font-bold mt-10 mb-6 text-gray-900">Protecting Specialized Coatings: Marine, Aerospace, and Beyond</h4>
                                        <p className="mb-6">
                                        ...
                                        <h4 className="text-xl font-bold mt-10 mb-6 text-gray-900">Regulatory Synergy: BIS Standards and Trademark Quality</h4>
                                        <p className="mb-6">
                                        ...
                                        <h4 className="text-xl font-bold mt-10 mb-6 text-gray-900">Franchising and Licensing: Scaling the Paint Business</h4>
                                        <p className="mb-6">
                                        ...
                                        <h4 className="text-xl font-bold mt-10 mb-6 text-gray-900">The Digital Frontier: Online Brand Protection</h4>
                                        <p className="mb-6">
                                        ...
                                        <h4 className="text-xl font-bold mt-10 mb-6 text-gray-900">Conclusion: The Lasting brilliance of a Protected Brand</h4>
                                        <p className="mb-6">
                                    ...
                                    <section id="costs-and-fees" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8">
                                            <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100 flex flex-col items-center text-center">
                                                ...
                                                <h5 className="font-bold text-xl mb-4">Official Government Fees</h5>
                                    ...
                                    <section className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[2.5rem] p-8 md:p-16 text-center text-white relative overflow-hidden mt-12 shadow-2xl">
                                        <div className="relative z-10">
                                            <h3 className="text-3xl md:text-5xl font-black mb-6 leading-tight">Shield Your Coatings Brand Today</h3>
                        ...
                        <aside className="hidden lg:block space-y-8 sticky top-32">
                            ...
                            <div className="bg-gray-50 p-8 rounded-3xl shadow-sm border border-gray-100">
                                <h4 className="text-lg font-black text-gray-900 mb-6 border-b-2 border-[rgb(110,94,147)] pb-4 uppercase tracking-widest text-sm">Industrial Sectors</h4>
                                <ul className="space-y-4">
                                    <li>
