                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_300px] gap-8 items-start">
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-2xl shadow-sm border border-gray-100 space-y-12 md:space-y-20">
                                ...
                                <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed font-normal">
                                    ...
                                    <section id="importance-of-trademark" className="scroll-mt-32">
                                        <h2 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-6 leading-tight">Trademark Registration for the Carpet and Floor Covering Industry</h2>
                                        <p className="mb-6">
                                    ...
                                    <section id="class-27-overview" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8 mb-10">
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                                ...
                                                <h4 className="font-bold text-xl mb-3 text-gray-900">Carpets & Rugs</h4>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                                ...
                                                <h4 className="font-bold text-xl mb-3 text-gray-900">Vinyl & Linoleum</h4>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                                ...
                                                <h4 className="font-bold text-xl mb-3 text-gray-900">Mats & Matting</h4>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                                ...
                                                <h4 className="font-bold text-xl mb-3 text-gray-900">Artificial Turf</h4>
                                        ...
                                        <div className="relative space-y-12">
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900">1. Forensic Accessibility Audit</h4>
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900">2. Strategic E-Filing & User Proof</h4>
                                                    <p className="text-base text-gray-600 mb-4">
                                    ...
                                    <section id="required-docs" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-10">
                                            <div className="bg-white border-2 border-gray-100 p-8 rounded-2xl shadow-sm">
                                                <h4 className="text-xl font-black text-[rgb(110,94,147)] mb-6 uppercase tracking-wider">Individuals / MSMEs / Startups</h4>
                                            ...
                                            <div className="bg-white border-2 border-gray-100 p-8 rounded-2xl shadow-sm">
                                                <h4 className="text-xl font-black text-gray-400 mb-6 uppercase tracking-wider">Companies & Large Partnerships</h4>
                                                <ul className="space-y-4 text-gray-600">
                                    ...
                                    <section id="overcoming-objections" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8 mb-12">
                                            <div className="bg-white border-2 border-gray-100 p-8 rounded-2xl hover:border-red-100 transition-colors shadow-sm">
                                                ...
                                                <h4 className="text-xl font-bold mb-4 text-gray-900">Section 9: Descriptive Refusal</h4>
                                            ...
                                            <div className="bg-white border-2 border-gray-100 p-8 rounded-2xl hover:border-orange-100 transition-colors shadow-sm">
                                                ...
                                                <h4 className="text-xl font-bold mb-4 text-gray-900">Section 11: Priority Objections</h4>
                                                <p className="text-sm text-gray-600 leading-relaxed">
                                    ...
                                    <section id="global-strategy" className="scroll-mt-32">
                                        ...
                                        <div className="bg-gray-50 p-8 rounded-3xl border border-gray-100 my-10 relative overflow-hidden">
                                            <h4 className="font-bold text-xl mb-4 text-[rgb(110,94,147)]">Export Strategy Checklist</h4>
                                    ...
                                    <section id="business-valuation" className="scroll-mt-32">
                                        ...
                                        <div className="bg-yellow-50 p-8 rounded-2xl border-l-4 border-yellow-400 my-8 shadow-sm">
                                            <h5 className="font-bold text-yellow-800 mb-2">The Multiplier Effect</h5>
                                    ...
                                    <section id="digital-loom" className="scroll-mt-32">
                                        ...
                                        <div className="bg-indigo-50 p-8 rounded-3xl border border-indigo-100 my-10 shadow-sm relative overflow-hidden">
                                            ...
                                            <h4 className="font-bold text-xl mb-4 text-indigo-900 flex items-center">
                                    ...
                                    <section id="trade-dress-nuances" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8 my-10">
                                            <div className="bg-gray-50 p-8 rounded-2xl border-l-4 border-[rgb(110,94,147)] shadow-sm">
                                                <h5 className="font-bold text-gray-900 mb-2 underline">Texture as a Mark</h5>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-2xl border-l-4 border-[rgb(110,94,147)] shadow-sm">
                                                <h5 className="font-bold text-gray-900 mb-2 underline">Configuration Marks</h5>
                                    ...
                                    <section id="monetization" className="scroll-mt-32">
                                        ...
                                        <div className="bg-yellow-50 p-8 rounded-2xl border-l-4 border-yellow-400 my-8 shadow-sm">
                                            <h5 className="font-bold text-yellow-800 mb-2">Passive Income through IP</h5>
                                    ...
                                    <section className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[2.5rem] p-8 md:p-16 text-center text-white relative overflow-hidden mt-12 shadow-2xl">
                                        <div className="relative z-10">
                                            <h3 className="text-3xl md:text-5xl font-black mb-6 leading-tight">Secure Your Creative Legacy Today</h3>
                        ...
                        <aside className="hidden lg:block space-y-8 sticky top-32">
                            ...
                            <div className="bg-[#0C002B] p-8 rounded-3xl shadow-[0_20px_40px_rgba(0,0,0,0.1)] border border-gray-800 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-xl font-bold mb-4 relative z-10 leading-tight">Is Your Brand Safe?</h4>
