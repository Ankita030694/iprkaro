                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_320px] gap-4 md:gap-12 mt-8 items-start">
                        ...
                        <div className="min-w-0">
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-xl md:rounded-2xl shadow-sm border border-gray-100 prose prose-lg max-w-none text-gray-800 font-sans">
                                ...
                                <section id="statutory-foundation" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Statutory Foundation: 2017 Rules</h3>
                                    ...
                                    <div className="grid md:grid-cols-2 gap-6 my-10 text-center">
                                        <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100">
                                            <h5 className="font-bold text-[#0C002B] text-xl mb-4 text-justify">Section 2(1)(zb)</h5>
                                        ...
                                        <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100">
                                            <h5 className="font-bold text-[#0C002B] text-xl mb-4 text-justify">Rule 26(5)</h5>
                                ...
                                <section id="sound-marks" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6 text-justify">Sound Marks: From Jingles to Corporate Anthems</h3>
                                ...
                                <section id="sound-representation" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Graphical Representation of Sound</h3>
                                    ...
                                    <div className="grid md:grid-cols-2 gap-6 my-10 text-center">
                                        <div className="p-8 bg-white border border-gray-100 rounded-2xl shadow-sm">
                                            ...
                                            <h6 className="font-bold text-[#0C002B] text-xl">Musical Notation</h6>
                                            <p className="text-sm text-gray-500">Traditional sheet music showing pitch, duration, and notes.</p>
                                        </div>
                                        <div className="p-8 bg-white border border-gray-100 rounded-2xl shadow-sm">
                                            <FontAwesomeIcon icon={faSignature} className="text-[#6E5E93] text-3xl mb-4" />
                                            <h6 className="font-bold text-[#0C002B] text-xl">MP3 Format</h6>
                                ...
                                <section id="sound-success" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Sound Success Stories in India</h3>
                                ...
                                <section id="scent-marks" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Scent Marks: The Olfactory Frontier</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify">
                                    ...
                                    <div className="p-8 bg-red-50 border-l-8 border-red-400 rounded-r-2xl my-10">
                                        <h5 className="font-bold text-red-900 mb-2 uppercase tracking-wide">The Functionality Trap</h5>
                                ...
                                <section id="scent-breakthrough" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Breakthrough: 7-D Vector Mapping</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify">
                                ...
                                <section id="scent-case-study" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Case Study: The Rose-Scented Tyre</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify">
                                ...
                                <section id="distinctiveness-test" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">The Challenge of Distinctiveness</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify">
                                ...
                                <section id="filing-lifecycle" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6 text-justify">The Filing Lifecycle: Form TM-A</h3>
                                ...
                                <section id="business-benefits" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6 text-justify">Benefits of Sensory Trademarks</h3>
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-10">
                                        <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100">
                                            <h5 className="font-bold text-[#0C002B] text-xl mb-4">Emotional Connection</h5>
                                        ...
                                        <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100">
                                            <h5 className="font-bold text-[#0C002B] text-xl mb-4">Competitive Edge</h5>
                                ...
                                <section id="conclusion" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6 text-center text-justify">Future-Proofing Your Sensory Brand</h3>
                                ...
                                <div className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[40px] p-10 md:p-20 text-center text-white relative overflow-hidden mt-20 shadow-2xl">
                                    <div className="relative z-10">
                                        <h3 className="text-3xl md:text-5xl font-bold mb-6">Own Your Brand Texture</h3>
                        ...
                        <aside className="hidden lg:block space-y-10 sticky top-32">
                            ...
                            <div className="bg-[#0C002B] p-8 rounded-3xl shadow-xl border border-gray-800 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-2xl font-bold mb-4 relative z-10 text-justify">Sounds & Scents Matter</h4>
                            ...
                            <div className="bg-gray-50 p-8 rounded-3xl shadow-sm border border-gray-100">
                                <h4 className="text-xl font-bold text-[#0C002B] mb-6 border-b pb-4">Non-Conventional Hub</h4>
