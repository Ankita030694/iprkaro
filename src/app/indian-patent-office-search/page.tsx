...
const tocSections = [
    { id: 'introduction', title: 'Indian Patent Office Search Guide' },
    { id: 'inpass-overview', title: 'Indian Patent Office Search Guide' },
    { id: 'search-parameters', title: 'Indian Patent Office Search Guide' },
    { id: 'boolean-logic', title: 'Indian Patent Office Search Guide' },
    { id: 'date-forensics', title: 'Indian Patent Office Search Guide' },
    { id: 'ipc-classification', title: 'Indian Patent Office Search Guide' },
    { id: 'status-meaning', title: 'Indian Patent Office Search Guide' },
    { id: 'bolar-provision', title: 'Indian Patent Office Search Guide' },
    { id: 'fto-vs-novelty', title: 'Indian Patent Office Search Guide' },
    { id: 'international-filings', title: 'Indian Patent Office Search Guide' },
    { id: 'opposition-search', title: 'Indian Patent Office Search Guide' },
    { id: 'why-iprkaro', title: 'Indian Patent Office Search Guide' },
    { id: 'faqs', title: 'Indian Patent Office Search Guide' },
    { id: 'reviews', title: 'Indian Patent Office Search Guide' },
    { id: 'conclusion', title: 'Indian Patent Office Search Guide' },
];
...
export default function IndianPatentSearchPage() {
    ...
    const articleSchema = {
        "@context": "https://schema.org",
        "@type": "Article",
        "headline": "Indian Patent Office Search Guide",
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[220px_1fr_300px] gap-4 md:gap-12 mt-8 items-start">
                        ...
                        <div className="min-w-0">
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-xl md:rounded-2xl shadow-sm border border-gray-100 prose prose-lg max-w-none text-gray-800 font-sans">
                                ...
                                <section id="introduction" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h2 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6">Understanding InPASS</h2>
                                ...
                                <section id="inpass-overview" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Portal Architecture: Full-Text vs E-Register Search</h3>
                                ...
                                <section id="search-parameters" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Search Parameters: Titles, Abstracts, and Claims</h3>
                                    ...
                                    <ul className="space-y-6 my-10 list-none p-0">
                                        <li className="flex gap-4 p-6 bg-gray-50 rounded-2xl border border-gray-200 shadow-sm border-l-[10px] border-l-[#6E5E93]">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-[#0C002B] text-xl mb-1">Title & Abstract</h5>
                                        ...
                                        <li className="flex gap-4 p-6 bg-gray-50 rounded-2xl border border-gray-200 shadow-sm border-l-[10px] border-l-[#160049]">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-[#0C002B] text-xl mb-1">Claims (Forensic Power)</h5>
                                ...
                                <section id="boolean-logic" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Mastering Boolean Logic: AND, OR, and NOT Queries</h3>
                                    <p className="mb-6 leading-relaxed text-lg">
                                ...
                                <section id="date-forensics" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">The Clock of Innovation: Priority vs Filing vs Publication Dates</h3>
                                    <p className="mb-4 leading-relaxed text-lg">
                                ...
                                <section id="ipc-classification" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">IPC Classification (A-H): Narrowing Your Search Scope</h3>
                                    <p className="mb-8 leading-relaxed text-lg">
                                ...
                                <section id="status-meaning" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Patent Status Decoder: "Published" vs "Granted" vs "Lapsed"</h3>
                                    <p className="mb-6 leading-relaxed text-lg">
                                        When you view search results or hit the E-register, you must interpret the status correctly.
                                    </p>
                                    <div className="grid md:grid-cols-3 gap-6 my-10">
                                        <div className="p-6 bg-blue-50 rounded-2xl border border-blue-100">
                                            <h5 className="font-bold text-blue-900 text-xl mb-3">Published</h5>
                                        ...
                                        <div className="p-6 bg-green-50 rounded-2xl border border-green-100">
                                            <h5 className="font-bold text-green-900 text-xl mb-3">Granted</h5>
                                        ...
                                        <div className="p-6 bg-red-50 rounded-2xl border border-red-100">
                                            <h5 className="font-bold text-red-900 text-xl mb-3">Lapsed</h5>
                                ...
                                <section id="bolar-provision" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">The Bolar Provision: Research Exceptions under Section 107A</h3>
                                    <p className="mb-4 leading-relaxed text-lg">
                                ...
                                <section id="opposition-search" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Shield & Spear: Searching for Pre-Grant & Post-Grant Oppositions</h3>
                                    <p className="mb-4 leading-relaxed text-lg">
                                ...
                                <section id="why-iprkaro" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6 text-center">Why Leading Tech Giants Trust IPR Karo for Search Forensics</h3>
                                    ...
                                    <div className="grid md:grid-cols-3 gap-8 text-center bg-[#0C002B] p-10 rounded-[3rem] text-white">
                                        <div className="space-y-4">
                                            ...
                                            <h5 className="font-bold text-xl">Landscaping</h5>
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <h5 className="font-bold text-xl">FTO Audits</h5>
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <h5 className="font-bold text-xl">Invalidity Analysis</h5>
                                ...
                                <section id="conclusion" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6 text-center">Conclusion: Securing Your Invention’s Competitive Edge</h3>
                                ...
                                <div className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[40px] p-10 md:p-20 text-center text-white relative overflow-hidden mt-20 shadow-2xl">
                                    <div className="relative z-10">
                                        <h3 className="text-3xl md:text-5xl font-bold mb-6">Ready to Verify Your Invention?</h3>
                        ...
                        <aside className="hidden lg:block space-y-10 sticky top-32">
                            ...
                            <div className="bg-[#0C002B] p-8 rounded-3xl shadow-xl border border-gray-800 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-2xl font-bold mb-4 relative z-10">FTO Clearance</h4>
                            ...
                            <div className="bg-gray-50 p-8 rounded-3xl shadow-sm border border-gray-100">
                                <h4 className="text-xl font-bold text-[#0C002B] mb-6 border-b pb-4">Patent Resources</h4>
