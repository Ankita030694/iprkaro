          ...
          <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_300px] gap-8 items-start">
            ...
            <aside className="hidden lg:block sticky top-32 h-[calc(100vh-160px)] overflow-y-auto">
              <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                <p className="text-gray-900 font-bold text-lg mb-6 border-l-4 border-[rgb(110,94,147)] pl-3 italic uppercase tracking-[0.2em] font-black underline underline-offset-4 decoration-[rgb(110,94,147)]">Expert Index</p>
              ...
              <div className="bg-white p-4 md:p-12 rounded-2xl shadow-sm border border-gray-100 space-y-12 md:space-y-20">
                ...
                <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed font-normal">
                  ...
                  <section id="statutory-loss" className="scroll-mt-32">
                    <h3 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-6 leading-tight uppercase font-black italic tracking-tighter decoration-[rgb(110,94,147)] decoration-4 underline-offset-8">
                    ...
                    <div className="grid md:grid-cols-2 gap-8 mb-10">
                       <div className="bg-gray-50 border border-gray-100 p-8 rounded-3xl hover:bg-white hover:shadow-xl transition-all">
                          <h5 className="font-black text-gray-900 mb-4 uppercase text-sm tracking-widest italic flex items-center">
                  ...
                  <section id="o3-notice" className="scroll-mt-32">
                    ...
                    <div className="bg-[#0C002B] text-white p-10 rounded-[3rem] shadow-2xl relative overflow-hidden my-12">
                       ...
                       <h5 className="text-xl font-black mb-4 uppercase italic">Pro Tip: The Address Audit</h5>
                  ...
                  <section id="renewal-timeline" className="scroll-mt-32">
                    <h3 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-6 leading-tight uppercase font-black italic tracking-tighter decoration-[rgb(110,94,147)] decoration-4 underline-offset-8 text-center">
                    ...
                    <div className="relative space-y-12 py-10">
                       ...
                       <div className="flex gap-8 items-start relative">
                          ...
                          <div className="bg-gray-50 p-8 rounded-3xl flex-1 border-l-8 border-green-500">
                             <h4 className="font-bold text-lg mb-2 text-gray-900 uppercase">The Prime Renewal Window</h4>
                       ...
                       <div className="flex gap-8 items-start relative">
                          ...
                          <div className="bg-gray-50 p-8 rounded-3xl flex-1 border-l-8 border-yellow-500">
                             <h4 className="font-bold text-lg mb-2 text-gray-900 uppercase">The "Recoverable" Death</h4>
                       ...
                       <div className="flex gap-8 items-start relative">
                          ...
                          <div className="bg-gray-50 p-8 rounded-3xl flex-1 border-l-8 border-orange-600">
                             <h4 className="font-bold text-lg mb-2 text-gray-900 uppercase">The "Removed" Status</h4>
                       ...
                       <div className="flex gap-8 items-start relative">
                          ...
                          <div className="bg-gray-50 p-8 rounded-3xl flex-1 border-l-8 border-red-600">
                             <h4 className="font-bold text-lg mb-2 text-gray-900 uppercase">Final Abandonment</h4>
                  ...
                  <section id="removal-consequences" className="scroll-mt-32">
                    ...
                    <div className="grid md:grid-cols-3 gap-6 mb-12">
                       <div className="p-6 bg-blue-50 rounded-2xl border border-blue-100">
                          <h5 className="font-black text-blue-900 mb-3 text-sm">Investor Pullback</h5>
                       ...
                       <div className="p-6 bg-purple-50 rounded-2xl border border-purple-100">
                          <h5 className="font-black text-purple-900 mb-3 text-sm">Customs Seizures</h5>
                       ...
                       <div className="p-6 bg-green-50 rounded-2xl border border-green-100">
                          <h5 className="font-black text-green-900 mb-3 text-sm">Licensing Collapse</h5>
                  ...
                  <section id="grace-period" className="scroll-mt-32">
                    ...
                    <div className="bg-gray-50 p-10 rounded-[3rem] border-2 border-dashed border-gray-200 mb-12">
                       <h4 className="text-xl font-black mb-4 uppercase text-center italic">The Recovery Checklist</h4>
                  ...
                  <section className="bg-gradient-to-br from-[#0C002B] to-[#1a0031] rounded-[4rem] p-10 md:p-20 text-center text-white relative overflow-hidden mt-12 shadow-[0_40px_100px_rgba(0,0,0,0.3)] group border border-white/5">
                     ...
                     <div className="relative z-10">
                        <h3 className="text-4xl md:text-6xl font-black mb-8 leading-tight uppercase italic tracking-tighter">Is Your Brand Secure?</h3>
            ...
            <aside className="hidden lg:block space-y-8 sticky top-32">
              ...
              <div className="bg-[#0C002B] p-8 rounded-3xl shadow-[0_30px_60px_rgba(0,0,0,0.2)] border border-gray-800 text-white relative overflow-hidden group">
                 ...
                 <h4 className="text-xl font-bold mb-4 relative z-10 leading-tight uppercase font-black italic tracking-[0.1em]">Expiry Alert</h4>
              ...
              <div className="bg-gray-50 p-8 rounded-3xl shadow-sm border border-gray-100">
                <h4 className="text-sm font-black text-gray-400 mb-6 border-b-2 border-gray-100 pb-4 uppercase tracking-widest italic">Renewal Center</h4>
