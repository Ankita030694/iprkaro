          ...
          <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_300px] gap-8 items-start">
            ...
            <aside className="hidden lg:block sticky top-32">
              <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                <p className="text-gray-900 font-bold text-lg mb-6 border-l-4 border-[rgb(110,94,147)] pl-3">Pharma IP Guide</p>
              ...
              <div className="bg-white p-4 md:p-12 rounded-2xl shadow-sm border border-gray-100 space-y-12 md:space-y-20 article-content">
                <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed font-normal">
                  ...
                  <section id="class-5-decoding" className="scroll-mt-32">
                    <h3 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-6 leading-tight flex items-center tracking-tighter uppercase">
                    ...
                    <div className="grid md:grid-cols-2 gap-8 mb-10">
                       <div className="bg-gray-50 p-8 rounded-3xl border border-gray-100 shadow-sm font-medium">
                          <h4 className="font-black text-xl mb-4 text-indigo-950">Drug Formulations</h4>
                       ...
                       <div className="bg-gray-50 p-8 rounded-3xl border border-gray-100 shadow-sm font-medium">
                          <h4 className="font-black text-xl mb-4 text-indigo-950">Wellness & Biotech</h4>
                          <ul className="space-y-2 list-disc list-inside opacity-90 text-sm">
                  ...
                  <section id="registration-journey" className="scroll-mt-32 pt-12">
                     <h3 className="text-3xl md:text-5xl font-black text-gray-900 mb-12 text-center uppercase tracking-tighter">The Pharma IP Protocol</h3>
                        ...
                        {[
                          ...
                          { step: "4", title: "Registry Defense", desc: "Handling technical objections (Section 9/11) with a focus on 'Secondary Meaning' for historical drug brands." }
                           ...
                           <div key={i} className="flex items-start gap-5 p-6 bg-gray-50 rounded-3xl border border-gray-100 group hover:border-[rgb(110,94,147)] transition-colors">
                              ...
                              <div>
                                 <h5 className="font-extrabold text-gray-900 text-lg mb-1">{item.title}</h5>
                  ...
                  <section id="faqs" className="scroll-mt-32 pt-16">
                    <h3 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-12 text-center uppercase tracking-widest decoration-[rgb(110,94,147)] underline underline-offset-8">Pharma IP Intelligence Hub</h3>
                    <div className="grid gap-6">
                      {faqs.map((f, i) => (
                        <div key={i} className="bg-white border border-gray-100 rounded-3xl p-8 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group">
                           ...
                           <h4 className="text-xl font-black text-gray-900 mb-4 flex items-start">
                  ...
                  <section className="bg-indigo-950 rounded-[3rem] p-12 md:p-24 text-center text-white relative overflow-hidden mt-12 shadow-2xl group">
                     ...
                     <div className="relative z-10">
                        <h3 className="text-4xl md:text-7xl font-black mb-8 leading-tight tracking-tighter uppercase">Defend Your Science.</h3>
            ...
            <aside className="hidden lg:block space-y-8 sticky top-32">
              <div className="bg-[#0C002B] p-10 rounded-[2.5rem] shadow-2xl border border-gray-800 text-white group text-center">
                 <h4 className="text-2xl font-black mb-6 leading-tight uppercase tracking-tighter">Pharma Clearance Scan</h4>
              ...
              <div className="bg-gray-50 p-10 rounded-[2.5rem] border border-gray-100 shadow-sm relative overflow-hidden">
                <h4 className="text-[10px] font-black text-gray-400 mb-8 uppercase tracking-[0.4em]">Specialized IP</h4>
