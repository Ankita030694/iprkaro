                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_300px] gap-8 items-start">
                        ...
                        <aside className="hidden lg:block sticky top-32">
                            <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                                <p className="text-gray-900 font-bold text-lg mb-6 border-l-4 border-[rgb(110,94,147)] pl-3">Hand Tools IP Guide</p>
                                ...
                                <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed font-normal">
                                    ...
                                    <section id="class-8-definition" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8 mb-10">
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all">
                                                ...
                                                <h4 className="font-bold text-xl mb-3">Construction & Heavy Tools</h4>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all">
                                                ...
                                                <h4 className="font-bold text-xl mb-3">Cutlery & Tableware</h4>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all">
                                                ...
                                                <h4 className="font-bold text-xl mb-3">Grooming & Personal Care</h4>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all">
                                                ...
                                                <h4 className="font-bold text-xl mb-3">Agricultural & Garden</h4>
                                    ...
                                    <section id="hand-tool-subcategories" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-3 gap-6">
                                            <div className="p-6 bg-gray-50 rounded-xl border border-gray-100 hover:bg-white hover:shadow-xl transition-all">
                                                <h5 className="font-bold text-[rgb(110,94,147)] mb-3 text-lg">Cutlery & Kitchen</h5>
                                            ...
                                            <div className="p-6 bg-gray-50 rounded-xl border border-gray-100 hover:bg-white hover:shadow-xl transition-all">
                                                <h5 className="font-bold text-[rgb(110,94,147)] mb-3 text-lg">Grooming Sets</h5>
                                            ...
                                            <div className="p-6 bg-gray-50 rounded-xl border border-gray-100 hover:bg-white hover:shadow-xl transition-all">
                                                <h5 className="font-bold text-[rgb(110,94,147)] mb-3 text-lg">Artisan Craft Tools</h5>
                                        ...
                                        <div className="space-y-12 relative">
                                            ...
                                            <div className="flex gap-8 items-start relative transition-all hover:translate-x-2">
                                                ...
                                                <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm flex-1">
                                                    <h4 className="text-xl font-bold mb-3">Step 1: The 'Conflict-Free' AI Search</h4>
                                            ...
                                            <div className="flex gap-8 items-start relative transition-all hover:translate-x-2">
                                                ...
                                                <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm flex-1">
                                                    <h4 className="text-xl font-bold mb-3">Step 2: Tactical Drafting of Form TM-A</h4>
                                                    <p className="text-gray-600 leading-relaxed">
                                            ...
                                            <div className="flex gap-8 items-start relative transition-all hover:translate-x-2">
                                                ...
                                                <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm flex-1">
                                                    <h4 className="text-xl font-bold mb-3">Step 3: Journal Publication & Opposition</h4>
                                                    <p className="text-gray-600 leading-relaxed">
                                    ...
                                    <section id="objection-strategies" className="scroll-mt-32 pt-12">
                                        ...
                                        <div className="space-y-8">
                                            ...
                                            <div className="p-6 bg-white border-l-4 border-[rgb(110,94,147)] shadow-sm">
                                                <h5 className="font-bold text-lg mb-2 text-gray-900">2. Conflict with Machine Tools (Section 11)</h5>
                                    ...
                                    <section id="pricing-and-fees" className="scroll-mt-12">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8 mb-16">
                                            <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100 flex flex-col items-center">
                                                <h5 className="font-bold text-xl mb-6 text-gray-900 uppercase tracking-widest">Official Govt Fees</h5>
                                    ...
                                    <section className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[3rem] p-10 md:p-24 text-center text-white relative overflow-hidden mt-12 shadow-2xl group">
                                        ...
                                        <div className="relative z-10">
                                            <h3 className="text-4xl md:text-7xl font-black mb-10 leading-tight tracking-tighter uppercase">Forge Your Legal Destiny.</h3>
                        ...
                        <aside className="hidden lg:block space-y-8 sticky top-32">
                            ...
                            <div className="bg-[#0C002B] p-10 rounded-[2.5rem] shadow-2xl border border-gray-800 text-white group text-center relative overflow-hidden">
                                ...
                                <h4 className="text-2xl font-black mb-6 uppercase tracking-tighter relative z-10 leading-tight">Class 8 Scan</h4>
                            ...
                            <div className="bg-gray-50 p-10 rounded-[2.5rem] border border-gray-100 shadow-sm">
                                <h4 className="text-[10px] font-black text-gray-400 mb-8 uppercase tracking-[0.4em] border-b border-gray-200 pb-4">Tool IP Shield</h4>
