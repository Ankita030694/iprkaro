...
export const metadata: Metadata = {
  ...
  description: validateAndNormalizeDescription('Master the registration of trademark process in Bharat. Get step-by-step guidance on filing, documents, fees, and legal protection. Secure your brand today with IPR Karo.', "app/registration-of-trademark/page.tsx "),
  keywords: [
  ...
  openGraph: {
    ...
    description: validateAndNormalizeDescription('Learn everything about the registration of trademark in India. From initial search to final certificate, we cover it all.', "app/registration-of-trademark/page.tsx "),
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[220px_1fr_300px] gap-4 md:gap-12 mt-8 items-start">
            ...
            <div className="min-w-0">
              ...
              <div className="bg-white p-4 md:p-12 rounded-xl md:rounded-2xl shadow-sm border border-gray-100 prose prose-lg max-w-none text-gray-800 font-sans">
                ...
                <section id="introduction" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h2 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6">Trademark Registration</h2>
                ...
                <section id="importance" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Why Registration is Non Negotiable for Your Brand</h3>
                  ...
                  <ul className="space-y-6 my-10 list-none p-0">
                    <li className="flex gap-4 p-6 bg-green-50 rounded-2xl border border-green-100 shadow-sm border-l-[10px] border-l-green-500">
                      ...
                      <div>
                        <h5 className="font-bold text-green-900 text-xl mb-2">Legal Monopoly and Exclusive Rights</h5>
                    ...
                    <li className="flex gap-4 p-6 bg-green-50 rounded-2xl border border-green-100 shadow-sm border-l-[10px] border-l-green-500">
                      ...
                      <div>
                        <h5 className="font-bold text-green-900 text-xl mb-2">Asset Valuation and Financial Growth</h5>
                    ...
                    <li className="flex gap-4 p-6 bg-green-50 rounded-2xl border border-green-100 shadow-sm border-l-[10px] border-l-green-500">
                      ...
                      <div>
                        <h5 className="font-bold text-green-900 text-xl mb-2">Platform Protection (Amazon, Flipkart, Instagram)</h5>
                ...
                <section id="types-of-marks" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Navigating the Spectrum: Types of Marks You Can Register</h3>
                  <p className="mb-6 leading-relaxed text-lg">
                ...
                <section id="eligibility" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Who Can Apply for registration of trademark?</h3>
                  <p className="mb-6 leading-relaxed text-lg">
                  ...
                  <div className="bg-white border border-gray-100 rounded-3xl overflow-hidden shadow-sm my-10">
                    <div className="p-8 bg-gradient-to-r from-[#0C002B] to-[#160049] text-white">
                      <h5 className="text-xl font-bold">Categories of Eligible Applicants</h5>
                    </div>
                    <div className="p-8">
                ...
                <section id="classification" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">The Nice Classification: Structuring Your Protection Strategy</h3>
                  <p className="mb-6 leading-relaxed text-lg">
                ...
                <section id="pre-filing-search" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Strategic Pre Filing: The Importance of a Public Search</h3>
                  <p className="mb-6 leading-relaxed text-lg">
                  ...
                  <div className="grid md:grid-cols-3 gap-6 mb-10 text-center">
                    <div className="p-6 bg-blue-50 rounded-2xl border border-blue-100">
                      ...
                      <h6 className="font-bold mb-2">Identical Matches</h6>
                    ...
                    <div className="p-6 bg-blue-50 rounded-2xl border border-blue-100">
                      ...
                      <h6 className="font-bold mb-2">Phonetic Similarity</h6>
                    ...
                    <div className="p-6 bg-blue-50 rounded-2xl border border-blue-100">
                      ...
                      <h6 className="font-bold mb-2">Visual Elements</h6>
                ...
                <section id="the-process" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Demystified: The 7 Step Lifecycle of Trademark Registration</h3>
                  ...
                  <div className="space-y-12 my-12 relative before:absolute before:inset-0 before:ml-5 md:before:ml-[31px] before:-z-10 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-indigo-200 before:via-purple-200 before:to-transparent">
                    ...
                    <div className="relative flex items-center gap-6 md:gap-10">
                      ...
                      <div className="flex flex-col bg-gray-50 p-6 rounded-2xl border border-gray-100 shadow-sm w-full">
                        <h5 className="font-bold text-[#0C002B] text-xl mb-2">Application Filing (TM-A)</h5>
                    ...
                    <div className="relative flex items-center gap-6 md:gap-10">
                      ...
                      <div className="flex flex-col bg-gray-50 p-6 rounded-2xl border border-gray-100 shadow-sm w-full">
                        <h5 className="font-bold text-[#0C002B] text-xl mb-2">Formalities Check</h5>
                    ...
                    <div className="relative flex items-center gap-6 md:gap-10">
                      ...
                      <div className="flex flex-col bg-gray-50 p-6 rounded-2xl border border-gray-100 shadow-sm w-full">
                        <h5 className="font-bold text-[#0C002B] text-xl mb-2">Substantive Examination</h5>
                    ...
                    <div className="relative flex items-center gap-6 md:gap-10">
                      ...
                      <div className="flex flex-col bg-gray-50 p-6 rounded-2xl border border-gray-100 shadow-sm w-full">
                        <h5 className="font-bold text-[#0C002B] text-xl mb-2">Objection Handling (If Any)</h5>
                    ...
                    <div className="relative flex items-center gap-6 md:gap-10">
                      ...
                      <div className="flex flex-col bg-gray-50 p-6 rounded-2xl border border-gray-100 shadow-sm w-full">
                        <h5 className="font-bold text-[#0C002B] text-xl mb-2">Publication in Trademark Journal</h5>
                    ...
                    <div className="relative flex items-center gap-6 md:gap-10">
                      ...
                      <div className="flex flex-col bg-gray-50 p-6 rounded-2xl border border-gray-100 shadow-sm w-full">
                        <h5 className="font-bold text-[#0C002B] text-xl mb-2">Opposition Proceedings (Rare)</h5>
                    ...
                    <div className="relative flex items-center gap-6 md:gap-10">
                      ...
                      <div className="flex flex-col bg-gray-50 p-6 rounded-2xl border border-gray-100 shadow-sm w-full">
                        <h5 className="font-bold text-[#0C002B] text-xl mb-2">Registration and Certification</h5>
                ...
                <section id="documents" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Documents Required: Building Your Application Dossier</h3>
                  <p className="mb-6 leading-relaxed text-lg">
                  ...
                  <div className="grid md:grid-cols-2 gap-8 my-10">
                    <div className="bg-indigo-50 p-8 rounded-3xl border border-indigo-100 h-full">
                      <h5 className="font-bold text-[#0C002B] text-2xl mb-4">Core Identity & Address</h5>
                    ...
                    <div className="bg-purple-50 p-8 rounded-3xl border border-purple-100 h-full">
                      <h5 className="font-bold text-[#0C002B] text-2xl mb-4">Filing Specific Assets</h5>
                      <ul className="space-y-4">
                ...
                <section id="fees-breakdown" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Transparency Matters: Government Fees Breakdown 2026</h3>
                  <p className="mb-8 leading-relaxed text-lg">
                  ...
                  <div className="flex flex-col md:flex-row gap-8 my-12">
                    <div className="flex-1 p-8 bg-gradient-to-br from-green-50 to-white rounded-3xl border-2 border-green-200 text-center shadow-lg hover:-translate-y-2 transition-transform">
                      <h5 className="font-bold text-green-700 text-4xl mb-2">₹4,500</h5>
                    ...
                    <div className="flex-1 p-8 bg-gradient-to-br from-orange-50 to-white rounded-3xl border-2 border-orange-200 text-center shadow-lg hover:-translate-y-2 transition-transform">
                      <h5 className="font-bold text-orange-700 text-4xl mb-2">₹9,000</h5>
                ...
                <section id="objections-oppositions" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Handling Hurdles: Objections and Oppositions</h3>
                  <p className="mb-6 leading-relaxed text-lg">
                  ...
                  <div className="space-y-8 my-10">
                    <div className="p-8 bg-white rounded-3xl border-l-[10px] border-l-[#0C002B] shadow-xl">
                      <h5 className="font-bold text-[#0C002B] text-2xl mb-4 flex items-center">
                ...
                <section id="post-registration" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Post Registration: Safeguarding Your Success</h3>
                  <p className="mb-6 leading-relaxed text-lg">
                  ...
                  <div className="grid md:grid-cols-2 gap-8 my-10">
                    <div className="flex gap-4 p-6 bg-gray-50 rounded-2xl hover:bg-white transition-colors border border-transparent hover:border-gray-200">
                      ...
                      <div>
                        <h6 className="font-bold mb-1">Renewal Every 10 Years</h6>
                    ...
                    <div className="flex gap-4 p-6 bg-gray-50 rounded-2xl hover:bg-white transition-colors border border-transparent hover:border-gray-200">
                      ...
                      <div>
                        <h6 className="font-bold mb-1">Enforcement and Anti Counterfeit</h6>
                ...
                <section id="trademark-infringement" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">What Constitutes Trademark Infringement?</h3>
                  <p className="mb-6 leading-relaxed text-lg">
                ...
                <section id="common-mistakes" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Common Mistakes to Avoid During Online Filing</h3>
                  <p className="mb-6 leading-relaxed text-lg">
                ...
                <section id="global-protection" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Scaling Globally: The Madrid Protocol Strategy</h3>
                  <p className="mb-6 leading-relaxed text-lg">
                  ...
                  <div className="bg-[#6E5E93]/10 p-8 rounded-3xl border border-[#6E5E93]/20 my-10">
                    <h5 className="text-[#0C002B] font-bold text-2xl mb-4">Benefits of International Filing</h5>
                ...
                <section id="why-iprkaro" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6">Why Hundreds of Startups Trust IPR Karo</h3>
                  ...
                  <div className="grid md:grid-cols-3 gap-8 text-center bg-[#0C002B] p-10 rounded-[3rem] text-white">
                    <div className="space-y-4">
                      ...
                      <h5 className="font-bold text-xl">Same Day Filing</h5>
                    ...
                    <div className="space-y-4">
                      ...
                      <h5 className="font-bold text-xl">Expert Attorneys</h5>
                    ...
                    <div className="space-y-4">
                      ...
                      <h5 className="font-bold text-xl">Zero Hidden Fees</h5>
                ...
                <section id="conclusion" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6 text-center">Nishkarsh: Your Brand deserves the best protection</h3>
                ...
                <div className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[40px] p-10 md:p-20 text-center text-white relative overflow-hidden mt-20 shadow-2xl">
                  <div className="relative z-10">
                    <h3 className="text-3xl md:text-5xl font-bold mb-6">Claim Your Brand Name Today</h3>
            ...
            <aside className="hidden lg:block space-y-10 sticky top-32">
              ...
              <div className="bg-[#0C002B] p-8 rounded-3xl shadow-xl border border-gray-800 text-white relative overflow-hidden group">
                ...
                <h4 className="text-2xl font-bold mb-4 relative z-10">Free Availability Check</h4>
