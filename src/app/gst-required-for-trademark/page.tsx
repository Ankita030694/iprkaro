...
export const metadata: Metadata = {
  title: 'Is GST Mandatory for Trademark Registration in India? | IPR Karo',
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[220px_1fr_300px] gap-4 md:gap-12 mt-8 items-start">
            ...
            <div className="min-w-0">
              ...
              <div className="bg-white p-4 md:p-12 rounded-xl md:rounded-2xl shadow-sm border border-gray-100 prose prose-lg max-w-none text-gray-800 font-sans">
                ...
                <section id="introduction" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h2 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6">GST and Trademark Registration</h2>
                ...
                <section id="is-gst-mandatory" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Is GST Mandatory for Trademark Registration? The Legal Reality</h3>
                ...
                <section id="benefits-of-gst" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Why You Should Have GST: Benefits for Trademark Holders</h3>
                  <p className="mb-6 leading-relaxed text-lg">
                  ...
                  <ul className="space-y-6 my-10 list-none p-0">
                    <li className="flex gap-4 p-6 bg-green-50 rounded-2xl border border-green-100 shadow-sm border-l-[10px] border-l-green-500">
                      ...
                      <div>
                        <h5 className="font-bold text-green-900 text-xl mb-2">Proof of 'Trading As' Status</h5>
                    ...
                    <li className="flex gap-4 p-6 bg-green-50 rounded-2xl border border-green-100 shadow-sm border-l-[10px] border-l-green-500">
                      ...
                      <div>
                        <h5 className="font-bold text-green-900 text-xl mb-2">Financial Efficiency via ITC</h5>
                    ...
                    <li className="flex gap-4 p-6 bg-green-50 rounded-2xl border border-green-100 shadow-sm border-l-[10px] border-l-green-500">
                      ...
                      <div>
                        <h5 className="font-bold text-green-900 text-xl mb-2">Enhanced Business Credibility</h5>
                ...
                <section id="gst-on-fees" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Unpacking the 18% GST on Trademark Fees</h3>
                  <p className="mb-6 leading-relaxed text-lg">
                  ...
                  <div className="bg-purple-50 p-8 rounded-3xl border border-purple-100 my-10">
                    <h5 className="font-bold text-[#6E5E93] text-2xl mb-4">A Practical Calculation</h5>
                ...
                <section id="input-tax-credit" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Claiming Input Tax Credit (ITC) for Trademark Costs</h3>
                  <p className="mb-6 leading-relaxed text-lg">
                  ...
                  <div className="space-y-6 my-10">
                    <div className="p-6 bg-gray-50 rounded-xl flex items-start gap-4">
                        ...
                        <div>
                            <h6 className="font-bold text-xl mb-1">Provide Your GSTIN</h6>
                    ...
                    <div className="p-6 bg-gray-50 rounded-xl flex items-start gap-4">
                        ...
                        <div>
                            <h6 className="font-bold text-xl mb-1">Verify GSTR-2B</h6>
                    ...
                    <div className="p-6 bg-gray-50 rounded-xl flex items-start gap-4">
                        ...
                        <div>
                            <h6 className="font-bold text-xl mb-1">Maintain Proper Records</h6>
                ...
                <section id="msme-vs-gst" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">MSME vs GST: Which Registration Saves More on Trademarks?</h3>
                  <p className="mb-6 leading-relaxed text-lg">
                ...
                <section id="documents-checklist" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Document Checklist: Integrating GST into Your Filing</h3>
                  <p className="mb-6 leading-relaxed text-lg">
                  ...
                  <div className="flex flex-col md:flex-row gap-8 my-10">
                    <div className="flex-1 bg-gray-50 p-6 rounded-2xl">
                        <h6 className="font-bold text-xl mb-4 border-b pb-2">Individual Checklist</h6>
                    ...
                    <div className="flex-1 bg-[#6E5E93]/10 p-6 rounded-2xl">
                        <h6 className="font-bold text-xl mb-4 border-b pb-2">Business Checklist</h6>
                        <ul className="space-y-3 text-sm">
                ...
                <section id="trademark-classes-gst" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Understanding Trademark Classes and GST Application</h3>
                  <p className="mb-6 leading-relaxed text-lg">
                ...
                <section id="registration-process" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">The Step-by-Step Registration Guide (Integrated with GST)</h3>
                  ...
                  <div className="space-y-10 my-12">
                    <div className="flex gap-6 relative">
                       ...
                       <div>
                          <h5 className="font-bold text-[#0C002B] text-xl mb-1">Pre-Filing: Clearance Search</h5>
                    ...
                    <div className="flex gap-6 relative">
                       ...
                       <div className="absolute left-6 md:left-7 top-14 w-1 h-20 bg-gray-100 -z-0 hidden md:block"></div>
                       <div>
                          <h5 className="font-bold text-[#0C002B] text-xl mb-1">Filing Section: Form TM-A</h5>
                    ...
                    <div className="flex gap-6 relative">
                       ...
                       <div className="absolute left-6 md:left-7 top-14 w-1 h-20 bg-gray-100 -z-0 hidden md:block"></div>
                       <div>
                          <h5 className="font-bold text-[#0C002B] text-xl mb-1">Examination Phase</h5>
                    ...
                    <div className="flex gap-6 relative">
                       ...
                       <div className="absolute left-6 md:left-7 top-14 w-1 h-20 bg-gray-100 -z-0 hidden md:block"></div>
                       <div>
                          <h5 className="font-bold text-[#0C002B] text-xl mb-1">Journal Publication</h5>
                    ...
                    <div className="flex gap-6 relative">
                       ...
                       <div>
                          <h5 className="font-bold text-[#0C002B] text-xl mb-1">Registration Certificate</h5>
                ...
                <section id="common-mistakes" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Common Mistakes: Avoiding the GST and TM Pitfalls</h3>
                  <p className="mb-6 leading-relaxed text-lg">
                  ...
                  <ul className="grid md:grid-cols-2 gap-6 mb-10 list-none p-0">
                    <li className="p-6 bg-red-50 rounded-2xl border border-red-100">
                        <h6 className="font-bold text-red-900 mb-2">Mismatching Names</h6>
                    ...
                    <li className="p-6 bg-red-50 rounded-2xl border border-red-100">
                        <h6 className="font-bold text-red-900 mb-2">Ignoring ITC Deadlines</h6>
                    ...
                    <li className="p-6 bg-red-50 rounded-2xl border border-red-100">
                        <h6 className="font-bold text-red-900 mb-2">Wrong Applicant Type</h6>
                    ...
                    <li className="p-6 bg-red-50 rounded-2xl border border-red-100">
                        <h6 className="font-bold text-red-900 mb-2">Expired Certificates</h6>
                ...
                <section id="global-trademark" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">International Trademarks: The Madrid Protocol and GST</h3>
                  <p className="mb-6 leading-relaxed text-lg">
                  ...
                  <div className="bg-blue-900 text-white p-8 rounded-3xl my-10 shadow-xl">
                    <h5 className="font-bold text-2xl mb-4 text-[#FFD700]">Global Compliance Tip</h5>
                ...
                <section id="enforcement" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Legal Protection: Wielding Your Trademark Sword</h3>
                  <p className="mb-6 leading-relaxed text-lg">
                  ...
                  <div className="grid md:grid-cols-2 gap-8 my-10">
                    <div className="bg-red-50 p-6 rounded-2xl border-l-[10px] border-red-600">
                        <h6 className="font-bold text-red-900 mb-2">Civil Recovery</h6>
                    ...
                    <div className="bg-red-50 p-6 rounded-2xl border-l-[10px] border-red-600">
                        <h6 className="font-bold text-red-900 mb-2">Antitrust & Counterfeiting</h6>
                ...
                <section id="conclusion" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                   <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6">Conclusion: Integrating Tax Compliance and Brand Protection</h3>
                ...
                <div className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[40px] p-10 md:p-20 text-center text-white relative overflow-hidden mt-20 shadow-2xl">
                   <div className="relative z-10">
                    <h3 className="text-3xl md:text-5xl font-bold mb-6">Start Your Protection Journey Now</h3>
            ...
            <div className="hidden lg:block space-y-8 sticky top-32">
                ...
                <div className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] p-6 rounded-xl shadow-lg border border-gray-800 text-white text-center">
                  <h4 className="text-xl font-bold mb-3">Instant Search Report</h4>
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                  <h4 className="text-lg font-bold text-gray-900 mb-4">Related Services</h4>
                  <ul className="space-y-3 text-sm">
                    <li>
                ...
                <div className="bg-gray-50 p-6 rounded-xl border border-dashed border-gray-300">
                    <h5 className="font-bold text-gray-800 mb-2">Need a GST Number?</h5>
