                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[220px_1fr_300px] gap-4 md:gap-12 mt-8 items-start">
                        ...
                        <div className="min-w-0">
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-xl md:rounded-2xl shadow-sm border border-gray-100 prose prose-lg max-w-none text-gray-800 font-sans">
                                ...
                                <section id="introduction" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h2 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6">Decoding the Identity</h2>
                                ...
                                <section id="fundamental-definition" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">The Statutory Definition: Trademark India 1999</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-gray-800">
                                    ...
                                    <div className="grid md:grid-cols-3 gap-6 my-10">
                                        <div className="p-6 bg-gray-50 rounded-2xl border border-gray-100 shadow-sm text-center">
                                            ...
                                            <h6 className="font-bold mb-2">Graphic Nature</h6>
                                        ...
                                        <div className="p-6 bg-gray-50 rounded-2xl border border-gray-100 shadow-sm text-center">
                                            ...
                                            <h6 className="font-bold mb-2">Distinctiveness</h6>
                                        ...
                                        <div className="p-6 bg-gray-50 rounded-2xl border border-gray-100 shadow-sm text-center">
                                            ...
                                            <h6 className="font-bold mb-2">Trade Usage</h6>
                                ...
                                <section id="core-function" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">The Triple Role: Why Every Brand Needs One</h3>
                                    ...
                                    <div className="space-y-6 my-10">
                                        <div className="p-6 bg-indigo-50 rounded-2xl border border-indigo-100 flex gap-6">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-indigo-900 mb-1">Source Identifier</h5>
                                        ...
                                        <div className="p-6 bg-indigo-50 rounded-2xl border border-indigo-100 flex gap-6">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-indigo-900 mb-1">Quality Guarantee</h5>
                                        ...
                                        <div className="p-6 bg-indigo-50 rounded-2xl border border-indigo-100 flex gap-6">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-indigo-900 mb-1">Advertising Anchor</h5>
                                ...
                                <section id="types-of-marks" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">The Spectrum of Marks: What Can You Actually Protect?</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-gray-800">
                                    ...
                                    <div className="grid md:grid-cols-2 gap-8 my-10">
                                        <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100 group hover:bg-[#160049] transition-all">
                                            <h5 className="font-bold text-xl mb-4 group-hover:text-white transition-all">Standard Word Marks</h5>
                                        ...
                                        <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100 group hover:bg-[#160049] transition-all">
                                            <h5 className="font-bold text-xl mb-4 group-hover:text-white transition-all">Device Marks (Logos)</h5>
                                        ...
                                        <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100 group hover:bg-[#160049] transition-all">
                                            <h5 className="font-bold text-xl mb-4 group-hover:text-white transition-all">Shape Marks</h5>
                                        ...
                                        <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100 group hover:bg-[#160049] transition-all">
                                            <h5 className="font-bold text-xl mb-4 group-hover:text-white transition-all">Slogans & Taglines</h5>
                                ...
                                <section id="symbols-decoded" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">The Symbols: Decoding ™, SM, and ®</h3>
                                    ...
                                    <div className="flex flex-col md:flex-row gap-8 my-12">
                                        <div className="flex-1 p-10 bg-gradient-to-br from-[#0C002B] to-[#160049] rounded-3xl text-white shadow-2xl relative overflow-hidden">
                                            ...
                                            <h5 className="font-bold text-2xl mb-4">Unregistered / Pending</h5>
                                        ...
                                        <div className="flex-1 p-10 bg-white border-2 border-gray-100 rounded-3xl text-[#0C002B] shadow-xl relative overflow-hidden">
                                            <div className="text-5xl font-extrabold mb-4 text-[#6E5E93]">®</div>
                                            <h5 className="font-bold text-2xl mb-4">Registered</h5>
                                ...
                                <section id="why-it-matters" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Economic Importance for Modern Startups</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-gray-800">
                                ...
                                <section id="reviews" className="mb-16 scroll-mt-24 md:scroll-mt-32">
                                    <div className="py-16 bg-[#0C002B] rounded-3xl relative overflow-hidden">
                                        ...
                                        <div className="max-w-6xl mx-auto px-6">
                                            <h3 className="text-3xl md:text-4xl font-bold text-white mb-4 text-center">What Our <span className="text-[#FFB703]">Clients Say</span> About IPR Knowledge</h3>
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                                <div className="p-6 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm">
                                                    <div className="flex items-center gap-4 mb-4">
                                                        ...
                                                        <div><h4 className="text-white font-bold">Priya Sharma</h4><p className="text-white/50 text-xs">Founder, Handloom Startup</p></div>
                                                    </div>
                                                ...
                                                <div className="p-6 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm">
                                                    <div className="flex items-center gap-4 mb-4">
                                                        ...
                                                        <div><h4 className="text-white font-bold">Kabir Jain</h4><p className="text-white/50 text-xs">Owner, Specialty Coffee Chain</p></div>
                                                    </div>
                                                    <div className="mb-3 text-[#FFB703] text-sm flex gap-1">★★★★★</div>
                                                ...
                                                <div className="p-6 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm">
                                                    <div className="flex items-center gap-4 mb-4">
                                                        ...
                                                        <div><h4 className="text-white font-bold">Neha Reddy</h4><p className="text-white/50 text-xs">Co-Founder, Ayurvedic D2C Brand</p></div>
                                                    </div>
                                                    <div className="mb-3 text-[#FFB703] text-sm flex gap-1">★★★★★</div>
                                ...
                                <section id="conclusion" className="mb-12 scroll-mt-24 md:scroll-mt-32 text-gray-800">
                                    <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6 text-center">Nishkarsh: Your Brand Identity is Your Most Precious Asset</h3>
                                ...
                                <div className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[48px] p-12 md:p-24 text-center text-white relative overflow-hidden mt-20 shadow-2xl">
                                    <div className="relative z-10">
                                        <h3 className="text-3xl md:text-5xl font-bold mb-6 italic">Ready to Own Your Identity?</h3>
                        ...
                        <aside className="hidden lg:block space-y-10 sticky top-32">
                            ...
                            <div className="bg-[#0C002B] p-8 rounded-3xl shadow-xl border border-gray-800 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-2xl font-bold mb-4 relative z-10">Expert Basics</h4>
                            ...
                            <div className="bg-gray-50 p-8 rounded-3xl shadow-sm border border-gray-100 text-gray-800">
                                <h4 className="text-xl font-bold text-[#0C002B] mb-6 border-b pb-4 text-gray-800">Learn More</h4>
