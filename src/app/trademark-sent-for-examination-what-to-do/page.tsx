            ...
            <div className="bg-white min-h-screen font-sans text-gray-800">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_300px] gap-8 items-start">
                        ...
                        <aside className="hidden lg:block sticky top-32 self-start">
                            <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm overflow-y-auto max-h-[80vh]">
                                <p className="text-gray-900 font-bold text-lg mb-6 border-l-4 border-[rgb(110,94,147)] pl-3">Outline</p>
                                ...
                                <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed font-normal">
                                    ...
                                    <section id="timeline" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8 my-10">
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-gray-100">
                                                <h5 className="font-bold text-lg mb-4 text-[rgb(110,94,147)] flex items-center">
                                    ...
                                    <section id="substantive-review" className="scroll-mt-32">
                                        ...
                                        <div className="space-y-10">
                                            <div className="flex gap-8 items-start">
                                                ...
                                                <div>
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900">Absolute Grounds (Section 9)</h4>
                                            ...
                                            <div className="flex gap-8 items-start">
                                                ...
                                                <div>
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900">Relative Grounds (Section 11)</h4>
                                                    <p className="text-base text-gray-600 mb-4">
                                    ...
                                    <section id="possible-outcomes" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-3 gap-6">
                                            <div className="p-8 bg-green-50 rounded-3xl border border-green-100 shadow-sm text-center">
                                                ...
                                                <h5 className="font-bold mb-4 text-green-900">Accepted & Advertised</h5>
                                            ...
                                            <div className="p-8 bg-yellow-50 rounded-3xl border border-yellow-100 shadow-sm text-center">
                                                ...
                                                <h5 className="font-bold mb-4 text-yellow-900">Objected</h5>
                                            ...
                                            <div className="p-8 bg-red-50 rounded-3xl border border-red-100 shadow-sm text-center">
                                                ...
                                                <h5 className="font-bold mb-4 text-red-900">Show Cause Hearing</h5>
                                    ...
                                    <section id="case-laws" className="scroll-mt-32">
                                        ...
                                        <div className="bg-black text-white p-10 rounded-3x-l my-12 shadow-2xl relative overflow-hidden">
                                            ...
                                            <h4 className="text-2xl font-bold mb-6 text-[rgb(110,94,147)] uppercase tracking-widest">The Amritdhara Pharmacy Case</h4>
                                            ...
                                            <h4 className="text-2xl font-bold mb-6 text-[rgb(110,94,147)] uppercase tracking-widest">The Cadbury vs Lotus Case</h4>
                                    ...
                                    <section id="common-mistakes" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8">
                                            <div className="p-8 bg-gray-50 rounded-2xl border-l-4 border-red-500">
                                                <h5 className="font-bold text-lg mb-2">Changing the Mark</h5>
                                            ...
                                            <div className="p-8 bg-gray-50 rounded-2xl border-l-4 border-red-500">
                                                <h5 className="font-bold text-lg mb-2">Missing the Journal</h5>
                                            ...
                                            <div className="p-8 bg-gray-50 rounded-2xl border-l-4 border-red-500">
                                                <h5 className="font-bold text-lg mb-2">Ignoring Similar Filings</h5>
                                            ...
                                            <div className="p-8 bg-gray-50 rounded-2xl border-l-4 border-red-500">
                                                <h5 className="font-bold text-lg mb-2">Wrong Class Decisions</h5>
                                    ...
                                    <section className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[2.5rem] p-8 md:p-16 text-center text-white relative overflow-hidden mt-12 shadow-2xl">
                                        <div className="relative z-10">
                                            <h3 className="text-3xl md:text-5xl font-black mb-6 leading-tight">Expert Guidance for Your Examination</h3>
                        ...
                        <aside className="hidden lg:block space-y-8 sticky top-32 self-start">
                            <div className="bg-[#0C002B] p-8 rounded-3xl shadow-[0_20px_40px_rgba(0,0,0,0.1)] border border-gray-800 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-xl font-bold mb-4 relative z-10 leading-tight border-b border-white/10 pb-4">Need Help with Status?</h4>
                ...
                <div className="bg-gray-50 border-t border-gray-200 mt-20 pt-20 pb-20">
                    <div className="container mx-auto px-4 max-w-[1200px] text-center">
                        <h3 className="text-3xl md:text-4xl font-black text-gray-900 mb-12">What Our Clients Say</h3>
