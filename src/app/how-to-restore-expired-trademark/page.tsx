          ...
          <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_300px] gap-8 items-start">
            ...
            <aside className="hidden lg:block sticky top-32 h-[calc(100vh-160px)] overflow-y-auto">
              <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                <p className="text-gray-900 font-bold text-lg mb-6 border-l-4 border-[rgb(110,94,147)] pl-3 italic uppercase tracking-[0.2em] font-black decoration-[rgb(110,94,147)] underline underline-offset-4">Resurrection Map</p>
              ...
              <div className="bg-white p-4 md:p-12 rounded-2xl shadow-sm border border-gray-100 space-y-12 md:space-y-20">
                ...
                <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed font-normal">
                  ...
                  <section id="introduction" className="scroll-mt-32">
                    <h2 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-6 leading-tight uppercase font-black italic tracking-tighter decoration-[rgb(110,94,147)] decoration-4 underline-offset-8">Reclaiming Your Identity</h2>
                    <p className="mb-6">
                  ...
                  <section id="form-tm-r-guide" className="scroll-mt-32">
                    ...
                    <div className="bg-[#0C002B] text-white p-10 rounded-[3rem] shadow-2xl relative overflow-hidden my-12">
                       ...
                       <h5 className="text-xl font-black mb-4 uppercase italic">Technical Tip: The Digital Signature</h5>
                    ...
                    <div className="space-y-6">
                       {[
                         ...
                         <div key={i} className="flex gap-6 items-center p-6 bg-gray-50 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] transition-all">
                            ...
                            <div>
                               <h5 className="font-bold text-gray-900 uppercase italic text-sm">{step.title}</h5>
                  ...
                  <section id="preventive-measures" className="scroll-mt-32">
                    ...
                    <div className="grid md:grid-cols-2 gap-8 mb-10">
                       <div className="p-8 bg-gray-900 text-white rounded-[2rem] shadow-xl relative overflow-hidden group">
                          ...
                          <h5 className="font-extrabold mb-4 uppercase italic">Annual IP Health Check</h5>
                       ...
                       <div className="p-8 bg-gray-50 border border-gray-100 rounded-[2rem] shadow-sm">
                          <h5 className="font-extrabold mb-4 uppercase italic text-gray-900">Registry Syncing</h5>
                  ...
                  <section className="bg-gradient-to-br from-[#0C002B] to-[#1a0031] rounded-[4rem] p-10 md:p-20 text-center text-white relative overflow-hidden mt-12 shadow-[0_40px_100px_rgba(0,0,0,0.3)] group border border-white/5">
                     ...
                     <div className="relative z-10">
                        <h3 className="text-4xl md:text-6xl font-black mb-8 leading-tight uppercase italic tracking-tighter">Resurrect Your Legacy Today</h3>
            ...
            <aside className="hidden lg:block space-y-8 sticky top-32">
              ...
              <div className="bg-[#0C002B] p-8 rounded-3xl shadow-[0_30px_60px_rgba(0,0,0,0.2)] border border-gray-800 text-white relative overflow-hidden group">
                 ...
                 <h4 className="text-xl font-bold mb-4 relative z-10 leading-tight uppercase font-black italic tracking-[0.1em]">Restoration Alert</h4>
