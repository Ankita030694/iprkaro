                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[220px_1fr_300px] gap-4 md:gap-12 mt-8 items-start">
                        ...
                        <div className="min-w-0">
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-xl md:rounded-2xl shadow-sm border border-gray-100 prose prose-lg max-w-none text-gray-800 font-sans">
                                ...
                                <section id="introduction" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h2 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6">Scaling Your Brand in Bharat</h2>
                                ...
                                <section id="legal-framework" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">The Legal Foundation: Trade Marks Act 1999</h3>
                                    <p className="mb-4 leading-relaxed text-lg">
                                ...
                                <section id="benefits" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Strategic Benefits: Why Indian Businesses Must Register</h3>
                                    ...
                                    <ul className="space-y-6 my-10 list-none p-0">
                                        <li className="flex gap-4 p-6 bg-indigo-50 rounded-2xl border border-indigo-100 shadow-sm border-l-[10px] border-l-indigo-500">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-indigo-900 text-xl mb-2">Legal Remedy per Section 29</h5>
                                        ...
                                        <li className="flex gap-4 p-6 bg-indigo-50 rounded-2xl border border-indigo-100 shadow-sm border-l-[10px] border-l-indigo-500">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-indigo-900 text-xl mb-2">Builds Global Valuation</h5>
                                ...
                                <section id="types-of-trademarks" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">What Can You Register? The Spectrum of Indian Trademarks</h3>
                                    <p className="mb-6 leading-relaxed text-lg">
                                ...
                                <section id="step-by-step" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Step By Step: The Lifecycle of an Indian Trademark Application</h3>
                                    ...
                                    <div className="space-y-10 my-10">
                                        <div className="flex gap-6 items-start">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-[#160049] text-xl mb-2">Public Search & Classification</h5>
                                        ...
                                        <div className="flex gap-6 items-start">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-[#160049] text-xl mb-2">Online Filing (Form TM-A)</h5>
                                        ...
                                        <div className="flex gap-6 items-start">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-[#160049] text-xl mb-2">Departmental Examination</h5>
                                        ...
                                        <div className="flex gap-6 items-start">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-[#160049] text-xl mb-2">Show Cause Hearing (If Required)</h5>
                                        ...
                                        <div className="flex gap-6 items-start">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-[#160049] text-xl mb-2">Journal Publication</h5>
                                        ...
                                        <div className="flex gap-6 items-start">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-[#160049] text-xl mb-2">Final Certification</h5>
                                ...
                                <section id="docs-checklist" className="mb-12 scroll-mt-24 md:scroll-mt-32 text-gray-800">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Consolidated Checklist: Documents You Need</h3>
                                    <p className="mb-6 leading-relaxed text-lg">
                                    ...
                                    <div className="grid md:grid-cols-2 gap-8 my-10">
                                        <div className="bg-gray-50 p-8 rounded-3xl border border-gray-100">
                                            <h5 className="font-bold text-indigo-900 text-xl mb-4">For Individual Applicants</h5>
                                        ...
                                        <div className="bg-gray-50 p-8 rounded-3xl border border-gray-100">
                                            <h5 className="font-bold text-indigo-900 text-xl mb-4">For Corporate/Legal Entities</h5>
                                            <ul className="space-y-3">
                                ...
                                <section id="fee-structure" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Transparent Fees: Cost of Trademark Registration India</h3>
                                    <p className="mb-8 leading-relaxed text-lg">
                                    ...
                                    <div className="grid md:grid-cols-2 gap-8 my-12">
                                        <div className="p-8 bg-blue-50 rounded-3xl text-center border-b-8 border-b-blue-600 shadow-xl">
                                            ...
                                            <h5 className="text-[#0C002B] text-5xl font-bold mb-4">₹4,500 <span className="text-lg text-gray-500 font-normal">/class</span></h5>
                                        ...
                                        <div className="p-8 bg-gray-50 rounded-3xl text-center border-b-8 border-b-gray-400">
                                            ...
                                            <h5 className="text-gray-800 text-5xl font-bold mb-4">₹9,000 <span className="text-lg text-gray-400 font-normal">/class</span></h5>
                                ...
                                <section id="msme-startup" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Government Incentives for Small Enterprises</h3>
                                    <p className="mb-6 leading-relaxed text-lg">
                                    ...
                                    <div className="grid md:grid-cols-2 gap-6 my-10">
                                        <div className="p-6 bg-[#6E5E93]/10 rounded-2xl border border-[#6E5E93]/20">
                                            <h6 className="font-bold text-[#0C002B] mb-2 flex items-center">
                                ...
                                <section id="conclusion" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6 text-center">The Future of Your Brand in India</h3>
                                ...
                                <div className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[40px] p-10 md:p-20 text-center text-white relative overflow-hidden mt-20 shadow-2xl">
                                    <div className="relative z-10">
                                        <h3 className="text-3xl md:text-5xl font-bold mb-6">Build a Brand That Lasts</h3>
                        ...
                        <aside className="hidden lg:block space-y-10 sticky top-32">
                            ...
                            <div className="bg-[#0C002B] p-8 rounded-3xl shadow-xl border border-gray-800 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-2xl font-bold mb-4 relative z-10">Brand Safety Check</h4>
