          ...
          <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_300px] gap-8 items-start">
            ...
            <aside className="hidden lg:block sticky top-32 h-[calc(100vh-160px)] overflow-y-auto">
              <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                <p className="text-gray-900 font-bold text-lg mb-6 border-l-4 border-[rgb(110,94,147)] pl-3 italic uppercase tracking-[0.2em] font-black underline underline-offset-4 decoration-[rgb(110,94,147)]">Fast-Track Index</p>
              ...
              <div className="bg-white p-4 md:p-12 rounded-2xl shadow-sm border border-gray-100 space-y-12 md:space-y-20">
                <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed">
                  ...
                  <section id="introduction" className="scroll-mt-32">
                    ...
                    <div className="grid md:grid-cols-2 gap-8 my-10">
                      <div className="bg-red-50 p-8 rounded-3xl border border-red-100">
                        <h5 className="font-black text-red-900 mb-3 uppercase text-sm flex items-center gap-2">
                      ...
                      <div className="bg-green-50 p-8 rounded-3xl border border-green-100">
                        <h5 className="font-black text-green-900 mb-3 uppercase text-sm flex items-center gap-2">
                    ...
                    <div className="bg-purple-50 border-l-8 border-[rgb(110,94,147)] p-6 my-8 rounded-r-2xl shadow-sm">
                      <p className="text-base font-bold text-gray-800 leading-relaxed italic">
                        The <strong>expedited trademark filing process in India</strong> allows applicants to fast-track trademark examination under <strong>Rule 34 of the <a href="https://ipindia.gov.in/trade-marks-resources-rules" target="_blank" rel="noopener noreferrer" className="text-[rgb(110,94,147)] underline hover:no-underline">Trade Marks Rules, 2017</a></strong> by filing <strong>Form TM-M</strong> and paying an additional government fee of Rs. 20,000 (for individuals/MSMEs) or Rs. 40,000 (for companies). This compresses the typical 18 to 24-month registration timeline down to just 3 to 6 months.
                      </p>
                    </div>
                  ...
                  <section id="legal-basis" className="scroll-mt-32">
                    <h3 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-6 leading-tight uppercase italic tracking-tighter decoration-[rgb(110,94,147)] decoration-4 underline-offset-8">
                      Legal Basis: Rule 34 of the Trade Marks Rules, 2017
                    </h3>
                    <p className="mb-6">
                      The expedited trademark registration process is not an informal shortcut. It is a formally codified legal remedy under <strong>Rule 34 of the Trade Marks Rules, 2017</strong>. The rule, titled "Expedited Examination of Application," was introduced to provide a structured, transparent pathway for applicants who need priority processing. You can read the full text of the <a href="https://ipindia.gov.in/trade-marks-resources-rules" target="_blank" rel="noopener noreferrer" className="text-[rgb(110,94,147)] underline font-bold hover:no-underline">Trade Marks Rules, 2017</a> on the official government portal.
                    </p>
                    <p className="mb-6">
                    ...
                    <div className="bg-[#0C002B] text-white p-10 rounded-[3rem] shadow-2xl relative overflow-hidden my-12">
                      ...
                      <h5 className="text-xl font-black mb-4 uppercase italic">The Key Distinction</h5>
                    ...
                    <div className="space-y-6 mb-10">
                      {[
                        ...
                        <div key={i} className="flex gap-6 bg-gray-50 p-6 rounded-2xl border border-gray-100 hover:border-[rgb(110,94,147)] transition-all">
                          ...
                          <div>
                            <h5 className="font-black text-gray-900 text-sm uppercase mb-2">{item.title}</h5>
                  ...
                  <section id="eligibility" className="scroll-mt-32">
                    ...
                    <div className="grid md:grid-cols-2 gap-8 mb-10">
                      <div className="bg-blue-50 p-8 rounded-3xl border border-blue-100">
                        <h5 className="font-black text-blue-900 mb-4 uppercase text-sm">Reduced Fee Category (Rs. 20,000 additional)</h5>
                      ...
                      <div className="bg-gray-50 p-8 rounded-3xl border border-gray-200">
                        <h5 className="font-black text-gray-900 mb-4 uppercase text-sm">Standard Fee Category (Rs. 40,000 additional)</h5>
                        <ul className="space-y-2">
                          {[
                  ...
                  <section id="fast-track-vs-standard" className="scroll-mt-32">
                    <h3 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-6 leading-tight uppercase italic tracking-tighter decoration-[rgb(110,94,147)] decoration-4 underline-offset-8 text-center">
                    ...
                    <div className="space-y-6">
                      {[
                        ...
                        <div key={item.step} className="flex gap-6 items-start p-6 bg-gray-50 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all">
                          ...
                          <div>
                            <h5 className="font-black text-gray-900 uppercase text-sm mb-2">{item.title}</h5>
                            <p className="text-xs text-gray-600 font-bold italic leading-relaxed">{item.desc}</p>
                          </div>
                        </div>
                      ))}
                      ...
                      {[
                        ...
                        <div key={i} className="flex gap-8 items-start relative">
                          ...
                          <div className={`bg-gray-50 p-6 rounded-2xl flex-1 border-l-8 ${item.color.replace('bg-', 'border-')}`}>
                            <h4 className="font-black text-gray-900 mb-1 uppercase text-sm">{item.title}</h4>
                  ...
                  <section id="faqs" className="scroll-mt-32">
                    <h3 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-12 text-center uppercase tracking-tighter underline underline-offset-[12px] decoration-[rgb(110,94,147)] decoration-8">
                  ...
                  <section id="reviews" className="scroll-mt-32 pt-12">
                    <h3 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-12 text-center uppercase tracking-tighter">
                  ...
                  <section className="bg-gradient-to-br from-[#0C002B] to-[#1a0031] rounded-[4rem] p-10 md:p-20 text-center text-white relative overflow-hidden mt-12 shadow-[0_40px_100px_rgba(0,0,0,0.3)] group border border-white/5">
                    ...
                    <div className="relative z-10">
                      <h3 className="text-4xl md:text-6xl font-black mb-8 leading-tight uppercase italic tracking-tighter">Register in Months, Not Years</h3>
            ...
            <aside className="hidden lg:block space-y-8 sticky top-32">
              <div className="bg-[#0C002B] p-8 rounded-3xl shadow-[0_30px_60px_rgba(0,0,0,0.2)] border border-gray-800 text-white relative overflow-hidden group">
                ...
                <h4 className="text-xl font-bold mb-4 relative z-10 leading-tight uppercase font-black italic tracking-[0.1em]">Get a Fast-Track Quote</h4>
              ...
              <div className="bg-gray-50 p-8 rounded-3xl shadow-sm border border-gray-100">
                <h4 className="text-sm font-black text-gray-400 mb-6 border-b-2 border-gray-100 pb-4 uppercase tracking-widest italic">Related Guides</h4>
