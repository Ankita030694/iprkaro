              ...
              <div className="bg-white p-4 md:p-12 rounded-2xl shadow-sm border border-gray-100 space-y-12 md:space-y-20">
                <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed">
                  ...
                  <section id="introduction" className="scroll-mt-32">
                    ...
                    <div className="bg-purple-50 border-l-8 border-[rgb(110,94,147)] p-6 my-8 rounded-r-2xl shadow-sm">
                      <p className="text-base font-bold text-gray-800 leading-relaxed italic">
                        The <strong>expedited trademark filing process in India</strong> allows applicants to fast-track trademark examination under <strong>Rule 34 of the <a href="https://ipindia.gov.in/rules-trademarks.htm" target="_blank" rel="noopener noreferrer" className="text-[rgb(110,94,147)] underline hover:no-underline">Trade Marks Rules, 2017</a></strong> by filing <strong>Form TM-M</strong> and paying an additional government fee of Rs. 20,000 (for individuals/MSMEs) or Rs. 40,000 (for companies). This compresses the typical 18 to 24-month registration timeline down to just 3 to 6 months.
                      </p>
                    </div>
                  ...
                  <section id="legal-basis" className="scroll-mt-32">
                    ...
                    <p className="mb-6">
                      The expedited trademark registration process is not an informal shortcut. It is a formally codified legal remedy under <strong>Rule 34 of the Trade Marks Rules, 2017</strong>. The rule, titled "Expedited Examination of Application," was introduced to provide a structured, transparent pathway for applicants who need priority processing. You can read the full text of the <a href="https://ipindia.gov.in/rules-trademarks.htm" target="_blank" rel="noopener noreferrer" className="text-[rgb(110,94,147)] underline font-bold hover:no-underline">Trade Marks Rules, 2017</a> on the official government portal.
                    </p>
                    <p className="mb-6">
