                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_320px] gap-4 md:gap-12 mt-8 items-start">
                        ...
                        <div className="min-w-0">
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-xl md:rounded-2xl shadow-sm border border-gray-100 prose prose-lg max-w-none text-gray-800 font-sans">
                                ...
                                <section id="introduction" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h2 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6">Why Logo Protection Matters</h2>
                                ...
                                <section id="government-fees" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">The Official Price Tag: Understanding Government Fees</h3>
                                ...
                                <section id="applicant-types" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Cost Tiers for Individuals, Startups, and MSMEs</h3>
                                    <p className="mb-6 leading-relaxed text-lg text-justify">
                                ...
                                <section id="professional-fees" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">The Professional Variable: Attorney and Agent Fees</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify">
                                    ...
                                    <div className="grid md:grid-cols-3 gap-6 my-10">
                                        <div className="p-8 bg-gray-50 rounded-[2rem] border border-gray-100 flex flex-col h-full text-center">
                                            ...
                                            <h5 className="font-bold text-xl mb-3 text-[#0C002B]">Basic Filing</h5>
                                        ...
                                        <div className="p-8 bg-[#0C002B] rounded-[2rem] border border-[#6E5E93] shadow-xl text-white flex flex-col h-full text-center relative">
                                            ...
                                            <h5 className="font-bold text-xl mb-3">Comprehensive</h5>
                                        ...
                                        <div className="p-8 bg-gray-50 rounded-[2rem] border border-gray-100 flex flex-col h-full text-center">
                                            ...
                                            <h5 className="font-bold text-xl mb-3">Full Prosecution</h5>
                                ...
                                <section id="rebate-benefits" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6 text-center">Unlocking the Rebates: 50% Savings for Small Entities</h3>
                                        ...
                                        <div className="relative z-10">
                                            ...
                                            <div className="grid md:grid-cols-2 gap-8">
                                                <div className="bg-white/10 p-6 rounded-2xl backdrop-blur-sm border border-white/20">
                                                    <h5 className="font-bold text-xl mb-2 flex items-center gap-3">
                                ...
                                <section id="sipp-scheme" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">SIPP Scheme: Free Professional Support for Startups</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify">
                                ...
                                <section id="hidden-costs" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Hidden Costs: Searches, Objections, and Oppositions</h3>
                                    <p className="mb-6 leading-relaxed text-lg text-justify">
                                    ...
                                    <div className="grid md:grid-cols-2 gap-8 my-10">
                                        <div className="p-6 bg-red-50 rounded-2xl border border-red-100 border-l-8 border-l-red-500">
                                            <h5 className="font-bold text-red-700 text-xl mb-3"><FontAwesomeIcon icon={faExclamationTriangle} className="mr-2" /> Objections (Sec 9/11)</h5>
                                        ...
                                        <div className="p-6 bg-yellow-50 rounded-2xl border border-yellow-100 border-l-8 border-l-yellow-500">
                                            <h5 className="font-bold text-yellow-700 text-xl mb-3"><FontAwesomeIcon icon={faGavel} className="mr-2" /> Oppositions</h5>
                                        ...
                                        <div className="p-6 bg-blue-50 rounded-2xl border border-blue-100 border-l-8 border-l-blue-500">
                                            <h5 className="font-bold text-blue-700 text-xl mb-3"><FontAwesomeIcon icon={faSearch} className="mr-2" /> Forensic Search</h5>
                                        ...
                                        <div className="p-6 bg-indigo-50 rounded-2xl border border-indigo-100 border-l-8 border-l-indigo-500">
                                            <h5 className="font-bold text-indigo-700 text-xl mb-3"><FontAwesomeIcon icon={faHistory} className="mr-2" /> Rectifications</h5>
                                ...
                                <section id="renewal-costs" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">The Long Term Outlook: Trademark Renewal Costs</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify">
                                ...
                                <section id="efiling-vs-physical" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Digital Economy: e-Filing vs. Physical Filing Costs</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify">
                                    ...
                                    <ul className="space-y-4 my-10 list-none p-0">
                                        <li className="flex gap-4 p-6 bg-gray-50 rounded-2xl border border-gray-200 group hover:border-[#6E5E93] transition-colors">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-[#0C002B] text-xl mb-1">e-Filing (The Smart Choice)</h5>
                                        ...
                                        <li className="flex gap-4 p-6 bg-gray-50 rounded-2xl border border-gray-200 group opacity-70">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-[#0C002B] text-xl mb-1">Physical Filing (Obsolete)</h5>
                                ...
                                <section id="global-costs" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Going Global: Madrid Protocol Cost Overview</h3>
                                ...
                                <section id="why-iprkaro" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6 text-center">IPRKaro: Maximizing ROI on Your Brand Security</h3>
                                    ...
                                    <div className="grid md:grid-cols-2 gap-8 my-10">
                                        <div className="flex gap-4 items-start">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-[#0C002B] text-xl mb-1">Transparent Pricing</h5>
                                        ...
                                        <div className="flex gap-4 items-start">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-[#0C002B] text-xl mb-1">Strategic Class Mapping</h5>
                                ...
                                <section id="conclusion" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6 text-center">Conclusion: Securing Your Mark for the Future</h3>
                                ...
                                <div className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[40px] p-10 md:p-20 text-center text-white relative overflow-hidden mt-20 shadow-2xl">
                                    <div className="relative z-10">
                                        <h3 className="text-3xl md:text-5xl font-bold mb-6">Secure Your Brand Today</h3>
                        ...
                        <aside className="hidden lg:block space-y-10 sticky top-32">
                            ...
                            <div className="bg-[#0C002B] p-8 rounded-3xl shadow-xl border border-gray-800 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-2xl font-bold mb-4 relative z-10">Fee Calculator</h4>
                            ...
                            <div className="bg-gray-50 p-8 rounded-3xl shadow-sm border border-gray-100">
                                <h4 className="text-xl font-bold text-[#0C002B] mb-6 border-b pb-4 text-justify">Pricing Resources</h4>
