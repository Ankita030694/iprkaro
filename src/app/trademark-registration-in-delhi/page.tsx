          ...
          <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr_320px] gap-8 items-start">
            ...
            <aside className="hidden lg:block sticky top-32">
               <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                  <p className="text-gray-900 font-bold text-lg mb-6 border-l-4 border-[rgb(110,94,147)] pl-3">Delhi TM Guide</p>
               ...
               <div className="bg-white p-4 md:p-12 rounded-2xl shadow-sm border border-gray-100 space-y-12 md:space-y-20 article-content">
                  ...
                  <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed font-normal">
                      ...
                      <div className="relative space-y-16">
                         ...
                         <div className="flex flex-col lg:flex-row gap-10 items-start relative group">
                            ...
                            <div className="bg-gray-50 p-10 rounded-3xl flex-1 border border-transparent group-hover:border-[rgb(110,94,147)] transition-all shadow-sm">
                               <h4 className="text-2xl font-bold mb-4 text-gray-900">1. Delhi Pre-Filing Clearance Search</h4>
                         ...
                         <div className="flex flex-col lg:flex-row gap-10 items-start relative group">
                            ...
                            <div className="bg-gray-50 p-10 rounded-3xl flex-1 border border-transparent group-hover:border-[rgb(110,94,147)] transition-all shadow-sm">
                               <h4 className="text-2xl font-bold mb-4 text-gray-900">2. Expert Drafting & e-Filing (Form TM-A)</h4>
                               <p className="text-lg leading-relaxed text-gray-600">
                         ...
                         <div className="flex flex-col lg:flex-row gap-10 items-start relative group">
                            ...
                            <div className="bg-gray-50 p-10 rounded-3xl flex-1 border border-transparent group-hover:border-[rgb(110,94,147)] transition-all shadow-sm">
                               <h4 className="text-2xl font-bold mb-4 text-gray-900">3. Examination & Response Handling</h4>
                               <p className="text-lg leading-relaxed text-gray-600">
                         ...
                         <div className="flex flex-col lg:flex-row gap-10 items-start relative group">
                            ...
                            <div className="bg-gray-50 p-10 rounded-3xl flex-1 border border-transparent group-hover:border-[rgb(110,94,147)] transition-all shadow-sm">
                               <h4 className="text-2xl font-bold mb-4 text-gray-900">4. Journal Publication & Opposition</h4>
                               <p className="text-lg leading-relaxed text-gray-600">
                         ...
                         <div className="flex flex-col lg:flex-row gap-10 items-start relative group">
                            ...
                            <div className="bg-gray-50 p-10 rounded-3xl flex-1 border border-transparent group-hover:border-[rgb(110,94,147)] transition-all shadow-sm">
                               <h4 className="text-2xl font-bold mb-4 text-gray-900">5. Final Registration & Protection</h4>
                               <p className="text-lg leading-relaxed text-gray-600">
                    ...
                    <section id="conclusion-delhi-ip" className="scroll-mt-32">
                       <h3 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-6 leading-tight uppercase tracking-widest text-center border-t border-b border-gray-100 py-10">
                    ...
                    <section id="documents-checklist-delhi" className="scroll-mt-32">
                      ...
                      <div className="grid md:grid-cols-2 gap-8">
                         <div className="p-8 bg-white border border-gray-100 rounded-3xl shadow-sm hover:shadow-md transition-shadow">
                            ...
                            <h5 className="text-xl font-bold text-gray-900 mb-4">Startups & MSMEs</h5>
                         ...
                         <div className="p-8 bg-white border border-gray-100 rounded-3xl shadow-sm hover:shadow-md transition-shadow">
                            <div className="w-12 h-12 bg-purple-100 text-purple-600 rounded-2xl flex items-center justify-center mb-6">
                             ...
                             <h5 className="text-xl font-bold text-gray-900 mb-4">Individuals & Proprietors</h5>
                             <ul className="space-y-3">
                    ...
                    <section id="objection-handling-delhi" className="scroll-mt-32">
                      ...
                      <div className="grid md:grid-cols-2 gap-8 mb-10">
                         <div className="p-8 bg-red-50 rounded-3xl border-l-8 border-red-500 shadow-sm relative overflow-hidden group">
                             ...
                             <h5 className="text-xl font-bold text-red-900 mb-4 relative z-10 font-black">Section 9: Descriptive Marks</h5>
                         ...
                         <div className="p-8 bg-blue-50 rounded-3xl border-l-8 border-blue-500 shadow-sm relative overflow-hidden group">
                             ...
                             <h5 className="text-xl font-bold text-blue-900 mb-4 relative z-10 font-black">Section 11: Similar Marks</h5>
                             <p className="text-gray-700 text-sm relative z-10 leading-relaxed italic">
                     ...
                     <section id="benefits-delhi-startups" className="scroll-mt-32">
                        ...
                        <div className="grid md:grid-cols-3 gap-6 mb-10">
                           <div className="p-6 bg-gray-50 rounded-2xl border-b-4 border-[rgb(110,94,147)] hover:-translate-y-2 transition-transform">
                              <h5 className="font-bold mb-2">Immediate Use of ™</h5>
                           ...
                           <div className="p-6 bg-gray-50 rounded-2xl border-b-4 border-[rgb(110,94,147)] hover:-translate-y-2 transition-transform">
                              <h5 className="font-bold mb-2">Asset Creation</h5>
                           ...
                           <div className="p-6 bg-gray-50 rounded-2xl border-b-4 border-[rgb(110,94,147)] hover:-translate-y-2 transition-transform">
                              <h5 className="font-bold mb-2">Global Potential</h5>
                    ...
                    <section className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[3rem] p-10 md:p-20 text-center text-white relative overflow-hidden mt-16 shadow-2xl border border-white/5 border-t-white/10 group">
                       ...
                       <div className="relative z-10">
                          ...
                          <h3 className="text-4xl md:text-6xl font-black mb-8 leading-tight">Start Your Delhi <br /> Trademark Filing Today</h3>
            ...
            <aside className="hidden lg:block space-y-8 sticky top-32">
               ...
               <div className="bg-[#0C002B] p-10 rounded-[2.5rem] shadow-2xl border border-white/5 text-white relative overflow-hidden group">
                  ...
                  <h4 className="text-2xl font-black mb-6 relative z-10 leading-tight">Free Brand Search in Delhi</h4>
