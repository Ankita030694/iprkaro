...
const tocSections = [
    { id: 'introduction', title: 'Reasons for Trademark Rejection' },
    { id: 'absolute-grounds', title: 'Reasons for Trademark Rejection' },
    { id: 'lack-of-distinctiveness', title: 'Reasons for Trademark Rejection' },
    { id: 'descriptive-marks', title: 'Reasons for Trademark Rejection' },
    { id: 'public-order', title: 'Reasons for Trademark Rejection' },
    { id: 'relative-grounds', title: 'Reasons for Trademark Rejection' },
    { id: 'deceptive-similarity', title: 'Reasons for Trademark Rejection' },
    { id: 'well-known-marks', title: 'Reasons for Trademark Rejection' },
    { id: 'procedural-errors', title: 'Reasons for Trademark Rejection' },
    { id: 'how-to-respond', title: 'Reasons for Trademark Rejection' },
    { id: 'reviews', title: 'Reasons for Trademark Rejection' },
    { id: 'faqs', title: 'Reasons for Trademark Rejection' },
];
...
export default function TrademarkRejectionReasonsPage() {
    ...
    const articleSchema = {
        "@context": "https://schema.org",
        "@type": "Article",
        "headline": "Reasons for Trademark Rejection",
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_300px] gap-8 items-start">
                        ...
                        <aside className="hidden lg:block sticky top-32 h-[calc(100vh-160px)] overflow-y-auto">
                            <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                                <p className="text-gray-900 font-bold text-lg mb-6 border-l-4 border-[rgb(110,94,147)] pl-3">Legal Index</p>
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-2xl shadow-sm border border-gray-100 space-y-12 md:space-y-20">
                                ...
                                <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed font-normal">
                                    ...
                                    <section id="introduction" className="scroll-mt-32">
                                        <h2 className="text-2xl md:text-4xl lg:text-5xl font-black text-gray-900 mb-8 leading-tight">Navigating Trademark Borders</h2>
                                        <p className="mb-6">
                                    ...
                                    <section id="absolute-grounds" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8 mb-12">
                                            <div className="bg-gray-50 p-8 rounded-3xl border border-transparent hover:border-[rgb(110,94,147)] transition-all shadow-sm group">
                                                ...
                                                <h4 className="font-bold text-lg mb-2 text-gray-900 uppercase">Non-Distinctive</h4>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-3xl border border-transparent hover:border-[rgb(110,94,147)] transition-all shadow-sm group">
                                                ...
                                                <h4 className="font-bold text-lg mb-2 text-gray-900 uppercase">Descriptive</h4>
                                    ...
                                    <section id="lack-of-distinctiveness" className="scroll-mt-32">
                                        ...
                                        <div className="bg-gray-50 border-l-8 border-[rgb(110,94,147)] p-10 my-10 rounded-r-3xl">
                                            <h5 className="font-black text-gray-900 mb-4">The 'Primary Meaning' Problem</h5>
                                    ...
                                    <section id="public-order" className="scroll-mt-32">
                                        ...
                                        <div className="space-y-6 mb-12">
                                            <div className="flex bg-white p-8 rounded-3xl border border-gray-100 shadow-sm relative overflow-hidden group">
                                                ...
                                                <div>
                                                    <h5 className="text-xl font-black mb-2 uppercase">Official Prohibitions</h5>
                                            ...
                                            <div className="flex bg-white p-8 rounded-3xl border border-gray-100 shadow-sm relative overflow-hidden group">
                                                ...
                                                <div>
                                                    <h5 className="text-xl font-black mb-2 uppercase">Religious Sentiments</h5>
                                    ...
                                    <section id="relative-grounds" className="scroll-mt-32 pt-20">
                                        ...
                                        <div className="bg-gray-900 text-white p-12 rounded-[3.5rem] my-16 shadow-2xl relative overflow-hidden group border border-white/5">
                                            ...
                                            <h5 className="text-3xl font-black mb-6 uppercase tracking-wider relative z-10">The Confusion Test</h5>
                                    ...
                                    <section id="well-known-marks" className="scroll-mt-32 pt-16">
                                        ...
                                        <div className="bg-red-50 border-2 border-red-500/20 p-10 rounded-3xl relative overflow-hidden group">
                                            ...
                                            <h5 className="font-black text-red-900 mb-4 uppercase tracking-widest flex items-center">
                                    ...
                                    <section id="procedural-errors" className="scroll-mt-32 pt-20">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8 mb-12">
                                            <div className="bg-white border p-10 rounded-[2.5rem] shadow-sm hover:border-[rgb(157,78,221)] transition-all group">
                                                ...
                                                <h5 className="font-bold text-gray-900 mb-2 uppercase text-sm">Wrong Applicant Info</h5>
                                            ...
                                            <div className="bg-white border p-10 rounded-[2.5rem] shadow-sm hover:border-[rgb(157,78,221)] transition-all group">
                                                ...
                                                <h5 className="font-bold text-gray-900 mb-2 uppercase text-sm">Incorrect Classification</h5>
                                            ...
                                            <div className="bg-white border p-10 rounded-[2.5rem] shadow-sm hover:border-[rgb(157,78,221)] transition-all group">
                                                ...
                                                <h5 className="font-bold text-gray-900 mb-2 uppercase text-sm">Vague Descriptions</h5>
                                            ...
                                            <div className="bg-white border p-10 rounded-[2.5rem] shadow-sm hover:border-[rgb(157,78,221)] transition-all group">
                                                ...
                                                <h5 className="font-bold text-gray-900 mb-2 uppercase text-sm">Defective Power of Attorney</h5>
                                        ...
                                        <div className="bg-white border-2 border-gray-100 p-12 rounded-[3rem] shadow-sm">
                                            <div className="space-y-8">
                                                <div className="flex items-start">
                                                    ...
                                                    <div>
                                                        <h6 className="font-black text-gray-900 mb-2">The Written Reply</h6>
                                                ...
                                                <div className="flex items-start">
                                                    ...
                                                    <div>
                                                        <h6 className="font-black text-gray-900 mb-2">The User Affidavit</h6>
                                                ...
                                                <div className="flex items-start">
                                                    ...
                                                    <div>
                                                        <h6 className="font-black text-gray-900 mb-2">Consent Letters</h6>
                                    ...
                                    <section id="reviews" className="scroll-mt-32 pt-12">
                                        <h3 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-12 text-center underline decoration-[rgb(157,78,221)] decoration-4 underline-offset-8">
                                    ...
                                    <section id="faqs" className="scroll-mt-32">
                                        <h3 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-12 text-center underline decoration-[rgb(110,94,147)] decoration-4 underline-offset-8">
                                            Expert Legal FAQs
                                        </h3>
                                        <div className="space-y-4">
                                            {faqs.map((faq, index) => (
                                    ...
                                    <section className="bg-black text-white p-12 rounded-[4rem] my-16 shadow-2xl relative overflow-hidden group border border-white/5">
                                        ...
                                        <h3 className="text-3xl md:text-5xl font-black mb-8 leading-tight relative z-10">Don't Let Rejection Hurt Your Brand</h3>
                        ...
                        <aside className="hidden lg:block space-y-8 sticky top-32">
                            ...
                            <div className="bg-[#0C002B] p-8 rounded-3xl shadow-[0_20px_40px_rgba(0,0,0,0.1)] border border-gray-800 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-xl font-bold mb-4 relative z-10">Facing a TM Objection?</h4>
                            ...
                            <div className="bg-gray-50 p-8 rounded-3xl shadow-sm border border-gray-100">
                                <h4 className="text-lg font-black text-gray-900 mb-6 border-b-2 border-[rgb(110,94,147)] pb-4 uppercase tracking-widest">Related Guides</h4>
