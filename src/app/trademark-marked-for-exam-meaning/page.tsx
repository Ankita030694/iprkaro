...
const tocSections = [
    { id: 'introduction', title: 'Trademark Marked for Exam Meaning' },
    { id: 'meaning-explained', title: 'Trademark Marked for Exam Meaning' },
    { id: 'exam-vs-formalities', title: 'Trademark Marked for Exam Meaning' },
    { id: 'examiner-checklist', title: 'Trademark Marked for Exam Meaning' },
    { id: 'section-9-depth', title: 'Trademark Marked for Exam Meaning' },
    { id: 'section-11-depth', title: 'Trademark Marked for Exam Meaning' },
    { id: 'examination-report', title: 'Trademark Marked for Exam Meaning' },
    { id: 'timelines', title: 'Trademark Marked for Exam Meaning' },
    { id: 'success-strategies', title: 'Trademark Marked for Exam Meaning' },
    { id: 'faqs', title: 'Trademark Marked for Exam Meaning' },
];
...
export default function TrademarkMarkedForExamPage() {
    ...
    const articleSchema = {
        "@context": "https://schema.org",
        "@type": "Article",
        "headline": "Trademark Marked for Exam Meaning",
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_300px] gap-8 items-start">
                        ...
                        <aside className="hidden lg:block sticky top-32">
                            <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                                <p className="text-gray-900 font-bold text-lg mb-6 border-l-4 border-[rgb(110,94,147)] pl-3">Guide Chapters</p>
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-2xl shadow-sm border border-gray-100 space-y-12 md:space-y-20">
                                ...
                                <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed font-normal">
                                    ...
                                    <section id="introduction" className="scroll-mt-32">
                                        <h2 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-6 leading-tight">The Examination Milestones in Trademark Law</h2>
                                        <p className="mb-6">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8 mb-10">
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                                <div className="text-[rgb(110,94,147)] mb-4 flex items-center">
                                                    ...
                                                    <h4 className="font-bold text-xl text-gray-900">The Human Review</h4>
                                                </div>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                                <div className="text-[rgb(110,94,147)] mb-4 flex items-center">
                                                    ...
                                                    <h4 className="font-bold text-xl text-gray-900">Database Cross-Checking</h4>
                                                </div>
                                    ...
                                    <section id="exam-vs-formalities" className="scroll-mt-32">
                                        ...
                                        <div className="bg-gray-100 p-8 rounded-3xl my-10 border border-gray-200 shadow-inner">
                                            <h4 className="text-xl font-bold mb-4 text-gray-900 uppercase tracking-tighter">The Progression Chart</h4>
                                        ...
                                        <div className="relative space-y-12">
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900">Criterion 1: Distinctive Character</h4>
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900">Criterion 2: Phonetic & Visual Similarity</h4>
                                                    <p className="text-base text-gray-600 mb-4">
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900">Criterion 3: Public Deception & Prohibitions</h4>
                                                    <p className="text-base text-gray-600 mb-4">
                                    ...
                                    <section id="section-9-depth" className="scroll-mt-32">
                                        ...
                                        <div className="bg-black text-white p-10 rounded-3xl my-10 shadow-2xl">
                                            <h4 className="text-2xl font-bold mb-4 text-[rgb(110,94,147)] uppercase">The 'User' Proof</h4>
                                    ...
                                    <section id="timelines" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8">
                                            <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100 flex flex-col items-center text-center shadow-sm">
                                                ...
                                                <h5 className="font-bold text-xl mb-4">Standard Processing Time</h5>
                                            ...
                                            <div className="p-8 bg-[rgb(110,94,147)] text-white rounded-3xl shadow-xl flex flex-col items-center text-center">
                                                ...
                                                <h5 className="font-bold text-xl mb-4 text-white">How to Speed Things Up?</h5>
                                    ...
                                    <section id="success-strategies" className="scroll-mt-32">
                                        ...
                                        <div className="bg-gray-50 p-8 rounded-3xl border border-gray-100 mb-10 shadow-sm">
                                           <div className="flex items-start mb-6">
                                                ...
                                                <div>
                                                    <h4 className="font-bold text-xl text-gray-900">Compile Your Marketing History</h4>
                                           ...
                                           <div className="flex items-start mb-6">
                                                ...
                                                <div>
                                                    <h4 className="font-bold text-xl text-gray-900">Audit Your Invoices</h4>
                                           ...
                                           <div className="flex items-start">
                                                ...
                                                <div>
                                                    <h4 className="font-bold text-xl text-gray-900">Monitor Competitors</h4>
                                    ...
                                    <section id="search-metrics" className="scroll-mt-32">
                                        ...
                                        <div className="bg-gray-50 p-8 rounded-2xl border border-gray-100 my-10">
                                            <div className="flex items-center mb-4 text-[rgb(110,94,147)]">
                                                ...
                                                <h4 className="font-bold text-xl text-gray-900">The Overlap Factor</h4>
                                            </div>
                                    ...
                                    <section id="international-comparison" className="scroll-mt-32">
                                        ...
                                        <div className="bg-blue-50 border-l-8 border-[rgb(110,94,147)] p-8 my-10 rounded-r-2xl shadow-sm">
                                            <div className="flex items-center mb-4 text-blue-900">
                                                ...
                                                <h4 className="font-bold text-xl">Global Harmonization</h4>
                                            </div>
                                    ...
                                    <section className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[2.5rem] p-8 md:p-16 text-center text-white relative overflow-hidden mt-12 shadow-2xl">
                                        <div className="relative z-10">
                                            <h3 className="text-3xl md:text-5xl font-black mb-6 leading-tight">Is Your Application Stuck in Examination?</h3>
                        ...
                        <aside className="hidden lg:block space-y-8 sticky top-32">
                            <div className="bg-[#0C002B] p-8 rounded-3xl shadow-[0_20px_40px_rgba(0,0,0,0.1)] border border-gray-800 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-xl font-bold mb-4 relative z-10 leading-tight">Got an Objection?</h4>
                            ...
                            <div className="bg-gray-50 p-8 rounded-3xl shadow-sm border border-gray-100">
                                <h4 className="text-lg font-black text-gray-900 mb-6 border-b-2 border-[rgb(110,94,147)] pb-4 uppercase tracking-widest">Trademark Milestones</h4>
                                <ul className="space-y-4">
                                    <li>
