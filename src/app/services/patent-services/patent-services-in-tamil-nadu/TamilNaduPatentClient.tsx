...
export default function TamilNaduPatentClient() {
  ...
  const processSteps = [
    {
      ...
      description: "Checking existing patents to ensure novelty, crucial for Chennai's competitive automotive and tech sectors."
    },
    {
      step: "Drafting Specification",
      description: "Detailed technical drafting. For software (SaaS) and manufacturing patents, precise claims are vital."
    },
    {
      step: "Filing at Chennai Patent Office",
      description: "Submission to the Chennai jurisdiction (IP Building, Guindy). We handle both physical and e-filing."
    },
    {
      step: "Examination & FER Response",
      description: "Addressing objections from the Controller. Our experts specialize in technical arguments."
    },
    {
      step: "Grant & Maintenance",
      description: "Patent grant and subsequent renewal management for the full 20-year term."
    }
  ];
  ...
  return (
    <div className="min-h-screen relative overflow-x-hidden mt-20" style={{ 
      ...
      <TableOfContents activeSection={activeSection} stateName="Tamil Nadu" />
        ...
        <div className="container mx-auto px-3 sm:px-4 lg:px-5 xl:px-6 2xl:px-8 max-w-7xl">
          <div className={`text-center mb-8 lg:mb-10 transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <p className="text-white/90 font-nunito text-xs md:text-sm lg:text-sm xl:text-sm leading-relaxed max-w-3xl mx-auto mb-5">
              Protecting innovations in the Manufacturing & SaaS Capital. Expert patent filing services for <span className="text-[#FFB703] font-semibold">Chennai's Industries</span> and Coimbatore's Textile hubs.
            </p>
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 mb-4">
              <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/5 backdrop-blur-sm border border-white/10">
                <i className="fas fa-car text-[#FFB703] text-xs" aria-hidden="true"></i>
                <span className="text-white text-[10px] lg:text-xs font-nunito font-medium">Automotive Patents</span>
              </div>
              <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/5 backdrop-blur-sm border border-white/10">
                <i className="fas fa-laptop-code text-[#FFB703] text-xs" aria-hidden="true"></i>
                <span className="text-white text-[10px] lg:text-xs font-nunito font-medium">SaaS/Software IP</span>
              </div>
              <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/5 backdrop-blur-sm border border-white/10">
                <i className="fas fa-industry text-[#FFB703] text-xs" aria-hidden="true"></i>
                <span className="text-white text-[10px] lg:text-xs font-nunito font-medium">Manufacturing</span>
              </div>
              <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/5 backdrop-blur-sm border border-white/10">
                <i className="fas fa-balance-scale text-[#FFB703] text-xs" aria-hidden="true"></i>
                <span className="text-white text-[10px] lg:text-xs font-nunito font-medium">Chennai Registry</span>
              </div>
            </div>
                  ...
                  <div className="space-y-3 lg:space-y-4 xl:space-y-5">
                    <div className="flex items-center gap-2 lg:gap-3 xl:gap-4">
                      ...
                      <h2 className="text-white font-nunito text-base md:text-lg lg:text-xl xl:text-2xl 2xl:text-3xl font-bold">
                        Patent Registration in Tamil Nadu
                      </h2>
                    </div>
                    <div className="group relative p-4 lg:p-5 xl:p-6 2xl:p-8 rounded-lg lg:rounded-xl xl:rounded-2xl backdrop-blur-sm transition-all duration-500 hover:scale-[1.01]" style={{ background: 'linear-gradient(135deg, rgba(255, 255, 255, 0.08) 0%, rgba(255, 255, 255, 0.02) 100%)', border: '1px solid rgba(255, 255, 255, 0.1)', boxShadow: '0 8px 32px rgba(0, 0, 0, 0.3)' }}>
                      <p className="relative text-white/95 font-nunito text-sm md:text-sm lg:text-sm xl:text-sm 2xl:text-lg leading-relaxed mb-4">
                        Tamil Nadu, a powerhouse of industrial growth, is home to the <strong>Chennai Patent Office</strong> in Guindy. From the automotive giants in Oragadam to the SaaS unicorns on OMR, innovation is in the state's DNA.
                      </p>
                      <p className="relative text-white/95 font-nunito text-sm md:text-sm lg:text-sm xl:text-sm 2xl:text-lg leading-relaxed">
                        Our patent services are tailored for Tamil Nadu's unique ecosystem. We assist manufacturing units in Coimbatore protect their machinery designs and software companies in Chennai secure their algorithms (Computer Related Inventions), ensuring robust protection under Indian Patent Law.
                      </p>
                    </div>
                  </div>
                </section>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 lg:gap-4 xl:gap-5">
                      <div className="group relative p-3 lg:p-4 xl:p-5 rounded-lg lg:rounded-xl backdrop-blur-sm transition-all duration-300 hover:-translate-y-1" style={{ background: 'linear-gradient(135deg, rgba(255, 183, 3, 0.12) 0%, rgba(255, 183, 3, 0.04) 100%)', border: '1px solid rgba(255, 183, 3, 0.2)', boxShadow: '0 4px 20px rgba(0, 0, 0, 0.3)' }}>
                        <div className="flex items-center gap-2 lg:gap-3 mb-2">
                          ...
                          <span className="text-white font-nunito text-sm md:text-base lg:text-lg xl:text-xl font-semibold">Mechanical Engineering</span>
                        </div>
                        <p className="text-white/90 font-nunito text-xs lg:text-sm xl:text-base leading-relaxed">Crucial for automotive and textile machinery innovations.</p>
                      </div>
                      <div className="group relative p-3 lg:p-4 xl:p-5 rounded-lg lg:rounded-xl backdrop-blur-sm transition-all duration-300 hover:-translate-y-1" style={{ background: 'rgba(255, 255, 255, 0.03)', border: '1px solid rgba(255, 255, 255, 0.1)', boxShadow: '0 4px 20px rgba(0, 0, 0, 0.3)' }}>
                        <div className="flex items-center gap-2 lg:gap-3 mb-2">
                          ...
                          <span className="text-white font-nunito text-sm md:text-base lg:text-lg xl:text-xl font-semibold">Software/SaaS</span>
                        </div>
                        <p className="text-white/90 font-nunito text-xs lg:text-sm xl:text-base leading-relaxed">Protecting algorithms and technical effects in software.</p>
                      </div>
                    </div>
                  </div>
                </section>
                    ...
                    <div className="relative overflow-hidden p-4 lg:p-5 xl:p-6 rounded-lg lg:rounded-xl backdrop-blur-sm" style={{ background: 'rgba(255, 255, 255, 0.03)', border: '1px solid rgba(255, 183, 3, 0.2)', boxShadow: '0 8px 32px rgba(0, 0, 0, 0.3)' }}>
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-4">
                        <div className="flex items-start gap-2">
                          ...
                          <div>
                            <h4 className="text-white font-nunito font-semibold text-xs lg:text-sm mb-0.5">Chennai Experts</h4>
                            <p className="text-white/80 font-nunito text-[10px] lg:text-xs">Local Jurisdiction</p>
                          </div>
                        </div>
                        <div className="flex items-start gap-2">
                          <i className="fas fa-users text-[#FFB703] text-base mt-0.5" aria-hidden="true"></i>
                          <div>
                            <h4 className="text-white font-nunito font-semibold text-xs lg:text-sm mb-0.5">Tech Focus</h4>
                            <p className="text-white/80 font-nunito text-[10px] lg:text-xs">Software & Auto</p>
                          </div>
                        </div>
                        <div className="flex items-start gap-2">
                          <i className="fas fa-bolt text-[#FFB703] text-base mt-0.5" aria-hidden="true"></i>
                          <div>
                            <h4 className="text-white font-nunito font-semibold text-xs lg:text-sm mb-0.5">Fast Filing</h4>
                            <p className="text-white/80 font-nunito text-[10px] lg:text-xs">Online Process</p>
                          </div>
                        </div>
                      </div>
                      <p className="text-white/95 font-nunito text-sm md:text-base lg:text-lg leading-relaxed">
                        We specialize in filing patents for Tamil Nadu's manufacturing and IT sectors. Our team understands the specific requirements of the Chennai Patent Office and ensures your application is technically sound.
                      </p>
                    </div>
                  </div>
                </section>
