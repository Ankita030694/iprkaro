...
export default function KarnatakaPatentClient() {
  ...
  const documentsRequired = [
    ...
    "Drawings (crucial for engineering patents)",
    ...
    "MSME/Startup Certificate (for fee rebate)",
    "Priority Documents (if applicable)"
  ];

  const processSteps = [
    {
      step: "Tech-Focused Prior Art Search",
      description: "Specialized search for software and hardware patents to ensure novelty."
    },
    {
      step: "Drafting for Section 3(k) Compliance",
      description: "Expert drafting to ensure software-related inventions meet technical effect criteria."
    },
    {
      step: "Filing at Chennai Patent Office",
      description: "Online submission to the appropriate jurisdiction (Chennai) for Karnataka applicants."
    },
    {
      step: "Request for Examination",
      description: "Filing Form 18/18A. Startups in Karnataka can opt for expedited examination."
    },
    {
      step: "Addressing FER",
      description: "Responding to First Examination Reports, especially on technical grounds."
    }
  ];
  ...
  return (
    <div className="min-h-screen relative overflow-x-hidden mt-20" style={{ 
      ...
      <TableOfContents activeSection={activeSection} stateName="Karnataka" />
        ...
        <div className="container mx-auto px-3 sm:px-4 lg:px-5 xl:px-6 2xl:px-8 max-w-7xl">
          <div className={`text-center mb-8 lg:mb-10 transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <p className="text-white/90 font-nunito text-xs md:text-sm lg:text-sm xl:text-sm leading-relaxed max-w-3xl mx-auto mb-5">
              Protecting innovations in India's Silicon Valley. Specialized patent services for <span className="text-[#FFB703] font-semibold">Bangalore's Tech Startups</span> and Biotech firms.
            </p>
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 mb-4">
              <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/5 backdrop-blur-sm border border-white/10">
                <i className="fas fa-microchip text-[#FFB703] text-xs" aria-hidden="true"></i>
                <span className="text-white text-[10px] lg:text-xs font-nunito font-medium">Tech Patents</span>
              </div>
              <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/5 backdrop-blur-sm border border-white/10">
                <i className="fas fa-rocket text-[#FFB703] text-xs" aria-hidden="true"></i>
                <span className="text-white text-[10px] lg:text-xs font-nunito font-medium">Startup Friendly</span>
              </div>
              <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/5 backdrop-blur-sm border border-white/10">
                <i className="fas fa-dna text-[#FFB703] text-xs" aria-hidden="true"></i>
                <span className="text-white text-[10px] lg:text-xs font-nunito font-medium">Biotech Expert</span>
              </div>
              <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-white/5 backdrop-blur-sm border border-white/10">
                <i className="fas fa-headset text-[#FFB703] text-xs" aria-hidden="true"></i>
                <span className="text-white text-[10px] lg:text-xs font-nunito font-medium">IP Strategy</span>
              </div>
            </div>
            ...
            <div className="flex items-center justify-center gap-3">
              <button className="group px-6 py-2 lg:px-8 lg:py-3 rounded-lg font-nunito font-bold text-xs lg:text-sm transition-all duration-300 hover:scale-105 hover:shadow-2xl relative overflow-hidden" style={{ background: 'linear-gradient(135deg, #FFB703 0%, #FFA000 100%)', color: '#0C002B', boxShadow: '0 10px 30px rgba(255, 183, 3, 0.4)' }}>
                <span className="relative z-10 flex items-center gap-1.5">Start Filing <i className="fas fa-arrow-right group-hover:translate-x-1 transition-transform text-[10px]" aria-hidden="true"></i></span>
                  ...
                  <div className="space-y-3 lg:space-y-4 xl:space-y-5">
                    ...
                    <div className="group relative p-4 lg:p-5 xl:p-6 2xl:p-8 rounded-lg lg:rounded-xl xl:rounded-2xl backdrop-blur-sm transition-all duration-500 hover:scale-[1.01]" style={{ background: 'linear-gradient(135deg, rgba(255, 255, 255, 0.08) 0%, rgba(255, 255, 255, 0.02) 100%)', border: '1px solid rgba(255, 255, 255, 0.1)', boxShadow: '0 8px 32px rgba(0, 0, 0, 0.3)' }}>
                      <p className="relative text-white/95 font-nunito text-sm md:text-sm lg:text-sm xl:text-sm 2xl:text-lg leading-relaxed mb-4">
                        Karnataka, particularly Bangalore, is the innovation hub of India, home to thousands of R&D centers, startups, and multinational tech corporations. While the <strong>Patent Office in Chennai</strong> has jurisdiction over Karnataka, the local ecosystem demands specialized IP support.
                      </p>
                      <p className="relative text-white/95 font-nunito text-sm md:text-sm lg:text-sm xl:text-sm 2xl:text-lg leading-relaxed">
                        Innovators in Karnataka face unique challenges, especially in patenting <strong>Software and Algorithms</strong> (Computer Related Inventions). Our team in Bangalore specializes in navigating Section 3(k) exclusions, drafting claims that demonstrate technical advancement to secure grants for software products. We also support the growing Biotech and Aerospace clusters in the state.
                      </p>
                    </div>
                  </div>
                </section>
                ...
                <section id="criteria" className="scroll-mt-20">
                  <div className="space-y-3 lg:space-y-4 xl:space-y-5">
                    <div className="flex items-center gap-2 lg:gap-3 xl:gap-4">
                      ...
                      <h2 className="text-white font-nunito text-base md:text-lg lg:text-xl xl:text-2xl 2xl:text-3xl font-bold">
                        Key Patentability Criteria (Software & Tech)
                      </h2>
                    </div>
                      ...
                      <div className="group relative p-3 lg:p-4 xl:p-5 rounded-lg lg:rounded-xl backdrop-blur-sm transition-all duration-300 hover:-translate-y-1" style={{ background: 'linear-gradient(135deg, rgba(255, 183, 3, 0.12) 0%, rgba(255, 183, 3, 0.04) 100%)', border: '1px solid rgba(255, 183, 3, 0.2)', boxShadow: '0 4px 20px rgba(0, 0, 0, 0.3)' }}>
                        <div className="flex items-center gap-2 lg:gap-3 mb-2">
                          <div className="w-8 h-8 lg:w-10 lg:h-10 rounded-full flex items-center justify-center" style={{ background: 'linear-gradient(135deg, #FFB703, #FFA000)', boxShadow: '0 4px 15px rgba(255, 183, 3, 0.4)' }}>
                            <i className="fas fa-microchip text-[#0C002B] text-sm lg:text-base" aria-hidden="true"></i>
                          </div>
                          <span className="text-white font-nunito text-sm md:text-base lg:text-lg xl:text-xl font-semibold">Technical Effect</span>
                        </div>
                        <p className="text-white/90 font-nunito text-xs lg:text-sm xl:text-base leading-relaxed">For software, invention must solve a technical problem.</p>
                      </div>
                      <div className="group relative p-3 lg:p-4 xl:p-5 rounded-lg lg:rounded-xl backdrop-blur-sm transition-all duration-300 hover:-translate-y-1" style={{ background: 'rgba(255, 255, 255, 0.03)', border: '1px solid rgba(255, 255, 255, 0.1)', boxShadow: '0 4px 20px rgba(0, 0, 0, 0.3)' }}>
                        <div className="flex items-center gap-2 lg:gap-3 mb-2">
                          <div className="w-8 h-8 lg:w-10 lg:h-10 rounded-full flex items-center justify-center" style={{ background: 'rgba(255, 183, 3, 0.15)', border: '1px solid rgba(255, 183, 3, 0.3)' }}>
                            <i className="fas fa-code text-[#FFB703] text-sm lg:text-base" aria-hidden="true"></i>
                          </div>
                          <span className="text-white font-nunito text-sm md:text-base lg:text-lg xl:text-xl font-semibold">Hardware Combo</span>
                        </div>
                        <p className="text-white/90 font-nunito text-xs lg:text-sm xl:text-base leading-relaxed">Software claimed with hardware is easier to patent.</p>
                      </div>
                    </div>
                  </div>
                </section>
                ...
                <section id="process" className="scroll-mt-20">
                  <div className="space-y-3 lg:space-y-4">
                    <div className="flex items-center gap-2 lg:gap-3 xl:gap-4">
                      ...
                      <h2 className="text-white font-nunito text-base md:text-lg lg:text-xl xl:text-2xl 2xl:text-3xl font-bold">
                        Filing Process (Chennai Jurisdiction)
                      </h2>
                    </div>
                  ...
                  <div className="space-y-3 lg:space-y-4">
                    ...
                    <div className="relative p-4 lg:p-5 xl:p-6 rounded-lg lg:rounded-xl backdrop-blur-sm" style={{ background: 'rgba(255, 255, 255, 0.03)', border: '1px solid rgba(255, 255, 255, 0.1)', boxShadow: '0 8px 32px rgba(0, 0, 0, 0.3)' }}>
                      <p className="text-white/95 font-nunito text-sm md:text-base lg:text-lg leading-relaxed mb-3">
                        Patents are valid for 20 years. For software products with shorter lifecycles, speed is key. We help Karnataka startups utilize the <strong>Expedited Examination</strong> route to get patents granted in as little as 1 year.
                      </p>
                    </div>
                  </div>
                </section>
                ...
                <section id="support" className="scroll-mt-20">
                  <div className="space-y-3 lg:space-y-4">
                    <div className="flex items-center gap-2 lg:gap-3 xl:gap-4">
                      ...
                      <h2 className="text-white font-nunito text-base md:text-lg lg:text-xl xl:text-2xl 2xl:text-3xl font-bold">
                        Why Choose IPRKaro in Karnataka?
                      </h2>
                    </div>
                    <div className="relative overflow-hidden p-4 lg:p-5 xl:p-6 rounded-lg lg:rounded-xl backdrop-blur-sm" style={{ background: 'rgba(255, 255, 255, 0.03)', border: '1px solid rgba(255, 183, 3, 0.2)', boxShadow: '0 8px 32px rgba(0, 0, 0, 0.3)' }}>
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-4">
                        <div className="flex items-start gap-2">
                          ...
                          <div>
                            <h4 className="text-white font-nunito font-semibold text-xs lg:text-sm mb-0.5">Tech Experts</h4>
                            <p className="text-white/80 font-nunito text-[10px] lg:text-xs">Engineers & Attorneys</p>
                          </div>
                        </div>
                        <div className="flex items-start gap-2">
                          <i className="fas fa-rocket text-[#FFB703] text-base mt-0.5" aria-hidden="true"></i>
                          <div>
                            <h4 className="text-white font-nunito font-semibold text-xs lg:text-sm mb-0.5">Fast Track</h4>
                            <p className="text-white/80 font-nunito text-[10px] lg:text-xs">For Startups</p>
                          </div>
                        </div>
                        <div className="flex items-start gap-2">
                          <i className="fas fa-shield-alt text-[#FFB703] text-base mt-0.5" aria-hidden="true"></i>
                          <div>
                            <h4 className="text-white font-nunito font-semibold text-xs lg:text-sm mb-0.5">NDA Signed</h4>
                            <p className="text-white/80 font-nunito text-[10px] lg:text-xs">Complete Confidentiality</p>
                          </div>
                        </div>
                      </div>
                      <p className="text-white/95 font-nunito text-sm md:text-base lg:text-lg leading-relaxed">
                        We understand the pace of innovation in Bangalore. Our digital-first process allows you to file patents without leaving your office. We provide specialized support for computer-related inventions and startup IP portfolios.
                      </p>
                    </div>
                  </div>
                </section>
