          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-white font-nunito text-xs md:text-sm lg:text-base leading-relaxed">
                Secure your brand identity and business name with our professional Trademark Registration services in India. Whether you are a startup, MSME, or corporate, we help you register trademarks, logos, and brand names efficiently. Our end-to-end services include trademark search, filing, objections, and monitoring, ensuring your brand is legally protected against infringement. Boost your business credibility and safeguard your brand assets with India's trusted IP experts.
              </p>
            </div>
