...
export default function FaqSection() {
  const faqs = [
    {
      question: "How can I register a trademark in Odisha?",
      answer: "To register a trademark in Odisha, you need to follow the standard procedure defined by the Trade Marks Registry. This involves conducting a trademark search, filing the application (Form TM-A) either online through the IP India portal or physically at the Kolkata Trademark Registry (which has jurisdiction over Odisha), responding to examination reports, and handling any oppositions. The process is streamlined online, allowing applicants from Odisha to file without visiting Kolkata."
    },
    {
      question: "Which Trademark Registry office handles applications from Odisha?",
      answer: "Trademark applications from Odisha fall under the jurisdiction of the Trademark Registry in Kolkata. The address is: Boudhik Sampada Bhawan, CP-2, Sector V, Salt Lake City, Kolkata - 700091. However, the entire filing and prosecution process can be handled online through the official website ipindiaservices.gov.in."
    },
    {
      question: "What are the documents required for trademark registration in Odisha?",
    ...
    {
      question: "Is it mandatory to hire a trademark attorney in Odisha?",
    ...
    {
      question: "What is the validity of a registered trademark in Odisha?",
      answer: "A trademark registered in Odisha (or anywhere in India) is valid for 10 years from the date of application filing. It can be renewed indefinitely for successive periods of 10 years by paying the prescribed renewal fees."
    },
    {
      question: "Can I register a trademark for Odisha's traditional products like Pattachitra or Silver Filigree?",
      answer: "Yes, traditional products can be protected, often under Geographical Indications (GI) if they are specific to a region like Odisha Pattachitra or Cuttack Silver Filigree. However, individual businesses can also register trademarks for their specific brands of these products to distinguish their goods from others in the market."
    },
    {
      question: "How long does the trademark registration process take in Odisha?",
    ...
    {
      question: "What is the government fee for trademark registration in Odisha?",
    ...
    {
      question: "Can I file for a trademark online from Bhubaneswar or Cuttack?",
      answer: "Yes, absolutely. The IP India portal allows applicants from Bhubaneswar, Cuttack, Rourkela, Berhampur, or any part of Odisha to file trademark applications online. You do not need to travel to the Kolkata registry office."
    },
    {
