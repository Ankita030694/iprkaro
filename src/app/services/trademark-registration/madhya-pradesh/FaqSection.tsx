...
export default function FaqSection() {
  const faqs = [
    {
      question: "How do I register a trademark in Madhya Pradesh?",
      answer: "To register a trademark in Madhya Pradesh, you must follow the online process via the IP India portal. The steps include conducting a trademark search, filing Form TM-A, responding to examination reports, and handling any oppositions. The Mumbai Trademark Registry has jurisdiction over applications from Madhya Pradesh."
    },
    {
      question: "Which Trademark Registry office covers Madhya Pradesh?",
      answer: "The Trademark Registry in Mumbai has jurisdiction over Madhya Pradesh. However, the entire process is digital, so you can file your application online from Bhopal, Indore, Gwalior, or anywhere in the state without visiting the Mumbai office."
    },
    {
      question: "What documents are required for trademark registration in MP?",
    ...
    {
      question: "Can I register a GI tag for my traditional product in Madhya Pradesh?",
      answer: "GI tags are for community-owned products like Chanderi Sarees or Ratlami Sev. As an individual or business, you cannot own a GI tag, but you can register a trademark to protect your specific brand name or logo associated with these products."
    },
    {
      question: "What is the validity of a trademark registered in Madhya Pradesh?",
    ...
    {
      question: "Is it mandatory to hire a trademark attorney in Madhya Pradesh?",
      answer: "It is not mandatory but highly recommended. An experienced attorney can help with a comprehensive search, correct class selection (e.g., Class 30 for Ratlami Sev or Class 24 for Chanderi textiles), and legally handle objections, ensuring a smoother registration process."
    },
    {
    ...
    {
      question: "Can I file for a trademark online from Indore or Bhopal?",
      answer: "Yes, the trademark filing system in India is centralized and online. You can file your application from Indore, Bhopal, Jabalpur, or any other city in Madhya Pradesh through the official website ipindiaservices.gov.in."
    },
    {
