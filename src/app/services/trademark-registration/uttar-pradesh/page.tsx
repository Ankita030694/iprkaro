...
import UttarPradeshClient from './UttarPradeshClient';

export const metadata: Metadata = {
  title: 'Trademark Registration in Uttar Pradesh | Complete Guide 2025 | IPRKaro',
  description: 'Expert trademark registration services in Uttar Pradesh. Complete guide with step-by-step process, required documents, eligibility criteria, timeline, and professional assistance for businesses in Noida, Lucknow, Kanpur, and across UP.',
  keywords: [
    'trademark registration in uttar pradesh',
    'trademark registration uttar pradesh',
    'how to register trademark in uttar pradesh',
    'trademark registration process uttar pradesh',
    'trademark registration online uttar pradesh',
    'trademark registration noida',
    'trademark registration lucknow',
    'trademark registration kanpur',
    'trademark registration agra',
    'trademark registration ghaziabad',
    'trademark registration varanasi',
    'trademark registration greater noida',
    'uttar pradesh trademark office',
    'trademark attorney uttar pradesh',
    'trademark registration cost uttar pradesh',
    'trademark filing uttar pradesh',
    'trademark lawyer uttar pradesh',
    'trademark consultant uttar pradesh',
    'trademark search uttar pradesh',
    'trademark services uttar pradesh',
    'brand registration uttar pradesh',
    'logo registration uttar pradesh',
    'startup trademark registration uttar pradesh',
    'trademark registration for startups uttar pradesh',
    'IPRKaro trademark registration uttar pradesh',
    'trademark registration uttar pradesh india',
    'trademark registration uttar pradesh 2025',
    'trademark registration up',
    'noida trademark registration',
    'lucknow trademark services'
  ],
  openGraph: {
    title: 'Trademark Registration in Uttar Pradesh | Complete Process Guide | IPRKaro',
    description: 'Professional trademark registration services in Uttar Pradesh. Comprehensive guide covering process, documents, timeline, and expert assistance for businesses across UP including Noida, Lucknow, and Kanpur.',
    type: 'article',
    locale: 'en_IN',
    siteName: 'IPRKaro',
  },
  twitter: {
    ...
    title: 'Trademark Registration in Uttar Pradesh | Complete Guide & Process',
    description: 'Complete guide to trademark registration in Uttar Pradesh with expert assistance, step-by-step process, and comprehensive timeline information.',
  },
  alternates: {
    canonical: 'https://iprkaro.com/services/trademark-registration/uttar-pradesh',
  },
  robots: {
    index: true,
    follow: true,
...
export default function UttarPradeshTrademarkPage() {
  const faqSchema = {
  ...
  const serviceSchema = {
    "@context": "https://schema.org",
    "@type": "Service",
    "serviceType": "Trademark Registration Services in Uttar Pradesh",
    "provider": {
      "@type": "Organization",
      "name": "IPRKaro",
    ...
    "hasOfferCatalog": {
      "@type": "OfferCatalog",
      "name": "Trademark Registration Services in Uttar Pradesh",
      "itemListElement": [
        {
          "@type": "Offer",
          "itemOffered": {
            "@type": "Service",
            "name": "Trademark Search in Uttar Pradesh",
            "description": "Comprehensive trademark availability search and conflict assessment across UP"
          }
        },
        {
          "@type": "Offer",
          "itemOffered": {
            "@type": "Service",
            "name": "Trademark Application Filing in Uttar Pradesh",
            "description": "Complete trademark registration application filing and documentation for UP businesses"
          }
        },
        {
          "@type": "Offer",
          "itemOffered": {
            "@type": "Service",
            "name": "Trademark Objection Response in Uttar Pradesh",
        ...
        },
        {
          ...
          "itemOffered": {
            "@type": "Service",
            "name": "Trademark Opposition Defense in Uttar Pradesh",
            "description": "Legal defense against trademark oppositions and infringement matters across UP"
          }
        }
      ]
    }
  ...
  const breadcrumbSchema = {
    ...
    "itemListElement": [
      ...
      },
      {
        "@type": "ListItem",
        "position": 4,
        "name": "Trademark Registration in Uttar Pradesh",
        "item": "https://iprkaro.com/services/trademark-registration/uttar-pradesh"
      }
    ]
  };
