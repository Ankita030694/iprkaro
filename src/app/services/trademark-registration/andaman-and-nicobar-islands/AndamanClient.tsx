        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 xl:px-12 2xl:px-16">
          <section className="mb-6">
            <div className="flex items-center gap-2 text-sm text-white/80 font-nunito">
              ...
              <i className="fas fa-chevron-right text-xs text-white/50" aria-hidden="true"></i>
              <span className="text-[#FFB703] font-medium">Andaman and Nicobar Islands</span>
            </div>
          </section>
          ...
          <section className="mb-8">
            ...
            <div className="p-4 lg:p-5 rounded-lg backdrop-blur-sm" style={{ background: 'rgba(255, 255, 255, 0.05)', border: '1px solid rgba(255, 255, 255, 0.1)' }}>
              <p className="text-white/95 font-nunito text-base lg:text-lg leading-relaxed">
                Protect your brand in the Andaman and Nicobar Islands. With Port Blair as the commercial hub, trademark registration is essential for businesses operating in the tourism, fisheries, and local trade sectors.
              </p>
            </div>
          </section>

          <section className="mb-8">
            <h2 className="text-white font-nunito text-2xl md:text-3xl lg:text-4xl font-bold mb-3">Why Register Your Trademark?</h2>
            <div className="p-4 rounded-lg" style={{ background: 'rgba(255, 255, 255, 0.03)', border: '1px solid rgba(255, 255, 255, 0.1)' }}>
              <p className="text-white/90 font-nunito text-base leading-relaxed">
                Trademark registration provides exclusive legal rights to your brand identity, prevents unauthorized use, and builds trust with your customers. It is a vital asset for any growing business in the islands.
              </p>
            </div>
          </section>
          ...
          <section className="mt-12">
            <div className="p-8 rounded-xl text-center" style={{ background: 'rgba(255, 183, 3, 0.1)', border: '2px solid rgba(255, 183, 3, 0.3)' }}>
              <h3 className="text-white text-2xl font-bold mb-4">Get Expert Assistance Today</h3>
