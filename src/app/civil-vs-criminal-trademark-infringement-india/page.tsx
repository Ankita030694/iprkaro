...
const tocSections = [
    { id: 'executive-summary', title: 'Civil vs Criminal TM Infringement' },
    { id: 'foundational-concepts', title: 'Civil vs Criminal TM Infringement' },
    { id: 'civil-remedies', title: 'Civil vs Criminal TM Infringement' },
    { id: 'injunctions-and-local-commissioners', title: 'Civil vs Criminal TM Infringement' },
    { id: 'criminal-proceedings', title: 'Civil vs Criminal TM Infringement' },
    { id: 'police-powers-and-seizures', title: 'Civil vs Criminal TM Infringement' },
    { id: 'comparative-analysis', title: 'Civil vs Criminal TM Infringement' },
    { id: 'burden-of-proof', title: 'Civil vs Criminal TM Infringement' },
    { id: 'famous-case-laws', title: 'Civil vs Criminal TM Infringement' },
    { id: 'strategic-decision-making', title: 'Civil vs Criminal TM Infringement' },
    { id: 'faqs', title: 'Civil vs Criminal TM Infringement' },
];
...
export default function CivilVsCriminalTrademarkPage() {
    ...
    const articleSchema = {
        "@context": "https://schema.org",
        "@type": "Article",
        "headline": "Civil vs Criminal TM Infringement",
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_300px] gap-8 items-start">
                        ...
                        <aside className="hidden lg:block sticky top-32">
                            <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                                <p className="text-gray-900 font-bold text-lg mb-6 border-l-4 border-[rgb(110,94,147)] pl-3">Legal Guide</p>
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-2xl shadow-sm border border-gray-100 space-y-12 md:space-y-20">
                                ...
                                <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed font-normal">
                                    ...
                                    <section id="executive-summary" className="scroll-mt-32">
                                        <h2 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-6 leading-tight">The Strategic Battleground of Intellectual Property Rights</h2>
                                        <p className="mb-6">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8 mb-10">
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                                <div className="text-[rgb(110,94,147)] mb-4 flex items-center">
                                                    ...
                                                    <h4 className="font-bold text-xl text-gray-900">Trademark Infringement</h4>
                                                </div>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                                <div className="text-[rgb(110,94,147)] mb-4 flex items-center">
                                                    ...
                                                    <h4 className="font-bold text-xl text-gray-900">Passing Off Action</h4>
                                                </div>
                                        ...
                                        <div className="relative space-y-12">
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900">Interim and Permanent Injunctions</h4>
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900">Damages and Account of Profits</h4>
                                                    <p className="text-base text-gray-600 mb-4">
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900">Delivery-Up and Destruction</h4>
                                                    <p className="text-base text-gray-600 mb-4">
                                    ...
                                    <section id="criminal-proceedings" className="scroll-mt-32">
                                        ...
                                        <div className="bg-black text-white p-10 rounded-3xl my-10 shadow-2xl">
                                            <h4 className="text-2xl font-bold mb-4 text-[rgb(110,94,147)] uppercase">The Deterrence Factor</h4>
                                    ...
                                    <section id="comparative-analysis" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8">
                                            <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100 flex flex-col items-center text-center">
                                                ...
                                                <h5 className="font-bold text-xl mb-4">Civil Suit Advantages</h5>
                                            ...
                                            <div className="p-8 bg-[rgb(110,94,147)] text-white rounded-3xl shadow-xl flex flex-col items-center text-center">
                                                ...
                                                <h5 className="font-bold text-xl mb-4 text-white">Criminal Route Advantages</h5>
                                    ...
                                    <section id="famous-case-laws" className="scroll-mt-32">
                                        ...
                                        <div className="space-y-8">
                                            <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm hover:border-[rgb(110,94,147)] transition-all">
                                                <h4 className="text-xl font-bold text-gray-900 mb-4">Renaissance Hotel Holdings vs. B. Vijaya Sai (2022)</h4>
                                            ...
                                            <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm hover:border-[rgb(110,94,147)] transition-all">
                                                <h4 className="text-xl font-bold text-gray-900 mb-4">Yahoo! Inc. vs. Akash Arora (1999)</h4>
                                            ...
                                            <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-sm hover:border-[rgb(110,94,147)] transition-all">
                                                <h4 className="text-xl font-bold text-gray-900 mb-4">Cadila Healthcare vs. Cadila Pharmaceuticals (2001)</h4>
                                    ...
                                    <section className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[2.5rem] p-8 md:p-16 text-center text-white relative overflow-hidden mt-12 shadow-2xl">
                                        <div className="relative z-10">
                                            <h3 className="text-3xl md:text-5xl font-black mb-6 leading-tight">Protect Your Empire Today</h3>
                        ...
                        <aside className="hidden lg:block space-y-8 sticky top-32">
                            <div className="bg-[#0C002B] p-8 rounded-3xl shadow-[0_20px_40px_rgba(0,0,0,0.1)] border border-gray-800 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-xl font-bold mb-4 relative z-10 leading-tight">Facing Infringement?</h4>
                            ...
                            <div className="bg-gray-50 p-8 rounded-3xl shadow-sm border border-gray-100">
                                <h4 className="text-lg font-black text-gray-900 mb-6 border-b-2 border-[rgb(110,94,147)] pb-4 uppercase tracking-widest">Related Resources</h4>
