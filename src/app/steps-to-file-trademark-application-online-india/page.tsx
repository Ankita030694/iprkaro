            ...
            <div className="min-w-0">
              ...
              <div className="bg-white p-4 md:p-12 rounded-xl md:rounded-2xl shadow-sm space-y-8 md:space-y-16">
                ...
                <section id="importance-of-registration" className="scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Why Trademark Registration is Essential?</h3>
                ...
                <section id="pre-filing-steps" className="scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Pre-Filing Steps: Before You Login</h3>
                  <p className="text-base md:text-lg leading-relaxed mb-4 text-gray-700">
                  ...
                  <div className="space-y-6 mb-8">
                     <div>
                        <h4 className="text-ld md:text-xl font-bold text-gray-900 mb-2">1. Comprehensive Trademark Search</h4>
                     ...
                     <div>
                        <h4 className="text-ld md:text-xl font-bold text-gray-900 mb-2">2. Accurate Class Selection</h4>
                        <p className="text-gray-700 leading-relaxed">
                     ...
                     <div>
                        <h4 className="text-ld md:text-xl font-bold text-gray-900 mb-2">3. Digital Signature Certificate (DSC)</h4>
                        <p className="text-gray-700 leading-relaxed">
                  ...
                  <div className="grid md:grid-cols-3 gap-6 mt-6">
                    <div className="bg-purple-50 p-6 rounded-lg text-center">
                       ...
                       <h4 className="font-bold text-lg mb-2">Search First</h4>
                    ...
                    <div className="bg-purple-50 p-6 rounded-lg text-center">
                       ...
                       <h4 className="font-bold text-lg mb-2">Select Class</h4>
                    ...
                    <div className="bg-purple-50 p-6 rounded-lg text-center">
                       ...
                       <h4 className="font-bold text-lg mb-2">Get DSC</h4>
                ...
                <section id="step-by-step-guide" className="scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Step-by-Step Guide to Online Filing</h3>
                  ...
                  <div className="space-y-8">
                    ...
                    <div className="flex gap-4">
                      ...
                      <div>
                        <h4 className="text-xl font-bold text-gray-900 mb-2">Fill Form TM-A (New Application)</h4>
                        <p className="text-gray-700 mb-2">
                    ...
                    <div className="flex gap-4">
                      ...
                      <div>
                        <h4 className="text-xl font-bold text-gray-900 mb-2">Upload Supporting Documents</h4>
                        <p className="text-gray-700 mb-2">
                    ...
                    <div className="flex gap-4">
                      ...
                      <div>
                        <h4 className="text-xl font-bold text-gray-900 mb-2">Fee Calculation and Payment</h4>
                        <p className="text-gray-700 mb-2">
                    ...
                    <div className="flex gap-4">
                      ...
                      <div>
                        <h4 className="text-xl font-bold text-gray-900 mb-2">Generate Acknowledgement Receipt</h4>
                        <p className="text-gray-700">
                ...
                <section id="documents-required" className="scroll-mt-24 md:scroll-mt-32">
                   <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Documents Required for Online Application</h3>
                   <p className="text-base md:text-lg leading-relaxed mb-4 text-gray-700">
                   ...
                   <div className="bg-white border border-gray-200 rounded-xl p-6 mb-6">
                      <h4 className="text-lg font-bold text-gray-900 mb-4">Identity & Address Proof</h4>
                      ...
                      <h4 className="text-lg font-bold text-gray-900 mb-4">Trademark Representation</h4>
                      <ul className="space-y-3 mb-6">
                         <li className="flex items-start">
                             <FontAwesomeIcon icon={faCheck} className="mt-1 mr-3 text-green-500 text-sm w-4 h-4" />
                      ...
                      <h4 className="text-lg font-bold text-gray-900 mb-4">Legal Documents</h4>
                 ...
                 <section id="application-fees" className="scroll-mt-24 md:scroll-mt-32">
                   <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Application Fees (Government)</h3>
                ...
                <section id="common-mistakes" className="scroll-mt-24 md:scroll-mt-32">
                   <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Common Mistakes to Avoid While Filing Online</h3>
                   <p className="text-base md:text-lg leading-relaxed mb-6 text-gray-700">
                   ...
                   <div className="grid md:grid-cols-2 gap-6">
                      <div className="bg-red-50 p-6 rounded-lg border border-red-100">
                         <h4 className="font-bold text-lg text-red-800 mb-2">1. Using Generic Terms</h4>
                      ...
                      <div className="bg-red-50 p-6 rounded-lg border border-red-100">
                         <h4 className="font-bold text-lg text-red-800 mb-2">2. Incorrect Applicant Type</h4>
                      ...
                      <div className="bg-red-50 p-6 rounded-lg border border-red-100">
                         <h4 className="font-bold text-lg text-red-800 mb-2">3. Wrong Class</h4>
                      ...
                      <div className="bg-red-50 p-6 rounded-lg border border-red-100">
                         <h4 className="font-bold text-lg text-red-800 mb-2">4. Improper User Date</h4>
                ...
                <section id="post-filing-process" className="scroll-mt-24 md:scroll-mt-32">
                   <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Post-Filing Process: What Comes Next?</h3>
                   <p className="text-base md:text-lg leading-relaxed mb-4 text-gray-700">
                   ...
                   <div className="space-y-6">
                      <div className="flex gap-4">
                         ...
                         <div>
                            <h4 className="font-bold text-lg text-gray-900">Formalities Check (Pass/Fail)</h4>
                      ...
                      <div className="flex gap-4">
                         ...
                         <div>
                            <h4 className="font-bold text-lg text-gray-900">Examination</h4>
                            <p className="text-gray-700 text-sm mt-1">
                      ...
                      <div className="flex gap-4">
                         ...
                         <div>
                            <h4 className="font-bold text-lg text-gray-900">Response to Examination Report</h4>
                            <p className="text-gray-700 text-sm mt-1">
                      ...
                      <div className="flex gap-4">
                         ...
                         <div>
                            <h4 className="font-bold text-lg text-gray-900">Publication in Trademark Journal</h4>
                            <p className="text-gray-700 text-sm mt-1">
                      ...
                      <div className="flex gap-4">
                         ...
                         <div>
                            <h4 className="font-bold text-lg text-gray-900">Registration & Certification</h4>
                            <p className="text-gray-700 text-sm mt-1">
                ...
                <section id="why-hire-professional" className="scroll-mt-24 md:scroll-mt-32 bg-purple-50 p-6 md:p-8 rounded-xl border border-purple-100">
                   <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Why Hire a Professional vs DIY?</h3>
                   <p className="text-base md:text-lg leading-relaxed mb-4 text-gray-700">
                ...
                <section id="faqs" className="scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-6 md:mb-8">Common Questions About Application Steps</h3>
                ...
                <section id="conclusion" className="scroll-mt-24 md:scroll-mt-32">
                   <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Conclusion</h3>
                   <p className="text-base md:text-lg leading-relaxed mb-4 text-gray-700">
                ...
                <section id="client-success-stories" className="scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-6 md:mb-8">Client Success Stories</h3>
                ...
                <section id="why-choose-iprkaro" className="scroll-mt-24 md:scroll-mt-32 bg-black text-white p-6 md:p-8 rounded-xl md:rounded-2xl">
                  <h3 className="text-xl md:text-3xl font-bold mb-4 md:mb-6">Why Choose IPR Karo for Filing?</h3>
                  <div className="grid md:grid-cols-3 gap-6 text-center">
                    <div className="p-2 md:p-4">
                      ...
                      <h4 className="font-bold text-lg md:text-xl mb-2 text-[#FFD700]">Fastest Filing</h4>
                    ...
                    <div className="p-2 md:p-4">
                      ...
                      <h4 className="font-bold text-lg md:text-xl mb-2 text-[#FFD700]">Error-Free Forms</h4>
                    ...
                    <div className="p-2 md:p-4">
                      ...
                      <h4 className="font-bold text-lg md:text-xl mb-2 text-[#FFD700]">Best Pricing</h4>
                ...
                <section className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-xl md:rounded-3xl p-6 md:p-16 text-center text-white relative overflow-hidden mt-8 md:mt-12">
                   <div className="relative z-10">
                    <h3 className="text-xl md:text-4xl font-bold mb-4 md:mb-6">Ready to File Your Trademark?</h3>
             ...
             <div className="hidden lg:block space-y-8 sticky top-32">
                ...
                <div className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] p-6 rounded-xl shadow-lg border border-gray-800 text-white text-center">
                  <h4 className="text-xl font-bold mb-3">Trademark Enquiry</h4>
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                  <h4 className="text-lg font-bold text-gray-900 mb-4">Explore More</h4>
