                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_300px] gap-8 items-start">
                        ...
                        <aside className="hidden lg:block sticky top-32 h-[calc(100vh-160px)] overflow-y-auto">
                            <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                                <p className="text-gray-900 font-bold text-lg mb-6 border-l-4 border-[rgb(110,94,147)] pl-3">Legal Roadmap</p>
                                ...
                                <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed font-normal">
                                    ...
                                    <section id="understanding-opposition" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8 mb-12">
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] transition-all shadow-sm group">
                                                ...
                                                <h4 className="font-bold text-xl mb-4 text-gray-900">Who Can Oppose?</h4>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] transition-all shadow-sm group">
                                                ...
                                                <h4 className="font-bold text-xl mb-4 text-gray-900">The 4-Month Window</h4>
                                        ...
                                        <div className="bg-white border-2 border-gray-100 p-8 rounded-2xl shadow-sm mb-10">
                                            ...
                                            <ul className="grid md:grid-cols-2 gap-6">
                                                <li className="flex items-start bg-gray-50 p-6 rounded-xl">
                                                    ...
                                                    <div>
                                                        <h6 className="font-bold text-sm">Deceptive Similarity</h6>
                                                ...
                                                <li className="flex items-start bg-gray-50 p-6 rounded-xl">
                                                    ...
                                                    <div>
                                                        <h6 className="font-bold text-sm">Lack of Distinctiveness</h6>
                                                ...
                                                <li className="flex items-start bg-gray-50 p-6 rounded-xl">
                                                    ...
                                                    <div>
                                                        <h6 className="font-bold text-sm">Bad Faith Filing</h6>
                                                ...
                                                <li className="flex items-start bg-gray-50 p-6 rounded-xl">
                                                    ...
                                                    <div>
                                                        <h6 className="font-bold text-sm">Public Confusion</h6>
                                        ...
                                        <div className="relative space-y-12">
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900">Notice of Opposition</h4>
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900">Counter-Statement</h4>
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900">Evidence Battle</h4>
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900">Hearing & Decision</h4>
                                    ...
                                    <section id="counter-statement" className="scroll-mt-32">
                                        ...
                                        <div className="bg-blue-50 border-l-8 border-[rgb(110,94,147)] p-10 my-10 rounded-r-3xl">
                                            <h5 className="font-black text-xl mb-4 text-blue-900 uppercase tracking-widest">Rule of Denial</h5>
                                    ...
                                    <section id="evidence-stage" className="scroll-mt-32">
                                        ...
                                        <div className="space-y-6">
                                            <div className="bg-gray-50 p-8 rounded-2xl border-l-8 border-[rgb(110,94,147)] relative group">
                                                ...
                                                <h5 className="font-bold text-xl mb-2">Opponent's Evidence (Rule 45)</h5>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-2xl border-l-8 border-[rgb(110,94,147)] relative group">
                                                ...
                                                <h5 className="font-bold text-xl mb-2">Applicant's Evidence (Rule 46)</h5>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-2xl border-l-8 border-[rgb(110,94,147)] relative group">
                                                ...
                                                <h5 className="font-bold text-xl mb-2">Rebuttal Evidence (Rule 47)</h5>
                                    ...
                                    <section id="hearing-decision" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8 my-10">
                                            <div className="p-8 bg-[#0C002B] text-white rounded-[2rem] border border-white/5 relative overflow-hidden group">
                                                ...
                                                <h5 className="text-xl font-bold mb-4">The Oral Arguments</h5>
                                            ...
                                            <div className="p-8 bg-[#0C002B] text-white rounded-[2rem] border border-white/5 relative overflow-hidden group">
                                                ...
                                                <h5 className="text-xl font-bold mb-4">The Final Order</h5>
                                    ...
                                    <section id="defense-strategies" className="scroll-mt-32">
                                        ...
                                        <div className="space-y-6">
                                            <div className="flex items-start p-6 bg-gray-50 rounded-2xl border-l-4 border-[rgb(110,94,147)]">
                                                ...
                                                <div>
                                                    <h5 className="font-bold text-gray-900 mb-2">The 'Prior Use' Doctrine</h5>
                                            ...
                                            <div className="flex items-start p-6 bg-gray-50 rounded-2xl border-l-4 border-[rgb(110,94,147)]">
                                                <FontAwesomeIcon icon={faCheck} className="text-[rgb(110,94,147)] mt-1 mr-4 shrink-0" />
                                                <div>
                                                    <h5 className="font-bold text-gray-900 mb-2">Trade Channel Differentiation</h5>
                                            ...
                                            <div className="flex items-start p-6 bg-gray-50 rounded-2xl border-l-4 border-[rgb(110,94,147)]">
                                                <FontAwesomeIcon icon={faCheck} className="text-[rgb(110,94,147)] mt-1 mr-4 shrink-0" />
                                                <div>
                                                    <h5 className="font-bold text-gray-900 mb-2">Co-existence Agreements</h5>
                                    ...
                                    <section className="bg-black text-white p-12 rounded-[3rem] my-16 shadow-2xl relative overflow-hidden group">
                                        ...
                                        <h3 className="text-3xl md:text-5xl font-black mb-8 leading-tight">Don't Defend This Alone</h3>
                        ...
                        <aside className="hidden lg:block space-y-8 sticky top-32">
                            ...
                            <div className="bg-[#0C002B] p-8 rounded-3xl shadow-[0_20px_40px_rgba(0,0,0,0.1)] border border-gray-800 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-xl font-bold mb-4 relative z-10 leading-tight">Strong Defense Strategy</h4>
