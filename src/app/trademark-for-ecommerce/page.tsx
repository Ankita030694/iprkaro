          ...
          <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_300px] gap-8 items-start">
            ...
            <aside className="hidden lg:block sticky top-32">
              <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                <p className="text-gray-900 font-bold text-lg mb-6 border-l-4 border-[rgb(110,94,147)] pl-3">Digital Guide</p>
              ...
              <div className="bg-white p-4 md:p-12 rounded-2xl shadow-sm border border-gray-100 space-y-12 md:space-y-20">
                <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed font-normal">
                  ...
                  <section id="digital-gold-rush" className="scroll-mt-32">
                    <h2 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-6 leading-tight">Why Brand Security is the Bedrock of E-commerce Success</h2>
                    <p className="mb-6">
                  ...
                  <section id="naming-psychology" className="scroll-mt-32 border-t border-gray-100 pt-12">
                    <h3 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-6 leading-tight">The Psychology of E-commerce Brand Names: Descriptive vs. Arbitrary Marks</h3>
                    <p className="mb-6">
                  ...
                  <section id="madrid-step-by-step" className="scroll-mt-32 border-t border-gray-100 pt-12">
                    <h3 className="text-3xl md:text-5xl font-black text-gray-900 mb-12 text-center uppercase tracking-tighter">The Global IP Protocol (Madrid)</h3>
                    <div className="relative space-y-12">
                      ...
                      <div className="flex gap-8 items-start relative">
                        ...
                        <div className="p-8 bg-gray-50 rounded-3xl flex-1 hover:shadow-xl transition-shadow border border-gray-100">
                          <h4 className="text-xl font-bold mb-4 font-black">Basic Foundation</h4>
                      ...
                      <div className="flex gap-8 items-start relative">
                        ...
                        <div className="p-8 bg-gray-50 rounded-3xl flex-1 hover:shadow-xl transition-shadow border border-gray-100">
                          <h4 className="text-xl font-bold mb-4 font-black">WIPO Transcription</h4>
                      ...
                      <div className="flex gap-8 items-start relative">
                        ...
                        <div className="p-8 bg-gray-50 rounded-3xl flex-1 hover:shadow-xl transition-shadow border border-gray-100">
                          <h4 className="text-xl font-bold mb-4 font-black">Global Recognition</h4>
                  ...
                  <section id="handling-objections-ecommerce" className="scroll-mt-32 border-t border-gray-100 pt-12">
                    <h3 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-6 leading-tight">Digital Defense: Overcoming Registry Objections in E-commerce</h3>
                    <p className="mb-6">
                  ...
                  <section id="reviews-section" className="scroll-mt-32 border-t border-gray-100 pt-12">
                    <h3 className="text-4xl md:text-7xl font-black text-gray-900 mb-12 text-center tracking-tighter">Merchant Voices: IPR Karo Success Stories</h3>
                  ...
                  <section id="faqs" className="scroll-mt-32 border-t border-gray-100 pt-12">
                    <h3 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-12 text-center uppercase tracking-[0.3em] underline underline-offset-8 decoration-gray-200">The Intelligence Hub: Ecommerce FAQs</h3>
                  ...
                  <section className="bg-indigo-950 rounded-[4rem] p-12 md:p-24 text-center text-white relative overflow-hidden mt-12 shadow-2xl">
                    ...
                    <div className="relative z-10">
                      <h3 className="text-4xl md:text-8xl font-black mb-8 leading-tight tracking-tighter">Own Your Digital Future.</h3>
            ...
            <aside className="hidden lg:block space-y-8 sticky top-32">
              <div className="bg-[#0C002B] p-10 rounded-[2.5rem] shadow-2xl border border-gray-800 text-white group">
                <h4 className="text-2xl font-black mb-6 leading-tight">Brand Vitality Scan</h4>
              ...
              <div className="bg-gray-50 p-10 rounded-[2.5rem] border border-gray-100 shadow-sm relative overflow-hidden">
                ...
                <h4 className="text-[10px] font-black text-gray-400 mb-8 uppercase tracking-[0.4em]">Digital Verticals</h4>
