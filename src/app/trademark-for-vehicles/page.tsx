                ...
                <div className="flex flex-col lg:flex-row gap-12">
                    ...
                    <div className="flex-1 max-w-full lg:max-w-4xl order-1">
                        <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed font-normal">
                            ...
                            <section id="importance-of-trademark" className="scroll-mt-32">
                                <h2 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-6 leading-tight">Why Your Automotive Brand Needs a Trademark</h2>
                            ...
                            <section id="trademark-classes-auto" className="scroll-mt-32">
                                ...
                                <div className="grid md:grid-cols-2 gap-8 mb-12">
                                    <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                        ...
                                        <h4 className="font-bold text-xl mb-3 text-gray-900">Class 12: Locomotion</h4>
                                    ...
                                    <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                        ...
                                        <h4 className="font-bold text-xl mb-3 text-gray-900">Class 9: Intelligent Systems</h4>
                                        <p className="text-sm text-gray-700 leading-relaxed font-normal">
                                    ...
                                    <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                        ...
                                        <h4 className="font-bold text-xl mb-3 text-gray-900">Class 7: The Powerhouse</h4>
                                        <p className="text-sm text-gray-700 leading-relaxed font-normal">
                                    ...
                                    <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                        ...
                                        <h4 className="font-bold text-xl mb-3 text-gray-900">Class 37 & 35: Services</h4>
                                        <p className="text-sm text-gray-700 leading-relaxed font-normal">
                            ...
                            <section id="ev-and-smart-mobility" className="scroll-mt-32">
                                ...
                                <ul className="grid md:grid-cols-2 gap-6 list-none p-0 mb-12">
                                    <li className="flex items-start bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
                                        ...
                                        <div>
                                            <h5 className="font-bold text-gray-900 mb-1 text-sm uppercase">Software Interface (UI/UX)</h5>
                                    ...
                                    <li className="flex items-start bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
                                        ...
                                        <div>
                                            <h5 className="font-bold text-gray-900 mb-1 text-sm uppercase">Charging Infrastructure</h5>
                                    ...
                                    <li className="flex items-start bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
                                        ...
                                        <div>
                                            <h5 className="font-bold text-gray-900 mb-1 text-sm uppercase">Proprietary Battery Tech</h5>
                                    ...
                                    <li className="flex items-start bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
                                        ...
                                        <div>
                                            <h5 className="font-bold text-gray-900 mb-1 text-sm uppercase">Connected Services</h5>
                                ...
                                <div className="space-y-12">
                                    <div className="flex flex-col md:flex-row gap-8 items-start relative pb-12">
                                        ...
                                        <div className="flex-1">
                                            <h4 className="text-2xl font-black text-gray-900 mb-4">Multi-Class Clearance Search</h4>
                                    ...
                                    <div className="flex flex-col md:flex-row gap-8 items-start relative pb-12">
                                        ...
                                        <div className="flex-1">
                                            <h4 className="text-2xl font-black text-gray-900 mb-4">Strategic TM-A Drafting</h4>
                                            <p className="text-gray-700 mb-4">
                                    ...
                                    <div className="flex flex-col md:flex-row gap-8 items-start relative pb-12">
                                        ...
                                        <div className="flex-1">
                                            <h4 className="text-2xl font-black text-gray-900 mb-4">Handling Ministry Objections</h4>
                                            <p className="text-gray-700 mb-4">
                            ...
                            <section id="legal-case-studies" className="scroll-mt-32 pt-12">
                                ...
                                <div className="space-y-8">
                                    <div className="bg-gray-50 p-10 rounded-[2rem] border-2 border-dashed border-gray-200">
                                        <h4 className="text-2xl font-black text-gray-900 mb-4 uppercase tracking-tighter">Toyota vs. Prius Auto: The Global Goodwill Test</h4>
                                    ...
                                    <div className="bg-gray-50 p-10 rounded-[2rem] border-2 border-dashed border-gray-200">
                                        <h4 className="text-2xl font-black text-gray-900 mb-4 uppercase tracking-tighter">BMW vs. Om Balajee: The Phonetic Similarity Test</h4>
                                        <p className="text-gray-700 leading-relaxed italic border-b border-gray-200 pb-6 mb-6">
                            ...
                            <section id="spare-parts-legality" className="scroll-mt-32 pt-12">
                                ...
                                <div className="bg-yellow-50 border-l-8 border-yellow-400 p-8 my-10 rounded-r-2xl shadow-sm">
                                    <h5 className="font-black text-yellow-900 uppercase tracking-widest text-sm mb-4">Section 30(2)(d) of the Trade Marks Act</h5>
                                ...
                                <div className="grid md:grid-cols-2 gap-8 mb-12">
                                    <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-lg">
                                        <h5 className="font-bold text-gray-900 mb-4 uppercase text-sm tracking-widest">Permissible Use</h5>
                                    ...
                                    <div className="bg-white p-8 rounded-2xl border border-gray-100 shadow-lg border-t-4 border-t-red-500">
                                        <h5 className="font-bold text-gray-900 mb-4 uppercase text-sm tracking-widest">Infringing Use</h5>
                            ...
                            <section id="policing-and-enforcement" className="scroll-mt-32 pt-12">
                                ...
                                <div className="space-y-6 mb-12">
                                    <div className="flex gap-6 items-start p-6 bg-white border border-gray-100 rounded-2xl shadow-sm hover:border-[rgb(110,94,147)] transition-all">
                                        ...
                                        <div>
                                            <h5 className="font-bold text-gray-900 mb-2">John Doe Orders (Ex-Parte Injunctions)</h5>
                                    ...
                                    <div className="flex gap-6 items-start p-6 bg-white border border-gray-100 rounded-2xl shadow-sm hover:border-[rgb(110,94,147)] transition-all">
                                        ...
                                        <div>
                                            <h5 className="font-bold text-gray-900 mb-2">Criminal Raids & Seizures</h5>
                                            <p className="text-sm text-gray-500 leading-relaxed font-normal">
                                    ...
                                    <div className="flex gap-6 items-start p-6 bg-white border border-gray-100 rounded-2xl shadow-sm hover:border-[rgb(110,94,147)] transition-all">
                                        ...
                                        <div>
                                            <h5 className="font-bold text-gray-900 mb-2">Customs Recordation</h5>
                                            <p className="text-sm text-gray-500 leading-relaxed font-normal">
                            ...
                            <section id="licensing-and-dealerships" className="scroll-mt-32 pt-12">
                                ...
                                <div className="bg-[#0C002B] p-10 rounded-[2.5rem] text-white">
                                    <h5 className="text-xl font-bold mb-4">Protecting the 'Authorized' Status</h5>
                            ...
                            <section id="global-brand-protection" className="scroll-mt-32">
                                ...
                                <div className="bg-[#0C002B] text-white p-8 rounded-2xl shadow-xl relative overflow-hidden group">
                                    ...
                                    <div className="flex items-start gap-6 relative z-10">
                                        ...
                                        <div>
                                            <h5 className="font-bold text-xl mb-2">Exporting Parts or Vehicles?</h5>
                            ...
                            <section id="brand-valuation" className="scroll-mt-32">
                                ...
                                <div className="grid md:grid-cols-3 gap-6 mb-12">
                                    <div className="text-center p-6 border border-gray-100 rounded-xl shadow-sm">
                                        ...
                                        <h5 className="font-bold text-gray-900 text-sm mb-2">Licensed</h5>
                                    ...
                                    <div className="text-center p-6 border border-gray-100 rounded-xl shadow-sm">
                                        ...
                                        <h5 className="font-bold text-gray-900 text-sm mb-2">Pledged</h5>
                                    ...
                                    <div className="text-center p-6 border border-gray-100 rounded-xl shadow-sm">
                                        ...
                                        <h5 className="font-bold text-gray-900 text-sm mb-2">Hypothecated</h5>
                            ...
                            <section id="cost-of-registration" className="scroll-mt-32">
                                ...
                                <div className="grid md:grid-cols-2 gap-8">
                                    ...
                                    <div className="p-8 bg-[#0C002B] text-white rounded-3xl shadow-2xl flex flex-col items-center text-center relative border border-white/10">
                                        ...
                                        <h5 className="font-bold text-xl mb-4 text-gray-100">IPR Karo Service Fee</h5>
                            ...
                            <section className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[2.5rem] p-8 md:p-16 text-center text-white relative overflow-hidden mt-12 shadow-2xl border border-white/5">
                                ...
                                <div className="relative z-10">
                                    <h3 className="text-3xl md:text-5xl font-black mb-6 leading-tight uppercase tracking-tighter">Accelerate Your Brand's Legal Journey</h3>
                    ...
                    <aside className="lg:w-80 space-y-8 sticky top-32 h-[calc(100vh-100px)] overflow-y-auto pr-2 scrollbar-hide order-2 lg:order-3">
                        <div className="bg-[#0C002B] p-8 rounded-3xl shadow-2xl border border-gray-800 text-white relative overflow-hidden group">
                            ...
                            <h4 className="text-xl font-bold mb-4 relative z-10 leading-tight">Verify Your Brand Availability</h4>
                        ...
                        <div className="bg-white p-8 rounded-3xl shadow-xl border border-gray-100">
                            <h4 className="text-lg font-black text-gray-900 mb-6 border-b-2 border-[rgb(110,94,147)] pb-4 uppercase tracking-widest text-xs">Automotive Protection</h4>
