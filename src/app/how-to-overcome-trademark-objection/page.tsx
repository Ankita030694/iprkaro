          ...
          <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_300px] gap-8 items-start">
            ...
            <aside className="hidden lg:block sticky top-32 h-[calc(100vh-160px)] overflow-y-auto">
              <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                <p className="text-gray-900 font-bold text-lg mb-6 border-l-4 border-[rgb(110,94,147)] pl-3 italic uppercase tracking-[0.2em] font-black">Strategy Index</p>
              ...
              <div className="bg-white p-4 md:p-12 rounded-2xl shadow-sm border border-gray-100 space-y-12 md:space-y-20">
                ...
                <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed font-normal">
                  ...
                  <section id="logic-of-objection" className="scroll-mt-32">
                    <h3 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-6 leading-tight uppercase font-black italic tracking-tighter">
                    ...
                    <div className="grid md:grid-cols-3 gap-8 mb-10">
                      <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                         ...
                         <h4 className="font-bold text-lg mb-3 text-gray-900">Search Algorithms</h4>
                      ...
                      <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                         ...
                         <h4 className="font-bold text-lg mb-3 text-gray-900">Intrinsic Quality</h4>
                      ...
                      <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                         ...
                         <h4 className="font-bold text-lg mb-3 text-gray-900">Public Policy</h4>
                  ...
                  <section id="absolute-grounds" className="scroll-mt-32">
                    ...
                    <div className="bg-white border-2 border-gray-100 p-10 rounded-3xl shadow-sm mb-12">
                       <h4 className="text-2xl font-black text-[rgb(110,94,147)] mb-6 uppercase italic underline decoration-4 underline-offset-8 decoration-[rgb(110,94,147)]">The Acquired Distinctiveness Playbook</h4>
                  ...
                  <section id="relative-grounds" className="scroll-mt-32">
                    ...
                    <div className="grid md:grid-cols-2 gap-8 mb-10">
                       <div className="bg-[#0C002B] text-white p-8 rounded-3xl shadow-2xl group border border-white/5 relative overflow-hidden">
                          ...
                          <h5 className="text-xl font-black mb-4 uppercase italic relative z-10">Phonetic Disparity Analysis</h5>
                       ...
                       <div className="bg-gray-50 border border-gray-100 p-8 rounded-3xl hover:bg-white hover:shadow-xl transition-all">
                          <h5 className="text-xl font-black mb-4 uppercase italic text-gray-900">Class & Specification Rebuttal</h5>
                  ...
                  <section id="strategic-rebuttal" className="scroll-mt-32">
                    ...
                    <div className="bg-gray-50 p-10 rounded-[3rem] border border-gray-100 mb-12 shadow-sm">
                       <h4 className="text-xl md:text-2xl font-black text-gray-900 mb-6 uppercase tracking-widest text-center italic">The Rebuttal Structure</h4>
                    ...
                    <div className="grid md:grid-cols-2 gap-10">
                       <div className="space-y-6">
                          <div className="flex gap-4 items-start">
                             ...
                             <div>
                                <h5 className="font-bold text-gray-900">Commercial Invoices</h5>
                          ...
                          <div className="flex gap-4 items-start">
                             <div className="bg-green-100 text-green-600 p-2 rounded-full flex-shrink-0 mt-1"><FontAwesomeIcon icon={faCheck} className="w-4 h-4" /></div>
                             <div>
                                <h5 className="font-bold text-gray-900">Marketing Spends</h5>
                  ...
                  <section id="hearing-success" className="scroll-mt-32">
                    ...
                    <div className="bg-gray-50 p-8 md:p-12 rounded-[3.5rem] border border-gray-100 shadow-inner group">
                       <h4 className="text-xl font-black mb-6 uppercase tracking-widest text-center text-[rgb(110,94,147)] group-hover:scale-105 transition-transform">3 Tips for Hearing Win</h4>
                  ...
                  <section id="case-studies" className="scroll-mt-32">
                    <h3 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-12 text-center uppercase italic tracking-widest underline decoration-[rgb(110,94,147)] decoration-4 underline-offset-8">
                  ...
                  <section className="bg-gradient-to-br from-[#0C002B] to-[#1a0031] rounded-[4rem] p-10 md:p-20 text-center text-white relative overflow-hidden mt-12 shadow-[0_40px_100px_rgba(0,0,0,0.3)] group border border-white/5">
                     ...
                     <div className="relative z-10">
                        <h3 className="text-4xl md:text-6xl font-black mb-8 leading-tight uppercase italic tracking-tighter">Win Your Brand Battle</h3>
            ...
            <aside className="hidden lg:block space-y-8 sticky top-32">
              ...
              <div className="bg-[#0C002B] p-8 rounded-3xl shadow-[0_30px_60px_rgba(0,0,0,0.2)] border border-gray-800 text-white relative overflow-hidden group">
                 ...
                 <h4 className="text-xl font-bold mb-4 relative z-10 leading-tight uppercase font-black italic tracking-[0.1em]">Instant Status Fix</h4>
              ...
              <div className="bg-gray-50 p-8 rounded-3xl shadow-sm border border-gray-100">
                <h4 className="text-sm font-black text-gray-400 mb-6 border-b-2 border-gray-100 pb-4 uppercase tracking-widest italic">Legal Resources</h4>
