                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[220px_1fr_300px] gap-4 md:gap-12 mt-8 items-start">
                        ...
                        <div className="min-w-0">
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-xl md:rounded-2xl shadow-sm border border-gray-100 prose prose-lg max-w-none text-gray-800 font-sans">
                                ...
                                <section id="introduction" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h2 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6">Trade Mark Registration</h2>
                                    <p className="mb-4 leading-relaxed text-lg">
                                        In the brutally competitive and rapidly expanding corridors of modern Indian commerce, a brand's distinctly unique identity is undeniably its most powerful, revenue-generating weapon.
                                    </p>
                                    <p className="mb-4 leading-relaxed text-lg">
                                        When we analytically discuss professional <strong>trade mark registration</strong>, we are deeply exploring the absolute foundational legal bedrock of consumer trust, perceived quality, and market exclusivity that a forward-looking business meticulously builds with its loyal customers over years of operation.
                                    </p>
                                    <p className="mb-4 leading-relaxed text-lg">
                                        An official trade mark is exponentially more than just a fleeting marketing tool or an aesthetic logo; it is a highly proprietary, deeply valuable corporate asset that strictly signifies commercial origin and absolutely guarantees product consistency in a relentlessly crowded, noisy marketplace.
                                    </p>
                                    <p className="mb-4 leading-relaxed text-lg">
                                        The decisive act of formally registering a trade mark in the dynamic economy of Bharat is a profound, public declaration of authentic business maturity and strategic foresight.
                                    </p>
                                    <p className="mb-4 leading-relaxed text-lg">
                                        It explicitly demonstrates to investors, competitors, and consumers alike that you are not merely thinking about generating today's quick sales, but are heavily invested in deliberately forging tomorrow's enduring legacy.
                                    </p>
                                    <p className="mb-4 leading-relaxed text-lg">
                                        By proactively securing your overarching corporate identity through statutory legal means, you effectively create an insurmountable, legally-enforced barrier to entry for unethical competitors and simultaneously establish a luminous beacon of reliability for your desired target audience.
                                    </p>
                                    <p className="mb-4 leading-relaxed text-lg">
                                        In this hyper-connected era of borderless, globalized trade, your protected mark serves as your most authoritative, legally-binding handshake with the entire commercial world.
                                    </p>
                                    <p className="mb-4 leading-relaxed text-lg">
                                        IPR Karo has passionately pioneered a dramatically streamlined, technology-driven approach to what is traditionally complex and archaic intellectual property law.
                                    </p>
                                    <p className="mb-4 leading-relaxed text-lg">
                                        We resolutely believe that legally securing your core brand identity should be exactly as intuitive, efficient, and transparent as actively building your flagship product.
                                    </p>
                                    <p className="mb-4 leading-relaxed text-lg">
                                ...
                                <section id="definition" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Defining the Trade Mark: Legal and Commercial Perspectives</h3>
                                    <p className="mb-4 leading-relaxed text-lg">
                                        What exactly is a "Trade Mark"? According to the Trade Marks Act, it is a mark "capable of being represented graphically and which is capable of distinguishing the goods or services of one person from those of others."
                                    </p>
                                    <p className="mb-4 leading-relaxed text-lg">
                                        This definition encompasses names, logos, slogans, device marks, and even unique packaging shapes.
                                    </p>
                                    <p className="mb-4 leading-relaxed text-lg">
                                        Commercially, a trade mark is a promise. It promises a specific level of performance, a particular aesthetic, and a defined set of values.
                                    </p>
                                    <p className="mb-4 leading-relaxed text-lg">
                                        When a customer sees your mark, they shouldn't just think of a product; they should feel an association with your company's mission.
                                    </p>
                                    <p className="mb-4 leading-relaxed text-lg">
                                        Registration protects this emotional and financial connection from being diluted or stolen by imitators.
                                    </p>
                                </section>

                                <section id="relevance" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Why the Multi Word "Trade Mark" terminology is crucial</h3>
                                    ...
                                    <div className="bg-gray-50 border border-gray-100 p-8 rounded-3xl my-10">
                                        <h5 className="font-bold text-[#0C002B] mb-4">Key Distinctions in Usage</h5>
                                ...
                                <section id="act-nuances" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Diving into the Trade Marks Act of 1999</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-gray-800">
                                    ...
                                    <div className="grid md:grid-cols-2 gap-8 my-10">
                                        <div className="flex gap-4 p-6 bg-white rounded-2xl border border-gray-100 shadow-sm">
                                            ...
                                            <div>
                                                <h6 className="font-bold mb-1">Service Marks</h6>
                                        ...
                                        <div className="flex gap-4 p-6 bg-white rounded-2xl border border-gray-100 shadow-sm">
                                            ...
                                            <div>
                                                <h6 className="font-bold mb-1">Collective Marks</h6>
                                                <p className="text-sm opacity-80">Allowing associations to protect a common brand for all their members.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <p className="mb-4 leading-relaxed text-lg">
                                        The Act provides a fine balance between the rights of the mark owner and the rights of the public to use common language.
                                    </p>
                                    <p className="mb-4 leading-relaxed text-lg">
                                        It outlines 'Absolute Grounds for Refusal' (Section 9) which prevents the monopolization of generic words, and 'Relative Grounds' (Section 11) which prevents confusion with earlier registered brands.
                                    </p>
                                </section>

                                <section id="filing-journey" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">The Journey: From Idea to Registered Trade Mark</h3>
                                    ...
                                    <div className="space-y-12 my-10">
                                        <div className="relative pl-12 before:absolute before:left-5 before:top-2 before:bottom-0 before:w-0.5 before:bg-gray-200 last:before:hidden">
                                            ...
                                            <h5 className="font-bold text-xl mb-2 text-[#6E5E93]">Preliminary Strategic Search</h5>
                                        ...
                                        <div className="relative pl-12 before:absolute before:left-5 before:top-2 before:bottom-0 before:w-0.5 before:bg-gray-200 last:before:hidden">
                                            ...
                                            <h5 className="font-bold text-xl mb-2 text-[#6E5E93]">Online Application Submission (TM-A)</h5>
                                        ...
                                        <div className="relative pl-12 before:absolute before:left-5 before:top-2 before:bottom-0 before:w-0.5 before:bg-gray-200 last:before:hidden">
                                            ...
                                            <h5 className="font-bold text-xl mb-2 text-[#6E5E93]">Examination and Objection Management</h5>
                                        ...
                                        <div className="relative pl-12 before:absolute before:left-5 before:top-2 before:bottom-0 before:w-0.5 before:bg-gray-200 last:before:hidden">
                                            ...
                                            <h5 className="font-bold text-xl mb-2 text-[#6E5E93]">Registration Certificate Issuance</h5>
                                ...
                                <section id="doc-checklist" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Consolidated Checklist: Documents for a Smooth Filing</h3>
                                    ...
                                    <div className="grid md:grid-cols-2 gap-8 my-10">
                                        <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100 h-full">
                                            <h5 className="font-bold text-[#0C002B] border-b pb-4 mb-4">Core Identity Docs</h5>
                                        ...
                                        <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100 h-full">
                                            <h5 className="font-bold text-[#0C002B] border-b pb-4 mb-4">Specific Asset Docs</h5>
                                            <ul className="space-y-3">
                                ...
                                <section id="fee-analysis" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Economic Analysis of Costs for 2026</h3>
                                    <p className="mb-8 leading-relaxed text-lg text-gray-800">
                                    ...
                                    <div className="flex flex-col md:flex-row gap-8 my-12">
                                        <div className="flex-1 p-10 bg-gradient-to-br from-[#0C002B] to-[#160049] rounded-3xl text-white shadow-2xl hover:scale-105 transition-transform">
                                            <h5 className="font-bold text-4xl mb-4">₹4,500</h5>
                                        ...
                                        <div className="flex-1 p-10 bg-white border-2 border-gray-100 rounded-3xl text-[#0C002B] shadow-xl hover:scale-105 transition-transform">
                                            <h5 className="font-bold text-4xl mb-4">₹9,000</h5>
                                ...
                                <section id="search-necessity" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">The Pre Filing Search: Your Preventive Medicine</h3>
                                    <p className="mb-6 leading-relaxed text-lg text-gray-800">
                                        Filing without a search is like driving blindfolded.
                                    </p>
                                    <p className="mb-6 leading-relaxed text-lg text-gray-800">
                                        A <strong>trade mark registration</strong> search allows us to identify phononetic and visual matches that could lead to a rejection.
                                    </p>
                                    <div className="p-8 bg-blue-50 rounded-3xl border border-blue-100 my-10">
                                        <h5 className="font-bold text-blue-900 mb-4">What our Search covers:</h5>
                                ...
                                <section id="trademark-infringement" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Guarding Against Corporate Trade Mark Infringement</h3>
                                    <p className="mb-6 leading-relaxed text-lg">
                                        For rapidly scaling organizations, unauthorized exploitation of business identity represents a severe existential threat.
                                    </p>
                                    <p className="mb-6 leading-relaxed text-lg">
                                        Trade mark infringement legally occurs when an unassociated third party leverages a mark that is deceptively identical or confusingly similar to your registered and protected brand name, specifically for marketing identical or closely related commercial goods or services.
                                    </p>
                                    <p className="mb-6 leading-relaxed text-lg">
                                        This unethical usage purposefully creates deep-rooted consumer confusion, directly cannibalizing your rightful sales revenue and critically eroding the premium brand equity you spent heavily to develop.
                                    </p>
                                    <p className="mb-4 leading-relaxed text-lg">
                                        Armed with a formal registration certificate issued under the <strong>Trade Marks Act, 1999</strong>, corporate entities secure indispensable statutory powers to effortlessly crush infringement.
                                    </p>
                                    <p className="mb-4 leading-relaxed text-lg">
                                        You gain the sweeping legal authority to enforce debilitating civil injunctions, immediately physically seize counterfeit inventory through authorized police raids under swift criminal provisions, and relentlessly pursue heavy monetary compensation or 'accounts of profits' through the high courts.
                                    </p>
                                    <p className="mb-4 leading-relaxed text-lg">
                                ...
                                <section id="common-mistakes" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Critical Filing Errors That Paralyze Registration</h3>
                                    <p className="mb-6 leading-relaxed text-lg">
                                ...
                                <section id="faqs" className="mb-16 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-3xl md:text-5xl font-bold text-[#0C002B] mb-12 text-center text-gray-800">Frequently Asked Questions</h3>
                                    <div className="space-y-8 max-w-4xl mx-auto">
                                        {faqs.map((faq, index) => (
                                            <div key={index} className="border-b border-gray-100 pb-10 last:border-0 p-8 rounded-3xl hover:bg-gray-50 transition-all hover:shadow-sm text-gray-800">
                                                <h4 className="text-xl md:text-2xl font-bold text-[#0C002B] mb-5 flex gap-4 items-start">
                                ...
                                <section id="reviews" className="mb-16 scroll-mt-24 md:scroll-mt-32">
                                    <div className="py-16 bg-[#0C002B] rounded-3xl relative overflow-hidden">
                                        ...
                                        <div className="max-w-6xl mx-auto px-6">
                                            <h3 className="text-3xl md:text-4xl font-bold text-white mb-4 text-center">What <span className="text-[#FFB703]">Business Owners</span> Say About Registration</h3>
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                                <div className="p-6 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm">
                                                    <div className="flex items-center gap-4 mb-4">
                                                        ...
                                                        <div><h4 className="text-white font-bold">Varun Thakur</h4><p className="text-white/50 text-xs">Founder, Streetwear Brand</p></div>
                                                    </div>
                                                ...
                                                <div className="p-6 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm">
                                                    <div className="flex items-center gap-4 mb-4">
                                                        ...
                                                        <div><h4 className="text-white font-bold">Anjali Goel</h4><p className="text-white/50 text-xs">Director, Home Furnishing Company</p></div>
                                                    </div>
                                                    <div className="mb-3 text-[#FFB703] text-sm flex gap-1">★★★★★</div>
                                                ...
                                                <div className="p-6 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm">
                                                    <div className="flex items-center gap-4 mb-4">
                                                        ...
                                                        <div><h4 className="text-white font-bold">Manish Kumar</h4><p className="text-white/50 text-xs">CEO, Logistics Startup</p></div>
                                                    </div>
                                                    <div className="mb-3 text-[#FFB703] text-sm flex gap-1">★★★★★</div>
                                ...
                                <section id="conclusion" className="mb-12 scroll-mt-24 md:scroll-mt-32 text-gray-800">
                                    <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6 text-center">Nishkarsh: Elevating Your Brand Integrity</h3>
                                ...
                                <div className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[42px] p-12 md:p-24 text-center text-white relative overflow-hidden mt-20 shadow-2xl">
                                    <div className="relative z-10">
                                        <h3 className="text-3xl md:text-5xl font-bold mb-6 italic">Secure Your Legacy Today</h3>
                        ...
                        <aside className="hidden lg:block space-y-10 sticky top-32">
                            ...
                            <div className="bg-[#160049] p-8 rounded-3xl shadow-xl border border-gray-800 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-2xl font-bold mb-4 relative z-10">Free Legal Search</h4>
                            ...
                            <div className="bg-gray-50 p-8 rounded-3xl shadow-sm border border-gray-100 text-gray-800">
                                <h4 className="text-xl font-bold text-[#0C002B] mb-6 border-b pb-4">Explore More</h4>
