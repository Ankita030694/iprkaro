                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[220px_1fr_300px] gap-4 md:gap-12 mt-8 items-start">
                        ...
                        <div className="min-w-0">
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-xl md:rounded-2xl shadow-sm border border-gray-100 prose prose-lg max-w-none text-gray-800 font-sans">
                                ...
                                <section id="introduction" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h2 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6">The Rise of Intellectual Property in Bharat</h2>
                                ...
                                <section id="legal-framework" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">The Statutory Architecture: From 1999 to the Digital Era</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-gray-800">
                                    ...
                                    <div className="grid md:grid-cols-2 gap-8 my-10">
                                        <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100 shadow-sm transition-all hover:bg-white hover:shadow-md">
                                            <h5 className="font-bold text-[#160049] text-xl mb-4 flex items-center">
                                ...
                                <section id="why-india" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Why Protecting Your Mark in India is Non Negotiable</h3>
                                ...
                                <section id="registry-offices" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Jurisdictional Map: The Five Trademark Offices</h3>
                                    ...
                                    <div className="grid grid-cols-2 md:grid-cols-5 gap-4 my-10 text-center">
                                        <div className="p-4 bg-gray-50 rounded-xl border border-gray-100">
                                            <h6 className="font-bold text-[#6E5E93]">Delhi</h6>
                                            <p className="text-xs opacity-60">North India</p>
                                        </div>
                                        <div className="p-4 bg-gray-50 rounded-xl border border-gray-100">
                                            <h6 className="font-bold text-[#6E5E93]">Mumbai</h6>
                                            <p className="text-xs opacity-60">West/Central</p>
                                        </div>
                                        <div className="p-4 bg-gray-50 rounded-xl border border-gray-100">
                                            <h6 className="font-bold text-[#6E5E93]">Chennai</h6>
                                            <p className="text-xs opacity-60">South India</p>
                                        </div>
                                        <div className="p-4 bg-gray-50 rounded-xl border border-gray-100">
                                            <h6 className="font-bold text-[#6E5E93]">Kolkata</h6>
                                            <p className="text-xs opacity-60">East India</p>
                                        </div>
                                        <div className="p-4 bg-gray-50 rounded-xl border border-gray-100">
                                            <h6 className="font-bold text-[#6E5E93]">Ahmedabad</h6>
                                ...
                                <section id="startup-incentives" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Incentives for Startups & MSMEs in Bharat</h3>
                                    <p className="mb-4 leading-relaxed text-lg">
                                    ...
                                    <div className="p-8 bg-[#0C002B] text-white rounded-[2rem] shadow-xl my-10">
                                        <h5 className="font-bold text-2xl mb-4 italic text-[#6E5E93]">The MSME Dividend</h5>
                                ...
                                <section id="trademark-infringement" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Addressing Trademark Infringement in India</h3>
                                ...
                                <section id="common-mistakes" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Fatal Blunders to Avoid During Trademark Application</h3>
                                    <p className="mb-6 leading-relaxed text-lg">
                                ...
                                <section id="reviews" className="mb-16 scroll-mt-24 md:scroll-mt-32">
                                    <div className="py-16 bg-[#0C002B] rounded-3xl relative overflow-hidden">
                                        ...
                                        <div className="max-w-6xl mx-auto px-6">
                                            <h3 className="text-3xl md:text-4xl font-bold text-white mb-4 text-center">Voices from <span className="text-[#FFB703]">Across Bharat</span></h3>
                                            ...
                                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                                <div className="p-6 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm">
                                                    <div className="flex items-center gap-4 mb-4">
                                                        ...
                                                        <div><h4 className="text-white font-bold">Pooja Pandey</h4><p className="text-white/50 text-xs">Founder, Handicraft Export House</p></div>
                                                    </div>
                                                ...
                                                <div className="p-6 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm">
                                                    <div className="flex items-center gap-4 mb-4">
                                                        ...
                                                        <div><h4 className="text-white font-bold">Aditya Srinivasan</h4><p className="text-white/50 text-xs">MD, Chennai-based Pharma Company</p></div>
                                                    </div>
                                                    <div className="mb-3 text-[#FFB703] text-sm flex gap-1">★★★★★</div>
                                                ...
                                                <div className="p-6 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-sm">
                                                    <div className="flex items-center gap-4 mb-4">
                                                        ...
                                                        <div><h4 className="text-white font-bold">Lakshmi Subramaniam</h4><p className="text-white/50 text-xs">Owner, Traditional Silk Saree Brand</p></div>
                                                    </div>
                                                    <div className="mb-3 text-[#FFB703] text-sm flex gap-1">★★★★★</div>
                                ...
                                <section id="conclusion" className="mb-12 scroll-mt-24 md:scroll-mt-32 text-gray-800">
                                    <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6 text-center">Nishkarsh: Building a Resilient Brand in the Indian Era</h3>
                                ...
                                <div className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[48px] p-12 md:p-24 text-center text-white relative overflow-hidden mt-20 shadow-2xl">
                                    <div className="relative z-10">
                                        <h3 className="text-3xl md:text-5xl font-bold mb-6 italic">Secure Your Piece of the Indian Market</h3>
                        ...
                        <aside className="hidden lg:block space-y-10 sticky top-32">
                            ...
                            <div className="bg-[#160049] p-8 rounded-3xl shadow-xl border border-gray-800 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-2xl font-bold mb-4 relative z-10">National Protection</h4>
