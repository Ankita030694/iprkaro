                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_300px] gap-8 items-start">
                                ...
                                <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed font-normal">
                                    ...
                                    <section id="why-trademark-matters" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8 mb-10 text-balance">
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                                ...
                                                <h4 className="font-bold text-xl mb-3 text-gray-900">Preventing Total Brand Confusion</h4>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                                ...
                                                <h4 className="font-bold text-xl mb-3 text-gray-900">Legal Shield Against Infringers</h4>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                                ...
                                                <h4 className="font-bold text-xl mb-3 text-gray-900">Platform for Seamless Expansion</h4>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                                ...
                                                <h4 className="font-bold text-xl mb-3 text-gray-900">Securing Venture Funding</h4>
                                    ...
                                    <section id="class-39-deep-dive" className="scroll-mt-32">
                                        ...
                                        <div className="space-y-6">
                                            ...
                                            <div className="p-8 bg-blue-50 rounded-2xl border-l-4 border-blue-400">
                                                <h5 className="font-bold text-blue-900 mb-2 font-nunito uppercase tracking-tight">The "Hybrid" Class Challenge</h5>
                                        ...
                                        <section id="trade-dress-protection" className="scroll-mt-32 pt-12">
                                            ...
                                            <div className="bg-gray-100 p-8 rounded-3xl my-10 border-l-8 border-gray-300">
                                                <h5 className="font-bold text-gray-900 mb-4 uppercase tracking-widest text-sm">Case Study: The Power of Color</h5>
                                        ...
                                        <div className="relative space-y-12">
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900 uppercase tracking-tighter font-nunito">Step 1: Scientific Search Discovery</h4>
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900 uppercase tracking-tighter font-nunito">Step 2: Expert Drafting and Filing</h4>
                                                    <p className="text-base text-gray-600 leading-relaxed">
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900 uppercase tracking-tighter font-nunito">Step 3: Response to Examination</h4>
                                                    <p className="text-base text-gray-600 leading-relaxed">
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900 uppercase tracking-tighter font-nunito">Step 4: Publication and Journal Monitoring</h4>
                                                    <p className="text-base text-gray-600 leading-relaxed">
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all border-2 border-[rgb(110,94,147)]">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900 uppercase tracking-tighter font-nunito">Step 5: Registration and Certification</h4>
                                    ...
                                    <section id="documents-required" className="scroll-mt-32 border-t border-gray-100 pt-20">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8">
                                            <div className="p-8 bg-white border border-gray-100 rounded-2xl shadow-sm hover:shadow-md transition-shadow">
                                                <h5 className="font-bold text-xl mb-6 border-b pb-4 text-[rgb(110,94,147)] font-nunito">For Individuals & MSMEs</h5>
                                            ...
                                            <div className="p-8 bg-white border border-gray-100 rounded-2xl shadow-sm hover:shadow-md transition-shadow">
                                                <h5 className="font-bold text-xl mb-6 border-b pb-4 text-[rgb(110,94,147)] font-nunito">For Companies & LLPs</h5>
                                                <ul className="space-y-4">
                                    ...
                                    <section id="case-studies" className="scroll-mt-32 pt-12">
                                        ...
                                        <div className="bg-red-50 border-r-4 border-red-200 p-8 my-10 rounded-l-2xl shadow-sm">
                                            <h5 className="font-bold text-red-900 mb-2 uppercase text-xs tracking-widest">Legal Warning</h5>
                                    ...
                                    <section id="business-valuation" className="scroll-mt-32">
                                        ...
                                        <div className="bg-black text-white p-12 rounded-[2.5rem] shadow-2xl relative overflow-hidden my-12 group">
                                            ...
                                            <div className="relative z-10">
                                                <h4 className="text-2xl font-bold mb-6 italic text-[rgb(110,94,147)]">"A registered trademark is the only asset that becomes more valuable the more you use it. In a business exit or acquisition, the brand value often exceeds the value of the physical fleet."</h4>
                                    ...
                                    <section id="global-expansion" className="scroll-mt-32 pt-12">
                                        ...
                                        <div className="p-8 bg-indigo-50 rounded-2xl border-2 border-indigo-100 flex gap-6 items-center my-10">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-indigo-900 mb-1">Ambitious? Think Madrid Protocol</h5>
                                    ...
                                    <section id="pricing" className="scroll-mt-32 pt-12 border-t border-gray-100">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                                            <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100 flex flex-col items-center text-center shadow-sm hover:shadow-md transition-shadow">
                                                ...
                                                <h5 className="font-bold text-xl mb-4 text-gray-900 uppercase tracking-tighter font-nunito">Government Filing Fees</h5>
                                            ...
                                            <div className="p-8 bg-[rgb(110,94,147)] text-white rounded-3xl shadow-xl flex flex-col items-center text-center relative overflow-hidden group">
                                                ...
                                                <h5 className="font-bold text-xl mb-4 uppercase tracking-tighter font-nunito">IPR Karo Service Fee</h5>
                                    ...
                                    <section className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[3rem] p-8 md:p-20 text-center text-white relative overflow-hidden mt-20 shadow-[-20px_20px_60px_rgba(110,94,147,0.3)]">
                                        ...
                                        <div className="relative z-10">
                                            <h3 className="text-3xl md:text-5xl font-black mb-8 leading-tight uppercase tracking-tight">Your Brand Is Your Value. <br />Protect It Today.</h3>
                        ...
                        <aside className="hidden lg:block space-y-8 sticky top-32 h-[calc(100vh-140px)] overflow-y-auto no-scrollbar">
                            ...
                            <div className="bg-[#0C002B] p-8 rounded-3xl shadow-[0_20px_40px_rgba(0,0,0,0.1)] border border-gray-800 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-xl font-bold mb-4 relative z-10 leading-tight uppercase tracking-tighter font-nunito">Check Your Brand Name Availability</h4>
                            ...
                            <div className="bg-gray-50 p-10 rounded-[2rem] shadow-sm border border-gray-100">
                                <h4 className="text-lg font-black text-gray-900 mb-8 border-b-2 border-[rgb(110,94,147)] pb-4 uppercase tracking-widest text-center font-nunito">Industry Specific</h4>
