            ...
            <div className="min-w-0">
              ...
              <div className="bg-white p-4 md:p-12 rounded-xl md:rounded-2xl shadow-sm space-y-8 md:space-y-16">
                ...
                <section id="introduction" className="scroll-mt-24 md:scroll-mt-32">
                  <h2 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Trademarks for Indian Startups</h2>
                ...
                <section id="why-need-trademark" className="scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Why Your Startup Needs a Trademark Immediately</h3>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="bg-gray-50 p-6 rounded-lg">
                       <h4 className="font-bold text-lg mb-2 text-[rgb(110,94,147)] flex items-center">
                ...
                <section id="sipp-scheme" className="scroll-mt-24 md:scroll-mt-32">
                   <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">The Startup India IP Protection Scheme (SIPP) Explained</h3>
                   <p className="text-base md:text-lg leading-relaxed mb-4 text-gray-700">
                   ...
                   <div className="space-y-4">
                      <div className="flex items-start gap-4 p-4 bg-purple-50 rounded-lg">
                         ...
                         <div>
                            <h5 className="font-bold text-gray-900">Free Legal Facilitation</h5>
                      ...
                      <div className="flex items-start gap-4 p-4 bg-purple-50 rounded-lg">
                         ...
                         <div>
                            <h5 className="font-bold text-gray-900">End-to-End Support</h5>
                      ...
                      <div className="flex items-start gap-4 p-4 bg-purple-50 rounded-lg">
                         ...
                         <div>
                            <h5 className="font-bold text-gray-900">Fast-Track Processing</h5>
                ...
                <section id="saving-costs" className="scroll-mt-24 md:scroll-mt-32">
                   <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Saving Costs: Government Fee Concessions</h3>
                   <p className="text-base md:text-lg leading-relaxed mb-6 text-gray-700">
                ...
                <section id="types-of-trademarks" className="scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Types of Trademarks Your Startup Should Consider</h3>
                  <div className="space-y-6">
                     <div className="flex gap-6">
                        ...
                        <div>
                           <h4 className="font-bold text-xl mb-1">Word Marks</h4>
                     ...
                     <div className="flex gap-6">
                        ...
                        <div>
                           <h4 className="font-bold text-xl mb-1">Device Marks (Logos)</h4>
                     ...
                     <div className="flex gap-6">
                        ...
                        <div>
                           <h4 className="font-bold text-xl mb-1">Taglines & Slogans</h4>
                ...
                <section id="registration-process" className="scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Step-by-Step Guide to the Registration Process</h3>
                  <div className="relative border-l-2 border-purple-100 ml-4 pl-8 space-y-12">
                     <div className="relative">
                        ...
                        <h4 className="font-bold text-lg mb-2">Step 1: The Comprehensive Search</h4>
                     ...
                     <div className="relative">
                        <div className="absolute -left-10 top-0 w-4 h-4 bg-[rgb(110,94,147)] rounded-full border-4 border-white shadow-sm"></div>
                        <h4 className="font-bold text-lg mb-2">Step 2: Filing Form TM-A</h4>
                     ...
                     <div className="relative">
                        <div className="absolute -left-10 top-0 w-4 h-4 bg-[rgb(110,94,147)] rounded-full border-4 border-white shadow-sm"></div>
                        <h4 className="font-bold text-lg mb-2">Step 3: Examination & Reply</h4>
                     ...
                     <div className="relative">
                        <div className="absolute -left-10 top-0 w-4 h-4 bg-[rgb(110,94,147)] rounded-full border-4 border-white shadow-sm"></div>
                        <h4 className="font-bold text-lg mb-2">Step 4: Journal Publication</h4>
                     ...
                     <div className="relative">
                        <div className="absolute -left-10 top-0 w-4 h-4 bg-[rgb(110,94,147)] rounded-full border-4 border-white shadow-sm"></div>
                        <h4 className="font-bold text-lg mb-2">Step 5: Registration Certificate</h4>
                ...
                <section id="choosing-class" className="scroll-mt-24 md:scroll-mt-32">
                   <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Choosing the Right Trademark Class</h3>
                   <p className="text-base md:text-lg leading-relaxed mb-6 text-gray-700">
                ...
                <section id="documents-checklist" className="scroll-mt-24 md:scroll-mt-32">
                   <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Essential Documents Checklist</h3>
                ...
                <section id="overcoming-objections" className="scroll-mt-24 md:scroll-mt-32">
                   <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Overcoming Trademark Objections</h3>
                   <div className="grid md:grid-cols-2 gap-6">
                      <div className="p-6 bg-red-50 rounded-xl border border-red-100">
                         <h4 className="font-bold text-red-800 mb-2">Section 9 (Absolute)</h4>
                      ...
                      <div className="p-6 bg-red-50 rounded-xl border border-red-100">
                         <h4 className="font-bold text-red-800 mb-2">Section 11 (Relative)</h4>
                ...
                <section id="opposition-proceedings" className="scroll-mt-24 md:scroll-mt-32">
                   <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Defending Your Brand in Opposition</h3>
                   <p className="text-base md:text-lg leading-relaxed mb-6 text-gray-700">
                   ...
                   <div className="flex flex-col md:flex-row gap-6">
                      <div className="flex-1 p-4 bg-gray-50 rounded-lg">
                         <h5 className="font-bold text-gray-900 mb-2">Common Grounds</h5>
                      ...
                      <div className="flex-1 p-4 bg-gray-50 rounded-lg">
                         <h5 className="font-bold text-gray-900 mb-2">The Procedure</h5>
                         <ul className="text-sm text-gray-600 list-disc pl-4 space-y-1">
                ...
                <section id="global-registration" className="scroll-mt-24 md:scroll-mt-32">
                   <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Going Global: The Madrid Protocol for Export-Oriented Startups</h3>
                   <p className="text-base md:text-lg leading-relaxed mb-4 text-gray-700">
                   ...
                   <div className="bg-gradient-to-r from-purple-100 to-blue-100 p-6 rounded-xl">
                      <div className="flex items-center gap-4 mb-4">
                         ...
                         <h4 className="font-bold text-xl text-gray-900">One Application, 130 Countries</h4>
                      </div>
                ...
                <section id="monitoring-enforcement" className="scroll-mt-24 md:scroll-mt-32">
                   <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Monitoring and Enforcement: Guarding Your Market Share</h3>
                   <p className="text-base md:text-lg leading-relaxed mb-6 text-gray-700">
                   ...
                   <div className="grid md:grid-cols-2 gap-8">
                      <div>
                         <h5 className="font-bold text-[rgb(110,94,147)] mb-3 flex items-center">
                ...
                <section id="choosing-service" className="scroll-mt-24 md:scroll-mt-32">
                   <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">How to Identify the Best Filing Service for Your Startup</h3>
                   <p className="text-base md:text-lg leading-relaxed mb-6 text-gray-700">
                   ...
                   <div className="grid md:grid-cols-2 gap-4">
                      <div className="p-4 border border-gray-100 rounded-lg">
                         <h6 className="font-bold mb-1">IP Law Specialization</h6>
                      ...
                      <div className="p-4 border border-gray-100 rounded-lg">
                         <h6 className="font-bold mb-1">Track Record in Litigation</h6>
                      ...
                      <div className="p-4 border border-gray-100 rounded-lg">
                         <h6 className="font-bold mb-1">Tech-Enabled Transparency</h6>
                      ...
                      <div className="p-4 border border-gray-100 rounded-lg">
                         <h6 className="font-bold mb-1">Focus on Startup Benefits</h6>
                ...
                <section id="why-iprkaro" className="scroll-mt-24 md:scroll-mt-32 bg-black text-white p-6 md:p-12 rounded-xl md:rounded-3xl relative overflow-hidden">
                   ...
                   <h3 className="text-xl md:text-3xl font-bold mb-8 relative z-10">Why IPR Karo is the Strategic Partner for Indian Startups</h3>
                   ...
                   <div className="grid md:grid-cols-2 gap-8 relative z-10">
                      <div className="flex gap-4">
                         ...
                         <div>
                            <h5 className="font-bold text-lg mb-1">Expert Legal Team</h5>
                      ...
                      <div className="flex gap-4">
                         ...
                         <div>
                            <h5 className="font-bold text-lg mb-1">SIPP Facilitation</h5>
                      ...
                      <div className="flex gap-4">
                         ...
                         <div>
                            <h5 className="font-bold text-lg mb-1">Full Lifecycle Support</h5>
                      ...
                      <div className="flex gap-4">
                         ...
                         <div>
                            <h5 className="font-bold text-lg mb-1">Founder-First Approach</h5>
                ...
                <section id="faqs" className="scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-6 md:mb-8">Frequently Asked Questions</h3>
                  <div className="space-y-4 md:space-y-6">
                    {faqs.map((faq, index) => (
                      <div key={index} className="border-b border-gray-200 pb-6 md:pb-8 last:border-0">
                        <h4 className="text-base md:text-xl font-bold text-gray-900 mb-2 md:mb-4 flex items-start">
                ...
                <section id="client-reviews" className="scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-6 md:mb-8">What Our Founders Say</h3>
                ...
                <section className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-xl md:rounded-3xl p-6 md:p-16 text-center text-white relative overflow-hidden mt-8 md:mt-12">
                   <div className="relative z-10">
                    <h3 className="text-xl md:text-4xl font-bold mb-4 md:mb-6">Secure Your Brand Today</h3>
             ...
             <div className="hidden lg:block space-y-8 sticky top-32">
                ...
                <div className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] p-6 rounded-xl shadow-lg border border-gray-800 text-white text-center">
                  <h4 className="text-xl font-bold mb-3">Startup Enquiry</h4>
