                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_320px] gap-4 md:gap-12 mt-8 items-start">
                        ...
                        <div className="min-w-0">
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-xl md:rounded-2xl shadow-sm border border-gray-100 prose prose-lg max-w-none text-gray-800 font-sans">
                                ...
                                <section id="introduction" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h2 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6">Introduction to the IP Divide</h2>
                                ...
                                <section id="historical-context" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Historical Evolution: The 2003 Service Mark Revolution</h3>
                                ...
                                <section id="classification" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">The Classification Matrix: Classes 1-34 vs. 35-45</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify text-justify">
                                    ...
                                    <div className="space-y-6 my-10">
                                        <div className="flex gap-6 p-8 bg-[#0C002B] text-white rounded-[2.5rem] shadow-xl relative overflow-hidden group">
                                            ...
                                            <div>
                                                <h5 className="text-2xl font-bold mb-2">The World of Goods (Classes 1-34)</h5>
                                        ...
                                        <div className="flex gap-6 p-8 bg-gray-50 border border-gray-200 rounded-[2.5rem] group hover:border-[#6E5E93] transition-colors relative">
                                            ...
                                            <div>
                                                <h5 className="text-2xl font-bold mb-2 text-[#0C002B]">The Era of Services (Classes 35-45)</h5>
                                ...
                                <section id="evidence-use" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Practical Differences: How Evidence of Use Varies</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify text-justify">
                                    ...
                                    <div className="flex flex-col md:flex-row gap-8 my-10">
                                        <div className="flex-1 p-8 bg-gray-50 rounded-3xl border border-gray-100">
                                            <h5 className="font-bold text-[#0C002B] text-xl mb-4 flex items-center gap-3">
                                ...
                                <section id="distinctiveness" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Thresholds of Distinctiveness: Products vs. Experiences</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify text-justify text-justify">
                                ...
                                <section id="associated-marks" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Associated Trademarks: Linking Goods and Services</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify text-justify">
                                ...
                                <section id="well-known-marks" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6 text-center">Transcending Classes: The Power of Well-Known Marks</h3>
                                ...
                                <section id="dual-filing" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">The Dual-Class Strategy for Future-Proof Brands</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify text-justify text-justify">
                                    ...
                                    <ul className="space-y-4 my-10 list-none p-0">
                                        <li className="flex gap-4 p-6 bg-gray-50 rounded-2xl border border-gray-200 group hover:border-[#6E5E93] transition-colors">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-[#0C002B] text-xl mb-1">360-Degree Protection</h5>
                                        ...
                                        <li className="flex gap-4 p-6 bg-gray-50 rounded-2xl border border-gray-200 group hover:border-[#6E5E93] transition-colors">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-[#0C002B] text-xl mb-1">Preventing Allied Confusion</h5>
                                ...
                                <section id="why-iprkaro" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6 text-center">IPRKaro: Forensic Brand Architecture Specialists</h3>
                                    ...
                                    <div className="grid md:grid-cols-2 gap-8 my-10">
                                        <div className="flex gap-4 items-start">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-[#0C002B] text-xl mb-1">Hybrid Classification Logic</h5>
                                        ...
                                        <div className="flex gap-4 items-start">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-[#0C002B] text-xl mb-1">Evidence Curation</h5>
                                ...
                                <section id="conclusion" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6 text-center">Mastering the IP Synthesis for Brand Immortality</h3>
                                ...
                                <div className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[40px] p-10 md:p-20 text-center text-white relative overflow-hidden mt-20 shadow-2xl">
                                    <div className="relative z-10">
                                        <h3 className="text-3xl md:text-5xl font-bold mb-6">Secure Your Brands Dual Legacy</h3>
                        ...
                        <aside className="hidden lg:block space-y-10 sticky top-32">
                            ...
                            <div className="bg-[#0C002B] p-8 rounded-3xl shadow-xl border border-gray-800 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-2xl font-bold mb-4 relative z-10">Class Selection</h4>
                            ...
                            <div className="bg-gray-50 p-8 rounded-3xl shadow-sm border border-gray-100">
                                <h4 className="text-xl font-bold text-[#0C002B] mb-6 border-b pb-4">IP Comparison Center</h4>
