                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_300px] gap-8 items-start">
                        ...
                        <aside className="hidden lg:block sticky top-32">
                            <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                                <p className="text-gray-900 font-bold text-lg mb-6 border-l-4 border-[rgb(110,94,147)] pl-3">Violation Topics</p>
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-2xl shadow-sm border border-gray-100 space-y-12 md:space-y-20">
                                ...
                                <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed font-normal">
                                    ...
                                    <section id="introduction" className="scroll-mt-32">
                                        <h2 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-6 leading-tight">Trademark Violations in Modern India</h2>
                                        <p className="mb-6">
                                    ...
                                    <section id="deceptive-similarity" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-3 gap-6 mb-10">
                                            ...
                                            <div className="bg-gray-50 p-6 rounded-2xl text-center border-b-4 border-[rgb(110,94,147)]">
                                                ...
                                                <h4 className="font-bold mb-2">Phonetic</h4>
                                            ...
                                            <div className="bg-gray-50 p-6 rounded-2xl text-center border-b-4 border-[rgb(110,94,147)]">
                                                ...
                                                <h4 className="font-bold mb-2">Conceptual</h4>
                                    ...
                                    <section id="phonetic-examples" className="scroll-mt-32">
                                        ...
                                        <ul className="space-y-6">
                                            <li className="bg-gray-50 p-8 rounded-3xl border-l-8 border-[rgb(110,94,147)]">
                                                <h5 className="font-bold text-gray-900 text-xl mb-2 italic">Example 1: Lakme vs. LikeMe</h5>
                                            ...
                                            <li className="bg-gray-50 p-8 rounded-3xl border-l-8 border-[rgb(110,94,147)]">
                                                <h5 className="font-bold text-gray-900 text-xl mb-2 italic">Example 2: Mahindra vs. Mahendra</h5>
                                            ...
                                            <li className="bg-gray-50 p-8 rounded-3xl border-l-8 border-[rgb(110,94,147)]">
                                                <h5 className="font-bold text-gray-900 text-xl mb-2 italic">Example 3: INDI vs. INDEED</h5>
                                    ...
                                    <section id="visual-packaging" className="scroll-mt-32">
                                        ...
                                        <div className="flex flex-col md:flex-row gap-8 items-center bg-gray-900 text-white p-10 rounded-[2rem] my-10">
                                            <div className="flex-1">
                                                <h5 className="text-2xl font-bold mb-4 text-[rgb(110,94,147)]">The Parle Benchmark</h5>
                                    ...
                                    <section id="trade-dress" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8 mb-10">
                                            <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm">
                                                ...
                                                <h5 className="font-bold text-gray-900 mb-4">Colgate vs. Anchor</h5>
                                            ...
                                            <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm">
                                                ...
                                                <h5 className="font-bold text-gray-900 mb-4">The Louboutin Red Sole</h5>
                                    ...
                                    <section id="conceptual-similarity" className="scroll-mt-32">
                                        ...
                                        <div className="bg-gray-50 p-10 rounded-[2.5rem] border border-gray-100 mb-10">
                                            <h5 className="text-xl font-bold mb-4">Example: Corn Products v. Shangrila</h5>
                                    ...
                                    <section id="sound-and-shape" className="scroll-mt-32">
                                        ...
                                        <ul className="space-y-6 mb-10">
                                            <li className="p-6 bg-gray-50 rounded-2xl">
                                                <h5 className="font-bold mb-2">Sound Mark Violation</h5>
                                            ...
                                            <li className="p-6 bg-gray-50 rounded-2xl">
                                                <h5 className="font-bold mb-2">Shape of Goods</h5>
                                    ...
                                    <section id="preventing-violations" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8 mb-10">
                                            <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100 shadow-sm">
                                                ...
                                                <h5 className="font-bold mb-4">Proactive Monitoring</h5>
                                            ...
                                            <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100 shadow-sm">
                                                ...
                                                <h5 className="font-bold mb-4">Rapid Enforcement</h5>
                                    ...
                                    <section className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[2.5rem] p-8 md:p-16 text-center text-white relative overflow-hidden mt-12 shadow-2xl">
                                        <div className="relative z-10">
                                            <h3 className="text-3xl md:text-5xl font-black mb-6 leading-tight">Secure Your Brand from Imitators</h3>
                        ...
                        <aside className="hidden lg:block space-y-8 sticky top-32">
                            <div className="bg-[#0C002B] p-8 rounded-3xl shadow-[0_20px_40px_rgba(0,0,0,0.1)] border border-gray-800 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-xl font-bold mb-4 relative z-10 leading-tight">Seen a Copycat?</h4>
                            ...
                            <div className="bg-gray-50 p-8 rounded-3xl shadow-sm border border-gray-100">
                                <h4 className="text-lg font-black text-gray-900 mb-6 border-b-2 border-[rgb(110,94,147)] pb-4 uppercase tracking-widest">Enforcement Center</h4>
