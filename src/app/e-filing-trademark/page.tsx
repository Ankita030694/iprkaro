          ...
          <div className="grid grid-cols-1 lg:grid-cols-[220px_1fr_300px] gap-4 md:gap-12 items-start mt-8">
            ...
            <div className="hidden lg:block sticky top-32">
              <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
                <p className="text-lg font-bold text-gray-900 mb-6 flex items-center">
              ...
              <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed">
                ...
                <section id="benefits" className="scroll-mt-32 mt-16">
                  ...
                  <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 my-12">
                    <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100 group hover:bg-white hover:shadow-xl transition-all">
                      ...
                      <h4 className="text-xl font-bold mb-3 uppercase tracking-tighter">1. Significant Cost Efficiency</h4>
                    ...
                    <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100 group hover:bg-white hover:shadow-xl transition-all">
                      ...
                      <h4 className="text-xl font-bold mb-3 uppercase tracking-tighter">2. Instant Priority and Timestamps</h4>
                      <p className="text-sm leading-relaxed text-gray-600">
                    ...
                    <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100 group hover:bg-white hover:shadow-xl transition-all">
                      ...
                      <h4 className="text-xl font-bold mb-3 uppercase tracking-tighter">3. Real-Time Status Tracking</h4>
                      <p className="text-sm leading-relaxed text-gray-600">
                ...
                <section id="process" className="scroll-mt-32 mt-16">
                  ...
                  <div className="space-y-16 mt-12">
                    <div className="flex flex-col md:flex-row gap-8 items-start">
                      ...
                      <div>
                        <h4 className="text-2xl font-black mb-5 uppercase tracking-tight text-gray-900">Comprehensive Public Search</h4>
                    ...
                    <div className="flex flex-col md:flex-row gap-8 items-start">
                      ...
                      <div>
                        <h4 className="text-2xl font-black mb-5 uppercase tracking-tight text-gray-900">Portal Registration and User Setup</h4>
                        <p className="text-lg text-gray-600 mb-4 leading-relaxed">
                    ...
                    <div className="flex flex-col md:flex-row gap-8 items-start">
                      ...
                      <div>
                        <h4 className="text-2xl font-black mb-5 uppercase tracking-tight text-gray-900">Legal Drafting of Form TM-A</h4>
                        <p className="text-lg text-gray-600 mb-4 leading-relaxed">
                ...
                <section id="documents" className="scroll-mt-32 mt-16">
                  ...
                  <div className="grid md:grid-cols-2 gap-8 mt-12">
                    <div className="bg-white p-10 rounded-3xl shadow-lg border border-gray-100 flex flex-col relative overflow-hidden group">
                      ...
                      <h5 className="text-xl font-black mb-4 uppercase tracking-tighter">Identity Proof</h5>
                    ...
                    <div className="bg-white p-10 rounded-3xl shadow-lg border border-gray-100 flex flex-col relative overflow-hidden group">
                      ...
                      <h5 className="text-xl font-black mb-4 uppercase tracking-tighter">Business Proof</h5>
                ...
                <section id="classes" className="scroll-mt-32 mt-16">
                  ...
                  <div className="space-y-6">
                    <div className="p-10 bg-gray-50 rounded-3xl border border-gray-100">
                      <h4 className="text-xl font-black mb-4 text-[rgb(110,94,147)] uppercase">Goods Classes (1-34)</h4>
                    ...
                    <div className="p-10 bg-gray-50 rounded-3xl border border-gray-100">
                      <h4 className="text-xl font-black mb-4 text-[rgb(110,94,147)] uppercase">Service Classes (35-45)</h4>
                ...
                <section id="objections" className="scroll-mt-32 mt-16">
                  ...
                  <div className="grid md:grid-cols-2 gap-8 my-10">
                    <div className="bg-red-50 p-8 rounded-2xl border border-red-100">
                      <h5 className="text-lg font-black text-red-600 mb-3 uppercase">Section 9: Distinctiveness</h5>
                    ...
                    <div className="bg-orange-50 p-8 rounded-2xl border border-orange-100">
                      <h5 className="text-lg font-black text-orange-600 mb-3 uppercase">Section 11: Similarity</h5>
                ...
                <section id="opposition" className="scroll-mt-32 mt-16">
                  ...
                  <div className="bg-[#0C002B] text-white p-10 rounded-2xl my-10 shadow-2xl relative overflow-hidden">
                    ...
                    <h4 className="text-xl font-black mb-6 border-b border-white/10 pb-4 uppercase tracking-widest">The Opposition Timeline</h4>
                    <div className="space-y-6">
                ...
                <section id="faqs" className="scroll-mt-32 mt-24">
                  <h3 className="text-2xl md:text-4xl font-black text-gray-900 mb-10">Expert FAQs on E-Filing Trademark</h3>
                  <div className="space-y-10">
                    {faqs.map((faq, index) => (
                      <div key={index} className="border-b border-gray-100 pb-10 last:border-0">
                        <h4 className="text-xl font-black text-gray-900 mb-5 flex items-start">
                ...
                <div className="bg-gradient-to-br from-[#0C002B] to-[#160049] p-10 md:p-20 rounded-3xl text-center text-white mt-24 relative overflow-hidden shadow-2xl">
                  <div className="relative z-10">
                    <h3 className="text-2xl md:text-5xl font-black mb-6 leading-tight">Start Your Digital Brand Journey</h3>
