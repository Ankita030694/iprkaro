          ...
          <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_300px] gap-8 items-start">
               ...
               <div className="bg-white p-4 md:p-12 rounded-2xl shadow-sm border border-gray-100 space-y-12 md:space-y-20">
                ...
                <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed font-normal">
                  ...
                  <section id="introduction" className="scroll-mt-32">
                    <h2 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-6 leading-tight">An Introduction to Trademark Classification</h2>
                    <p className="mb-6">
                  ...
                  <section id="why-classification-matters" className="scroll-mt-32">
                    ...
                    <div className="grid md:grid-cols-2 gap-8 mb-10">
                      <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                        ...
                        <h4 className="font-bold text-xl mb-3 text-gray-900">Enforcement Scope</h4>
                      ...
                      <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                        ...
                        <h4 className="font-bold text-xl mb-3 text-gray-900">Mitigating Objections</h4>
                      ...
                      <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                        ...
                        <h4 className="font-bold text-xl mb-3 text-gray-900">Future Proofing</h4>
                      ...
                      <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                        ...
                        <h4 className="font-bold text-xl mb-3 text-gray-900">Investment & Valuation</h4>
                    ...
                    <div className="bg-gray-100 p-8 rounded-3xl mb-8 border-2 border-[rgb(110,94,147)]/20 shadow-inner">
                      <div className="flex flex-col md:flex-row gap-12 items-center">
                        <div className="flex-1 text-center md:text-left">
                          <h5 className="text-5xl font-black text-[rgb(110,94,147)] mb-2">34</h5>
                        ...
                        <div className="flex-1 text-center md:text-left">
                          <h5 className="text-5xl font-black text-[rgb(110,94,147)] mb-2">11</h5>
                  ...
                  <section id="classes-1-34-goods" className="scroll-mt-32">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="bg-white border-2 border-gray-100 p-8 rounded-3xl shadow-sm hover:border-[rgb(110,94,147)] transition-all">
                            <h4 className="text-xl font-bold text-gray-900 border-b pb-4 mb-4 flex items-center">
                  ...
                  <section id="classes-35-45-services" className="scroll-mt-32 pt-12">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                         <div className="p-8 bg-gray-50 rounded-2xl border border-gray-200">
                            <h5 className="font-black text-[rgb(110,94,147)] mb-4 uppercase">Class 35: Business & Retail</h5>
                         ...
                         <div className="p-8 bg-gray-50 rounded-2xl border border-gray-200">
                            <h5 className="font-black text-[rgb(110,94,147)] mb-4 uppercase">Class 36: Finance & Insurance</h5>
                            <p className="text-sm opacity-80">Banking, insurance, real estate affairs, and digital payment gateways.</p>
                         </div>
                         <div className="p-8 bg-gray-50 rounded-2xl border border-gray-200">
                            <h5 className="font-black text-[rgb(110,94,147)] mb-4 uppercase">Class 42: Tech & Analysis</h5>
                            <p className="text-sm opacity-80">Design and development of computer hardware and software. SaaS platforms live here.</p>
                         </div>
                         <div className="p-8 bg-gray-50 rounded-2xl border border-gray-200">
                            <h5 className="font-black text-[rgb(110,94,147)] mb-4 uppercase">Class 45: Legal & Security</h5>
                  ...
                  <section id="how-to-choose-class" className="scroll-mt-32 pt-12">
                    ...
                    <div className="space-y-6">
                        <div className="flex gap-6 items-start">
                            ...
                            <div>
                                <h4 className="font-bold text-gray-900 mb-2">What is the core revenue driver?</h4>
                        ...
                        <div className="flex gap-6 items-start">
                            ...
                            <div>
                                <h4 className="font-bold text-gray-900 mb-2">Where do your competitors reside?</h4>
                        ...
                        <div className="flex gap-6 items-start">
                            ...
                            <div>
                                <h4 className="font-bold text-gray-900 mb-2">What is the 3-year expansion roadmap?</h4>
                  ...
                  <section id="common-classification-errors" className="scroll-mt-32 pt-12">
                    ...
                    <h4 className="text-xl font-bold mb-4">The 'Class 35' Over-Reliance</h4>
                    <p className="mb-6">
                    ...
                    <h4 className="text-xl font-bold mb-4">The 'Software vs. Service' Confusion</h4>
                    <p className="mb-6">
                    ...
                    <h4 className="text-xl font-bold mb-4">Mismatched Description of Goods</h4>
                    <p className="mb-6">
                  ...
                  <section id="legal-implications" className="scroll-mt-32 pt-12">
                    ...
                    <div className="bg-black text-white p-12 rounded-[3.5rem] my-12 shadow-2xl relative overflow-hidden group">
                        ...
                        <h4 className="text-2xl font-black mb-6 text-[rgb(110,94,147)] uppercase tracking-tighter">The Doctrine of Related Goods</h4>
                  ...
                  <section className="scroll-mt-32 pt-12">
                    ...
                    <div className="bg-slate-900 text-white rounded-3xl p-10 mt-8 mb-12 shadow-xl border border-slate-800">
                        <h5 className="text-[rgb(110,94,147)] font-bold text-xl mb-4 uppercase">Meta-Classification Checklist:</h5>
                  ...
                  <section className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[3.5rem] p-12 md:p-24 text-center text-white relative overflow-hidden mt-24 shadow-2xl">
                    ...
                    <div className="relative z-10">
                        <h3 className="text-3xl md:text-6xl font-black mb-8 leading-tight tracking-tighter">Your Brand Deserves Precision Protection</h3>
            ...
            <aside className="hidden lg:block space-y-8 sticky top-32">
              ...
              <div className="bg-[#0C002B] p-10 rounded-[2.5rem] shadow-[0_30px_60px_rgba(0,0,0,0.3)] border border-gray-800 text-white relative overflow-hidden group">
                 ...
                 <h4 className="text-2xl font-black mb-6 relative z-10 leading-tight">Identify Your Category</h4>
              ...
              <div className="bg-white p-10 rounded-[2.5rem] shadow-sm border border-gray-100">
                <h4 className="text-lg font-black text-gray-900 mb-8 border-b-2 border-[rgb(110,94,147)] pb-4 uppercase tracking-widest">Growth Resources</h4>
