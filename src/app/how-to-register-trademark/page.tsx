          ...
          <div className="grid grid-cols-1 lg:grid-cols-[220px_1fr_300px] gap-4 md:gap-12 items-start mt-8">
            ...
            <div className="min-w-0">
              ...
              <div className="bg-white p-4 md:p-12 rounded-xl md:rounded-2xl shadow-sm space-y-8 md:space-y-16">
                ...
                <section id="what-is-trademark" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-black md:text-[#0C002B] mb-4">What Exactly is a Trademark?</h3>
                  <p className="mb-4 leading-relaxed text-base text-black md:text-inherit">
                  ...
                  <div className="grid md:grid-cols-2 gap-4 my-8">
                    <div className="p-5 bg-gray-50 rounded-2xl border border-gray-200">
                      <h5 className="font-bold text-black md:text-[#0C002B] text-lg mb-2">Word Marks</h5>
                    ...
                    <div className="p-5 bg-gray-50 rounded-2xl border border-gray-200">
                      <h5 className="font-bold text-black md:text-[#0C002B] text-lg mb-2">Device Marks</h5>
                    ...
                    <div className="p-5 bg-gray-50 rounded-2xl border border-gray-200">
                      <h5 className="font-bold text-black md:text-[#0C002B] text-lg mb-2">Service Marks</h5>
                    ...
                    <div className="p-5 bg-gray-50 rounded-2xl border border-gray-200">
                      <h5 className="font-bold text-black md:text-[#0C002B] text-lg mb-2">Shape Marks</h5>
                ...
                <section id="why-register" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-black md:text-[#0C002B] mb-4">Why Registering Your Brand is Non-Negotiable</h3>
                  <p className="mb-4 leading-relaxed text-base text-black md:text-inherit">
                  ...
                  <ul className="space-y-4 my-8 list-none p-0">
                    <li className="flex gap-4 p-5 bg-green-50 rounded-2xl border border-green-100 shadow-sm">
                      ...
                      <div>
                        <h5 className="font-bold text-green-900 text-lg">Legal Exclusivity and Monopoly</h5>
                    ...
                    <li className="flex gap-4 p-5 bg-green-50 rounded-2xl border border-green-100 shadow-sm">
                      ...
                      <div>
                        <h5 className="font-bold text-green-900 text-lg">Valuable Business Asset and Goodwill</h5>
                    ...
                    <li className="flex gap-4 p-5 bg-green-50 rounded-2xl border border-green-100 shadow-sm">
                      ...
                      <div>
                        <h5 className="font-bold text-green-900 text-lg">Global Foundation and Madrid Protocol</h5>
                    ...
                    <li className="flex gap-4 p-5 bg-green-50 rounded-2xl border border-green-100 shadow-sm">
                      ...
                      <div>
                        <h5 className="font-bold text-green-900 text-lg">Deterrence and Litigation Power</h5>
                ...
                <section id="trademark-types" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-4">Exploring the Different Types of Trademarks</h3>
                  <p className="mb-4 leading-relaxed text-base">
                  ...
                  <h4 className="text-xl font-bold text-[#160049] mb-3">Collective Marks</h4>
                  <p className="mb-4 leading-relaxed text-base">
                  ...
                  <h4 className="text-xl font-bold text-[#160049] mb-3">Certification Marks</h4>
                  <p className="mb-4 leading-relaxed text-base">
                  ...
                  <h4 className="text-xl font-bold text-[#160049] mb-3">Pattern and Sound Marks</h4>
                  <p className="mb-4 leading-relaxed text-base">
                ...
                <section id="pre-filing-search" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-4">The Critical First Step: Pre-Filing Trademark Search</h3>
                  <p className="mb-4 leading-relaxed text-base">
                  ...
                  <div className="bg-[#0C002B] text-white p-6 rounded-2xl my-8">
                    <h5 className="text-[#FFB703] font-bold text-xl mb-3">Pro Tip: Avoid Descriptive and Common Names</h5>
                ...
                <section id="step-by-step-guide" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-4">The Official Step-by-Step Registration Process</h3>
                  <p className="mb-4 leading-relaxed text-base">
                  ...
                  <div className="space-y-8 my-10">
                    <div className="flex gap-4">
                      ...
                      <div>
                        <h5 className="font-bold text-[#0C002B] text-lg md:text-xl mb-1.5">Filing the Application (Form TM-A)</h5>
                    ...
                    <div className="flex gap-4">
                      ...
                      <div>
                        <h5 className="font-bold text-[#0C002B] text-lg md:text-xl mb-1.5">Formalities Check and Examination</h5>
                    ...
                    <div className="flex gap-4">
                      ...
                      <div>
                        <h5 className="font-bold text-[#0C002B] text-lg md:text-xl mb-1.5">Replying to Objections and Hearing</h5>
                    ...
                    <div className="flex gap-4">
                      ...
                      <div>
                        <h5 className="font-bold text-[#0C002B] text-lg md:text-xl mb-1.5">Journal Publication and Public Notice</h5>
                    ...
                    <div className="flex gap-4">
                      ...
                      <div>
                        <h5 className="font-bold text-[#0C002B] text-lg md:text-xl mb-1.5">Registration and Digital Certification</h5>
                ...
                <section id="documents-required" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-4">Documents Checklist for Trademark Registration</h3>
                  <p className="mb-4 leading-relaxed text-base">
                  ...
                  <div className="grid md:grid-cols-2 gap-6 my-8">
                    <div className="p-6 bg-gray-50 rounded-2xl border border-gray-100 h-full">
                      <h5 className="font-bold text-[#0C002B] text-lg mb-3 underline">For Individuals and Sole Proprietors</h5>
                    ...
                    <div className="p-6 bg-gray-50 rounded-2xl border border-gray-100 h-full">
                      <h5 className="font-bold text-[#0C002B] text-lg mb-3 underline">For MSMEs, Startups, and Companies</h5>
                      <ul className="space-y-2.5">
                ...
                <section id="trademark-classes" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-4">Decoding the Trademark Class System: All 45 Classes Explained</h3>
                  <p className="mb-4 leading-relaxed text-base">
                ...
                <section id="government-fees" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-4">Breakdown of Government Fees and Costs for 2026</h3>
                  <p className="mb-4 leading-relaxed text-base">
                  ...
                  <div className="grid md:grid-cols-2 gap-6 my-8">
                    <div className="p-6 bg-yellow-50 rounded-2xl border-2 border-[#FFB703] text-center shadow-md hover:shadow-lg transition-shadow">
                      <h5 className="font-bold text-black md:text-[#0C002B] text-3xl mb-1.5">₹4,500</h5>
                      <h5 className="font-bold text-black md:text-[#0C002B] text-lg mb-3">Individuals / MSMEs / Startups</h5>
                    ...
                    <div className="p-6 bg-gray-50 rounded-2xl border-2 border-gray-300 text-center shadow-md hover:shadow-lg transition-shadow">
                      <h5 className="font-bold text-black md:text-[#0C002B] text-3xl mb-1.5">₹9,000</h5>
                      <h5 className="font-bold text-black md:text-[#0C002B] text-lg mb-3">Standard Companies / Others</h5>
                ...
                <section id="objection-handling" className="mb-16 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-3xl md:text-4xl font-bold text-[#0C002B] mb-6">Expert Strategies for Handling Trademark Objections</h3>
                  ...
                  <div className="space-y-6 my-8">
                    <div className="p-6 bg-gray-50 rounded-2xl border-l-[8px] border-[#0C002B] shadow-sm">
                      <h5 className="font-bold text-[#0C002B] text-xl mb-3">Section 9 Objections: Absolute Grounds</h5>
                    ...
                    <div className="p-6 bg-gray-50 rounded-2xl border-l-[8px] border-[#FFB703] shadow-sm">
                      <h5 className="font-bold text-[#0C002B] text-xl mb-3">Section 11 Objections: Relative Grounds</h5>
                ...
                <section id="opposition-process" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-4">Surviving the Journal Publication and Third Party Opposition</h3>
                  <p className="mb-4 leading-relaxed text-base">
                ...
                <section id="renewal-restoration" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-4">Renewal and Long Term Maintenance of Your Rights</h3>
                  <p className="mb-4 leading-relaxed text-base">
                ...
                <section id="msme-startup-benefits" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-4">Unlocking Special Benefits for MSMEs and Startups</h3>
                  <p className="mb-4 leading-relaxed text-base">
                ...
                <section id="global-protection" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-4">How to Secure Your Brand Identity Globally</h3>
                  <p className="mb-4 leading-relaxed text-base">
                  ...
                  <h4 className="text-xl font-bold text-[#160049] mb-3">The Madrid Protocol System</h4>
                  <p className="mb-4 leading-relaxed text-base">
                  ...
                  <h4 className="text-xl font-bold text-[#160049] mb-3">Direct Convention Filing</h4>
                  <p className="mb-4 leading-relaxed text-base">
                ...
                <section id="regional-offices" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-4">Regional Trademark Offices: Where is Your Application Processed?</h3>
                  <p className="mb-4 leading-relaxed text-base">
                  ...
                  <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 my-8">
                    <div className="p-5 bg-blue-50 rounded-2xl border border-blue-100">
                      <h5 className="font-bold text-black md:text-[#0C002B] mb-1.5 text-sm uppercase">Mumbai Office</h5>
                      <p className="text-[10px] text-black md:text-gray-700">Jurisdiction: Maharashtra, Madhya Pradesh, Chhattisgarh, Goa.</p>
                    </div>
                    <div className="p-5 bg-blue-50 rounded-2xl border border-blue-100">
                      <h5 className="font-bold text-black md:text-[#0C002B] mb-1.5 text-sm uppercase">Delhi Office</h5>
                    ...
                    <div className="p-5 bg-blue-50 rounded-2xl border border-blue-100">
                      <h5 className="font-bold text-black md:text-[#0C002B] mb-1.5 text-sm uppercase">Kolkata Office</h5>
                    ...
                    <div className="p-5 bg-blue-50 rounded-2xl border border-blue-100">
                      <h5 className="font-bold text-black md:text-[#0C002B] mb-1.5 text-sm uppercase">Ahmedabad Office</h5>
                    ...
                    <div className="p-5 bg-blue-50 rounded-2xl border border-blue-100">
                      <h5 className="font-bold text-black md:text-[#0C002B] mb-1.5 text-sm uppercase">Chennai Office</h5>
                ...
                <section id="legal-enforcement" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-4">Enforcing Your Intellectual Property Rights: A Strategic Approach</h3>
                  <p className="mb-4 leading-relaxed text-base">
                  ...
                  <h4 className="text-xl font-bold text-[#160049] mb-3">Statutory Remedy: Trademark Infringement</h4>
                  <p className="mb-4 leading-relaxed text-base">
                  ...
                  <h4 className="text-xl font-bold text-[#160049] mb-3">Common Law Remedy: The Action of Passing Off</h4>
                  <p className="mb-4 leading-relaxed text-base">
                  ...
                  <div className="bg-red-50 p-6 md:p-10 rounded-3xl border-l-[8px] border-red-600 my-8 shadow-lg">
                    <h5 className="text-red-900 font-bold text-xl mb-3">Extraordinary Judicial Relief: John Doe and Anton Piller Orders</h5>
                ...
                <section id="common-mistakes" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-4">Navigating the Minefield: 10 Common Trademark Mistakes</h3>
                  <p className="mb-4 leading-relaxed text-base">
                ...
                <section id="conclusion" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-4">Conclusion: Building a Legacy with Legal Integrity</h3>
                  <p className="mb-4 leading-relaxed text-base">
                ...
                <section id="faqs" className="mb-12 scroll-mt-24">
                  <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-8">Frequently Asked Questions</h3>
                  <div className="space-y-6">
                    {faqs.map((faq, index) => (
                      <div key={index} className="border-b border-gray-100 pb-6 last:border-0 hover:bg-gray-50 p-5 rounded-2xl transition-all font-sans">
                        <h4 className="text-lg font-bold text-black md:text-[#0C002B] mb-3 flex gap-2.5">
                ...
                <div className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-3xl p-8 md:p-12 text-center text-white relative overflow-hidden mt-16">
                  <div className="relative z-10">
                    <h3 className="text-2xl md:text-4xl font-bold mb-4">Ready to Protect Your Brand?</h3>
            ...
            <aside className="hidden lg:block space-y-10 sticky top-32">
              ...
              <div className="bg-[#0C002B] p-8 rounded-3xl shadow-xl border border-gray-800 text-white relative overflow-hidden group">
                ...
                <h4 className="text-2xl font-bold mb-4 relative z-10">Brand Availability?</h4>
