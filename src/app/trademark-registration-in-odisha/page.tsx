                ...
                <div className="container mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr_320px] gap-8 items-start">
                        <aside className="hidden lg:block sticky top-32">
                            <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                                <p className="text-gray-900 font-bold text-lg mb-6 border-l-4 border-[rgb(110,94,147)] pl-3">Odisha IP Guide</p>
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-2xl shadow-sm border border-gray-100 space-y-12 md:space-y-20 article-content">
                                <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed font-normal">
                                    <section id="intro" className="scroll-mt-32">
                                        <h2 className="text-2xl md:text-4xl font-black text-gray-900 mb-8 flex items-center"><FontAwesomeIcon icon={faRocket} className="w-12 h-12 mr-4 text-[rgb(110,94,147)]" />Trademark Registration in Odisha</h2>
                                    ...
                                    <section id="registry" className="scroll-mt-32 pt-12">
                                        <h3 className="text-2xl md:text-4xl font-black text-gray-900 mb-8 flex items-center"><FontAwesomeIcon icon={faBuilding} className="w-12 h-12 mr-4 text-[rgb(110,94,147)]" />The Kolkata Registry Nexus: Centralized Administration for Odisha IP</h3>
                                    ...
                                    <section id="msme" className="scroll-mt-32 pt-12">
                                        <h3 className="text-2xl md:text-4xl font-black text-gray-900 mb-8 flex items-center"><FontAwesomeIcon icon={faAward} className="w-12 h-12 mr-4 text-[rgb(110,94,147)]" />Odisha MSME Development Policy 2022: Total Cost Reimbursement</h3>
                                    ...
                                    <section id="startup" className="scroll-mt-32 pt-12">
                                        <h3 className="text-2xl md:text-4xl font-black text-gray-900 mb-8 flex items-center"><FontAwesomeIcon icon={faMicrochip} className="w-12 h-12 mr-4 text-[rgb(110,94,147)]" />Startup Odisha: Fueling Innovation with IP Rebates and Support</h3>
                                    ...
                                    <section id="steel" className="scroll-mt-32 pt-12">
                                        <h3 className="text-2xl md:text-4xl font-black text-gray-900 mb-8 flex items-center"><FontAwesomeIcon icon={faIndustry} className="w-12 h-12 mr-4 text-[rgb(110,94,147)]" />Industrial IP Strategy: Protecting Rourkela Steel and Cuttack Trade</h3>
                                    ...
                                    <section id="handloom" className="scroll-mt-32 pt-12">
                                        <h3 className="text-2xl md:text-4xl font-black text-gray-900 mb-8 flex items-center"><FontAwesomeIcon icon={faLeaf} className="w-12 h-12 mr-4 text-[rgb(110,94,147)]" />Silk, Handloom, and GI: Preserving the Heritage of Sambalpur</h3>
                                    ...
                                    <section id="bhbnswr" className="scroll-mt-32 pt-12">
                                        <h3 className="text-2xl md:text-4xl font-black text-gray-900 mb-8 flex items-center"><FontAwesomeIcon icon={faFlask} className="w-12 h-12 mr-4 text-[rgb(110,94,147)]" />Bhubaneswar: The Digital and Bio-Tech Brand Frontier</h3>
                                    ...
                                    <section id="process" className="scroll-mt-32 pt-12">
                                        <h3 className="text-2xl md:text-4xl font-black text-gray-900 mb-8 flex items-center"><FontAwesomeIcon icon={faChartLine} className="w-12 h-12 mr-4 text-[rgb(110,94,147)]" />The 8-Step Filing Journey: Your Path to Brand Monopoly</h3>
                                    ...
                                    <section id="documents" className="scroll-mt-32 pt-12">
                                        <h3 className="text-2xl md:text-4xl font-black text-gray-900 mb-8 flex items-center"><FontAwesomeIcon icon={faScaleBalanced} className="w-12 h-12 mr-4 text-[rgb(110,94,147)]" />Mandatory Document Checklist for Odisha Applicants</h3>
                                    ...
                                    <section id="legal" className="scroll-mt-32 pt-16">
                                        <h3 className="text-2xl md:text-4xl font-black text-gray-900 mb-8 flex items-center"><FontAwesomeIcon icon={faShieldHalved} className="w-12 h-12 mr-4 text-[rgb(110,94,147)]" />Infringement Protection: The Legal Shield of your Brand</h3>
                                    ...
                                    <section id="global" className="scroll-mt-32 pt-12">
                                        <h3 className="text-2xl md:text-4xl font-black text-gray-900 mb-8 flex items-center"><FontAwesomeIcon icon={faGlobe} className="w-12 h-12 mr-4 text-[rgb(110,94,147)]" />International Branding: The Madrid Protocol and Beyond</h3>
                                    ...
                                    <section id="faqs" className="scroll-mt-32 pt-16">
                                        <h3 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-12 text-center text-[rgb(110,94,147)] uppercase tracking-tighter">Odisha Trademark IP FAQ</h3>
                                    ...
                                    <section id="reviews" className="scroll-mt-32 pt-20 border-t border-gray-100">
                                        <h3 className="text-3xl md:text-4xl font-black text-gray-900 mb-12 text-center text-[rgb(110,94,147)] uppercase tracking-widest">Industry Voices from Odisha</h3>
                        ...
                        <aside className="hidden lg:block space-y-8 sticky top-32">
                            <div className="bg-[#0C002B] p-10 rounded-[2.5rem] shadow-2xl border border-white/5 text-white relative overflow-hidden group text-center">
                                ...
                                <h4 className="text-2xl font-black mb-6 relative z-10 leading-tight uppercase tracking-tighter">Odisha Brand Search</h4>
                    ...
                    <section className="bg-gradient-to-br from-[#0C002B] to-[#1a1130] rounded-[3rem] p-10 md:p-20 text-center text-white relative overflow-hidden mt-16 shadow-2xl border border-white/5 group">
                        ...
                        <div className="relative z-10">
                            ...
                            <h3 className="text-4xl md:text-6xl font-black mb-8 leading-tight">Master Your Market <br /> with Odisha's IP Elite</h3>
