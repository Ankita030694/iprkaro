...
const tocSections = [
    { id: 'introduction', title: 'Trademark for Raw Ag. Products' },
    { id: 'what-is-class-31', title: 'Trademark for Raw Ag. Products' },
    { id: 'covered-products', title: 'Trademark for Raw Ag. Products' },
    { id: 'not-covered', title: 'Trademark for Raw Ag. Products' },
    { id: 'registration-process', title: 'Trademark for Raw Ag. Products' },
    { id: 'documents-checklist', title: 'Trademark for Raw Ag. Products' },
    { id: 'importance-for-farmers', title: 'Trademark for Raw Ag. Products' },
    { id: 'legal-objections', title: 'Trademark for Raw Ag. Products' },
    { id: 'global-protection', title: 'Trademark for Raw Ag. Products' },
    { id: 'brand-monitoring', title: 'Trademark for Raw Ag. Products' },
    { id: 'trade-dress-agri', title: 'Trademark for Raw Ag. Products' },
    { id: 'valuation-agri', title: 'Trademark for Raw Ag. Products' },
    { id: 'geographical-indications', title: 'Trademark for Raw Ag. Products' },
    { id: 'government-fees', title: 'Trademark for Raw Ag. Products' },
    { id: 'faqs', title: 'Trademark for Raw Ag. Products' },
];
...
export default function TrademarkForRawAgriPage() {
    ...
    const articleSchema = {
        "@context": "https://schema.org",
        "@type": "Article",
        "headline": "Trademark for Raw Ag. Products",
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_300px] gap-8 items-start">
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-2xl shadow-sm border border-gray-100 space-y-12 md:space-y-20">
                                ...
                                <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed font-normal">
                                    ...
                                    <section id="introduction" className="scroll-mt-32">
                                        <h2 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-6 leading-tight">Trademark Protection in Indian Agriculture</h2>
                                        <p className="mb-6">
                                    ...
                                    <section id="covered-products" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8 mb-10">
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                                ...
                                                <h4 className="font-bold text-xl mb-3 text-gray-900">Seeds & Seedlings</h4>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                                ...
                                                <h4 className="font-bold text-xl mb-3 text-gray-900">Fresh Produce</h4>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                                ...
                                                <h4 className="font-bold text-xl mb-3 text-gray-900">Live Animals & Feed</h4>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                                ...
                                                <h4 className="font-bold text-xl mb-3 text-gray-900">Raw Forestry & Flowers</h4>
                                        ...
                                        <div className="relative space-y-12">
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all border border-transparent hover:border-gray-200">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900">Phase 1: Deep Search & Conflict Analysis</h4>
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all border border-transparent hover:border-gray-200">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900">Phase 2: Filing Form TM-A</h4>
                                                    <p className="text-base text-gray-600 mb-4">
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all border border-transparent hover:border-gray-200">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900">Phase 3: Examination & Certificate</h4>
                                                    <p className="text-base text-gray-600 mb-4">
                                    ...
                                    <section id="global-protection" className="scroll-mt-32">
                                        ...
                                        <div className="bg-black text-white p-10 rounded-3xl my-10 shadow-2xl">
                                            <h4 className="text-2xl font-bold mb-4 text-[rgb(110,94,147)] uppercase">The Export Valuation</h4>
                                    ...
                                    <section id="government-fees" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8">
                                            <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100 flex flex-col items-center text-center">
                                                ...
                                                <h5 className="font-bold text-xl mb-4">Official Government Fee</h5>
                                            ...
                                            <div className="p-8 bg-[rgb(110,94,147)] text-white rounded-3xl shadow-xl flex flex-col items-center text-center">
                                                ...
                                                <h5 className="font-bold text-xl mb-4">IPR Karo Prof. Fee</h5>
                                    ...
                                    <section id="reviews" className="scroll-mt-32 pt-12">
                                        <h3 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-12 text-center uppercase">
                                    ...
                                    <section className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[2.5rem] p-8 md:p-16 text-center text-white relative overflow-hidden mt-12 shadow-2xl">
                                        <div className="relative z-10">
                                            <h3 className="text-3xl md:text-5xl font-black mb-6 leading-tight">Secure Your Harvest with Elite Protection</h3>
                        ...
                        <aside className="hidden lg:block space-y-8 sticky top-32">
                            ...
                            <div className="bg-[#0C002B] p-8 rounded-3xl shadow-[0_20px_40px_rgba(0,0,0,0.1)] border border-gray-800 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-xl font-bold mb-4 relative z-10 leading-tight">Check Agri-Name Availability</h4>
                            ...
                            <div className="bg-gray-50 p-8 rounded-3xl shadow-sm border border-gray-100">
                                <h4 className="text-lg font-black text-gray-900 mb-6 border-b-2 border-[rgb(110,94,147)] pb-4 uppercase tracking-widest text-sm">Industry Specific</h4>
