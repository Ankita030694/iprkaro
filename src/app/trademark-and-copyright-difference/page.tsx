...
const tocSections = [
    { id: 'introduction', title: 'Difference Between TM & Copyright' },
    { id: 'governing-acts', title: 'Difference Between TM & Copyright' },
    { id: 'definition-scope', title: 'Difference Between TM & Copyright' },
    { id: 'purpose-protection', title: 'Difference Between TM & Copyright' },
    { id: 'work-made-for-hire', title: 'Difference Between TM & Copyright' },
    { id: 'duration-renewal', title: 'Difference Between TM & Copyright' },
    { id: 'moral-vs-economic', title: 'Difference Between TM & Copyright' },
    { id: 'section-45-noc', title: 'Difference Between TM & Copyright' },
    { id: 'overlap-logos', title: 'Difference Between TM & Copyright' },
    { id: 'infringement-remedies', title: 'Difference Between TM & Copyright' },
    { id: 'comparison-table', title: 'Difference Between TM & Copyright' },
    { id: 'why-iprkaro', title: 'Difference Between TM & Copyright' },
    { id: 'faqs', title: 'Difference Between TM & Copyright' },
    { id: 'reviews', title: 'Difference Between TM & Copyright' },
    { id: 'conclusion', title: 'Difference Between TM & Copyright' },
];
...
export default function TrademarkCopyrightDifferencePage() {
    ...
    const articleSchema = {
        "@context": "https://schema.org",
        "@type": "Article",
        "headline": "Difference Between TM & Copyright",
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[220px_1fr_300px] gap-4 md:gap-12 mt-8 items-start">
                        ...
                        <div className="min-w-0">
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-xl md:rounded-2xl shadow-sm border border-gray-100 prose prose-lg max-w-none text-gray-800 font-sans">
                                ...
                                <section id="introduction" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h2 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6">Trademark vs Copyright</h2>
                                ...
                                <section id="governing-acts" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Governing Acts: Trade Marks Act 1999 vs Copyright Act 1957</h3>
                                ...
                                <section id="definition-scope" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Defining the Scope: What Each Protects</h3>
                                    ...
                                    <div className="space-y-6 my-10">
                                        <div className="p-8 bg-gray-50 rounded-3xl border border-gray-200">
                                            <h5 className="font-bold text-[#0C002B] text-2xl mb-4">Trademark Scope</h5>
                                        ...
                                        <div className="p-8 bg-indigo-50 rounded-3xl border border-indigo-100">
                                            <h5 className="font-bold text-[#0C002B] text-2xl mb-4">Copyright Scope</h5>
                                            <ul className="grid md:grid-cols-2 gap-4 text-gray-700">
                                ...
                                <section id="work-made-for-hire" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Ownership Forensics: "Work Made for Hire" under Section 17</h3>
                                    <p className="mb-4 leading-relaxed text-lg">
                                ...
                                <section id="duration-renewal" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Longevity: 10-Year Renewals vs Lifetime Protection</h3>
                                    <p className="mb-6 leading-relaxed text-lg">
                                    ...
                                    <ul className="space-y-6 my-10 list-none p-0 text-lg">
                                        <li className="flex gap-4 p-6 bg-gray-50 rounded-2xl border border-gray-200 shadow-sm">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-[#0C002B] text-xl mb-1">Trademark Longevity</h5>
                                        ...
                                        <li className="flex gap-4 p-6 bg-indigo-50 rounded-2xl border border-indigo-100 shadow-sm">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-[#0C002B] text-xl mb-1">Copyright Longevity</h5>
                                ...
                                <section id="moral-vs-economic" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Moral vs Economic Rights: The Soul of Copyright</h3>
                                    <p className="mb-4 leading-relaxed text-lg">
                                ...
                                <section id="section-45-noc" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">The Section 45 Search Certificate: When They Intersect</h3>
                                    <p className="mb-6 leading-relaxed text-lg">
                                    ...
                                    <div className="p-8 bg-[#0C002B] text-white rounded-[2rem] shadow-2xl my-10">
                                        <h5 className="text-cyan-400 font-bold text-2xl mb-4">The "Search Certificate" Requirement</h5>
                                ...
                                <section id="comparison-table" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-8 text-center">At a Glance: Comparison Matrix</h3>
                                ...
                                <section id="infringement-remedies" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Statutory Damages: Legal Remedies for Infringement in India</h3>
                                    <p className="mb-4 leading-relaxed text-lg">
                                ...
                                <section id="why-iprkaro" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6 text-center">Why Businesses Trust IPR Karo for IP Forensics</h3>
                                    ...
                                    <div className="grid md:grid-cols-3 gap-8 text-center bg-[#0C002B] p-10 rounded-[3rem] text-white">
                                        <div className="space-y-4">
                                            ...
                                            <h5 className="font-bold text-xl">Conflict Discovery</h5>
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <h5 className="font-bold text-xl">Asset Mapping</h5>
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <h5 className="font-bold text-xl">Legal Opinions</h5>
                                ...
                                <section id="conclusion" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6 text-center">Conclusion: Choosing the Right Shield for Your Business</h3>
                                ...
                                <div className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[40px] p-10 md:p-20 text-center text-white relative overflow-hidden mt-20 shadow-2xl">
                                    <div className="relative z-10">
                                        <h3 className="text-3xl md:text-5xl font-bold mb-6">Confused About Which to Choose?</h3>
                        ...
                        <aside className="hidden lg:block space-y-10 sticky top-32">
                            ...
                            <div className="bg-[#0C002B] p-8 rounded-3xl shadow-xl border border-gray-800 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-2xl font-bold mb-4 relative z-10">IP Health Check</h4>
                            ...
                            <div className="bg-gray-50 p-8 rounded-3xl shadow-sm border border-gray-100">
                                <h4 className="text-xl font-bold text-[#0C002B] mb-6 border-b pb-4">Knowledge Base</h4>
