...
const tocSections = [
    { id: 'introduction', title: 'IPIndia Trademark Status Check' },
    { id: 'how-to-check', title: 'IPIndia Trademark Status Check' },
    { id: 'common-statuses', title: 'IPIndia Trademark Status Check' },
    { id: 'ai-examination', title: 'IPIndia Trademark Status Check' },
    { id: 'historical-context', title: 'IPIndia Trademark Status Check' },
    { id: 'vienna-codification', title: 'IPIndia Trademark Status Check' },
    { id: 'formalities-check', title: 'IPIndia Trademark Status Check' },
    { id: 'examination-phase', title: 'IPIndia Trademark Status Check' },
    { id: 'journal-publication', title: 'IPIndia Trademark Status Check' },
    { id: 'opposition-proceedings', title: 'IPIndia Trademark Status Check' },
    { id: 'the-golden-status', title: 'IPIndia Trademark Status Check' },
    { id: 'negative-statuses', title: 'IPIndia Trademark Status Check' },
    { id: 'litigation-strategy', title: 'IPIndia Trademark Status Check' },
    { id: 'post-registration-status', title: 'IPIndia Trademark Status Check' },
    { id: 'next-steps', title: 'IPIndia Trademark Status Check' },
    { id: 'why-iprkaro', title: 'IPIndia Trademark Status Check' },
    { id: 'faqs', title: 'IPIndia Trademark Status Check' },
    { id: 'reviews', title: 'IPIndia Trademark Status Check' },
    { id: 'conclusion', title: 'IPIndia Trademark Status Check' },
];
...
export default function TrademarkStatusPage() {
    ...
    const articleSchema = {
        "@context": "https://schema.org",
        "@type": "Article",
        "headline": "IPIndia Trademark Status Check",
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[220px_1fr_300px] gap-4 md:gap-12 mt-8 items-start">
                        ...
                        <div className="min-w-0">
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-xl md:rounded-2xl shadow-sm border border-gray-100 prose prose-lg max-w-none text-gray-800 font-sans">
                                ...
                                <section id="introduction" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h2 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6">Non Negotiable</h2>
                                ...
                                <section id="how-to-check" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Step by Step Guide: How to Check Status on IP India</h3>
                                ...
                                <section id="common-statuses" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">The Dictionary of Statuses: Meanings & Legal Implications</h3>
                                    <p className="mb-6 leading-relaxed text-lg">
                                    ...
                                    <div className="space-y-8 my-10">
                                        <div className="p-8 bg-blue-50 rounded-3xl border border-blue-100 shadow-sm">
                                            <h5 className="font-bold text-blue-900 text-2xl mb-4 flex items-center">
                                ...
                                <section id="ai-examination" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Modern Context: AI & Automation in Trademark Examination</h3>
                                    <p className="mb-4 leading-relaxed text-lg">
                                ...
                                <section id="historical-context" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Evolution: A Brief History of Trademark Statuses in Bharat</h3>
                                    <p className="mb-4 leading-relaxed text-lg">
                                ...
                                <section id="vienna-codification" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Vienna Codification: The Mystery of the Logo</h3>
                                    <p className="mb-6 leading-relaxed text-lg">
                                ...
                                <section id="formalities-check" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Formalities Check: Pass vs. Fail</h3>
                                    <p className="mb-6 leading-relaxed text-lg">
                                    ...
                                    <div className="grid md:grid-cols-2 gap-8 my-10">
                                        <div className="p-8 bg-green-50 rounded-3xl border border-green-200">
                                            <h5 className="font-bold text-green-900 text-xl mb-4 flex items-center">
                                        ...
                                        <div className="p-8 bg-red-50 rounded-3xl border border-red-200">
                                            <h5 className="font-bold text-red-900 text-xl mb-4 flex items-center">
                                ...
                                <section id="examination-phase" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">The Examination Phase: Marked for Exam & Objected</h3>
                                    <p className="mb-6 leading-relaxed text-lg">
                                    ...
                                    <ul className="space-y-6 my-10 list-none p-0">
                                        <li className="flex gap-4 p-6 bg-gray-50 rounded-2xl border border-gray-200">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-[#0C002B] text-xl mb-1">Marked for Exam</h5>
                                        ...
                                        <li className="flex gap-4 p-6 bg-yellow-50 rounded-2xl border border-yellow-200 shadow-sm border-l-[10px] border-l-yellow-500">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-yellow-900 text-xl mb-1">Objected</h5>
                                ...
                                <section id="journal-publication" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Publication: Accepted & Advertised vs. Advertised Before Acc</h3>
                                    <p className="mb-6 leading-relaxed text-lg">
                                    ...
                                    <div className="bg-[#6E5E93]/10 p-8 rounded-3xl border border-[#6E5E93]/20 my-10">
                                        <h5 className="text-[#0C002B] font-bold text-2xl mb-4">Accepted & Advertised</h5>
                                ...
                                <section id="opposition-proceedings" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Facing the Heat: What if Your Mark is Opposed?</h3>
                                    <p className="mb-6 leading-relaxed text-lg">
                                ...
                                <section id="the-golden-status" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Registered: The Final Victory</h3>
                                    <p className="mb-6 leading-relaxed text-lg">
                                    ...
                                    <div className="flex flex-col md:flex-row gap-8 my-10">
                                        <div className="flex-1 p-8 bg-gradient-to-br from-green-50 to-white rounded-3xl border-2 border-green-200 text-center shadow-lg">
                                            <h5 className="font-bold text-green-700 text-4xl mb-2">®</h5>
                                ...
                                <section id="negative-statuses" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Negative Statuses: Abandoned, Refused, and Withdrawn</h3>
                                    <p className="mb-6 leading-relaxed text-lg">
                                    ...
                                    <div className="grid md:grid-cols-3 gap-6 my-10">
                                        <div className="p-6 bg-gray-100 rounded-2xl border border-gray-200">
                                            <h6 className="font-bold text-gray-900 mb-2">Abandoned</h6>
                                        ...
                                        <div className="p-6 bg-gray-100 rounded-2xl border border-gray-200">
                                            <h6 className="font-bold text-gray-900 mb-2">Refused</h6>
                                        ...
                                        <div className="p-6 bg-gray-100 rounded-2xl border border-gray-200">
                                            <h6 className="font-bold text-gray-900 mb-2">Withdrawn</h6>
                                ...
                                <section id="litigation-strategy" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Litigation Strategy: When to Appeal a Refusal</h3>
                                    <p className="mb-4 leading-relaxed text-lg">
                                ...
                                <section id="post-registration-status" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Post Registration: Removed and Renewed Statuses</h3>
                                    <p className="mb-6 leading-relaxed text-lg">
                                ...
                                <section id="next-steps" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6">Strategic Next Steps Based on Your Current Status</h3>
                                    ...
                                    <div className="grid md:grid-cols-2 gap-8 text-white">
                                        <div className="bg-[#0C002B] p-8 rounded-[2rem] border border-gray-700">
                                            <h5 className="text-xl font-bold mb-4">If status is "Objected"</h5>
                                        ...
                                        <div className="bg-[#160049] p-8 rounded-[2rem] border border-gray-700">
                                            <h5 className="text-xl font-bold mb-4">If status is "Opposed"</h5>
                                ...
                                <section id="why-iprkaro" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6">Why IPR Karo is Your Status Monitoring Partner</h3>
                                    <p className="mb-10 leading-relaxed text-lg">
                                    ...
                                    <div className="grid md:grid-cols-3 gap-8 text-center">
                                        <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100 shadow-inner">
                                            ...
                                            <h5 className="font-bold text-xl mb-4">24/7 Automation</h5>
                                        ...
                                        <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100 shadow-inner">
                                            ...
                                            <h5 className="font-bold text-xl mb-4">Proactive Defense</h5>
                                        ...
                                        <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100 shadow-inner">
                                            ...
                                            <h5 className="font-bold text-xl mb-4">Expert Interpreters</h5>
                                ...
                                <section id="conclusion" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6 text-center">Conclusion: Vigilance is the Key to Brand Protection</h3>
                            ...
                            <div className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[40px] p-10 md:p-20 text-center text-white relative overflow-hidden mt-20 shadow-2xl">
                                <div className="relative z-10">
                                    <h3 className="text-3xl md:text-5xl font-bold mb-6">Unsure About Your Trademark Status?</h3>
                        ...
                        <aside className="hidden lg:block space-y-10 sticky top-32">
                            ...
                            <div className="bg-[#0C002B] p-8 rounded-3xl shadow-xl border border-gray-800 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-2xl font-bold mb-4 relative z-10">Urgent Response?</h4>
