          ...
          <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_300px] gap-8 items-start">
            ...
            <aside className="hidden lg:block sticky top-32 h-[calc(100vh-160px)] overflow-y-auto">
              <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                <p className="text-gray-900 font-bold text-lg mb-6 border-l-4 border-[rgb(110,94,147)] pl-3 italic uppercase tracking-[0.2em] font-black underline underline-offset-4 decoration-[rgb(110,94,147)]">Legal Roadmap</p>
                ...
                <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed">
                  ...
                  <section id="introduction" className="scroll-mt-32">
                    ...
                    <div className="bg-[#0C002B] text-white p-10 rounded-[3rem] shadow-2xl relative overflow-hidden my-12">
                      ...
                      <h5 className="text-xl font-black mb-4 uppercase italic">The Cost of Inaction</h5>
                  ...
                  <section id="legal-notice" className="scroll-mt-32">
                    ...
                    <div className="grid md:grid-cols-3 gap-6 mb-10">
                      <div className="text-center p-6 bg-purple-50 rounded-2xl border border-purple-100">
                        ...
                        <h5 className="font-black text-gray-900 text-xs uppercase mb-2">Formal Warning</h5>
                      ...
                      <div className="text-center p-6 bg-blue-50 rounded-2xl border border-blue-100">
                        ...
                        <h5 className="font-black text-gray-900 text-xs uppercase mb-2">Knowledge on Record</h5>
                      ...
                      <div className="text-center p-6 bg-green-50 rounded-2xl border border-green-100">
                        ...
                        <h5 className="font-black text-gray-900 text-xs uppercase mb-2">Settlement Opening</h5>
                  ...
                  <section id="interim-injunction" className="scroll-mt-32">
                    ...
                    <div className="bg-gray-50 border-2 border-dashed border-gray-200 p-10 rounded-[3rem] mb-12">
                      <h4 className="text-xl font-black mb-6 text-center uppercase italic">3-Part Test for an Interim Injunction</h4>
                      <div className="space-y-4">
                        {[
                          ...
                          <div key={i} className="flex gap-4 items-start">
                            ...
                            <div>
                              <h5 className="font-black text-gray-900 text-sm uppercase">{item.label}</h5>
                    ...
                    <div className="space-y-6 mb-10">
                      {[
                        ...
                        <div key={i} className="flex gap-6 bg-white border border-gray-100 p-6 rounded-2xl shadow-sm">
                          ...
                          <div>
                            <h5 className="font-black text-gray-900 text-sm uppercase mb-2">{item.platform}</h5>
                            <p className="text-xs text-gray-600 font-bold italic leading-relaxed">{item.desc}</p>
                          </div>
                        </div>
                      ))}
                  ...
                  <section id="damages-recovery" className="scroll-mt-32">
                    ...
                    <div className="grid md:grid-cols-3 gap-6 mb-10">
                      <div className="p-6 bg-blue-50 rounded-2xl border border-blue-100 text-center">
                        <h5 className="font-black text-blue-900 text-xs uppercase mb-3">Compensatory Damages</h5>
                      ...
                      <div className="p-6 bg-purple-50 rounded-2xl border border-purple-100 text-center">
                        <h5 className="font-black text-purple-900 text-xs uppercase mb-3">Account of Profits</h5>
                      ...
                      <div className="p-6 bg-red-50 rounded-2xl border border-red-100 text-center">
                        <h5 className="font-black text-red-900 text-xs uppercase mb-3">Punitive Damages</h5>
                  ...
                  <section className="bg-gradient-to-br from-[#0C002B] to-[#1a0031] rounded-[4rem] p-10 md:p-20 text-center text-white relative overflow-hidden mt-12 shadow-[0_40px_100px_rgba(0,0,0,0.3)] group border border-white/5">
                    ...
                    <div className="relative z-10">
                      <h3 className="text-4xl md:text-6xl font-black mb-8 leading-tight uppercase italic tracking-tighter">Don't Let Them Win</h3>
            ...
            <aside className="hidden lg:block space-y-8 sticky top-32">
              <div className="bg-[#0C002B] p-8 rounded-3xl shadow-[0_30px_60px_rgba(0,0,0,0.2)] border border-gray-800 text-white relative overflow-hidden group">
                ...
                <h4 className="text-xl font-bold mb-4 relative z-10 leading-tight uppercase font-black italic tracking-[0.1em]">Act Now</h4>
