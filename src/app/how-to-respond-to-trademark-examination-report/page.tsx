...
const tocSections = [
  { id: 'introduction', title: 'Respond to TM Examination Report' },
  { id: 'lifecycle', title: 'Respond to TM Examination Report' },
  { id: 'objection-types', title: 'Respond to TM Examination Report' },
  { id: 'deadline-management', title: 'Respond to TM Examination Report' },
  { id: 'drafting-strategy', title: 'Respond to TM Examination Report' },
  { id: 'evidence-gathering', title: 'Respond to TM Examination Report' },
  { id: 'online-filing', title: 'Respond to TM Examination Report' },
  { id: 'hearing-stage', title: 'Respond to TM Examination Report' },
  { id: 'post-response', title: 'Respond to TM Examination Report' },
  { id: 'faqs', title: 'Respond to TM Examination Report' },
];
...
export default function TrademarkExaminationResponsePage() {
  ...
  const articleSchema = {
    "@context": "https://schema.org",
    "@type": "Article",
    "headline": "Respond to TM Examination Report",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_300px] gap-8 items-start">
            ...
            <aside className="hidden lg:block sticky top-32 h-[calc(100vh-160px)] overflow-y-auto">
              <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                <p className="text-gray-900 font-bold text-lg mb-6 border-l-4 border-[rgb(110,94,147)] pl-3">Guide Navigation</p>
              ...
              <div className="bg-white p-4 md:p-12 rounded-2xl shadow-sm border border-gray-100 space-y-12 md:space-y-20">
                ...
                <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed font-normal">
                  ...
                  <section id="introduction" className="scroll-mt-32">
                    <h2 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-6 leading-tight uppercase font-black">A Strategic Overview</h2>
                    <p className="mb-6">
                  ...
                  <section id="lifecycle" className="scroll-mt-32">
                    <h3 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-6 leading-tight uppercase font-black">
                    ...
                    <div className="grid md:grid-cols-2 gap-8 mb-10">
                      <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                        ...
                        <h4 className="font-bold text-xl mb-3 text-gray-900">Filing (Form TM-A)</h4>
                      ...
                      <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                        ...
                        <h4 className="font-bold text-xl mb-3 text-gray-900">Substantive Examination</h4>
                      ...
                      <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                        ...
                        <h4 className="font-bold text-xl mb-3 text-gray-900">Report Issuance</h4>
                      ...
                      <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                        ...
                        <h4 className="font-bold text-xl mb-3 text-gray-900">Acceptance/Journal</h4>
                  ...
                  <section id="objection-types" className="scroll-mt-32">
                    ...
                    <div className="space-y-6">
                      <div className="bg-white border-2 border-gray-100 p-8 rounded-2xl shadow-sm hover:border-[rgb(110,94,147)] transition-all">
                        <h4 className="text-xl font-black text-[rgb(110,94,147)] mb-4 uppercase">Section 9(1): Absolute Grounds</h4>
                      ...
                      <div className="bg-white border-2 border-gray-100 p-8 rounded-2xl shadow-sm hover:border-[rgb(110,94,147)] transition-all">
                        <h4 className="text-xl font-black text-[rgb(110,94,147)] mb-4 uppercase tracking-tighter">Section 11(1): Relative Grounds</h4>
                  ...
                  <section id="deadline-management" className="scroll-mt-32">
                    ...
                    <div className="bg-black text-white p-10 rounded-[2.5rem] my-10 shadow-2xl relative overflow-hidden group">
                       ...
                       <h4 className="text-2xl font-black mb-4 uppercase italic">Fatal Error: Abandonment</h4>
                  ...
                  <section id="drafting-strategy" className="scroll-mt-32">
                    <h3 className="text-3xl md:text-5xl font-black text-gray-900 mb-12 text-center uppercase tracking-tight italic">
                    ...
                    <div className="relative space-y-12">
                       ...
                       <div className="flex gap-8 items-start relative">
                          ...
                          <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                             <h4 className="text-xl font-black mb-4 text-gray-900 uppercase tracking-tighter">Phase 1: Analyzing Cited Marks</h4>
                       ...
                       <div className="flex gap-8 items-start relative">
                          ...
                          <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                             <h4 className="text-xl font-black mb-4 text-gray-900 uppercase tracking-tighter">Phase 2: Side-by-Side Comparison</h4>
                             <p className="text-base text-gray-600 font-bold italic mb-4">
                       ...
                       <div className="flex gap-8 items-start relative">
                          ...
                          <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                             <h4 className="text-xl font-black mb-4 text-gray-900 uppercase tracking-tighter">Phase 3: Citing Legal Precedents</h4>
                             <p className="text-base text-gray-600 font-bold italic mb-4">
                  ...
                  <section id="post-response" className="scroll-mt-32">
                    ...
                    <div className="bg-gray-50 border-l-8 border-[rgb(110,94,147)] p-8 my-10 rounded-r-3xl">
                       <h5 className="font-bold text-[rgb(110,94,147)] mb-4 uppercase">Status Watchlist</h5>
                  ...
                  <section id="reviews" className="scroll-mt-32 pt-12">
                     <h3 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-12 text-center uppercase tracking-widest font-black italic">
                  ...
                  <section id="faqs" className="scroll-mt-32">
                    <h3 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-12 text-center uppercase underline decoration-[rgb(110,94,147)] decoration-4 underline-offset-8">
                       Objection Mastery: Strategic FAQs
                    </h3>
                    <div className="space-y-4">
                      {faqs.map((faq, index) => (
                        <div key={index} className="border-b border-gray-100 last:border-0 pb-6 mb-6">
                          <h4 className="text-lg md:text-xl font-black text-gray-900 mb-4 flex items-start">
                  ...
                  <section className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[3.5rem] p-8 md:p-16 text-center text-white relative overflow-hidden mt-12 shadow-2xl group border border-white/5">
                     ...
                     <div className="relative z-10">
                        <h3 className="text-3xl md:text-5xl font-black mb-6 leading-tight uppercase italic tracking-tighter">Your Brand Deserves Protection</h3>
            ...
            <aside className="hidden lg:block space-y-8 sticky top-32">
              ...
              <div className="bg-[#0C002B] p-8 rounded-3xl shadow-[0_20px_40px_rgba(0,0,0,0.1)] border border-gray-800 text-white relative overflow-hidden group">
                 ...
                 <h4 className="text-xl font-bold mb-4 relative z-10 leading-tight uppercase font-black italic tracking-widest">Urgent Response Desk</h4>
              ...
              <div className="bg-gray-50 p-8 rounded-3xl shadow-sm border border-gray-100">
                <h4 className="text-lg font-black text-gray-900 mb-6 border-b-2 border-[rgb(110,94,147)] pb-4 uppercase tracking-widest italic">Legal Guidance</h4>
