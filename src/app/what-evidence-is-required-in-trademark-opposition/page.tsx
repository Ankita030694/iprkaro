                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_300px] gap-8 items-start">
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-2xl shadow-sm border border-gray-100 space-y-12 md:space-y-20">
                                ...
                                <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed font-normal">
                                    ...
                                    <section id="strategic-importance" className="scroll-mt-32">
                                        <h2 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-6 leading-tight">Evidence in Trademark Battles</h2>
                                        <p className="mb-6">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8 mb-10">
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                                <div className="text-[rgb(110,94,147)] mb-4 flex items-center">
                                                    ...
                                                    <h4 className="font-bold text-xl text-gray-900">The Power of the Registrar</h4>
                                                </div>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                                <div className="text-[rgb(110,94,147)] mb-4 flex items-center">
                                                    ...
                                                    <h4 className="font-bold text-xl text-gray-900">The Role of Affidavits</h4>
                                                </div>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                                <div className="text-[rgb(110,94,147)] mb-4 flex items-center">
                                                    ...
                                                    <h4 className="font-bold text-xl text-gray-900">Priority of Use</h4>
                                                </div>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                                <div className="text-[rgb(110,94,147)] mb-4 flex items-center">
                                                    ...
                                                    <h4 className="font-bold text-xl text-gray-900">Deemed Abandonment</h4>
                                                </div>
                                        ...
                                        <div className="relative space-y-12">
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900">The Two-Month Hard Deadline</h4>
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900">The Core Narrative: Proof of Damage</h4>
                                                    <p className="text-base text-gray-600 mb-4">
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900">The Mandatory Service of Documents</h4>
                                                    <p className="text-base text-gray-600 mb-4">
                                    ...
                                    <section id="rule-46-evidence" className="scroll-mt-32">
                                        ...
                                        <div className="bg-black text-white p-10 rounded-3xl my-10 shadow-2xl">
                                            <h4 className="text-2xl font-bold mb-4 text-[rgb(110,94,147)] uppercase">The Defensive Pivot</h4>
                                    ...
                                    <section id="types-of-documentary-proof" className="scroll-mt-32">
                                        ...
                                        <div className="space-y-10">
                                            <div>
                                                <h4 className="text-xl font-bold text-[#6E5E93] mb-4 flex items-center">
                                    ...
                                    <section id="digital-evidence-segment" className="scroll-mt-32">
                                        ...
                                        <div className="bg-gray-50 p-8 rounded-3xl border border-gray-100 my-8">
                                            <h4 className="font-bold text-lg mb-4 text-gray-900">Digital Evidence Best Practices:</h4>
                                    ...
                                    <section id="technical-filing-requirements" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-3 gap-6 my-10">
                                            <div className="p-6 bg-gray-50 rounded-2xl text-center">
                                                ...
                                                <h5 className="font-bold mb-2">Notarization</h5>
                                            ...
                                            <div className="p-6 bg-gray-50 rounded-2xl text-center">
                                                ...
                                                <h5 className="font-bold mb-2">Chronological Index</h5>
                                            ...
                                            <div className="p-6 bg-gray-50 rounded-2xl text-center">
                                                ...
                                                <h5 className="font-bold mb-2">Service Proof</h5>
                                    ...
                                    <section className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[2.5rem] p-8 md:p-16 text-center text-white relative overflow-hidden mt-12 shadow-2xl">
                                        <div className="relative z-10">
                                            <h3 className="text-3xl md:text-5xl font-black mb-6 leading-tight">Don't Leave Your Brand to Chance</h3>
                        ...
                        <aside className="hidden lg:block space-y-8 sticky top-32">
                            <div className="bg-[#0C002B] p-8 rounded-3xl shadow-[0_20px_40px_rgba(0,0,0,0.1)] border border-gray-800 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-xl font-bold mb-4 relative z-10 leading-tight">Strategic Evidence Review</h4>
