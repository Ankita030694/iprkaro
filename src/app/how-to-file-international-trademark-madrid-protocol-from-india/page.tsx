                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_300px] gap-8 items-start">
                        ...
                        <aside className="hidden lg:block sticky top-32 h-[calc(100vh-160px)] overflow-y-auto">
                            <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                                <p className="text-gray-900 font-bold text-lg mb-6 border-l-4 border-[rgb(110,94,147)] pl-3">Global Guide</p>
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-2xl shadow-sm border border-gray-100 space-y-12 md:space-y-20">
                                ...
                                <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed font-normal">
                                    ...
                                    <section id="introduction" className="scroll-mt-32">
                                        <h2 className="text-2xl md:text-4xl lg:text-5xl font-black text-gray-900 mb-8 leading-tight">Why Indian Brands Must Go International</h2>
                                        <p className="mb-6">
                                    ...
                                    <section id="what-is-madrid" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-3 gap-8 mb-12">
                                            <div className="bg-gray-50 p-8 rounded-3xl border border-transparent hover:border-[rgb(110,94,147)] transition-all shadow-sm group">
                                                ...
                                                <h4 className="font-bold text-lg mb-2">Centralized Bureau</h4>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-3xl border border-transparent hover:border-[rgb(110,94,147)] transition-all shadow-sm group">
                                                ...
                                                <h4 className="font-bold text-lg mb-2">130+ Countries</h4>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-3xl border border-transparent hover:border-[rgb(110,94,147)] transition-all shadow-sm group">
                                                ...
                                                <h4 className="font-bold text-lg mb-2">Office of Origin</h4>
                                    ...
                                    <section id="benefits" className="scroll-mt-32">
                                        ...
                                        <div className="space-y-6">
                                            <div className="flex bg-white p-8 rounded-3xl border border-gray-100 shadow-sm relative overflow-hidden group">
                                                ...
                                                <div>
                                                    <h5 className="text-xl font-black mb-2">Massive Cost Savings</h5>
                                            ...
                                            <div className="flex bg-white p-8 rounded-3xl border border-gray-100 shadow-sm relative overflow-hidden group">
                                                ...
                                                <div>
                                                    <h5 className="text-xl font-black mb-2">Management Simplicity</h5>
                                            ...
                                            <div className="flex bg-white p-8 rounded-3xl border border-gray-100 shadow-sm relative overflow-hidden group">
                                                ...
                                                <div>
                                                    <h5 className="text-xl font-black mb-2">Expansion Flexibility</h5>
                                    ...
                                    <section id="step-by-step" className="scroll-mt-32 pt-20">
                                        <h3 className="text-3xl md:text-5xl font-black text-gray-900 mb-16 text-center tracking-tighter uppercase">
                                        ...
                                        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4 px-2">
                                            <div className="bg-gray-50 p-6 rounded-2xl flex flex-col items-center text-center hover:bg-white hover:shadow-xl hover:scale-105 transition-all border border-gray-100 group">
                                                ...
                                                <h5 className="font-bold text-sm mb-2 text-gray-900 uppercase tracking-tighter">Draft MM2</h5>
                                            ...
                                            <div className="bg-gray-50 p-6 rounded-2xl flex flex-col items-center text-center hover:bg-white hover:shadow-xl hover:scale-105 transition-all border border-gray-100 group">
                                                ...
                                                <h5 className="font-bold text-sm mb-2 text-gray-900 uppercase tracking-tighter">IP India Certification</h5>
                                            ...
                                            <div className="bg-gray-50 p-6 rounded-2xl flex flex-col items-center text-center hover:bg-white hover:shadow-xl hover:scale-105 transition-all border border-gray-100 group">
                                                ...
                                                <h5 className="font-bold text-sm mb-2 text-gray-900 uppercase tracking-tighter">WIPO Formalities</h5>
                                            ...
                                            <div className="bg-gray-50 p-6 rounded-2xl flex flex-col items-center text-center hover:bg-white hover:shadow-xl hover:scale-105 transition-all border border-gray-100 group">
                                                ...
                                                <h5 className="font-bold text-sm mb-2 text-gray-900 uppercase tracking-tighter">Notice of Notification</h5>
                                            ...
                                            <div className="bg-gray-50 p-6 rounded-2xl flex flex-col items-center text-center hover:bg-white hover:shadow-xl hover:scale-105 transition-all border border-gray-100 group mt-4">
                                                ...
                                                <h5 className="font-bold text-sm mb-2 text-gray-900 uppercase tracking-tighter">Substantive Review</h5>
                                            ...
                                            <div className="bg-gray-50 p-6 rounded-2xl flex flex-col items-center text-center hover:bg-white hover:shadow-xl hover:scale-105 transition-all border border-gray-100 group mt-4">
                                                ...
                                                <h5 className="font-bold text-sm mb-2 text-gray-900 uppercase tracking-tighter">Provisional Refusal?</h5>
                                            ...
                                            <div className="bg-gray-50 p-6 rounded-2xl flex flex-col items-center text-center hover:bg-white hover:shadow-xl hover:scale-105 transition-all border border-gray-100 group mt-4">
                                                ...
                                                <h5 className="font-bold text-sm mb-2 text-gray-900 uppercase tracking-tighter">Global Protection</h5>
                                    ...
                                    <section id="fees-structure" className="scroll-mt-32 pt-20">
                                        ...
                                        <div className="bg-white border rounded-[2rem] overflow-hidden shadow-sm">
                                            <div className="p-8 bg-gray-50 border-b">
                                                <h5 className="font-black text-gray-900 uppercase tracking-widest text-lg">Fee Component Breakdown</h5>
                                            </div>
                                    ...
                                    <section id="forms-needed" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-6">
                                            <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100 flex items-start group hover:bg-white hover:shadow-lg transition-all">
                                                ...
                                                <div>
                                                    <h5 className="font-bold text-gray-900 mb-1">MM2(E)</h5>
                                            ...
                                            <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100 flex items-start group hover:bg-white hover:shadow-lg transition-all">
                                                ...
                                                <div>
                                                    <h5 className="font-bold text-gray-900 mb-1">MM18</h5>
                                    ...
                                    <section id="strategic-tips" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8">
                                            <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100 relative group overflow-hidden">
                                                ...
                                                <h5 className="font-bold text-lg mb-4 text-gray-900">Conduct a Global Search</h5>
                                            ...
                                            <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100 relative group overflow-hidden">
                                                <div className="absolute bottom-0 right-0 w-24 h-24 bg-[rgb(110,94,147)] opacity-5 rounded-full -mb-8 -mr-8 transition-all group-hover:scale-150"></div>
                                                <h5 className="font-bold text-lg mb-4 text-gray-900">Use Professional Classes</h5>
                                    ...
                                    <section className="bg-black text-white p-12 rounded-[3.5rem] my-16 shadow-2xl relative overflow-hidden group border border-white/5">
                                        ...
                                        <h3 className="text-3xl md:text-5xl font-black mb-8 leading-tight">Scale Your Vision Globally</h3>
                        ...
                        <aside className="hidden lg:block space-y-8 sticky top-32">
                            ...
                            <div className="bg-[#0C002B] p-8 rounded-3xl shadow-[0_20px_40px_rgba(0,0,0,0.1)] border border-gray-800 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-xl font-bold mb-4 relative z-10 leading-tight">Expert Global Filing</h4>
                            ...
                            <div className="bg-gray-50 p-8 rounded-3xl shadow-sm border border-gray-100">
                                <h4 className="text-lg font-black text-gray-900 mb-6 border-b-2 border-[rgb(110,94,147)] pb-4 uppercase tracking-widest">Global IP Library</h4>
                                <ul className="space-y-4">
                                    <li>
