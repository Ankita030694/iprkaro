                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[220px_1fr_300px] gap-4 md:gap-12 mt-8 items-start">
                        ...
                        <div className="min-w-0">
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-xl md:rounded-2xl shadow-sm border border-gray-100 prose prose-lg max-w-none text-gray-800 font-sans">
                                ...
                                <section id="introduction" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h2 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6">Understanding the Small Company Advantage</h2>
                                ...
                                <section id="legal-definition" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Section 2(85): The Statutory Definition of a Small Company</h3>
                                ...
                                <section id="updated-thresholds" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">The 2022 Re-calibration: ₹4 Crore Capital & ₹40 Crore Turnover</h3>
                                    ...
                                    <ul className="space-y-6 my-10 list-none p-0 text-lg">
                                        <li className="flex gap-4 p-6 bg-gray-50 rounded-2xl border border-gray-200 shadow-sm">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-[#0C002B] text-xl mb-1">Paid-up Capital: ≤ ₹4 Crore</h5>
                                        ...
                                        <li className="flex gap-4 p-6 bg-indigo-50 rounded-2xl border border-indigo-100 shadow-sm">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-[#0C002B] text-xl mb-1">Annual Turnover: ≤ ₹40 Crore</h5>
                                ...
                                <section id="eligibility-criteria" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Who Qualifies? Eligibility and Strict Exclusions</h3>
                                    <p className="mb-4 leading-relaxed text-lg">
                                    ...
                                    <div className="bg-red-50 p-6 rounded-2xl border border-red-100 my-6">
                                        <h5 className="text-red-800 font-bold mb-3 flex items-center"><FontAwesomeIcon icon={faExclamationTriangle} className="mr-2" /> Ineligible Entities:</h5>
                                ...
                                <section id="compliance-benefits" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Exemptions & Relaxations: Why Small Status is a Boon</h3>
                                    <p className="mb-6 leading-relaxed text-lg">
                                    ...
                                    <div className="grid md:grid-cols-3 gap-4 my-10">
                                        <div className="p-6 bg-gray-50 rounded-2xl border border-gray-200 text-center">
                                            ...
                                            <h5 className="font-bold mb-2">No Cash Flow</h5>
                                        ...
                                        <div className="p-6 bg-gray-50 rounded-2xl border border-gray-200 text-center">
                                            ...
                                            <h5 className="font-bold mb-2">Only 2 Meetings</h5>
                                        ...
                                        <div className="p-6 bg-gray-50 rounded-2xl border border-gray-200 text-center">
                                            ...
                                            <h5 className="font-bold mb-2">MGT-7A Form</h5>
                                ...
                                <section id="financial-statements" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Financial Statement Relief: Farewell to Cash Flow Reporting</h3>
                                    <p className="mb-6 leading-relaxed text-lg">
                                    ...
                                    <div className="p-8 bg-[#0C002B] text-white rounded-[2rem] shadow-2xl my-10">
                                        <h5 className="text-cyan-400 font-bold text-2xl mb-4">The Accounting Advantage</h5>
                                ...
                                <section id="ifc-relief" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">IFC Relief: Internal Financial Controls & Audit Ease</h3>
                                    <p className="mb-4 leading-relaxed text-lg">
                                ...
                                <section id="board-meetings" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Operational Ease: Board Meeting Requirements</h3>
                                    <p className="mb-4 leading-relaxed text-lg">
                                ...
                                <section id="annual-return" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Filing Ease: The MGT-7A Abridged Annual Return</h3>
                                    <p className="mb-4 leading-relaxed text-lg">
                                ...
                                <section id="fast-track-merger" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Strategic Growth: Fast Track Mergers under Section 233</h3>
                                    <p className="mb-4 leading-relaxed text-lg">
                                ...
                                <section id="penalties-reduction" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Section 446B: The 50% Penalty Shield for Small Companies</h3>
                                    <p className="mb-4 leading-relaxed text-lg">
                                    ...
                                    <div className="bg-[#0C002B] text-white p-8 rounded-3xl shadow-xl my-8">
                                        <h5 className="text-cyan-400 font-bold text-xl mb-4">The Forensic Formula of Section 446B:</h5>
                                ...
                                <section id="small-vs-opc" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Small Company vs OPC: Decoding the Structural Differences</h3>
                                    <p className="mb-4 leading-relaxed text-lg">
                                ...
                                <section id="why-iprkaro" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6 text-center">Why Growth Startups Trust IPR Karo for MCA Forensics</h3>
                                    ...
                                    <div className="grid md:grid-cols-3 gap-8 text-center bg-[#0C002B] p-10 rounded-[3rem] text-white">
                                        <div className="space-y-4">
                                            ...
                                            <h5 className="font-bold text-xl">Threshold Tracking</h5>
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <h5 className="font-bold text-xl">Exemption Audit</h5>
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <h5 className="font-bold text-xl">Penalty Defense</h5>
                                ...
                                <section id="conclusion" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6 text-center">Conclusion: Fostering Entrepreneurship Through Regulatory Ease</h3>
                                ...
                                <div className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[40px] p-10 md:p-20 text-center text-white relative overflow-hidden mt-20 shadow-2xl">
                                    <div className="relative z-10">
                                        <h3 className="text-3xl md:text-5xl font-bold mb-6">Want to Optimize Your Compliance?</h3>
                        ...
                        <aside className="hidden lg:block space-y-10 sticky top-32">
                            ...
                            <div className="bg-[#0C002B] p-8 rounded-3xl shadow-xl border border-gray-800 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-2xl font-bold mb-4 relative z-10">Fast Track Merger</h4>
                            ...
                            <div className="bg-gray-50 p-8 rounded-3xl shadow-sm border border-gray-100">
                                <h4 className="text-xl font-bold text-[#0C002B] mb-6 border-b pb-4">Corporate Guides</h4>
