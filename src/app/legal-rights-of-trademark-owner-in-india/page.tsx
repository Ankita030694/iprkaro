...
const tocSections = [
    { id: 'introduction', title: 'Legal Rights of Trademark Owners' },
    { id: 'exclusive-use', title: 'Legal Rights of Trademark Owners' },
    { id: 'well-known-rights', title: 'Legal Rights of Trademark Owners' },
    { id: 'dilution-protection', title: 'Legal Rights of Trademark Owners' },
    { id: 'statutory-rights', title: 'Legal Rights of Trademark Owners' },
    { id: 'advertising-rights', title: 'Legal Rights of Trademark Owners' },
    { id: 'portfolio-management', title: 'Legal Rights of Trademark Owners' },
    { id: 'licensing-assignment', title: 'Legal Rights of Trademark Owners' },
    { id: 'legal-remedies', title: 'Legal Rights of Trademark Owners' },
    { id: 'correction-rectification', title: 'Legal Rights of Trademark Owners' },
    { id: 'unregistered-rights', title: 'Legal Rights of Trademark Owners' },
    { id: 'global-protection', title: 'Legal Rights of Trademark Owners' },
    { id: 'owner-obligations', title: 'Legal Rights of Trademark Owners' },
    { id: 'expert-consultation', title: 'Legal Rights of Trademark Owners' },
    { id: 'reviews', title: 'Legal Rights of Trademark Owners' },
    { id: 'faqs', title: 'Legal Rights of Trademark Owners' },
];
...
export default function TrademarkRightsPage() {
    ...
    const articleSchema = {
        "@context": "https://schema.org",
        "@type": "Article",
        "headline": "Legal Rights of Trademark Owners",
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_300px] gap-8 items-start">
                        ...
                        <aside className="hidden lg:block sticky top-32 h-[calc(100vh-160px)] overflow-y-auto">
                            <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                                <p className="text-gray-900 font-bold text-lg mb-6 border-l-4 border-[rgb(110,94,147)] pl-3">Owner's Charter</p>
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-2xl shadow-sm border border-gray-100 space-y-12 md:space-y-20">
                                ...
                                <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed font-normal">
                                    ...
                                    <section id="exclusive-use" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8 mb-12">
                                            <div className="bg-gray-50 p-8 rounded-3xl border border-transparent hover:border-[rgb(110,94,147)] transition-all shadow-sm group">
                                                ...
                                                <h4 className="font-bold text-base mb-2 uppercase tracking-tighter">Absolute Monopoly</h4>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-3xl border border-transparent hover:border-[rgb(110,94,147)] transition-all shadow-sm group">
                                                ...
                                                <h4 className="font-bold text-base mb-2 uppercase tracking-tighter">Prima Facie Validity</h4>
                                    ...
                                    <section id="well-known-rights" className="scroll-mt-32 pt-16">
                                        <h3 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-8 leading-tight font-normal">
                                        ...
                                        <div className="bg-white border border-gray-200 p-8 my-8 rounded-3xl shadow-sm font-normal">
                                            <h5 className="font-bold text-gray-900 mb-4 font-normal">Factors for Well-Known Status:</h5>
                                    ...
                                    <section id="dilution-protection" className="scroll-mt-32 pt-16 font-normal">
                                        ...
                                        <div className="bg-gray-50 p-8 rounded-3xl border border-gray-100 mb-12">
                                            <h5 className="font-bold text-gray-900 mb-4 uppercase tracking-tighter">Forms of Dilution:</h5>
                                    ...
                                    <section id="statutory-rights" className="scroll-mt-32 pt-16">
                                        <h3 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-12 text-center font-normal">
                                            Core Statutory Rights Under the Act 1999
                                        </h3>
                                        <div className="space-y-6">
                                            {[
                                                { title: "Legal Rights of Trademark Owners", text: "Under Section 29, the owner can initiate civil or criminal proceedings against any third party using a deceptively similar mark. This is the ultimate defensive right." },
                                                { title: "Legal Rights of Trademark Owners", text: "Only a registered owner has the right to use the circled R symbol. Using it without registration is a punishable offense under Indian law." },
                                                { title: "Legal Rights of Trademark Owners", text: "You have the right to file an 'Opposition' (Form TM-O) against any pending application that clashes with your rights, preventing them from ever getting a certificate." },
                                                { title: "Legal Rights of Trademark Owners", text: "You can record your trademark with the Customs authorities to stop the import of counterfeit goods into India, effectively policing the country's borders for your brand." }
                                            ].map((item, idx) => (
                                    ...
                                    <section id="advertising-rights" className="scroll-mt-32 pt-16">
                                        ...
                                        <div className="bg-white border-l-4 border-red-500 p-8 my-8 shadow-sm font-normal">
                                            <h5 className="font-bold text-gray-900 mb-4 font-normal">Unfair Advertising Checklist:</h5>
                                            <ul className="text-sm text-gray-700 leading-relaxed space-y-2 list-disc pl-5 font-normal">
                                    ...
                                    <section id="portfolio-management" className="scroll-mt-32 pt-16">
                                        ...
                                        <div className="bg-gray-50 p-10 rounded-[3rem] my-10 border border-gray-100 font-normal">
                                            <h5 className="font-bold text-gray-900 mb-4 font-normal">The 'Associated Trademarks' Right</h5>
                                    ...
                                    <section id="licensing-assignment" className="scroll-mt-32 pt-20">
                                        ...
                                        <div className="bg-white border-2 border-dashed border-gray-300 p-10 rounded-[2.5rem] my-10 relative group">
                                            ...
                                            <div className="grid md:grid-cols-2 gap-10">
                                                <div>
                                                    <h5 className="font-bold text-gray-900 mb-4 uppercase tracking-tighter">Assignment (Sale)</h5>
                                                ...
                                                <div>
                                                    <h5 className="font-bold text-gray-900 mb-4 uppercase tracking-tighter">Licensing (Rent)</h5>
                                        ...
                                        <div className="bg-gray-900 text-white p-12 rounded-[3.5rem] my-12 relative overflow-hidden">
                                            <div className="grid md:grid-cols-3 gap-8 relative z-10 text-center">
                                                <div className="space-y-4">
                                                    ...
                                                    <h5 className="font-black text-xs uppercase tracking-widest font-normal">Injunctions</h5>
                                                ...
                                                <div className="space-y-4">
                                                    ...
                                                    <h5 className="font-black text-xs uppercase tracking-widest font-normal">Damages</h5>
                                                ...
                                                <div className="space-y-4">
                                                    ...
                                                    <h5 className="font-black text-xs uppercase tracking-widest font-normal">Delivery Up</h5>
                                    ...
                                    <section id="correction-rectification" className="scroll-mt-32 pt-16">
                                        ...
                                        <div className="bg-[#f0f9ff] border-l-8 border-blue-500 p-8 rounded-2xl mb-12 font-normal">
                                            <h5 className="font-black text-blue-900 mb-2 flex items-center font-normal">
                                    ...
                                    <section id="unregistered-rights" className="scroll-mt-32 pt-20">
                                        <h3 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-6 leading-tight flex items-center font-normal">
                                        ...
                                        <div className="bg-yellow-50 border border-yellow-100 p-10 rounded-[3rem] shadow-sm mb-12 font-normal">
                                            <h5 className="font-bold text-yellow-900 mb-4 uppercase tracking-widest text-sm font-normal">The Passing Off Remedy:</h5>
                                    ...
                                    <section id="global-protection" className="scroll-mt-32 pt-16">
                                        <h3 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-12 text-center underline decoration-[rgb(110,94,147)] decoration-4 underline-offset-8 font-normal">
                                    ...
                                    <section id="owner-obligations" className="scroll-mt-32 pt-12">
                                        ...
                                        <div className="grid md:grid-cols-3 gap-8 mb-12 font-normal">
                                            <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm hover:shadow-md transition-all">
                                                <h6 className="font-black text-xs uppercase mb-4 text-red-600 font-normal">The Duty to Renew</h6>
                                            ...
                                            <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm hover:shadow-md transition-all font-normal">
                                                <h6 className="font-black text-xs uppercase mb-4 text-red-600 font-normal">The Duty to Use</h6>
                                            ...
                                            <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm hover:shadow-md transition-all font-normal">
                                                <h6 className="font-black text-xs uppercase mb-4 text-red-600 font-normal">The Duty to Police</h6>
                                        ...
                                        <div className="space-y-4">
                                            {faqs.map((faq, index) => (
                                                <div key={index} className="border-b border-gray-100 last:border-0 pb-6 mb-6">
                                                    <h4 className="text-lg md:text-xl font-bold text-gray-900 mb-4 flex items-start font-normal">
                                    ...
                                    <section className="bg-black text-white p-12 rounded-[3.5rem] my-16 shadow-2xl relative overflow-hidden group border border-white/5">
                                        ...
                                        <h3 className="text-3xl md:text-5xl font-black mb-8 leading-tight relative z-10 font-normal">Ready to Exercise Your Rights?</h3>
                        ...
                        <aside className="hidden lg:block space-y-8 sticky top-32 font-normal">
                            ...
                            <div className="bg-[#0C002B] p-8 rounded-3xl shadow-[0_20px_40px_rgba(0,0,0,0.1)] border border-gray-800 text-white relative overflow-hidden group font-normal">
                                ...
                                <h4 className="text-xl font-bold mb-4 relative z-10 leading-tight font-normal">Secure Your Legacy</h4>
                            ...
                            <div className="bg-gray-50 p-8 rounded-3xl shadow-sm border border-gray-100 font-normal">
                                <h4 className="text-lg font-black text-gray-900 mb-6 border-b-2 border-[rgb(110,94,147)] pb-4 uppercase tracking-widest font-normal">Rights Library</h4>
                                <ul className="space-y-4 font-normal">
                                    <li>
                                        <Link href="/understanding-trademark-classes-for-services-and-goods-in-india" className="group flex items-center text-gray-600 hover:text-[rgb(110,94,147)] transition-all">
