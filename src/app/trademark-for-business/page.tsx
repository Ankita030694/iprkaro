          ...
          <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr_350px] gap-10 items-start">
            ...
            <aside className="hidden lg:block sticky top-36">
              <div className="bg-white rounded-[2rem] p-6 border border-gray-100 shadow-xl">
                <p className="text-gray-900 font-black text-lg mb-6 border-l-8 border-[rgb(110,94,147)] pl-4 uppercase">Chapters</p>
              ...
              <div className="bg-white p-6 md:p-12 lg:p-20 rounded-[2.5rem] shadow-2xl border border-gray-50 space-y-20">
                <article className="prose prose-lg max-w-none text-gray-700 leading-normal">
                  ...
                  <section id="basics" className="scroll-mt-40">
                    <h3 className="text-3xl md:text-5xl font-black text-gray-900 mb-8 underline decoration-[rgb(110,94,147)]">2. What is a Trademark?</h3>
                    <p className="mb-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-8 my-10">
                      <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100">
                        ...
                        <h4 className="text-xl font-bold mb-4">Word Marks</h4>
                      ...
                      <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100">
                        ...
                        <h4 className="text-xl font-bold mb-4">Device/Logo Marks</h4>
                  ...
                  <section id="benefits" className="scroll-mt-40">
                    <h3 className="text-3xl md:text-5xl font-black text-gray-900 mb-8 underline decoration-[rgb(110,94,147)]">3. Core Business Benefits</h3>
                    <div className="space-y-10 my-12">
                      <div className="flex gap-6">
                        ...
                        <div>
                          <h4 className="text-2xl font-bold mb-2">Legal Exclusivity</h4>
                      ...
                      <div className="flex gap-6">
                        ...
                        <div>
                          <h4 className="text-2xl font-bold mb-2">Trust & Recall</h4>
                      ...
                      <div className="flex gap-6">
                        ...
                        <div>
                          <h4 className="text-2xl font-bold mb-2">Asset Valuation</h4>
                  ...
                  <section id="types" className="scroll-mt-40">
                    <h3 className="text-3xl md:text-5xl font-black text-gray-900 mb-8 underline decoration-[rgb(110,94,147)]">4. Types of Protectable Marks</h3>
                  ...
                  <section id="classification" className="scroll-mt-40">
                    <h3 className="text-3xl md:text-5xl font-black text-gray-900 mb-8 underline decoration-[rgb(110,94,147)]">5. The Class System</h3>
                    ...
                    <div className="bg-[#0C002B] text-white p-10 rounded-3xl my-8">
                      <h5 className="text-xl font-bold mb-4 text-[rgb(110,94,147)]">Pro Tip: The Multi-Class Strategy</h5>
                  ...
                  <section id="process" className="scroll-mt-40">
                    <h3 className="text-3xl md:text-5xl font-black text-gray-900 mb-8 underline decoration-[rgb(110,94,147)]">6. The 5-Step Process</h3>
                    <div className="grid md:grid-cols-5 gap-4 text-center my-12">
                      {[
                        ...
                        <div key={s.n} className="p-4 bg-gray-50 rounded-2xl flex flex-col items-center">
                          ...
                          <h5 className="font-bold text-sm mb-1">{s.t}</h5>
                  ...
                  <section id="objections" className="scroll-mt-40">
                    <h3 className="text-3xl md:text-5xl font-black text-gray-900 mb-8 underline decoration-[rgb(110,94,147)]">7. Handling Objections</h3>
                    ...
                    <div className="space-y-6">
                      <div className="p-8 bg-red-50 rounded-3xl border border-red-100">
                        <h5 className="text-xl font-bold mb-3 text-red-900">Absolute Grounds (Section 9)</h5>
                      ...
                      <div className="p-8 bg-orange-50 rounded-3xl border border-orange-100">
                        <h5 className="text-xl font-bold mb-3 text-orange-900">Relative Grounds (Section 11)</h5>
                  ...
                  <section id="precedents" className="scroll-mt-40">
                    <h3 className="text-2xl md:text-4xl lg:text-5xl font-black text-gray-900 mb-8 leading-tight">8. Legal Precedents</h3>
                    <div className="space-y-10">
                      <div className="p-8 bg-gray-50 rounded-[2rem] border-l-8 border-[rgb(110,94,147)]">
                        <h4 className="text-xl font-bold mb-3 italic">Honda Motors Vs. Charanjit Singh</h4>
                      ...
                      <div className="p-8 bg-gray-50 rounded-[2rem] border-l-8 border-[rgb(110,94,147)]">
                        <h4 className="text-xl font-bold mb-3 italic">Bayerische Motoren Werke (BMW) Vs. Om Balajee Automobile</h4>
                  ...
                  <section id="litigation" className="scroll-mt-40">
                    <h3 className="text-2xl md:text-4xl lg:text-5xl font-black text-gray-900 mb-8 leading-tight">9. Enforcement & Litigation</h3>
                    ...
                    <div className="bg-red-50 p-10 rounded-[2.5rem] my-10 border border-red-100">
                      <h5 className="text-xl font-bold mb-4 text-red-900 border-b border-red-200 pb-3">Court Remedies:</h5>
                  ...
                  <section id="intl-cases" className="scroll-mt-40">
                    <h3 className="text-2xl md:text-4xl lg:text-5xl font-black text-gray-900 mb-8 leading-tight">10. Global Brand Battles</h3>
                    <div className="space-y-10">
                      <div className="bg-gray-50 p-8 rounded-3xl hover:shadow-xl transition-all border border-gray-100">
                        <h5 className="text-xl font-bold mb-3">Apple Vs. Pear Technologies (Conceptual)</h5>
                      ...
                      <div className="bg-gray-50 p-8 rounded-3xl hover:shadow-xl transition-all border border-gray-100">
                        <h5 className="text-xl font-bold mb-3">Mastercard Vs. Mc (Malaysia)</h5>
                  ...
                  <section id="maintenance" className="scroll-mt-40">
                    <h3 className="text-2xl md:text-4xl lg:text-5xl font-black text-gray-900 mb-8 leading-tight">11. Policing Your Brand</h3>
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                      <div className="p-8 bg-black text-white rounded-3xl">
                        <h5 className="text-lg font-bold mb-3 text-[rgb(110,94,147)] uppercase">The 10-Year Rule</h5>
                      ...
                      <div className="p-8 bg-black text-white rounded-3xl border border-[rgb(110,94,147)]">
                        <h5 className="text-lg font-bold mb-3 text-[rgb(110,94,147)] uppercase">Watch Services</h5>
                  ...
                  <section id="startup-ip" className="scroll-mt-40">
                    <h3 className="text-2xl md:text-4xl lg:text-5xl font-black text-gray-900 mb-8 leading-tight">12. Startup IP Strategy</h3>
                    ...
                    <div className="bg-[#f0f9ff] p-10 rounded-[2.5rem] border border-blue-100 my-8">
                      <h5 className="text-xl font-bold mb-4 text-blue-900">Founder Checklist:</h5>
                  ...
                  <section id="pitfalls" className="scroll-mt-40">
                    <h3 className="text-2xl md:text-4xl lg:text-5xl font-black text-gray-900 mb-8 leading-tight">13. Common Pitfalls</h3>
                    <div className="grid md:grid-cols-2 gap-6 my-8">
                      <div className="p-6 bg-gray-50 rounded-2xl flex items-start gap-4 shadow-sm">
                        ...
                        <div><h5 className="font-bold text-sm">Generic Names:</h5><p className="text-xs opacity-60">Trying to trademark "High Quality Software". It will be rejected for being descriptive.</p></div>
                      </div>
                      <div className="p-6 bg-gray-50 rounded-2xl flex items-start gap-4 shadow-sm">
                        <FontAwesomeIcon icon={faExclamationTriangle} className="text-red-500 w-5 h-5 mt-1" />
                        <div><h5 className="font-bold text-sm">Prior Use Ignorance:</h5><p className="text-xs opacity-60">Filing a brand that someone else has been using since 1990 without registration.</p></div>
                      </div>
                      <div className="p-6 bg-gray-50 rounded-2xl flex items-start gap-4 shadow-sm">
                        <FontAwesomeIcon icon={faExclamationTriangle} className="text-red-500 w-5 h-5 mt-1" />
                        <div><h5 className="font-bold text-sm">Wrong Class:</h5><p className="text-xs opacity-60">Filing a food brand in the clothing class (Class 25) by mistake.</p></div>
                      </div>
                      <div className="p-6 bg-gray-50 rounded-2xl flex items-start gap-4 shadow-sm">
                        <FontAwesomeIcon icon={faExclamationTriangle} className="text-red-500 w-5 h-5 mt-1" />
                        <div><h5 className="font-bold text-sm">Unsigned Docs:</h5><p className="text-xs opacity-60">Filing without a proper Power of Attorney (User Affidavit), causing delays.</p></div>
                      </div>
                    </div>
                    <p className="mb-6">
                  ...
                  <section id="madrid-protocol" className="scroll-mt-40">
                    <h3 className="text-3xl md:text-5xl font-black text-gray-900 mb-8 underline decoration-[rgb(110,94,147)]">14. International Protection</h3>
                    ...
                    <div className="flex flex-col md:flex-row gap-6 my-10 bg-gray-50 p-10 rounded-[2.5rem] border border-gray-100 shadow-inner">
                      <div className="flex-1">
                        <h5 className="text-xl font-bold mb-4">The Prerequisites:</h5>
                  ...
                  <section id="monetization" className="scroll-mt-40">
                    <h3 className="text-3xl md:text-5xl font-black text-gray-900 mb-8 underline decoration-[rgb(110,94,147)]">15. Scaling and Licensing</h3>
                  ...
                  <section id="comparison" className="scroll-mt-40">
                    <h3 className="text-2xl md:text-4xl lg:text-5xl font-black text-gray-900 mb-8 leading-tight">16. IP Comparisons</h3>
                    ...
                    <div className="grid md:grid-cols-3 gap-6 text-center">
                      <div className="p-6 border-2 border-dashed border-gray-200 rounded-3xl group hover:border-[rgb(110,94,147)] transition-all">
                        ...
                        <h5 className="font-bold text-sm">Trademark</h5>
                      ...
                      <div className="p-6 border-2 border-dashed border-gray-200 rounded-3xl group hover:border-[rgb(110,94,147)] transition-all">
                        ...
                        <h5 className="font-bold text-sm">Copyright</h5>
                      ...
                      <div className="p-6 border-2 border-dashed border-gray-200 rounded-3xl group hover:border-[rgb(110,94,147)] transition-all">
                        ...
                        <h5 className="font-bold text-sm">Patent</h5>
                  ...
                  <section id="financial-value" className="scroll-mt-40">
                    <h3 className="text-3xl md:text-5xl font-black text-gray-900 mb-8 underline decoration-[rgb(110,94,147)]">17. Financial Valuation</h3>
                  ...
                  <section id="future-ip" className="scroll-mt-40">
                    <h3 className="text-2xl md:text-4xl lg:text-5xl font-black text-gray-900 mb-8 leading-tight">18. Future of IP: AI & NFTs</h3>
                  ...
                  <section id="faqs" className="scroll-mt-40">
                    <h3 className="text-3xl md:text-5xl font-black text-gray-900 mb-12 text-center">19. Expert FAQs</h3>
                    <div className="grid md:grid-cols-2 gap-8">
                      {faqs.map((f, i) => (
                        <div key={i} className="group p-6 bg-gray-50 rounded-3xl hover:bg-white hover:shadow-2xl transition-all border border-gray-100">
                          <h5 className="text-lg font-black mb-3 group-hover:text-[rgb(110,94,147)]">? {f.question}</h5>
                  ...
                  <section className="bg-black text-white p-12 rounded-[3.5rem] text-center my-20 overflow-hidden relative group">
                    ...
                    <h3 className="text-4xl font-black mb-8">Don't Leave Your Brand to Chance</h3>
            ...
            <aside className="hidden lg:block space-y-10 sticky top-36">
              <div className="bg-[#0C002B] p-10 rounded-[2rem] shadow-3xl border border-gray-800 text-white relative overflow-hidden group">
                ...
                <h4 className="text-2xl font-black mb-4">Free IP Audit</h4>
              ...
              <div className="bg-gray-50 p-8 rounded-[2rem] shadow-xl border border-gray-100">
                <h4 className="text-lg font-black text-gray-900 mb-6 border-b-4 border-[rgb(110,94,147)] pb-4 uppercase text-center">Modules</h4>
