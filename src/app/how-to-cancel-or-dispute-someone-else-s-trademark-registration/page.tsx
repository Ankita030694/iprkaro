                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_320px] gap-4 md:gap-12 mt-8 items-start">
                        ...
                        <div className="min-w-0">
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-xl md:rounded-2xl shadow-sm border border-gray-100 prose prose-lg max-w-none text-gray-800 font-sans">
                                ...
                                <section id="section-47" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Section 47: Removal for Non-Use</h3>
                                    ...
                                    <div className="grid md:grid-cols-2 gap-6 my-10 text-center">
                                        <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100">
                                            <h5 className="font-bold text-[#0C002B] text-xl mb-4">The 5-Year Rule</h5>
                                        ...
                                        <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100">
                                            <h5 className="font-bold text-[#0C002B] text-xl mb-4">Bona Fide Intent</h5>
                                ...
                                <section id="section-57" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Section 57: Power of Rectification</h3>
                                ...
                                <section id="aggrieved-person" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Who is an "Aggrieved Person"?</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify">
                                    ...
                                    <div className="grid md:grid-cols-3 gap-6 my-10 text-center">
                                        <div className="p-6 bg-white border border-gray-100 rounded-2xl shadow-sm">
                                            <h6 className="font-bold text-[#0C002B] mb-3">Direct Competitors</h6>
                                            <p className="text-sm text-gray-500">Entities whose own applications are blocked by the mark.</p>
                                        </div>
                                        <div className="p-6 bg-white border border-gray-100 rounded-2xl shadow-sm">
                                            <h6 className="font-bold text-[#0C002B] mb-3">Infringement Defendants</h6>
                                            <p className="text-sm text-gray-500">Parties being sued by the owner of the disputed mark.</p>
                                        </div>
                                        <div className="p-6 bg-white border border-gray-100 rounded-2xl shadow-sm">
                                            <h6 className="font-bold text-[#0C002B] mb-3">Prior Users</h6>
                                ...
                                <section id="forensic-process" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">The Forensic Process: TM-O to court</h3>
                                ...
                                <section id="evidence" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6 text-justify">Evidence and Burden of Proof</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify">
                                    ...
                                    <div className="bg-red-50 p-8 rounded-3xl border border-red-100 my-10 text-center">
                                        <h5 className="font-bold text-red-900 mb-4 tracking-tight uppercase">Crucial Evidence Points</h5>
                                ...
                                <section id="fraud-grounds" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Cancellation on Grounds of Fraud</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify">
                                ...
                                <section id="defense-strategy" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Defending Your Own Mark</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify">
                                ...
                                <section id="suo-motu" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Suo Motu Powers of Registrar</h3>
                                ...
                                <section id="costs-timelines" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Costs and Timelines 2026</h3>
                                    <div className="grid md:grid-cols-2 gap-8 my-10">
                                        <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100 text-center">
                                            ...
                                            <h6 className="font-bold text-[#0C002B] text-xl mb-3">Timeline</h6>
                                        ...
                                        <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100 text-center">
                                            ...
                                            <h6 className="font-bold text-[#0C002B] text-xl mb-3">Global Impact</h6>
                                ...
                                <section id="conclusion" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6 text-center text-justify">Cleaning the Register for Fair Play</h3>
                                ...
                                <div className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[40px] p-10 md:p-20 text-center text-white relative overflow-hidden mt-20 shadow-2xl">
                                    <div className="relative z-10">
                                        <h3 className="text-3xl md:text-5xl font-bold mb-6">Reclaim Your Brand Authority</h3>
                        ...
                        <aside className="hidden lg:block space-y-10 sticky top-32">
                            ...
                            <div className="bg-[#0C002B] p-8 rounded-3xl shadow-xl border border-gray-800 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-2xl font-bold mb-4 relative z-10 text-justify">Dispute Conflicting Marks</h4>
                            ...
                            <div className="bg-gray-50 p-8 rounded-3xl shadow-sm border border-gray-100">
                                <h4 className="text-xl font-bold text-[#0C002B] mb-6 border-b pb-4">Dispute Hub</h4>
