                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_300px] gap-8 items-start">
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-2xl shadow-sm border border-gray-100 space-y-12 md:space-y-20">
                                ...
                                <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed font-normal">
                                    ...
                                    <section id="introduction-to-rectification" className="scroll-mt-32">
                                        <h2 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-6 leading-tight">Keeping the Register Pure</h2>
                                        <p className="mb-6">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8 mb-10">
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                                <div className="text-[rgb(110,94,147)] mb-4 flex items-center">
                                                    ...
                                                    <h4 className="font-bold text-xl text-gray-900">Section 47: Non-Use Removal</h4>
                                                </div>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                                <div className="text-[rgb(110,94,147)] mb-4 flex items-center">
                                                    ...
                                                    <h4 className="font-bold text-xl text-gray-900">Section 57: Wrongful Entries</h4>
                                                </div>
                                        ...
                                        <div className="relative space-y-12">
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900">Ground 1: Continuous Non-Use (Section 47)</h4>
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900">Ground 2: Fraud and Bad Faith Registration</h4>
                                                    <p className="text-base text-gray-600 mb-4">
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900">Ground 3: Loss of Distinctiveness (Generification)</h4>
                                                    <p className="text-base text-gray-600 mb-4">
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900">Ground 4: Contravention of Section 9 and 11</h4>
                                                    <p className="text-base text-gray-600 mb-4">
                                    ...
                                    <section id="filing-procedure-steps" className="scroll-mt-32">
                                        ...
                                        <div className="space-y-6">
                                            <div className="p-6 bg-white border border-gray-200 rounded-2xl shadow-sm hover:border-[rgb(110,94,147)] transition-colors">
                                                <h5 className="text-lg font-bold text-gray-900 mb-2 flex items-center">
                                    ...
                                    <section id="evidence-and-hearings" className="scroll-mt-32">
                                        ...
                                        <div className="bg-black text-white p-10 rounded-3xl my-10 shadow-2xl">
                                            <h4 className="text-2xl font-bold mb-4 text-[rgb(110,94,147)] uppercase">The High Court Transition</h4>
                                    ...
                                    <section id="fees-and-timelines" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8">
                                            <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100 flex flex-col items-center text-center">
                                                ...
                                                <h5 className="font-bold text-xl mb-4">Official Govt. Fees</h5>
                                            ...
                                            <div className="p-8 bg-[rgb(110,94,147)] text-white rounded-3xl shadow-xl flex flex-col items-center text-center">
                                                ...
                                                <h5 className="font-bold text-xl mb-4 text-white">Expected Timeline</h5>
                                    ...
                                    <section id="expert-strategies-success" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-6 mb-10">
                                            <div className="p-6 bg-blue-50 rounded-2xl border border-blue-100">
                                                <h6 className="font-black text-blue-900 mb-3 uppercase tracking-tighter">1. The "Commercial Death" Strategy</h6>
                                            ...
                                            <div className="p-6 bg-green-50 rounded-2xl border border-green-100">
                                                <h6 className="font-black text-green-900 mb-3 uppercase tracking-tighter">2. Chronological Domination</h6>
                                            ...
                                            <div className="p-6 bg-red-50 rounded-2xl border border-red-100">
                                                <h6 className="font-black text-red-900 mb-3 uppercase tracking-tighter">3. Deceptive Similarity Matrix</h6>
                                            ...
                                            <div className="p-6 bg-yellow-50 rounded-2xl border border-yellow-100">
                                                <h6 className="font-black text-yellow-900 mb-3 uppercase tracking-tighter">4. Settlement Leverage</h6>
                                    ...
                                    <section className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[2.5rem] p-8 md:p-16 text-center text-white relative overflow-hidden mt-12 shadow-2xl">
                                        <div className="relative z-10">
                                            <h3 className="text-3xl md:text-5xl font-black mb-6 leading-tight">Clear Your Path to Brand Freedom</h3>
                        ...
                        <aside className="hidden lg:block space-y-8 sticky top-32">
                            <div className="bg-[#0C002B] p-8 rounded-3xl shadow-[0_20px_40px_rgba(0,0,0,0.1)] border border-gray-800 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-xl font-bold mb-4 relative z-10 leading-tight">Evaluate Your Case</h4>
