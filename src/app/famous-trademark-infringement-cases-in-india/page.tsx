                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_300px] gap-8 items-start">
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-2xl shadow-sm border border-gray-100 space-y-12 md:space-y-20">
                                ...
                                <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed font-normal">
                                    ...
                                    <section id="introduction" className="scroll-mt-32">
                                        <h2 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-6 leading-tight">Trademark Jurisprudence in Indian Markets</h2>
                                        <p className="mb-6">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8 mb-10">
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                                <div className="text-[rgb(110,94,147)] mb-4 flex items-center">
                                                    ...
                                                    <h4 className="font-bold text-xl text-gray-900">Common Law Passing Off</h4>
                                                </div>
                                        ...
                                        <div className="relative space-y-12">
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900">Parle Products v. J.P. & Co. (1972)</h4>
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900">Cadila Healthcare v. Cadila Pharmaceuticals (2001)</h4>
                                                    <p className="text-base text-gray-600 mb-4">
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900">Coca-Cola Company v. Bisleri International (2009)</h4>
                                                    <p className="text-base text-gray-600 mb-4">
                                    ...
                                    <section id="recent-cases-2024-2025" className="scroll-mt-32">
                                        ...
                                        <div className="space-y-10">
                                            <div className="bg-gray-50 p-8 rounded-3xl border-l-8 border-[rgb(110,94,147)] shadow-sm">
                                                <h4 className="text-2xl font-bold mb-4 text-gray-900">IndiGo v. Mahindra & Mahindra (2024-2025)</h4>
                                                <p className="mb-4">
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-3xl border-l-8 border-gray-400 shadow-sm">
                                                <h4 className="text-2xl font-bold mb-4 text-gray-900">KRBL Ltd. vs. Bharat Gate (Jan 2025)</h4>
                                                <p className="mb-4">
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-3xl border-l-8 border-[rgb(110,94,147)] shadow-sm">
                                                <h4 className="text-2xl font-bold mb-4 text-gray-900">Goodai Global Inc. vs. Beauty of Joseon Squatters (2025)</h4>
                                                <p className="mb-4">
                                    ...
                                    <section id="personality-rights" className="scroll-mt-32">
                                        ...
                                        <div className="bg-black text-white p-10 rounded-3xl my-10 shadow-2xl">
                                            <h4 className="text-2xl font-bold mb-4 text-[rgb(110,94,147)] uppercase">The AI Challenge</h4>
                                    ...
                                    <section id="impact-on-business" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-3 gap-8">
                                            <div className="bg-gray-50 p-8 rounded-3xl border border-gray-100 flex flex-col items-center text-center">
                                                ...
                                                <h5 className="font-bold text-xl mb-4">Register Early</h5>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-3xl border border-gray-100 flex flex-col items-center text-center">
                                                ...
                                                <h5 className="font-bold text-xl mb-4">Monitor Diligently</h5>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-3xl border border-gray-100 flex flex-col items-center text-center">
                                                ...
                                                <h5 className="font-bold text-xl mb-4">Invest in distinctiveness</h5>
                                    ...
                                    <section className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[2.5rem] p-8 md:p-16 text-center text-white relative overflow-hidden mt-12 shadow-2xl">
                                        <div className="relative z-10">
                                            <h3 className="text-3xl md:text-5xl font-black mb-6 leading-tight">Protect Your Brand Before History Repeats Itself</h3>
                        ...
                        <aside className="hidden lg:block space-y-8 sticky top-32">
                            <div className="bg-[#0C002B] p-8 rounded-3xl shadow-[0_20px_40px_rgba(0,0,0,0.1)] border border-gray-800 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-xl font-bold mb-4 relative z-10 leading-tight">Stop Trademark Theft</h4>
