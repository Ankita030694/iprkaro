                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_320px] gap-4 md:gap-12 mt-8 items-start">
                        ...
                        <div className="min-w-0">
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-xl md:rounded-2xl shadow-sm border border-gray-100 prose prose-lg max-w-none text-gray-800 font-sans">
                                ...
                                <section id="introduction" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h2 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6">Protecting Your Brand in New India</h2>
                                ...
                                <section id="importance-of-names" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Why Brand Names are Strategic Business Assets</h3>
                                ...
                                <section id="pre-filing-research" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Phase 1: The Pre Filing Forensic Search</h3>
                                    <p className="mb-6 leading-relaxed text-lg text-justify">
                                    ...
                                    <div className="bg-white border-2 border-dashed border-[#6E5E93] p-8 my-10 rounded-3xl">
                                        <h5 className="font-bold text-[#0C002B] text-xl mb-4">The Search Hierarchy:</h5>
                                ...
                                <section id="class-selection" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Decoding the 45 Classes: The Nice Classification</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify">
                                    ...
                                    <div className="p-8 bg-gray-50 rounded-3xl border border-gray-200 my-10">
                                        <h5 className="font-bold text-[#0C002B] text-2xl mb-4 text-center">Common Class Pitfalls</h5>
                                        <div className="grid md:grid-cols-2 gap-8">
                                            <div>
                                                <h6 className="font-bold text-[#6E5E93] mb-2 underline">The Goods vs Services Trap</h6>
                                            ...
                                            <div>
                                                <h6 className="font-bold text-[#6E5E93] mb-2 underline">vague Descriptions</h6>
                                ...
                                <section id="dsc-requirement" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">The Digital Identity: Procurement and Mapping of Class 3 DSC</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify">
                                ...
                                <section id="ipindia-portal" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Navigating the Portal: Account Creation and Login</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify">
                                    ...
                                    <ul className="space-y-6 my-10 list-none p-0">
                                        <li className="flex gap-4 p-6 bg-gray-50 rounded-2xl border border-gray-200 shadow-sm border-l-[10px] border-l-[#6E5E93]">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-[#0C002B] text-xl mb-1">Proprietor</h5>
                                        ...
                                        <li className="flex gap-4 p-6 bg-gray-50 rounded-2xl border border-gray-200 shadow-sm border-l-[10px] border-l-[#6E5E93]">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-[#0C002B] text-xl mb-1">Agent/Attorney</h5>
                                ...
                                <section id="filing-tm-a" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Drafting Form TM-A: A Character by Character Guide</h3>
                                    <p className="mb-6 leading-relaxed text-lg text-justify">
                                    ...
                                    <div className="bg-[#0C002B] p-10 rounded-[2rem] text-white my-10 relative overflow-hidden">
                                        ...
                                        <h5 className="text-xl font-bold mb-4 border-b border-white/20 pb-2">Technical Section breakdown</h5>
                                ...
                                <section id="document-checklist" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Mandatory Documents for Individuals, Startups, and MSMEs</h3>
                                    <p className="mb-6 leading-relaxed text-lg text-justify">
                                    ...
                                    <div className="grid md:grid-cols-3 gap-6 my-10">
                                        <div className="p-6 bg-gray-50 rounded-2xl border border-gray-200 text-center">
                                            ...
                                            <h5 className="font-bold text-[#0C002B] mb-2">Form TM-48</h5>
                                        ...
                                        <div className="p-6 bg-gray-50 rounded-2xl border border-gray-200 text-center">
                                            ...
                                            <h5 className="font-bold text-[#0C002B] mb-2">MSME Certificate</h5>
                                        ...
                                        <div className="p-6 bg-gray-50 rounded-2xl border border-gray-200 text-center">
                                            ...
                                            <h5 className="font-bold text-[#0C002B] mb-2">User Affidavit</h5>
                                ...
                                <section id="fee-structure" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Government Fee Matrix 2026 and MSME Rebates</h3>
                                    <p className="mb-6 leading-relaxed text-lg text-justify">
                                ...
                                <section id="post-filing-stages" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">The Journey from Acknowledgement to Registration</h3>
                                    <p className="mb-6 leading-relaxed text-lg text-justify">
                                    ...
                                    <div className="space-y-6 my-10">
                                        <div className="flex gap-6 items-start border-l-4 border-[#6E5E93] pl-6 py-2 bg-gray-50 rounded-r-2xl">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-[#0C002B] text-xl">Formalities Check Pass</h5>
                                        ...
                                        <div className="flex gap-6 items-start border-l-4 border-[#6E5E93] pl-6 py-2 bg-gray-50 rounded-r-2xl">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-[#0C002B] text-xl">Examination</h5>
                                        ...
                                        <div className="flex gap-6 items-start border-l-4 border-[#6E5E93] pl-6 py-2 bg-gray-50 rounded-r-2xl">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-[#0C002B] text-xl">Accepted & Advertised</h5>
                                        ...
                                        <div className="flex gap-6 items-start border-l-4 border-[#6E5E93] pl-6 py-2 bg-gray-50 rounded-r-2xl">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-[#0C002B] text-xl">Registered</h5>
                                ...
                                <section id="objection-response" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Tactical Responses to Examination Reports</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify">
                                ...
                                <section id="journal-publication" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">The Publication Window: Handling Public Opposition</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify">
                                ...
                                <section id="madrid-protocol" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Scaling Global: International Filing via Madrid Protocol</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify">
                                ...
                                <section id="common-pitfalls" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6">Why Applications Fail: Top 10 Mistakes to Avoid</h3>
                                    ...
                                    <div className="grid md:grid-cols-2 gap-8 bg-[#0C002B] p-10 rounded-[3rem] text-white">
                                        <div className="space-y-4">
                                            <h5 className="font-bold text-xl text-[#6E5E93]">01. Choosing Descriptive Names</h5>
                                        ...
                                        <div className="space-y-4">
                                            <h5 className="font-bold text-xl text-[#6E5E93]">02. Incorrect Applicant Name</h5>
                                        ...
                                        <div className="space-y-4">
                                            <h5 className="font-bold text-xl text-[#6E5E93]">03. Missing the 30-Day Reply Window</h5>
                                        ...
                                        <div className="space-y-4">
                                            <h5 className="font-bold text-xl text-[#6E5E93]">04. Wrong User Date</h5>
                                        ...
                                        <div className="space-y-4">
                                            <h5 className="font-bold text-xl text-[#6E5E93]">05. Poor Quality Logos</h5>
                                        ...
                                        <div className="space-y-4">
                                            <h5 className="font-bold text-xl text-[#6E5E93]">06. Ignoring Class 35</h5>
                                ...
                                <section id="why-iprkaro" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">IPRKaro: Your Strategic Partner in IP Management</h3>
                                    <p className="mb-6 leading-relaxed text-lg text-justify">
                                ...
                                <section id="conclusion" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6 text-center">Conclusion: Securing Your Intellectual Legacy</h3>
                                ...
                                <div className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[40px] p-10 md:p-20 text-center text-white relative overflow-hidden mt-20 shadow-2xl">
                                    <div className="relative z-10">
                                        <h3 className="text-3xl md:text-5xl font-bold mb-6">Ready to Secure Your Brand?</h3>
                        ...
                        <aside className="hidden lg:block space-y-10 sticky top-32">
                            ...
                            <div className="bg-[#0C002B] p-8 rounded-3xl shadow-xl border border-gray-800 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-2xl font-bold mb-4 relative z-10">Instant TM-A Filing</h4>
                            ...
                            <div className="bg-gray-50 p-8 rounded-3xl shadow-sm border border-gray-100">
                                <h4 className="text-xl font-bold text-[#0C002B] mb-6 border-b pb-4">Brand Resources</h4>
