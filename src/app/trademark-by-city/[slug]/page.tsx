...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  let title = `Best TM Lawyers in ${location} | IPR Karo`;
  if (title.length > 50) {
    title = `TM Lawyers in ${location} | IPR Karo`;
    if (title.length > 50) {
      title = `TM Lawyers ${location} | IPR Karo`;
    }
    if (title.length > 50) {
            ...
            <div className="min-w-0">
              ...
              <div className="bg-white p-4 md:p-12 rounded-xl md:rounded-2xl shadow-sm space-y-8 md:space-y-16">
                ...
                <section id="types-of-trademarks" className="scroll-mt-24 md:scroll-mt-32">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                     ...
                     <div className="bg-gray-50 p-6 rounded-lg">
                        <h4 className="font-bold text-lg mb-2 text-[rgb(110,94,147)]">Logo & Name Combo</h4>
                ...
                <section id="documents-checklist" className="scroll-mt-24 md:scroll-mt-32">
                   <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Required Documents For {location} Businesses</h3>
                   
                   <div className="grid md:grid-cols-2 gap-8">
                       <div className="bg-gray-50 p-6 rounded-xl border border-gray-100">
                           <h4 className="font-bold text-lg mb-4 text-[rgb(110,94,147)]">Individuals & Proprietors in {location}</h4>
                       ...
                       <div className="bg-gray-50 p-6 rounded-xl border border-gray-100">
                           <h4 className="font-bold text-lg mb-4 text-[rgb(110,94,147)]">Companies & Startups in {location}</h4>
                           <ul className="space-y-3">
                                <li className="flex items-start">
                                     <FontAwesomeIcon icon={faCheck} className="mt-1 mr-3 text-green-500 text-sm w-4 h-4" />
                ...
                <section id="renewal-restoration" className="scroll-mt-24 md:scroll-mt-32">
                   <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Renewal & Restoration</h3>
                   <div className="grid md:grid-cols-2 gap-6">
                      <div className="p-4 border border-gray-100 rounded-lg">
                         <FontAwesomeIcon icon={faSync} className="text-2xl text-[rgb(110,94,147)] mb-3" />
                         <h4 className="font-bold text-lg mb-2">Trademark Renewal</h4>
                      ...
                      <div className="p-4 border border-gray-100 rounded-lg">
                         ...
                         <h4 className="font-bold text-lg mb-2">Restoration</h4>
                ...
                <section id="international-registration" className="scroll-mt-24 md:scroll-mt-32">
                   <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Going Global from {location}: Madrid Protocol</h3>
                ...
                <section id="faqs" className="scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-6 md:mb-8">Frequently Asked Questions for {location}</h3>
                ...
                <section id="reviews" className="scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-6 md:mb-8">What Businesses in {location} Say About Us</h3>
                      ...
                      {reviews.map((rev, i) => (
                         <div key={i} className="bg-gray-50 p-6 rounded-xl border border-gray-100 flex flex-col justify-between hover:shadow-md transition-all">
                            ...
                            <div className="flex items-center gap-3">
                               ...
                               <div>
                                  <h5 className="font-bold text-gray-900 text-sm">{rev.author}</h5>
                ...
                <section id="why-choose-iprkaro" className="scroll-mt-24 md:scroll-mt-32 bg-black text-white p-6 md:p-8 rounded-xl md:rounded-2xl">
                  <h3 className="text-xl md:text-3xl font-bold mb-4 md:mb-6 text-center">Why Trust IPR Karo for your business in {location}?</h3>
                  <div className="grid md:grid-cols-3 gap-6 text-center">
                    <div className="p-2 md:p-4">
                       <FontAwesomeIcon icon={faRocket} className="w-8 h-8 text-[rgb(110,94,147)] mb-4" />
                       <h4 className="font-bold text-lg mb-2 text-[#FFD700]">Same-Day Filing</h4>
                    ...
                    <div className="p-2 md:p-4">
                       ...
                       <h4 className="font-bold text-lg mb-2 text-[#FFD700]">Legal Expertise</h4>
                    ...
                    <div className="p-2 md:p-4">
                       ...
                       <h4 className="font-bold text-lg mb-2 text-[#FFD700]">Transparent Pricing</h4>
                ...
                <section className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-xl md:rounded-3xl p-6 md:p-16 text-center text-white relative overflow-hidden mt-8 md:mt-12">
                   <div className="relative z-10">
                    <h3 className="text-xl md:text-4xl font-bold mb-4 md:mb-6">Start Your Application in {location} Today</h3>
             ...
             <div className="hidden lg:block space-y-8 sticky top-32">
                <div className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] p-6 rounded-xl shadow-lg border border-gray-800 text-white text-center">
                  <h4 className="text-xl font-bold mb-3">Enquiry for {location}</h4>
