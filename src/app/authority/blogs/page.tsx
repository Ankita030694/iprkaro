...
export default function BlogsDashboard() {
  ...
  const [newBlog, setNewBlog] = useState<Blog>({
    title: '',
    subtitle: '',
    description: validateAndNormalizeDescription('', "app/authority/blogs/page.tsx "),
  ...
  const handleAutofillTestData = () => {
    ...
    setNewBlog({
      title: mockTitle,
      subtitle: "Drafting Objection Replies under Trade Marks Act 1999",
      ...
      date: new Date().toISOString().split('T')[0],
      description: validateAndNormalizeDescription(`<h2>Understanding Trademark Examination Reports</h2><p>When the Trade Marks Registry issues an examination report raising objections under Section 9 (Absolute grounds for refusal) or Section 11 (Relative grounds for refusal regarding identical/similar prior marks), applicants must file a formal reply within 30 statutory days.</p><div class="overflow-x-auto my-6"><table class="w-full border-collapse"><thead><tr><th>Parameter</th><th>Section / Rule</th><th>Statutory Requirement</th><th>Legal Effect / Remedy</th></tr></thead><tbody><tr><td>Absolute Grounds</td><td>Section 9(1)(a)-(c)</td><td>Lack of distinctive character</td><td>Establish acquired distinctiveness through long prior use</td></tr><tr><td>Relative Grounds</td><td>Section 11(1)</td><td>Similarity with prior existing registered mark</td><td>File comparative distinction affidavit and user proof</td></tr></tbody></table></div><h4>Official Sources, Statutory Portals & Legal References</h4><ul class="official-references-list"><li><a href="https://ipindiaonline.gov.in/trademarkefiling/" target="_blank" rel="noopener noreferrer"><strong>Trade Marks Registry E-Filing Gateway (CGPDTM)</strong></a> - Official portal for Form TM-A filings.</li><li><a href="https://ipindia.gov.in/" target="_blank" rel="noopener noreferrer"><strong>Intellectual Property India Official Portal</strong></a> - Public search records.</li><li><a href="https://www.wipo.int/" target="_blank" rel="noopener noreferrer"><strong>WIPO Madrid System</strong></a> - International trademark treaty.</li></ul>`, "app/authority/blogs/page.tsx "),
  ...
  const resetForm = () => {
    setNewBlog({
      title: '', subtitle: '', description: validateAndNormalizeDescription('', "app/authority/blogs/page.tsx "), date: new Date().toISOString().split('T')[0],
              ...
              <div className="p-6 border border-amber-200/80 bg-gradient-to-br from-amber-50/40 to-orange-50/10 rounded-2xl shadow-sm relative overflow-hidden">
                ...
                <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <h4 className="text-slate-800 text-sm font-bold uppercase tracking-wider">
