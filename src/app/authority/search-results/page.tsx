                    ...
                    {results.map((result) => (
                      ...
                      >
                        ...
                        <div className="flex items-center justify-between mb-2">
                          <h4 className="text-sm font-bold text-gray-900 font-nunito">
        ...
        >
          ...
          >
            ...
            <div className="sticky top-0 bg-gradient-to-r from-gray-900 to-gray-800 px-6 py-4 border-b border-gray-200 flex items-center justify-between">
              <div>
                <h3 className="text-xl font-bold text-white font-nunito capitalize">
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                <h4 className="text-sm font-bold text-gray-900 font-nunito mb-2">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                  <h5 className="text-xs font-bold text-gray-700 font-nunito mb-1">Class Fit Score</h5>
                ...
                <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                  <h5 className="text-xs font-bold text-gray-700 font-nunito mb-1">Registrability Score</h5>
                ...
                <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                  <h5 className="text-xs font-bold text-gray-700 font-nunito mb-1">Similarity Score</h5>
              ...
              {selectedResult.genericnessAssessment && (
                <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                  <h4 className="text-sm font-bold text-gray-900 font-nunito mb-3">
                    <i className="fas fa-clipboard-check mr-2"></i>
                    Assessment Details
                  </h4>
                  <div className="space-y-2">
                    <div>
                      <h5 className="text-xs font-bold text-gray-700 font-nunito mb-1">Class Fit</h5>
                      <p className="text-xs text-gray-600 font-nunito">{selectedResult.genericnessAssessment.classFit}</p>
                    </div>
                    <div>
                      <h5 className="text-xs font-bold text-gray-700 font-nunito mb-1">Registrability</h5>
                      <p className="text-xs text-gray-600 font-nunito">{selectedResult.genericnessAssessment.registrability}</p>
                    </div>
                    <div>
                      <h5 className="text-xs font-bold text-gray-700 font-nunito mb-1">Similarity</h5>
              ...
              {selectedResult.keyFactors && (
                <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div>
                      <h5 className="text-xs font-bold text-gray-700 font-nunito mb-1">Brand Strength</h5>
                      <p className="text-xs text-gray-600 font-nunito">{selectedResult.keyFactors.brandStrength}</p>
                    </div>
                    <div>
                      <h5 className="text-xs font-bold text-gray-700 font-nunito mb-1">Legal Risk</h5>
                      <p className="text-xs text-gray-600 font-nunito">{selectedResult.keyFactors.legalRisk}</p>
                    </div>
                    <div>
                      <h5 className="text-xs font-bold text-gray-700 font-nunito mb-1">Market Position</h5>
                      <p className="text-xs text-gray-600 font-nunito">{selectedResult.keyFactors.marketPosition}</p>
                    </div>
                    <div>
                      <h5 className="text-xs font-bold text-gray-700 font-nunito mb-1">Protection Level</h5>
                      <p className="text-xs text-gray-600 font-nunito">{selectedResult.keyFactors.protectionLevel}</p>
                    </div>
                    <div>
                      <h5 className="text-xs font-bold text-gray-700 font-nunito mb-1">Registration Speed</h5>
              ...
              <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
                  <div>
                    <h5 className="text-xs font-bold text-gray-700 font-nunito mb-1">Created</h5>
                    <p className="text-xs text-gray-600 font-nunito">{formatDate(selectedResult.createdAt)}</p>
                  </div>
                  <div>
                    <h5 className="text-xs font-bold text-gray-700 font-nunito mb-1">Last Updated</h5>
