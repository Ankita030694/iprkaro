                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_300px] gap-8 items-start">
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-2xl shadow-sm border border-gray-100 space-y-12 md:space-y-20">
                                ...
                                <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed font-normal">
                                    ...
                                    <section id="introduction" className="scroll-mt-32">
                                        <h2 className="text-2xl md:text-4xl lg:text-5xl font-black text-gray-900 mb-8 leading-tight">Navigating Trademark Borders in India</h2>
                                        <p className="mb-6">
                                    ...
                                    <section id="understanding-classes" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8 mb-12">
                                            <div className="bg-gray-50 p-8 rounded-3xl border border-transparent hover:border-[rgb(110,94,147)] transition-all shadow-sm group">
                                                ...
                                                <h4 className="font-bold text-lg mb-2">Goods (Classes 1-34)</h4>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-3xl border border-transparent hover:border-[rgb(110,94,147)] transition-all shadow-sm group">
                                                ...
                                                <h4 className="font-bold text-lg mb-2">Services (Classes 35-45)</h4>
                                    ...
                                    <section id="general-rule" className="scroll-mt-32">
                                        ...
                                        <div className="flex bg-white p-8 rounded-3xl border border-gray-100 shadow-sm relative overflow-hidden group mb-6">
                                            ...
                                            <div>
                                                <h5 className="text-xl font-black mb-2">Non-Competing Markets</h5>
                                        ...
                                        <div className="flex bg-white p-8 rounded-3xl border border-gray-100 shadow-sm relative overflow-hidden group mb-6">
                                            ...
                                            <div>
                                                <h5 className="text-xl font-black mb-2">Distinct Trade Channels</h5>
                                    ...
                                    <section id="section-11-nuances" className="scroll-mt-32 pt-20">
                                        ...
                                        <div className="bg-white border rounded-[2rem] overflow-hidden shadow-sm">
                                            <div className="p-8 bg-gray-50 border-b">
                                                <h5 className="font-black text-gray-900 uppercase tracking-widest text-lg">Rejection Criteria (Cross-Class)</h5>
                                            </div>
                                    ...
                                    <section id="case-studies" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8">
                                            <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100 relative group overflow-hidden">
                                                <h5 className="font-bold text-lg mb-4 text-gray-900">The 'Bata' vs 'Bata' Case</h5>
                                            ...
                                            <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100 relative group overflow-hidden">
                                                <h5 className="font-bold text-lg mb-4 text-gray-900">The 'Honda' vs 'Honda' Case</h5>
                                        ...
                                        <div className="bg-white border rounded-[2rem] overflow-hidden shadow-sm p-10">
                                            <div className="flex flex-col md:flex-row gap-10">
                                                <div className="flex-1">
                                                    <h6 className="font-black text-[rgb(110,94,147)] mb-4">THE TECH STARTUP</h6>
                                                ...
                                                <div className="flex-1">
                                                    <h6 className="font-black text-[rgb(110,94,147)] mb-4">THE FASHION LABEL</h6>
                                                    <ul className="text-xs space-y-2">
                                    ...
                                    <section id="legal-risks" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-3 gap-6">
                                            <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100 group hover:bg-white hover:shadow-lg transition-all">
                                                ...
                                                <h5 className="font-bold text-sm mb-1">Trademark Squatting</h5>
                                            ...
                                            <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100 group hover:bg-white hover:shadow-lg transition-all">
                                                <FontAwesomeIcon icon={faTriangleExclamation} className="text-red-500 mb-4" />
                                                <h5 className="font-bold text-sm mb-1">Injunction Suits</h5>
                                            ...
                                            <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100 group hover:bg-white hover:shadow-lg transition-all">
                                                <FontAwesomeIcon icon={faTriangleExclamation} className="text-red-500 mb-4" />
                                                <h5 className="font-bold text-sm mb-1">Oppositions</h5>
                                    ...
                                    <section className="bg-black text-white p-12 rounded-[3.5rem] my-16 shadow-2xl relative overflow-hidden group border border-white/5">
                                        ...
                                        <h3 className="text-3xl md:text-5xl font-black mb-8 leading-tight">Secure Your Brand Across the Classes</h3>
                        ...
                        <aside className="hidden lg:block space-y-8 sticky top-32">
                            ...
                            <div className="bg-[#0C002B] p-8 rounded-3xl shadow-[0_20px_40px_rgba(0,0,0,0.1)] border border-gray-800 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-xl font-bold mb-4 relative z-10 leading-tight">Expert Class Audit</h4>
                            ...
                            <div className="bg-gray-50 p-8 rounded-3xl shadow-sm border border-gray-100">
                                <h4 className="text-lg font-black text-gray-900 mb-6 border-b-2 border-[rgb(110,94,147)] pb-4 uppercase tracking-widest">Trademark Library</h4>
