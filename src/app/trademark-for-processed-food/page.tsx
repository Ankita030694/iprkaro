                    ...
                    <div className="container mx-auto px-4 py-12 lg:py-32 relative z-10 text-center">
                        <h1 className="text-2xl md:text-5xl lg:text-6xl font-extrabold mb-4 md:mb-6 leading-tight mt-20 md:mt-10 text-white">
                            ...
                            <span className="text-[#6E5E93] bg-clip-text text-transparent bg-gradient-to-r from-[#8A7AB5] to-[#D1C4E9]" style={{ WebkitTextFillColor: 'rgb(110, 94, 147)' }}>
                                Registration for Processed Food
                            </span>
                        </h1>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_300px] gap-8 items-start">
                        ...
                        <aside className="hidden lg:block sticky top-32">
                            <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                                <p className="text-gray-900 font-bold text-lg mb-6 border-l-4 border-[rgb(110,94,147)] pl-3">Guide Menu</p>
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-2xl shadow-sm border border-gray-100 space-y-12 md:space-y-20">
                                ...
                                <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed font-normal">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8 mb-10">
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                                <div className="flex items-center mb-4">
                                                    ...
                                                    <h4 className="font-bold text-xl text-gray-900">Class 29: Animal-Based & Processed Veggies</h4>
                                                </div>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                                <div className="flex items-center mb-4">
                                                    ...
                                                    <h4 className="font-bold text-xl text-gray-900">Class 30: Staples, Bakery & Spices</h4>
                                                </div>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                                <div className="flex items-center mb-4">
                                                    ...
                                                    <h4 className="font-bold text-xl text-gray-900">Class 31: Fresh & Unprocessed Goods</h4>
                                                </div>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                                <div className="flex items-center mb-4">
                                                    ...
                                                    <h4 className="font-bold text-xl text-gray-900">Class 32: Beverages & Juices</h4>
                                                </div>
                                        ...
                                        <div className="relative space-y-12">
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all border border-transparent hover:border-gray-200">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900">Phase 1: Phonetic & Visual Search</h4>
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all border border-transparent hover:border-gray-200">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900">Phase 2: Digital Filing & TM Generation</h4>
                                                    <p className="text-base text-gray-600 mb-4">
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all border border-transparent hover:border-gray-200">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900">Phase 3: Legal Response & Registry Defense</h4>
                                                    <p className="text-base text-gray-600 mb-4">
                                    ...
                                    <section id="benefits-of-registration" className="scroll-mt-32 pt-12">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8 my-10">
                                            <div className="p-8 bg-blue-50 rounded-3xl">
                                                <h5 className="font-black text-blue-900 mb-3 uppercase tracking-tighter">1. Nationwide Exclusive Rights</h5>
                                            ...
                                            <div className="p-8 bg-purple-50 rounded-3xl">
                                                <h5 className="font-black text-purple-900 mb-3 uppercase tracking-tighter">2. Amazon/Flipkart Protection</h5>
                                            ...
                                            <div className="p-8 bg-indigo-50 rounded-3xl md:col-span-2">
                                                <h5 className="font-black text-indigo-900 mb-3 uppercase tracking-tighter">3. Investment & Funding Magnet</h5>
                                            ...
                                            <div className="p-8 bg-green-50 rounded-3xl">
                                                <h5 className="font-black text-green-900 mb-3 uppercase tracking-tighter">4. Franchising Ready</h5>
                                            ...
                                            <div className="p-8 bg-orange-50 rounded-3xl">
                                                <h5 className="font-black text-orange-900 mb-3 uppercase tracking-tighter">5. Deterrence for Competitors</h5>
                                    ...
                                    <section id="government-fees" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8">
                                            <div className="p-8 bg-gray-50 rounded-[2.5rem] border border-gray-100 flex flex-col items-center text-center hover:bg-white hover:shadow-2xl transition-all">
                                                ...
                                                <h5 className="font-bold text-xl mb-4 text-gray-900">Official Government Fee</h5>
                                    ...
                                    <section id="faqs" className="scroll-mt-32">
                                        <h3 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-12 text-center uppercase tracking-widest">
                                    ...
                                    <section className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[3rem] p-8 md:p-20 text-center text-white relative overflow-hidden mt-20 shadow-[-20px_20px_60px_rgba(0,0,0,0.4)]">
                                        ...
                                        <div className="relative z-10">
                                            <h3 className="text-3xl md:text-6xl font-black mb-8 leading-tight">Your Food Brand Deserves <br /> Elite Protection</h3>
                        ...
                        <aside className="hidden lg:block space-y-10 sticky top-32">
                            ...
                            <div className="bg-[#0C002B] p-10 rounded-[2.5rem] shadow-2xl border border-white/5 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-2xl font-black mb-6 relative z-10 leading-tight">Free Name Check</h4>
                            ...
                            <div className="bg-gray-50 p-10 rounded-[2.5rem] shadow-sm border border-gray-100">
                                <h4 className="text-sm font-black text-gray-900 mb-8 border-b-2 border-[rgb(110,94,147)] pb-4 uppercase tracking-widest">Related Sectors</h4>
