                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_320px] gap-4 md:gap-12 mt-8 items-start">
                        ...
                        <div className="min-w-0">
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-xl md:rounded-2xl shadow-sm border border-gray-100 prose prose-lg max-w-none text-gray-800 font-sans">
                                ...
                                <section id="official-portal" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">The IP India Public Search Portal</h3>
                                    ...
                                    <div className="grid md:grid-cols-3 gap-6 my-10 text-center">
                                        <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100">
                                            ...
                                            <h5 className="font-bold text-[#0C002B] text-xl mb-4">Wordmark</h5>
                                        ...
                                        <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100">
                                            ...
                                            <h5 className="font-bold text-[#0C002B] text-xl mb-4">Phonetic</h5>
                                        ...
                                        <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100">
                                            ...
                                            <h5 className="font-bold text-[#0C002B] text-xl mb-4">Vienna Code</h5>
                                ...
                                <section id="wordmark-search" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Mastering the Wordmark Search</h3>
                                ...
                                <section id="phonetic-search" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Sound Alike: Phonetic Protection</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify text-justify">
                                ...
                                <section id="vienna-code" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Vienna Code: Logo Investigation</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify">
                                ...
                                <section id="risk-assessment" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">The Risks of Skipping the Search</h3>
                                    <div className="grid md:grid-cols-2 gap-8 my-10">
                                        <div className="p-8 bg-red-50 rounded-3xl border border-red-100 text-center">
                                            <h6 className="font-bold text-red-900 text-xl mb-3">Infringement Battles</h6>
                                            <p className="text-sm text-red-700 text-justify">Being sued for millions before your product even gains market traction.</p>
                                        </div>
                                        <div className="p-8 bg-red-50 rounded-3xl border border-red-100 text-center">
                                            <h6 className="font-bold text-red-900 text-xl mb-3">Expensive Rebranding</h6>
                                ...
                                <section id="class-framework" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Understanding the 45 Classes</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify">
                                ...
                                <section id="prior-use" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Prior-User Rights and Investigation</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify">
                                ...
                                <section id="international-search" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">WIPO and Global Searching</h3>
                                    <div className="p-8 bg-indigo-50 border-l-8 border-[#160049] rounded-r-2xl my-10">
                                        <h5 className="font-bold text-[#0C002B] mb-2 uppercase tracking-wide">Madrid Protocol Readiness</h5>
                                ...
                                <section id="search-statuses" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Understanding Search Statuses</h3>
                                ...
                                <section id="conclusion" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6 text-center text-justify">Securing Your Brand Destiny</h3>
                                ...
                                <div className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[40px] p-10 md:p-20 text-center text-white relative overflow-hidden mt-20 shadow-2xl">
                                    <div className="relative z-10 text-center">
                                        <h3 className="text-3xl md:text-5xl font-bold mb-6">Investigate Before You Build</h3>
                        ...
                        <aside className="hidden lg:block space-y-10 sticky top-32">
                            ...
                            <div className="bg-[#0C002B] p-8 rounded-3xl shadow-xl border border-gray-800 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-2xl font-bold mb-4 relative z-10 text-justify">Brand Clearance Hub</h4>
                            ...
                            <div className="bg-gray-50 p-8 rounded-3xl shadow-sm border border-gray-100">
                                <h4 className="text-xl font-bold text-[#0C002B] mb-6 border-b pb-4 text-justify">Registry Tools</h4>
