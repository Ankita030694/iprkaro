        ...
        <div className="relative w-full overflow-hidden" 
          ...
          <div className="container mx-auto px-4 py-12 lg:py-32 relative z-10 text-center">
             <h1 className="text-2xl md:text-5xl lg:text-6xl font-extrabold mb-4 md:mb-6 leading-tight mt-20 md:mt-10 text-white">
               Stop Unauthorized Brand Use: <br />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_300px] gap-8 items-start">
              ...
              <div className="bg-white p-4 md:p-12 rounded-2xl shadow-sm border border-gray-100 space-y-12 md:space-y-20">
                ...
                <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed font-normal">
                  ...
                  <section id="legal-framework-infringement" className="scroll-mt-32">
                    <h2 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-6 leading-tight">Understanding Indian Trademark Law</h2>
                    <p className="mb-6">
                  ...
                  <section id="identifying-infringement" className="scroll-mt-32">
                    ...
                    <div className="grid md:grid-cols-2 gap-8 mb-10">
                      <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                        ...
                        <h4 className="font-bold text-xl mb-3 text-gray-900">Phonetic Similarity</h4>
                      ...
                      <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                        ...
                        <h4 className="font-bold text-xl mb-3 text-gray-900">Visual Look-alikes</h4>
                      ...
                      <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                        ...
                        <h4 className="font-bold text-xl mb-3 text-gray-900">Deceptive Similarity</h4>
                      ...
                      <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                        ...
                        <h4 className="font-bold text-xl mb-3 text-gray-900">Dilution of Reputation</h4>
                    ...
                    <div className="relative space-y-12">
                       ...
                       <div className="flex gap-8 items-start relative">
                          ...
                          <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                             <h4 className="text-xl font-bold mb-4 text-gray-900">What is a Cease and Desist Notice?</h4>
                       ...
                       <div className="flex gap-8 items-start relative">
                          ...
                          <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                             <h4 className="text-xl font-bold mb-4 text-gray-900">Essential Clauses of a Strong Notice</h4>
                             <p className="text-base text-gray-600 mb-4">
                       ...
                       <div className="flex gap-8 items-start relative">
                          ...
                          <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                             <h4 className="text-xl font-bold mb-4 text-gray-900">Tactical Delivery</h4>
                             <p className="text-base text-gray-600 mb-4">
                  ...
                  <section id="online-brand-protection" className="scroll-mt-32">
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100 flex flex-col items-center text-center">
                           ...
                           <h5 className="font-bold text-xl mb-4">Domain Name Retrieval</h5>
                        ...
                        <div className="p-8 bg-[rgb(110,94,147)] text-white rounded-3xl shadow-xl flex flex-col items-center text-center">
                           ...
                           <h5 className="font-bold text-xl mb-4">Social Media Takedowns</h5>
                  ...
                  <section className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[2.5rem] p-8 md:p-16 text-center text-white relative overflow-hidden mt-12 shadow-2xl">
                     <div className="relative z-10">
                        <h3 className="text-3xl md:text-5xl font-black mb-6 leading-tight">Stop the Misuse Before It's Too Late</h3>
            ...
            <aside className="hidden lg:block space-y-8 sticky top-32">
              ...
              <div className="bg-[#0C002B] p-8 rounded-3xl shadow-[0_20px_40px_rgba(0,0,0,0.1)] border border-gray-800 text-white relative overflow-hidden group">
                 ...
                 <h4 className="text-xl font-bold mb-4 relative z-10 leading-tight">File Your Brand Complaint</h4>
