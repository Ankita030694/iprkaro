          ...
          <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_300px] gap-8 items-start">
            ...
            <aside className="hidden lg:block sticky top-32">
              <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                <p className="text-gray-900 font-bold text-lg mb-6 border-l-4 border-[rgb(110,94,147)] pl-3 text-sm">Navigation</p>
              ...
              <div className="bg-white p-4 md:p-12 rounded-2xl shadow-sm border border-gray-100 space-y-12 md:space-y-20">
                ...
                <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed font-normal">
                  ...
                  <section id="introduction" className="scroll-mt-32">
                    <h2 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-6 leading-tight">Raw Data is Not Strategy</h2>
                    <p className="mb-6">
                  ...
                  <section id="why-legal-support" className="scroll-mt-32">
                    ...
                    <div className="grid md:grid-cols-2 gap-8 mb-10">
                      <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                        ...
                        <h4 className="font-bold text-xl mb-3 text-gray-900">Relative Grounds (Section 11)</h4>
                      ...
                      <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                        ...
                        <h4 className="font-bold text-xl mb-3 text-gray-900">Absolute Grounds (Section 9)</h4>
                  ...
                  <section id="top-india-providers" className="scroll-mt-32">
                    ...
                    <div className="space-y-12">
                      <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm relative overflow-hidden group">
                        ...
                        <h4 className="text-2xl font-bold mb-4 text-gray-900 flex items-center">
                  ...
                  <section id="what-legal-support-includes" className="scroll-mt-32">
                    ...
                    <h4 className="text-2xl font-bold mt-12 mb-6 text-gray-900">Decoding the 'Attorney Opinion' Letter</h4>
                    <p className="mb-6">
                    ...
                    <h4 className="text-2xl font-bold mt-12 mb-6 text-gray-900">The Power of Strategic Class Mapping</h4>
                    <p className="mb-6">
                  ...
                  <section id="ipr-karo-advantage" className="scroll-mt-32">
                    ...
                    <div className="space-y-4 mb-10">
                       <div className="flex items-start bg-gray-50 p-6 rounded-2xl">
                          ...
                          <div>
                             <h5 className="font-bold text-gray-900">Pre-Filing Vulnerability Audit</h5>
                       ...
                       <div className="flex items-start bg-gray-50 p-6 rounded-2xl">
                          <FontAwesomeIcon icon={faCheck} className="text-[rgb(110,94,147)] w-12 h-12 mr-4 mt-1" />
                          <div>
                             <h5 className="font-bold text-gray-900">Class 45 NICE Intelligence</h5>
                       ...
                       <div className="flex items-start bg-gray-50 p-6 rounded-2xl">
                          <FontAwesomeIcon icon={faCheck} className="text-[rgb(110,94,147)] w-12 h-12 mr-4 mt-1" />
                          <div>
                             <h5 className="font-bold text-gray-900">Phonetic Soundex Verification</h5>
                  ...
                  <section id="online-agency-risks" className="scroll-mt-32">
                    ...
                    <h4 className="text-2xl font-bold mt-12 mb-6 text-gray-900">The Problem with 'Exact Match' Thinking</h4>
                    <p className="mb-6">
                    ...
                    <h4 className="text-2xl font-bold mt-12 mb-6 text-gray-900">The Common Law Ghost: Searching Beyond the Registry</h4>
                    <p className="mb-6">
                  ...
                  <section id="cost-vs-value" className="scroll-mt-32">
                    ...
                    <div className="bg-white border-2 border-gray-100 p-8 rounded-3xl shadow-sm mb-10">
                       <h5 className="text-xl font-bold mb-4">The Price of Professionalism</h5>
                  ...
                  <section id="msme-startup-benefits" className="scroll-mt-32">
                    ...
                    <h4 className="text-2xl font-bold mt-12 mb-6 text-gray-900">Legal Support for MSME Loan and Funding Requirements</h4>
                    <p className="mb-6">
                  ...
                  <section id="hearing-support" className="scroll-mt-32">
                    <h4 className="text-2xl font-bold mt-12 mb-6 text-gray-900">Search as Shield: Role in 'Show Cause' Hearings</h4>
                    <p className="mb-6">
                  ...
                  <section className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[2.5rem] p-8 md:p-16 text-center text-white relative overflow-hidden mt-12 shadow-2xl">
                     <div className="relative z-10">
                        <h3 className="text-3xl md:text-5xl font-black mb-6 leading-tight">Get Professional Support</h3>
                  ...
                  <section id="mergers-acquisitions" className="scroll-mt-32">
                    <h4 className="text-2xl font-bold mt-12 mb-6 text-gray-900">Trademark Search in Mergers and Acquisitions (M&A)</h4>
                    <p className="mb-6">
            ...
            <aside className="hidden lg:block space-y-8 sticky top-32">
              ...
              <div className="bg-[#0C002B] p-8 rounded-3xl shadow-[0_20px_40px_rgba(0,0,0,0.1)] border border-gray-800 text-white relative overflow-hidden group">
                 ...
                 <h4 className="text-xl font-bold mb-4 relative z-10 leading-tight flex items-center">
              ...
              <div className="bg-gray-50 p-8 rounded-3xl shadow-sm border border-gray-100">
                <h4 className="text-lg font-black text-gray-900 mb-6 border-b-2 border-[rgb(110,94,147)] pb-4 uppercase tracking-widest text-sm">Legal Resources</h4>
