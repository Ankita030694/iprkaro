                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_300px] gap-8 items-start">
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-2xl shadow-sm border border-gray-100 space-y-12 md:space-y-20">
                                ...
                                <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed font-normal">
                                    ...
                                    <section id="immediate-actions" className="scroll-mt-32">
                                        <h2 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-6 leading-tight">Three Steps You Must Take Immediately</h2>
                                        <p className="mb-6">
                                        ...
                                        <div className="bg-gray-50 p-8 rounded-3xl border border-[rgb(110,94,147)] my-8">
                                            <h4 className="text-xl font-bold mb-4 text-gray-900">Why the 'Objection' Phase Exists</h4>
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8 mb-10">
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                                <div className="text-[rgb(110,94,147)] mb-4 flex items-center">
                                                    ...
                                                    <h4 className="font-bold text-xl text-gray-900">Trademark Objection</h4>
                                                </div>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                                <div className="text-[rgb(110,94,147)] mb-4 flex items-center">
                                                    ...
                                                    <h4 className="font-bold text-xl text-gray-900">Trademark Opposition</h4>
                                                </div>
                                                <ul className="text-sm space-y-3">
                                        ...
                                        <div className="space-y-8">
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900">Lack of Distinctiveness [Section 9(1)(a)]</h4>
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900">Descriptive Nature [Section 9(1)(b)]</h4>
                                                    <p className="text-base text-gray-600 mb-4">
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900">Scandalous, Religious or Prohibited [Section 9(2)]</h4>
                                                    <p className="text-base text-gray-600 mb-4">
                                    ...
                                    <section id="section-11-grounds" className="scroll-mt-32">
                                        ...
                                        <div className="bg-black text-white p-10 rounded-3xl my-10 shadow-2xl">
                                            <h4 className="text-2xl font-bold mb-4 text-[rgb(110,94,147)] uppercase">The Concept of Honest Concurrent Use</h4>
                                    ...
                                    <section id="show-cause-hearing" className="scroll-mt-32">
                                        ...
                                        <div className="bg-gray-50 p-8 rounded-3xl border border-gray-100 flex gap-6 items-center my-8 shadow-sm">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-lg mb-2 text-gray-900 uppercase">IPR Karo's Hearing Success Protocol</h5>
                                    ...
                                    <section id="costs-and-timelines" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8">
                                            <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100 flex flex-col items-center text-center shadow-sm">
                                                ...
                                                <h5 className="font-bold text-xl mb-4 text-gray-900">The Realistic Timeline</h5>
                                            ...
                                            <div className="p-8 bg-[rgb(110,94,147)] text-white rounded-3xl shadow-xl flex flex-col items-center text-center">
                                                ...
                                                <h5 className="font-bold text-xl mb-4 text-white">Legal Service Investment</h5>
                        ...
                        <aside className="hidden lg:block space-y-8 sticky top-32">
                            <div className="bg-[#0C002B] p-8 rounded-3xl shadow-[0_20px_40px_rgba(0,0,0,0.1)] border border-gray-800 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-xl font-bold mb-4 relative z-10 leading-tight">Urgent: 30 Day Deadline</h4>
