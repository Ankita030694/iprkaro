                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_300px] gap-8 items-start">
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-2xl shadow-sm border border-gray-100 space-y-12 md:space-y-20">
                                ...
                                <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed font-normal">
                                    ...
                                    <section id="importance-of-trademark" className="scroll-mt-32">
                                        <h2 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-6 leading-tight">Trademark Registration for Ropes and Tents</h2>
                                        <p className="mb-6">
                                    ...
                                    <section id="class-22-overview" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8 mb-10">
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                                ...
                                                <h4 className="font-bold text-xl mb-3 text-gray-900">Cordage & Ropes</h4>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                                ...
                                                <h4 className="font-bold text-xl mb-3 text-gray-900">Outdoor Shelters</h4>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                                ...
                                                <h4 className="font-bold text-xl mb-3 text-gray-900">Packing & Sacks</h4>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-2xl border border-transparent hover:border-[rgb(110,94,147)] hover:bg-white transition-all shadow-sm">
                                                ...
                                                <h4 className="font-bold text-xl mb-3 text-gray-900">Marine & Sailing</h4>
                                        ...
                                        <div className="relative space-y-12">
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900">1. AI-Powered Availability Search</h4>
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900">2. Filing the Form TM-A</h4>
                                                    <p className="text-base text-gray-600 mb-4">
                                            ...
                                            <div className="flex gap-8 items-start relative">
                                                ...
                                                <div className="bg-gray-50 p-8 rounded-3xl flex-1 hover:shadow-xl transition-all">
                                                    <h4 className="text-xl font-bold mb-4 text-gray-900">3. Examination and Official Objections</h4>
                                                    <p className="text-base text-gray-600 mb-4">
                                    ...
                                    <section id="overcoming-objections" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8 mb-12">
                                            <div className="bg-white border-2 border-gray-100 p-8 rounded-2xl hover:border-red-100 transition-colors">
                                                <h5 className="text-red-600 font-black uppercase text-xs tracking-widest mb-4">Challenge A</h5>
                                                <h4 className="text-xl font-bold mb-4 text-gray-900">Section 11 Objections: Relative Grounds</h4>
                                            ...
                                            <div className="bg-white border-2 border-gray-100 p-8 rounded-2xl hover:border-orange-100 transition-colors">
                                                <h5 className="text-orange-600 font-black uppercase text-xs tracking-widest mb-4">Challenge B</h5>
                                                <h4 className="text-xl font-bold mb-4 text-gray-900">Third Party Opposition</h4>
                                                <p className="text-sm text-gray-600 leading-relaxed">
                                    ...
                                    <section id="reviews" className="scroll-mt-32">
                                        <h3 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-8 border-b-4 border-[rgb(110,94,147)] pb-4 inline-block">
                        ...
                        <aside className="hidden lg:block space-y-8 sticky top-32">
                            ...
                            <div className="bg-[#0C002B] p-8 rounded-3xl shadow-[0_20px_40px_rgba(0,0,0,0.1)] border border-gray-800 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-xl font-bold mb-4 relative z-10 leading-tight">Is Your Name Protected?</h4>
