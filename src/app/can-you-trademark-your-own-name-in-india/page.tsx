...
const tocSections = [
    { id: 'introduction', title: 'Can You Trademark Your Own Name' },
    { id: 'section-9', title: 'Can You Trademark Your Own Name' },
    { id: 'acquired-distinctiveness', title: 'Can You Trademark Your Own Name' },
    { id: 'section-11', title: 'Can You Trademark Your Own Name' },
    { id: 'section-35', title: 'Can You Trademark Your Own Name' },
    { id: 'case-laws', title: 'Can You Trademark Your Own Name' },
    { id: 'celebrity-rights', title: 'Can You Trademark Your Own Name' },
    { id: 'registration-steps', title: 'Can You Trademark Your Own Name' },
    { id: 'expert-strategy', title: 'Can You Trademark Your Own Name' },
    { id: 'reviews', title: 'Can You Trademark Your Own Name' },
    { id: 'faqs', title: 'Can You Trademark Your Own Name' },
];
...
export default function PersonalNameTrademarkPage() {
    ...
    const articleSchema = {
        "@context": "https://schema.org",
        "@type": "Article",
        "headline": "Can You Trademark Your Own Name",
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_300px] gap-8 items-start">
                        ...
                        <aside className="hidden lg:block sticky top-32 h-[calc(100vh-160px)] overflow-y-auto">
                            <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                                <p className="text-gray-900 font-bold text-lg mb-6 border-l-4 border-[rgb(110,94,147)] pl-3">Personal IP Guide</p>
                                ...
                                <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed font-normal">
                                    ...
                                    <section id="section-9" className="scroll-mt-32">
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8 mb-12">
                                            <div className="bg-gray-50 p-8 rounded-3xl border border-transparent hover:border-[rgb(110,94,147)] transition-all shadow-sm group">
                                                ...
                                                <h4 className="font-bold text-base mb-2 uppercase tracking-tighter">Inherent Distinctiveness</h4>
                                            ...
                                            <div className="bg-gray-50 p-8 rounded-3xl border border-transparent hover:border-[rgb(110,94,147)] transition-all shadow-sm group">
                                                ...
                                                <h4 className="font-bold text-base mb-2 uppercase tracking-tighter">Non-Descriptive Rule</h4>
                                    ...
                                    <section id="acquired-distinctiveness" className="scroll-mt-32 pt-16">
                                        ...
                                        <div className="bg-blue-50 border-x-4 border-blue-500 p-8 rounded-2xl my-10">
                                            <h5 className="font-bold text-blue-900 mb-2 uppercase">The Evidence Test</h5>
                                    ...
                                    <section id="case-laws" className="scroll-mt-32 pt-20">
                                        ...
                                        <div className="space-y-8">
                                            <div className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm relative group overflow-hidden">
                                                ...
                                                <h5 className="font-black text-xl mb-2 flex items-center">
                                    ...
                                    <section id="celebrity-rights" className="scroll-mt-32 pt-16">
                                        ...
                                        <div className="bg-gray-900 text-white p-12 rounded-[3.5rem] my-12 relative overflow-hidden group border border-white/5">
                                            ...
                                            <h5 className="font-black text-xl mb-6 relative z-10 font-black tracking-widest uppercase">The Publicity Bar</h5>
                                    ...
                                    <section id="registration-steps" className="scroll-mt-32 pt-16">
                                        ...
                                        <div className="grid md:grid-cols-4 gap-4">
                                            <div className="bg-gray-50 p-6 rounded-2xl text-center border border-gray-100 shadow-sm hover:translate-y-[-5px] transition-transform">
                                                ...
                                                <h6 className="font-bold text-[10px] uppercase mb-2">Public Search</h6>
                                            ...
                                            <div className="bg-gray-50 p-6 rounded-2xl text-center border border-gray-100 shadow-sm hover:translate-y-[-5px] transition-transform">
                                                ...
                                                <h6 className="font-bold text-[10px] uppercase mb-2">Evidence Audit</h6>
                                            ...
                                            <div className="bg-gray-50 p-6 rounded-2xl text-center border border-gray-100 shadow-sm hover:translate-y-[-5px] transition-transform">
                                                ...
                                                <h6 className="font-bold text-[10px] uppercase mb-2">Filing Form TM-A</h6>
                                            ...
                                            <div className="bg-gray-50 p-6 rounded-2xl text-center border border-gray-100 shadow-sm hover:translate-y-[-5px] transition-transform">
                                                ...
                                                <h6 className="font-bold text-[10px] uppercase mb-2">Examination</h6>
                                    ...
                                    <section className="bg-black text-white p-12 rounded-[3.5rem] my-16 shadow-2xl relative overflow-hidden group border border-white/5">
                                        ...
                                        <h3 className="text-3xl md:text-5xl font-black mb-8 leading-tight">Ready to Protect Your Name?</h3>
                        ...
                        <aside className="hidden lg:block space-y-8 sticky top-32">
                            ...
                            <div className="bg-[#0C002B] p-8 rounded-3xl shadow-[0_20px_40px_rgba(0,0,0,0.1)] border border-gray-800 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-xl font-bold mb-4 relative z-10 leading-tight">Name Rights Audit</h4>
                            ...
                            <div className="bg-gray-50 p-8 rounded-3xl shadow-sm border border-gray-100">
                                <h4 className="text-lg font-black text-gray-900 mb-6 border-b-2 border-[rgb(110,94,147)] pb-4 uppercase tracking-widest">Brand Legal</h4>
