            ...
            <div className="min-w-0">
              ...
              <div className="bg-white p-4 md:p-12 rounded-xl md:rounded-2xl shadow-sm space-y-8 md:space-y-16">
                ...
                <section id="importance-of-trademark-renewal" className="scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Importance of Trademark Renewal</h3>
                  <p className="text-base md:text-lg leading-relaxed mb-4 md:mb-6 text-gray-700">
                ...
                <section id="duration-of-trademark-registration" className="scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Duration of Trademark Registration in India</h3>
                  <p className="text-base md:text-lg leading-relaxed mb-4 md:mb-6 text-gray-700">
                ...
                <section id="renewal-process" className="scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Renewal Process for Trademark Registration</h3>
                  <p className="text-base md:text-lg leading-relaxed mb-4 md:mb-6 text-gray-700">
                 ...
                 <section id="timeline-for-trademark-renewal" className="scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Timeline for Trademark Renewal</h3>
                  <p className="text-base md:text-lg leading-relaxed mb-4 md:mb-6 text-gray-700">
                ...
                <section id="fees-associated-with-renewal" className="scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Fees Associated with Trademark Renewal</h3>
                  <p className="text-base md:text-lg leading-relaxed mb-4 md:mb-6 text-gray-700">
                ...
                <section id="consequences-of-failing-to-renew" className="scroll-mt-24 md:scroll-mt-32">
                   <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Consequences of Failing to Renew a Trademark</h3>
                ...
                <section id="tips-for-keeping-track" className="scroll-mt-24 md:scroll-mt-32">
                   <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Tips for Keeping Track of Trademark Renewals</h3>
                   <p className="text-base md:text-lg leading-relaxed mb-4 text-gray-700">
                ...
                <section id="faqs" className="scroll-mt-24 md:scroll-mt-32">
                  <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-6 md:mb-8">Common Questions About Trademark Renewal</h3>
                ...
                <section id="conclusion" className="scroll-mt-24 md:scroll-mt-32">
                   <h3 className="text-xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Conclusion and Final Thoughts</h3>
                   <p className="text-base md:text-lg leading-relaxed mb-4 text-gray-700">
