    ...
    const breadcrumbSchema = {
        ...
        "itemListElement": [
            ...
            },
            {
                ...
                "item": "https://www.iprkaro.com/trademark-registration-in-punjab"
            }
        ]
    };
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[280px_1fr_320px] gap-8 items-start">
                        <aside className="hidden lg:block sticky top-32">
                            <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                                <p className="text-gray-900 font-bold text-lg mb-6 border-l-4 border-[rgb(110,94,147)] pl-3">Punjab Guide</p>
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-2xl shadow-sm border border-gray-100 space-y-12 md:space-y-20 article-content">
                                <article className="prose prose-lg max-w-none text-gray-700 leading-relaxed font-normal">
                                    ...
                                    <section id="ludhiana" className="scroll-mt-32 pt-12">
                                        <h3 className="text-2xl md:text-4xl font-black text-gray-900 mb-8 flex items-center"><FontAwesomeIcon icon={faIndustry} className="w-12 h-12 mr-4 text-[rgb(110,94,147)]" />Ludhiana: The Hosiery and Cycle Capital</h3>
                                    ...
                                    <section id="jalandhar" className="scroll-mt-32 pt-12">
                                        <h3 className="text-2xl md:text-4xl font-black text-gray-900 mb-8 flex items-center"><FontAwesomeIcon icon={faAward} className="w-12 h-12 mr-4 text-[rgb(110,94,147)]" />Jalandhar: Sports Goods and Hand Tools</h3>
                                    ...
                                    <section id="amritsar" className="scroll-mt-32 pt-12">
                                        <h3 className="text-2xl md:text-4xl font-black text-gray-900 mb-8 flex items-center"><FontAwesomeIcon icon={faGlobe} className="w-8 h-8 mr-4 text-[rgb(110,94,147)]" />Amritsar: Textiles and Spiritual Commerce</h3>
                                    ...
                                    <section id="mohali" className="scroll-mt-32 pt-12">
                                        <h3 className="text-2xl md:text-4xl font-black text-gray-900 mb-8 flex items-center"><FontAwesomeIcon icon={faMicrochip} className="w-8 h-8 mr-4 text-[rgb(110,94,147)]" />Mohali: The IT and SaaS Disruptor</h3>
                                    ...
                                    <section id="gobindgarh" className="scroll-mt-32 pt-12">
                                        <h3 className="text-2xl md:text-4xl font-black text-gray-900 mb-8 flex items-center"><FontAwesomeIcon icon={faGavel} className="w-8 h-8 mr-4 text-[rgb(110,94,147)]" />Mandi Gobindgarh: The Iron & Steel Capital of Punjab</h3>
                                    ...
                                    <section id="process" className="scroll-mt-32 pt-12">
                                        <h3 className="text-2xl md:text-4xl font-black text-gray-900 mb-8 flex items-center"><FontAwesomeIcon icon={faScaleBalanced} className="w-8 h-8 mr-4 text-[rgb(110,94,147)]" />The IPR Karo 8-Step Filing Journey for Punjab</h3>
                                    ...
                                    <section id="benefits" className="scroll-mt-32 pt-12">
                                        <h3 className="text-2xl md:text-4xl font-black text-gray-900 mb-8 flex items-center"><FontAwesomeIcon icon={faShieldHalved} className="w-8 h-8 mr-4 text-[rgb(110,94,147)]" />MSME Benefits under Punjab Industrial & Business Development Policy 2022</h3>
                                    ...
                                    <section id="remedies" className="scroll-mt-32 pt-12">
                                        <h3 className="text-2xl md:text-4xl font-black text-gray-900 mb-8 flex items-center"><FontAwesomeIcon icon={faScaleBalanced} className="w-8 h-8 mr-4 text-[rgb(110,94,147)]" />Legal Remedies for Trademark Infringement in Punjab</h3>
                                        ...
                                        <div className="grid md:grid-cols-2 gap-8 mb-8">
                                            <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100">
                                                <h5 className="font-bold text-gray-900 mb-3 flex items-center"><FontAwesomeIcon icon={faGavel} className="w-5 h-5 mr-2 text-[rgb(110,94,147)]" /> Civil Action</h5>
                                            ...
                                            <div className="bg-gray-50 p-6 rounded-2xl border border-gray-100">
                                                <h5 className="font-bold text-gray-900 mb-3 flex items-center"><FontAwesomeIcon icon={faMicrochip} className="w-5 h-5 mr-2 text-[rgb(110,94,147)]" /> Criminal Action</h5>
                                    ...
                                    <section id="pitfalls" className="scroll-mt-32 pt-12 text-gray-700 font-medium">
                                        <h3 className="text-2xl md:text-4xl font-black text-gray-900 mb-8 flex items-center"><FontAwesomeIcon icon={faGavel} className="w-8 h-8 mr-4 text-[rgb(110,94,147)]" />Avoiding Common Pitfalls in Punjab</h3>
                                    ...
                                    <section id="faqs" className="scroll-mt-32 pt-12">
                                        <h3 className="text-2xl md:text-3xl lg:text-4xl font-black text-gray-900 mb-12 text-center text-[rgb(110,94,147)] uppercase tracking-tighter">Punjab Trademark FAQ</h3>
                                    ...
                                    <section id="reviews" className="scroll-mt-32 pt-16 border-t border-gray-100">
                                        <h3 className="text-2xl md:text-4xl font-black text-gray-900 mb-12 text-center text-[rgb(110,94,147)]">Why Punjab Trusts IPR Karo</h3>
                        ...
                        <aside className="hidden lg:block space-y-8 sticky top-32">
                            <div className="bg-[#0C002B] p-10 rounded-[2.5rem] shadow-2xl border border-white/5 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-2xl font-black mb-6 relative z-10 leading-tight">Punjab Brand Search</h4>
                            ...
                            <div className="bg-gray-50 p-10 rounded-[2.5rem] shadow-sm border border-gray-100">
                                <h4 className="text-sm font-black text-gray-400 mb-8 uppercase tracking-[0.3em]">Punjab Links</h4>
