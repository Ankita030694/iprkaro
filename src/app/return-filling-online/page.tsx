                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[220px_1fr_300px] gap-4 md:gap-12 mt-8 items-start">
                        ...
                        <div className="min-w-0">
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-xl md:rounded-2xl shadow-sm border border-gray-100 prose prose-lg max-w-none text-gray-800 font-sans">
                                ...
                                <section id="introduction" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h2 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6">Online Return Filing in India</h2>
                                ...
                                <section id="itr-portal-overview" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">E-Filing 2.0: Navigating the New Income Tax Portal</h3>
                                ...
                                <section id="ais-tis-forensics" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">AIS & TIS Scrutiny: The Department’s Panoramic View of Your Finances</h3>
                                    <p className="mb-4 leading-relaxed text-lg">
                                ...
                                <section id="itr-forms-guide" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">ITR Forms Decoder: Which Form (ITR-1 to 7) is for You?</h3>
                                    ...
                                    <div className="space-y-6 my-10">
                                        <div className="p-8 bg-gray-50 rounded-3xl border border-gray-200 group hover:shadow-md transition-all">
                                            <h5 className="font-bold text-[#0C002B] text-2xl mb-4">ITR-1 (Sahaj)</h5>
                                        ...
                                        <div className="p-8 bg-indigo-50 rounded-3xl border border-indigo-100 group hover:shadow-md transition-all">
                                            <h5 className="font-bold text-[#0C002B] text-2xl mb-4">ITR-4 (Sugam)</h5>
                                        ...
                                        <div className="p-8 bg-gray-50 rounded-3xl border border-gray-200 group hover:shadow-md transition-all">
                                            <h5 className="font-bold text-[#0C002B] text-2xl mb-4">ITR-3</h5>
                                ...
                                <section id="updated-returns" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Section 139(8A): Fixing Mistakes with the Updated Return (ITR-U)</h3>
                                    <p className="mb-4 leading-relaxed text-lg">
                                ...
                                <section id="gst-returns-basics" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">GST Return Basics: Understanding GSTR-1 and GSTR-3B</h3>
                                    <p className="mb-6 leading-relaxed text-lg">
                                    ...
                                    <ul className="space-y-6 my-10 list-none p-0 text-lg">
                                        <li className="flex gap-4 p-6 bg-gray-50 rounded-2xl border border-gray-200 shadow-sm">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-[#0C002B] text-xl mb-1">GSTR-1 (Outward Supplies)</h5>
                                        ...
                                        <li className="flex gap-4 p-6 bg-indigo-50 rounded-2xl border border-indigo-100 shadow-sm">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-[#0C002B] text-xl mb-1">GSTR-3B (Payment Return)</h5>
                                ...
                                <section id="gst-reconciliation" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">The Art of Reconciliation: GSTR-2B vs GSTR-3B Matching</h3>
                                    <p className="mb-4 leading-relaxed text-lg">
                                ...
                                <section id="e-verification" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">E-Verification: How to Complete Your Filing with Aadhaar OTP</h3>
                                    <p className="mb-6 leading-relaxed text-lg">
                                    ...
                                    <div className="p-8 bg-[#0C002B] text-white rounded-[2rem] shadow-2xl my-10">
                                        <h5 className="text-cyan-400 font-bold text-2xl mb-4">The 30-Day Rule</h5>
                                ...
                                <section id="why-iprkaro" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6 text-center">Why Businesses Trust IPR Karo for Tax & Compliance Forensics</h3>
                                    ...
                                    <div className="grid md:grid-cols-3 gap-8 text-center bg-[#0C002B] p-10 rounded-[3rem] text-white">
                                        <div className="space-y-4">
                                            ...
                                            <h5 className="font-bold text-xl">AIS Scrutiny</h5>
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <h5 className="font-bold text-xl">Audit Preparedness</h5>
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <h5 className="font-bold text-xl">ITC Optimization</h5>
                                ...
                                <section id="conclusion" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6 text-center">Conclusion: Tax Maturity: From Burden to Business Asset</h3>
                                ...
                                <div className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[40px] p-10 md:p-20 text-center text-white relative overflow-hidden mt-20 shadow-2xl">
                                    <div className="relative z-10">
                                        <h3 className="text-3xl md:text-5xl font-bold mb-6">Want to File Worry-Free?</h3>
                        ...
                        <aside className="hidden lg:block space-y-10 sticky top-32">
                            ...
                            <div className="bg-[#0C002B] p-8 rounded-3xl shadow-xl border border-gray-800 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-2xl font-bold mb-4 relative z-10">Tax Notice Support</h4>
                            ...
                            <div className="bg-gray-50 p-8 rounded-3xl shadow-sm border border-gray-100">
                                <h4 className="text-xl font-bold text-[#0C002B] mb-6 border-b pb-4">Tax Knowledge</h4>
