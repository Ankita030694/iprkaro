                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-[250px_1fr_320px] gap-4 md:gap-12 mt-8 items-start">
                        ...
                        <div className="min-w-0">
                            ...
                            <div className="bg-white p-4 md:p-12 rounded-xl md:rounded-2xl shadow-sm border border-gray-100 prose prose-lg max-w-none text-gray-800 font-sans">
                                ...
                                <section id="statutory-foundation" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Statutory Foundation: The Trade Marks Act, 1999</h3>
                                    ...
                                    <div className="grid md:grid-cols-2 gap-6 my-10 text-center">
                                        <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100">
                                            <h5 className="font-bold text-[#0C002B] text-xl mb-4">Rule 57 (Rules 2017)</h5>
                                        ...
                                        <div className="p-8 bg-gray-50 rounded-3xl border border-gray-100">
                                            <h5 className="font-bold text-[#0C002B] text-xl mb-4">Section 25(3)</h5>
                                ...
                                <section id="lifecycle" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">The 10-Year Lifecycle: Validity & Expiry</h3>
                                ...
                                <section id="renewal-window" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">The Renewal Window: When to File Form TM-R</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify">
                                    ...
                                    <ul className="space-y-6 my-10 list-none p-0">
                                        <li className="flex gap-4 p-6 bg-white border border-gray-100 rounded-2xl shadow-sm hover:border-[#6E5E93] transition-colors">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-[#0C002B] text-xl">12 Months Early</h5>
                                        ...
                                        <li className="flex gap-4 p-6 bg-white border border-gray-100 rounded-2xl shadow-sm hover:border-[#6E5E93] transition-colors">
                                            ...
                                            <div>
                                                <h5 className="font-bold text-[#0C002B] text-xl">The O-3 Notice</h5>
                                ...
                                <section id="filing-guide" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Step-by-Step Filing Guide: IP India Portal</h3>
                                ...
                                <section id="fee-structure" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Fee Structure 2026: Per Class Breakdown</h3>
                                ...
                                <section id="grace-period" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">The Grace Period: The 6-Month Safety Net</h3>
                                    <p className="mb-4 leading-relaxed text-lg text-justify">
                                    ...
                                    <div className="p-8 bg-indigo-50 border-l-8 border-[#160049] rounded-r-2xl my-10">
                                        <h5 className="font-bold text-[#160049] mb-2 uppercase tracking-wide">The Surcharge Penalty</h5>
                                ...
                                <section id="restoration" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Trademark Restoration: Resurrecting a Removed Mark</h3>
                                    <div className="p-10 bg-gradient-to-br from-indigo-900 to-blue-900 text-white rounded-[3rem] shadow-2xl my-10 relative overflow-hidden group">
                                        <div className="relative z-10 flex flex-col md:flex-row gap-8 items-center">
                                            ...
                                            <div>
                                                <h5 className="text-2xl font-bold mb-3">Post-Removal Resurrection</h5>
                                ...
                                <section id="consequences" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-3xl font-bold text-[#0C002B] mb-6">Consequences of Non-Renewal: Legal Loss</h3>
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-10">
                                        <div className="p-8 bg-white border border-gray-100 rounded-3xl shadow-sm hover:border-red-100 transition-all group">
                                            ...
                                            <h5 className="font-bold text-[#0C002B] text-xl mb-2">Loss of Protection</h5>
                                        ...
                                        <div className="p-8 bg-white border border-gray-100 rounded-3xl shadow-sm hover:border-red-100 transition-all group">
                                            ...
                                            <h5 className="font-bold text-[#0C002B] text-xl mb-2">Third-Party Registration</h5>
                                ...
                                <section id="conclusion" className="mb-12 scroll-mt-24 md:scroll-mt-32">
                                    <h3 className="text-2xl md:text-4xl font-bold text-[#0C002B] mb-6 text-center text-justify">Eternal Brand Protection</h3>
                                ...
                                <div className="bg-gradient-to-br from-[#0C002B] to-[#1a0033] rounded-[40px] p-10 md:p-20 text-center text-white relative overflow-hidden mt-20 shadow-2xl">
                                    <div className="relative z-10">
                                        <h3 className="text-3xl md:text-5xl font-bold mb-6">Renew Your Brand Immunity</h3>
                        ...
                        <aside className="hidden lg:block space-y-10 sticky top-32">
                            ...
                            <div className="bg-[#0C002B] p-8 rounded-3xl shadow-xl border border-gray-800 text-white relative overflow-hidden group">
                                ...
                                <h4 className="text-2xl font-bold mb-4 relative z-10">Is Your Expiry Near?</h4>
                            ...
                            <div className="bg-gray-50 p-8 rounded-3xl shadow-sm border border-gray-100">
                                <h4 className="text-xl font-bold text-[#0C002B] mb-6 border-b pb-4">Renewal Resources</h4>
