...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      {
        source: '/Can-two-trademarks-exist-in-different-classes-in-India',
        destination: '/can-two-trademarks-exist-in-different-classes-in-india',
        permanent: true,
      },
      {
        source: '/What-happens-after-trademark-opposition-is-filed',
        destination: '/what-happens-after-trademark-opposition-is-filed',
        permanent: true,
      },
      {
    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: "default-src 'self'; script-src 'self' 'unsafe-eval' 'unsafe-inline' https://www.googletagmanager.com https://connect.facebook.net https://vercel.live https://va.vercel-scripts.com https://apis.google.com https://*.clerk.accounts.dev https://clerk.iprkaro.com; style-src 'self' 'unsafe-inline' https://cdnjs.cloudflare.com https://fonts.googleapis.com; img-src 'self' data: blob: https://www.google-analytics.com https://www.facebook.com https://firebasestorage.googleapis.com https://image.pollinations.ai https://images.unsplash.com https://img.clerk.com; font-src 'self' data: https://cdnjs.cloudflare.com https://fonts.gstatic.com; connect-src 'self' https://firestore.googleapis.com https://identitytoolkit.googleapis.com https://iprkaro-729d3.firebaseapp.com https://firebasestorage.googleapis.com https://www.google-analytics.com https://region1.google-analytics.com https://www.googletagmanager.com https://connect.facebook.net https://mpc-prod-23-s6uit34pua-ue.a.run.app https://apis.google.com https://*.clerk.accounts.dev https://api.clerk.com https://clerk.iprkaro.com https://vitals.vercel-insights.com wss://*.clerk.accounts.dev wss://vercel.live ws://localhost:* wss://localhost:*; frame-src 'self' https://www.youtube.com https://www.google.com https://connect.facebook.net; media-src 'self' https://firebasestorage.googleapis.com; object-src 'none'; base-uri 'self'; form-action 'self';",
          },
        ],
      },
      {
